...
//die($clemppresta->sql_query(null,"*","o58_orgao, e45_data","$txt_where"));
$result=$clemppresta->sql_record($clemppresta->sql_query(null,"*","o58_orgao, e45_data","$txt_where"));
...
for($x = 0; $x < $clemppresta->numrows;$x++) {
   ...
   if ($pdf->gety() > $pdf->h - 30 || $troca != 0 ) {
      ...
      $pdf->cell(70,$alt,'Nome do Servidor',1,0,"C",1); 
      ...
      $pdf->cell(40,$alt,"Instituicao",1,1,"C",1);
      $p=0;
      $troca = 0;
  }
   ...
   if ($x == $clemppresta->numrows or $orgao != $o58_orgao) {
     ...
     if ($totalreg > 0) {
       $pdf->cell(146,$alt,"TOTAL DE REGISTROS: $totalreg","T",0,"L",0);
     ...
     $pdf->setfont('arial','b',8);
     $pdf->ln();
     $pdf->cell(275,$alt,"ORGAO: $o58_orgao - $o40_descr","TB",0,"L",1);
     $pdf->ln();
     $orgao = $o58_orgao;
  ...
  $pdf->setfont('arial','',8);
  $pdf->cell(15,$alt,trim($e60_codemp),0,0,"C",$p);
  ...
  $valor_gasto=0;
  $result_valor=$clempprestaitem->sql_record($clempprestaitem->sql_query(null,"*",null,"e46_numemp=$e45_numemp"));
//  echo $clempprestaitem->sql_query(null,"*",null,"e46_numemp=$e45_numemp");
  ...
  if (isset($e54_acerta) && trim(@$e54_acerta) == "" && isset($e45_cnferido) && trim(@$e45_conferido) ==""){
      $anular_despesa=0; 
  } else {
...
$pdf->setfont('arial','b',8);
$pdf->ln(3);
$pdf->cell(146,$alt,"TOTAL GERAL DE REGISTROS: $total","T",0,"L",0);
