...
if($quebrar == 'n'){
  $head3 = "RELATÓRIO DE FUNCIONARIOS";
  $ordem = ' z01_nome';
}else{
  $head3 = "RELATÓRIO DE FUNCIONÁRIOS POR SECRETARIA";
...
case substr(r70_estrut,2,2)
            ...
            when '02' then 'SECRETARIA DA ADMINISTRAÇÃO'                                
            ...
            when '07' then 'SECRETARIA DE SAÚDE'                                
            when '08' then 'SECRETARIA DA ASSISTÊNCIA SOCIAL'                                
            when '09' then 'SECRETARIA DE TRANSPORTES E TRÂNSITO'                                
