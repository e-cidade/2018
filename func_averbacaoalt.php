    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_j75_codigo) && (trim($chave_j75_codigo)!="") ){
	         $sql = $claverbacao->sql_query($chave_j75_codigo,$campos,"j75_codigo","j75_codigo = $chave_j75_codigo and $db_where");
        }else{
           $sql = $claverbacao->sql_query("",$campos,"j75_codigo",$db_where);
        }
        $repassa = array();
...
?>
<script>
js_tabulacaoforms("form2","chave_j75_codigo",true,1,"chave_j75_codigo",true);
</script>