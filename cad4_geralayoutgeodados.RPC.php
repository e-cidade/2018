    ...
    case "geraDados":
      ...
      switch ($oParam->iFormato) {
        ...
        case 2:   // VERSAO
          ...
          layout2($aGeodados, $aCaracteristicasDisponiveis, $sTmpNomeArquivo, $sZipTmpNomeArquivo);
...
function layout2($aGeodados, $aCaracteristicasDisponiveis, $sNomeArquivo, $sZipTmpNomeArquivo) {
  ...
  geraLinhaArquivo($pArquivo, $oGeodadosLayout2, true);
    ...
    foreach ($aImoveis as $oImovel) {
      ...
      if(count($aConstrucoes) > 0) {
        ...
        foreach ($aConstrucoes as $oConstrucao) {
          ...
          geraLinhaArquivo($pArquivo, $oGeodadosLayout2);
...
function geraLinhaArquivo($pArquivo, $oLinhaArquivo, $lCabecalho = false) {
  ...
  fputs($pArquivo, '"'.implode('";"', (array) $oLinha).'"'. "\n");
