...
DBViewCadastroAtributoDinamico = function () {
  ...
  this.showForm = function () {
    ...
    oCboTipoAtt.addItem('2', 'Número sem casas decimais');
    oCboTipoAtt.addItem('3', 'Data');
    oCboTipoAtt.addItem('4', 'Número com casas decimais');
