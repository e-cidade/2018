...
function js_ValidaCamposText(obj,tipo) {
  if(tipo == 4) {
    ...
    if(obj.value.match(expr)) {
	  alert("Este campo deve ser preenchido sómente com números decimais!");
	  obj.select();	
	}
  } else if(tipo == 1) {
    var expr = new RegExp("[^0-9]+");
    if(obj.value.match(expr)) {
	  alert("Este campo deve ser preenchido sómente com números!");
	  obj.select();	
	}
  } else if(tipo == 2) {
    var expr = new RegExp("[^A-Za-zà-úÁ-ÚüÜ]+");
    if(obj.value.match(expr)) {
	  alert("Este campo deve ser preenchido sómente com Letras!");
	  obj.select();	
	}  
  } else if(tipo == 3) {
    var expr = new RegExp("[^A-Za-z0-9à-úÁ-ÚüÜ \.,;:@&%-\_]+");
	if(obj.value.match(expr)) {
	  alert("Este campo deve ser preenchido sómente com Letras, números, espaço, virgula, ponto-e-virgula, hífen,2 pontos,arroba,sublinhado!");
	  obj.select();	
	}  
  }
}
...
function js_ValidaCampos(obj,tipo,nome,aceitanulo,maiusculo,evt) {
  ...
  if(tipo == 1) {
    var expr = new RegExp("[^0-9]+");
    if(obj.value.match(expr)) {
	  alert(nome+" deve ser preenchido sómente com números!");
	  obj.select();	
	  obj.focus();	
	}
  } else if(tipo == 2) {
    var expr = new RegExp("[^A-Za-zà-úÁ-ÚüÜ]+");
    if(obj.value.match(expr)) {
	  alert(nome+" deve ser preenchido sómente com Letras!");
	  obj.select();	
	  obj.focus();	
	}  
  } else if(tipo == 3) {
    var expr = new RegExp("[^A-Za-z0-9à-úÁ-ÚüÜ \.,;:@&%-\_]+");
	if(obj.value.match(expr)) {
	  alert(nome+" deve ser preenchido sómente com Letras, números, espaço, virgula, ponto-e-virgula, hífen,2 pontos,arroba,sublinhado!");
	  obj.select();	
	  obj.focus();	
	}  
  } else  if(tipo == 4) {
    var expr = new RegExp("[^0-9\.]+");
    if(obj.value.match(expr)) {
	  alert(nome+" deve ser preenchido sómente com números decimais!");
	  obj.select();	
	  obj.focus();	
	}
  } else  if(tipo == 5) {
    ...
    if(obj.value.match(expr)) {
	  alert(nome+" deve ser preenchido sómente com falso ou verdadeiro!");
	  obj.select();	
	  obj.focus();	
	}
  }
