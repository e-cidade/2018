...
switch ($oParam->exec) {
  ...
  case "getQuantidadeRestanteItemEstimativa" :
    ...
    $sSqlItem = $oDaoSolicitempcmater->sql_query_itemEstimativa($oParam->iNumeroSolicitacao, $oParam->iCodigoMaterial, $iDepartamento);
    $rsItem   = $oDaoSolicitempcmater->sql_record($sSqlItem);

    /**
     * Nao encontrou item, ou erro de query 
     */
    ...
    $oDaoItem = db_utils::fieldsMemory($rsItem, 0);
    $iCodigoItemORigem = $oDaoItem->pc16_solicitem;
