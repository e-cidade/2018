...
/**
 * Este Fonte substitui o fonte cai3_gerfinanc027.php
 */
...
//   echo "<pre>";
//   print_r($oDadosCgm[0]->complemento);
//   echo "</pre>";
  $oPdf->Text( 5  , 42 ,"Nome:");
...
//   if ($oDadosProcessoForo->processo_foro[0]->inicial == 504313) {
//     echo "<pre>";
//     print_r($oDadosProcessoForo);
//     echo "</pre>";
//   }
