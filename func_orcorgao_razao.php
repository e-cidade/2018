     ...
     $campos = " distinct orcorgao.o40_orgao,orcorgao.o40_codtri,orcorgao.o40_descr,orcorgao.o40_instit,orcorgao.o40_anousu as db_o40_anousu";
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_o40_orgao) && (trim($chave_o40_orgao)!="") ){
	         $sql = $clorcorgao->sql_query_razao(null,null,$campos,"o40_orgao","o40_anousu=".db_getsession('DB_anousu')." and o40_orgao = $chave_o40_orgao and o40_instit= ".db_getsession('DB_instit'));
        }else if(isset($chave_o40_descr) && (trim($chave_o40_descr)!="") ){
	         $sql = $clorcorgao->sql_query_razao(db_getsession('DB_anousu'),"",$campos,"o40_descr"," o40_descr like '$chave_o40_descr%'  and o40_instit= ".db_getsession('DB_instit'));
        }else if(isset($o40_instit)){
           $sql = $clorcorgao->sql_query_razao("","",$campos,"o40_anousu#o40_orgao","o40_anousu=".db_getsession('DB_anousu')." and o40_instit=".db_getsession('DB_instit'));
        }else{
           $sql = $clorcorgao->sql_query_razao(null,null,$campos,"o40_anousu#o40_orgao"," o40_anousu = ".db_getsession('DB_anousu')." and o40_instit= ".db_getsession('DB_instit'));
        }
        db_lovrot($sql,15,"()","",$funcao_js);
      }else{
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $clorcorgao->sql_record($clorcorgao->sql_query_razao(null,null,"*",'',"o40_anousu = ".db_getsession('DB_anousu')." and o40_instit= ".db_getsession('DB_instit')." and o40_orgao=$pesquisa_chave"));
