...
if ($calendario != 0) {
  ...
  $result4 = $clcalendario->sql_record($clcalendario->sql_query("",
                                                                "ed52_c_descr,ed52_i_calendant as calendant",
                                                                "",
...
$sCampos  = "ed47_i_codigo,ed47_v_nome,ed47_v_ender,ed47_c_numero,ed47_v_bairro,ed56_c_situacao,ed11_c_descr,ed52_c_descr";
$sql      = " SELECT  $sCampos";
$sql     .= "   FROM  alunocurso ";
...
$pdf->cell(275,4,"Total de vagas disponíveis:".$vagas,1,1,"L",1);
$pdf->Output();
?>