...
if ($oParam->exec == 'getDadosUltimaMatriculaAluno') {
  ...
  $oRetorno->aResultado = db_utils::getColectionByRecord($rsResultUf, false, false, true);
  ...
  if (isset($oParam->iAtoLegal)) {
    ...
    $oRetorno->aResultado = db_utils::getColectionByRecord($rsAnexoAtoLegal, false, false, true);
  ...
  if ($oDaoCalendario->numrows > 0) {
    ...
    $oRetorno->aResult  = db_utils::getColectionByRecord($rsResultCalendario, false, false, true);
  ...
  if (isset($oParam->escola) && isset($oParam->calendario)) {
    ...
    if ($oDaoTurma->numrows > 0) {
      ...
      $oRetorno->aResult1 = db_utils::getColectionByRecord($rsResultEtapa, false, false, true);
  ...
  if (isset($oParam->escola) && isset($oParam->calendario)) {
    ...
    if ($oDaoTurma->numrows > 0) {
      ...
      $oRetorno->aResult1 = db_utils::getColectionByRecord($rsResultTurma, false, false, true);
  ...
  if (isset($oParam->escola)) {
    ...
    if ($oDaoEscolaDiretor->numrows > 0) {
      ...
      $oRetorno->aResultDiretor = db_utils::getColectionByRecord($rsDiretor, false, false, true);
  ...
  if (isset($oParam->escola)) {
    ...
    if ($oDaoRechumanoAtiv->numrows > 0) {
      ...
      $oRetorno->aResultSec = db_utils::getColectionByRecord($rsSec, false, false, true);
  ...
  if (isset($oParam->escola) && isset($oParam->calendario)) {
    ...
    if ($oDaoTurma->numrows > 0) {
      ...
      $oRetorno->aResultAta = db_utils::getColectionByRecord($rsResultAta, false, false, true);
  ...
  if (isset($oParam->escola) && isset($oParam->calendario)) {
    ...
    if ($oDaoTurma->numrows > 0) {
      ...
      $oRetorno->aResultEnsino = db_utils::getColectionByRecord($rsResultEnsino, false, false, true);
  ...
  if (isset($oParam->escola)) {
    ...
    if ($oDaoTipoEnsino->numrows > 0) {
      ...
      $oRetorno->aResultTipoEnsino = db_utils::getColectionByRecord($rsResultTipoEnsino, false, false, true);
  ...
  if (isset($oParam->tipoensino)) {
    ...
    if ($oDaoEnsino->numrows > 0) {
      ...
      $oRetorno->aResultNivelEnsino = db_utils::getColectionByRecord($rsResultNivelEnsino, false, false, true);
  ...
  if (isset($oParam->escola) && isset($oParam->tipoaluno)) {
    ...
    if ($iLinhas > 0) {
      ...
      $oRetorno->aResultHistorico = db_utils::getColectionByRecord($rs, false, false, true);
  ...
  if (isset($oParam->escola) && isset($oParam->tipoaluno)) {
    ...
    if ($iLinhasSelect > 0) {
      ...
      $oRetorno->aResultCert = db_utils::getColectionByRecord($rsResultSelect, false, false, true);
  ...
  if ($oDaoAreasConhecimento->erro_status == 0) {
    ...
    $oRetorno->aResultado = db_utils::getColectionByRecord($rsAreasConhecimento, false, false, true);
  ...
  if (isset($oParam->iCodigo)) {
    ...
    if ($oDaoCadDisciplinas->numrows > 0) {
      ...
      $oRetorno->aResultado      = db_utils::getColectionByRecord($rsDisciplinas, false, false, true);
  ...
  if (isset($oParam->iCurso) && isset($oParam->iEscola)) {
    ...
    if ($oParam->iCurso != 0) {
      $sWhereSerie  .= " and ed29_i_codigo IN (".$oParam->iCurso.") ";
    }
  ...
  if (isset($oParam->escola)) {
    ...
    if ($oDaoEduRelatModel->numrows > 0) {
      ...
      $oRetorno->aResultOrientacao = db_utils::getColectionByRecord($rsSec, false, false, true);
    ...
    if (isset($oParam->escola)) {
      ...
      if ($iLinhas > 0) {
        ...
        $oRetorno->aResultAssinatura = db_utils::getColectionByRecord($rsAssinatura, false, false, true);
    ...
    if (isset($oParam->escola)) {
      ...
      if ($oDaoEduRelatModel->numrows > 0) {
        ...
        $oRetorno->aResultTipoHistorico = db_utils::getColectionByRecord($rsRelatModel, false, false, true);
    ...
    if (isset($oParam->escola)) {
      ...
      if ($oDaoRelatModel->numrows > 0) {
        ...
        $oRetorno->aResultTipoCertificado = db_utils::getColectionByRecord($rsModelo, false, false, true);
     ...
     $oRetorno->itens = db_utils::getColectionByRecord($rsResultEscola, false, false, true);
      ...
      if ($oDaoEnsino->numrows > 0) {
        ...
        $oRetorno->aResultCursoEscola  = db_utils::getColectionByRecord($rsResultCursoEscola, false, false, true);
