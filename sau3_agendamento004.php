...
$sql=$cl_agendamentos_ext->sql_query_ext("","sd23_d_consulta,
												sd23_c_hora,
...
$result = pg_query($sql) or die ( pg_errormessage()."<br> $sql");
...
//	$pdf->setfont('arial','',9);
	...
	$pdf->cell(65,5,substr(trim($rh70_estrutural)." - ".trim($rh70_descr),0,60),0,0,"L",$cor);
