    ...
    <td align="center" valign="top"> 
      ...
      if (!isset($pesquisa_chave)) {
        ...
        if (isset($chave_o15_codigo) && (trim($chave_o15_codigo)!="") ) {
	         $sql = $clorctiporec->sql_query($chave_o15_codigo,$campos,"o15_codigo",$dbwhere);
        } else if (isset($chave_o15_descr) && (trim($chave_o15_descr)!="") ) {
	         $sql = $clorctiporec->sql_query("",$campos,"o15_descr"," o15_descr like '$chave_o15_descr%' and $dbwhere");
        } else {
           $sql = $clorctiporec->sql_query("",$campos,"o15_codigo",$dbwhere);
        }
        ...
        if ($pesquisa_chave!=null && $pesquisa_chave!="") {
          $result = $clorctiporec->sql_record($clorctiporec->sql_query($pesquisa_chave));
          if ($clorctiporec->numrows!=0) { 
            db_fieldsmemory($result,0);
            echo "<script>".$funcao_js."('$o15_codigo',false);</script>";
          } else {
