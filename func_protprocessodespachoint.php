...
<table height="100%" border="0"  align="center" cellspacing="0" bgcolor="#CCCCCC">
  ...
  <tr> 
    <td align="center" valign="top"> 
      <?
      die($clproctransferintand->sql_query_file());
      $result_proctransferintand = $clproctransferintand->sql_record($clproctransferintand->sql_query_file());
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_p58_codproc) && (trim($chave_p58_codproc)!="") ){
	         $sql = $clprotprocesso->sql_query(null,$campos,"p58_codproc desc","p58_codproc = $chave_p58_codproc  and $where ");
