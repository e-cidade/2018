...
try {
  ...
  switch ($oPost->sMethod) {
    ...
    case 'consultaPontoComplementar':
      ...
      $sSqlPontoComplementar = $clgerfcom->sql_query_file(null,
  	  ...
  	  if ( $clgerfcom->numrows > 0 ) {
  	    ...
  	    $aListaSemestre = db_utils::getColectionByRecord($rsPontoComplementar);
    ...
    case 'consultarDadosGeracaoSLIP':
      ...
      $aListaSlips = db_utils::getColectionByRecord($rsSlips,false,false,true);
    ...
    case 'consultarSelectContas':
      ...
      if ( $rsContas ) {
        ...
        $aListaContas  = array();
        $aListaContas  = db_utils::getColectionByRecord($rsContas,false,false,true);
    ...
    case 'getRescisoesNaoEmpenhadas':
      ...
      $aRescisoes  = $oDadosEmpenhoFolhaRescisao->getRescisoesNaoEmpenhadas($oPost->iMesFolha, $oPost->iAnoFolha);
      $aRetorno = array("lErro"           => false,
    ...
    case 'getRescisoesEmpenhadas':
      ...
      $oDadosEmpenhoFolhaRescisao = new dadosEmpenhoFolhaRescisao();
      $aRescisoes  = $oDadosEmpenhoFolhaRescisao->getRescisoesEmpenhadas($oPost->iMesFolha, $oPost->iAnoFolha);
      $aRetorno = array("lErro"           => false,
                        "sListaRescisoes" =>$aRescisoes
                       );
