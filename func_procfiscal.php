    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_y100_sequencial) && (trim($chave_y100_sequencial)!="") ){
	         $sql = $clprocfiscal->sql_query("",$campos,"y100_sequencial","y100_coddepto= ".db_getsession("DB_coddepto")." and y100_sequencial = $chave_y100_sequencial ");
        }else if(isset($chave_y100_coddepto) && (trim($chave_y100_coddepto)!="") ){
	         $sql = $clprocfiscal->sql_query("",$campos,"y100_coddepto","y100_coddepto= ".db_getsession("DB_coddepto")." and y100_coddepto like '$chave_y100_coddepto%' ");
        }else{
        ...
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $clprocfiscal->sql_record($clprocfiscal->sql_query($pesquisa_chave));
          if($clprocfiscal->numrows!=0){
            db_fieldsmemory($result,0);
            echo "<script>".$funcao_js."('$y100_coddepto',false);</script>";
          }else{
