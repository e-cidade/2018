...
db_input('y50_nome',40,$Iy50_nome,true,'text',3,'')
  ...
  <tr>
    ...
    <td> 
<?
db_input('y57_receit',4,$Iy57_receit,true,'text',$db_opcao," onchange='js_pesquisay57_receit(false);'");
if($db_opcao == 2){
  db_input('y57_receit',4,$Iy57_receit,true,'hidden',$db_opcao,"","y57_receit_old");
...
db_input('k02_descr',15,$Ik02_descr,true,'text',3,'')
  ...
  <tr>
    ...
    <td> 
<?
db_input('y57_descr',50,$Iy57_descr,true,'text',$db_opcao,"")
?>
    </td>
  </tr>
  <tr>
    ...
    <td> 
<?
db_input('y57_valor',10,$Iy57_valor,true,'text',$db_opcao,"")
?>
    </td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <?
    ...
    $cliframe_alterar_excluir->campos="y57_codauto,y57_receit,y57_valor,y57_descr";
    ...
    if($clautorec1->numrows == 0){
      echo "<script>
              if(document.formaba.receitas){";
      echo "    document.formaba.receitas.disabled=true;
              }
	      </script>";
    }
   ?>
