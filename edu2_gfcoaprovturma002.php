...
if($clturma->numrows>0){
 ...
 if($linhas1 == 0){?>
  ...
  for ($x = 0; $x < $linhas1; $x++) {
    ...
    $sql2 = "SELECT round(sum(ed72_i_valornota)/count(ed72_i_valornota),$decimais) as media,
              ...
              WHERE ed72_i_procavaliacao = $periodo
                ...
                AND ed232_i_codigo       = {$oDados1->ed232_i_codigo}
              GROUP BY ed232_i_codigo, ed232_c_abrev,ed232_c_descr,ed59_i_ordenacao
              ORDER BY ed59_i_ordenacao";
  ...
  //$media_turma = "76,55,61,67,67,72,67,76,58,68";
  ...
  echo "<form name='form1'>
        ...
        <script>
         function js_imprimir(){
          jan = window.open('edu2_gfcoaprovturma003.php?t=1&turma=$turma&nome_arquivo=$nome_arquivo','','width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
          jan.moveTo(0,0);
