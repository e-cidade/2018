  ...
  <tr> 
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        }else if(isset($chave_y27_codtipo) && (trim($chave_y27_codtipo)!="") ){
	         $sql = $cltipofiscaliza->sql_query("",$campos,"y27_codtipo"," y27_codtipo like '$chave_y27_codtipo%' and y27_instit = ".db_getsession('DB_instit') );
        }else{
        ...
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          ...
          if($cltipofiscaliza->numrows!=0){
            ...
            echo "<script>".$funcao_js."('$y27_codtipo',false);</script>";
          }else{
