...
for($ireg=0; $ireg<$index; $ireg++){
  ...
  while($ireg < $index && $quebrarpagina == $codigoquebra ){
     ...
     $arr_auxPR = split(",",$arr_rubricascodP["$registro"]); // Arrays com código das rubricas (PROVENTOS) do funcionário separadas por ","
     $arr_auxPD = split(",",$arr_rubricasdesP["$registro"]); // Arrays com descrição das rubricas (PROVENTOS) do funcionário separadas por ","
     $arr_auxPQ = split(",",$arr_rubricasqtdP["$registro"]); // Arrays com quantidade das rubricas (PROVENTOS) do funcionário separadas por ","
     $arr_auxPV = split(",",$arr_rubricasvlrP["$registro"]); // Arrays com valor das rubricas (PROVENTOS) do funcionário separadas por ","

     $arr_auxDR = split(",",$arr_rubricascodD["$registro"]); // Arrays com código das rubricas (DESCONTOS) do funcionário separadas por ","
     $arr_auxDD = split(",",$arr_rubricasdesD["$registro"]); // Arrays com descrição das rubricas (DESCONTOS) do funcionário separadas por ","
     $arr_auxDQ = split(",",$arr_rubricasqtdD["$registro"]); // Arrays com quantidade das rubricas (DESCONTOS) do funcionário separadas por ","
     $arr_auxDV = split(",",$arr_rubricasvlrD["$registro"]); // Arrays com valor das rubricas (DESCONTOS) do funcionário separadas por ","
