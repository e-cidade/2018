...
$clorcimpactomov->rotulo->label("o63_codimp");
    ...
    <td height="63" width="60%" align="left" valign="top">
        <table  border="0" align="left" cellspacing="0">
	     <form name="form1" method="post" action="" >
          <tr> 
            <td  align="left" nowrap title="<?=$To63_codimp?>">
	      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <?=$Lo63_codimp?>
  ...
  <tr> 
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_o63_codimp) && (trim($chave_o63_codimp)!="") ){
	         $sql = $clorcimpactomov->sql_query_compl($chave_o63_codimp,$campos,"o63_codimp");
        }else if(isset($chave_o63_anoexe) && (trim($chave_o63_anoexe)!="") ){
	         $sql = $clorcimpactomov->sql_query_compl("",$campos,"o63_anoexe"," o63_anoexe like '$chave_o63_anoexe%' ");
		...
		$dbw = " and o63_unidade = $chave_o63_unidade ";
	      ...
	      $sql = $clorcimpactomov->sql_query_compl("",$campos,"o63_anoexe"," o63_orgao = $chave_o63_orgao $dbw");
	      	 
        }else{
           $sql = $clorcimpactomov->sql_query_compl("",$campos,"o63_codimp","");
        }
