  ...
  if (($linhasorigem > 0) && ($linhasdestino == 0 )) {
    ...
    for ($e=0; $e<$linhasemp; $e++) {
      ...
      $linhasemp2 = pg_num_rows($resultemp2);
        ...
        $cldb_viradaitemlog->c35_log           = "Empenho sem tipo correspondente -> {$e60_numemp} Instituição: {$e60_instit} Codcon: {$e64_codele}";
        ...
        if ($linhasemp3 > 0) {
          ...
          $cldb_viradaitemlog->c35_log = "Empenho $e60_numemp não encontrado no emprestotipo  $e64_codele    $c60_estrut";
