...
switch ($oParam->exec) {
  ...
  case "salvarPlanoConta":
    ...
    try {
      ...
      $oPlanoPCASP->setFuncao                  (db_stdClass::normalizeStringJson($oParam->sFuncao));
      $oPlanoPCASP->setFinalidade              (db_stdClass::normalizeStringJson($oParam->sFuncionamento));
      $oPlanoPCASP->setContraPartida           ("0");
      $oPlanoPCASP->setDescricao               (db_stdClass::normalizeStringJson($oParam->sTitulo));
  ...
  case "excluirReduzido":
    ...
    try {
      ...
      db_fim_transacao(false);
      $oRetorno->message = "Reduzido excluido com sucesso.";
