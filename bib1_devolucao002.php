...
if ($clexemplar->numrows == 0) {
  ...
  <script>
   ...
   parent.document.form1.titulo.value        = "<?=$bi06_titulo?>";
   parent.document.form1.bi18_carteira.value = '';
   parent.document.form1.ov02_nome.value     = '';
   parent.document.form1.proximo.click(); 
  </script>
 <?
