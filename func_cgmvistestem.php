      ...
      if(!isset($pesquisa_chave)){
        if(isset($campos)==false){
           if(file_exists("funcoes/db_func_cgm.php")==true){
             include("funcoes/db_func_cgm.php");
           }else{
           $campos = "cgm.*";
           }
        }
        if(isset($chave_z01_numcgm) && (trim($chave_z01_numcgm)!="") ){
	         $sql = $clcgm->sql_query("",$campos,"z01_numcgm"," z01_numcgm =  $chave_z01_numcgm and char_length(trim(z01_cgccpf)) = 11  and trim(z01_cgccpf) <> '00000000000'");
        }else if(isset($chave_z01_nome) && (trim($chave_z01_nome)!="") ){
	         $sql = $clcgm->sql_query("",$campos,"z01_nome"," z01_nome like '$chave_z01_nome%' and char_length(trim(z01_cgccpf)) = 11  and trim(z01_cgccpf) <> '00000000000'");
        }else{
           $sql = $clcgm->sql_query("",$campos,"z01_numcgm"," char_length(trim(z01_cgccpf)) = 11 and trim(z01_cgccpf) <> '00000000000'");
        }
