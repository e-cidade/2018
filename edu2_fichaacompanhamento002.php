...
for ($iContador = 0; $iContador < $iContadorAlunos; $iContador++) {
  ...
  $oPdf->SetX(30);
  $oPdf->Cell(150, $iHeigth, $oEscola->getDepartamento()->getNomeDepartamento(), 0, 1, "L");
  $oPdf->SetX(30);
  ...
  $oPdf->SetFont('arial', '', 7);
  $oPdf->Cell(30, $iHeigth, $sTurno,           0, 0, "L", 0);
  $oPdf->SetFont('arial', 'B', 8);
  ...
  /*
   * Desenha as linhas de preenchimento da ficha
  $oPdf->Line(30,  42, 155, 42);
  $oPdf->Line(177, 42, 200, 42);
  $oPdf->Line(30,  46, 200, 46);
  $oPdf->Line(30,  50, 60,  50);
  $oPdf->Line(71,  50, 100, 50);
   */
