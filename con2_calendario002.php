...
if(isset($identifica)){
  db_lovrot($cruzamento." = '".$data."' and at01_codcli = ".$identifica,15,"()",'','js_pesquisa_tarefa|at40_sequencial');
}else{
  db_lovrot($cruzamento." = '".$data."'",15,"()",'','js_pesquisa_tarefa|at40_sequencial');
