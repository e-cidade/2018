...
switch ($oParam->exec) {
  ...
  case 'findBairroByName':
    ...
    $aRetorno = endereco::findBairroByName($oParam->sQuery,
  ...
  case 'findRuaByName':
    ...
    $aRetorno = endereco::findRuaByName($oParam->sQuery,
                                        $oParam->iCodigoEstado,
                                        $oParam->iCodigoMunicipio,
  ...
  case 'findCondominioByName':
    ...
    $aRetorno = endereco::findCondominioByName($oParam->sQuery,        $oParam->iCodigoNumero, 
  ...
  case 'findLoteamentoByName':
    ...
    $aRetorno = endereco::findLoteamentoByName($oParam->sQuery,        $oParam->iCodigoNumero, 
                                               $oParam->iCodigoBairro, $oParam->iCodigoRua, true);
    echo $oJson->encode($aRetorno);
  ...
  case 'buscaBairroRuaMunicipio':
    ...
    $oRetorno->bairroRuaMunicipio = endereco::buscaBairroRuaMunicipio($oParam->icodigobairromunicipio, 
                                                                      $oParam->icodigoruamunicipio, true);
