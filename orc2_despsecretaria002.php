...
$resultinst = pg_exec("select codigo,nomeinst from db_config where codigo in ({$sInstit}) ");
$descr_inst = '';
$xvirg      = '';
...
for($mes=1;$mes<13;$mes++){
  ...
  pg_exec("begin");
  $result_ultdia = pg_exec("select fc_ultimodiames(". db_getsession("DB_anousu") . ",$mes) as ultimodiames");
