...
$clempagedadosretmov->rotulo->label("e76_codmov");
$clempagedadosretmov->rotulo->label("e76_errobanco");
?>
<html>
<head>
    ...
    <td height="63" align="center" valign="top">
        <table width="35%" border="0" align="center" cellspacing="0">
	     <form name="form2" method="post" action="" >
          ...
          <tr> 
            <td width="4%" align="right" nowrap title="<?=$Te76_codmov?>">
              <?=$Le76_codmov?>
            </td>
            <td width="96%" align="left" nowrap> 
              <?
          ...
          <tr> 
            <td width="4%" align="right" nowrap title="<?=$Te76_errobanco?>">
              <?=$Le76_errobanco?>
            </td>
            <td width="96%" align="left" nowrap> 
              <?
    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_e76_codret) && (trim($chave_e76_codret)!="") ){
	         $sql = $clempagedadosretmov->sql_query($chave_e76_codret,$chave_e76_codmov,$campos,"e76_codret");
        }else if(isset($chave_e76_errobanco) && (trim($chave_e76_errobanco)!="") ){
	         $sql = $clempagedadosretmov->sql_query("","",$campos,"e76_errobanco"," e76_errobanco like '$chave_e76_errobanco%' ");
        }else{
           $sql = $clempagedadosretmov->sql_query("","",$campos,"e76_codret#e76_codmov","");
        }
        ...
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          ...
          if($clempagedadosretmov->numrows!=0){
            ...
            echo "<script>".$funcao_js."('$e76_errobanco',false);</script>";
          }else{
