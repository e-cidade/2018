...
// Se viйr o parвmetro consulta por Json, adiciona no retorno
...
try {
	...
	/**
	 * 
	 *  Retorna um array com os atributos de um documento apartir do cуdigo do cadastro de documento
	 * 
	 */
  ...
  /**
   * 
   *  Salva um documento e retorna o cуdigo do documento gerado 
   * 
   */	
    ...
    $oRetorno->sMsg          = urlencode('Documento incluнdo com sucesso!');
  ...
  /*
   * 
   *  Retorna tods os atributos de um documento e seus valores jб cadastrados,  
   *  utilizado para visualizar os dados na rotina de alteraзгo de documento 
   * 
   */  
