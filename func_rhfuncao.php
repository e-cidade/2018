    ...
    <td height="63" align="center" valign="top">
      <table width="35%" border="0" align="center" cellspacing="0">
        <form name="form2" method="post" action="" >
          <tr>
            <td width="4%" align="right" nowrap title="<?php echo $Trh37_funcao; ?>">
          ...
          <tr>
            <td width="4%" align="right" nowrap title="<?php echo $Trh37_instit; ?>">
          ...
          <tr> 
            <td width="4%" align="right" nowrap title="<?php echo $Trh37_descr; ?>">
