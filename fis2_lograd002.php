...
$head2 = "RELATÓRIO DE INSC. POR LOGRADOURO";

foreach ($aInfo as $iInd => $sDescricao ) {
	${"head".($iInd+3)} = $sDescricao;
}
...
$result = pg_exec($sSqlInscrLograd);
   ...
   for($x = 0; $x <pg_numrows($result);$x++){
     ...
     if ($inscr != $q02_inscr){
	    ...
	    //mostra os registros da inscrição
	     ...
	     $oPdf->cell(80,$alt,trim($q03_descr),0,0,"L",$p);
