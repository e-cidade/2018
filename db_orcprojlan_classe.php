...
class cl_orcprojlan { 
   ...
   function incluir ($o51_codproj){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,6541,'$this->o51_codproj','I')");
       $resac = pg_query("insert into db_acount values($acount,1076,6541,'','".AddSlashes(pg_result($resaco,0,'o51_codproj'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1076,6542,'','".AddSlashes(pg_result($resaco,0,'o51_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1076,6543,'','".AddSlashes(pg_result($resaco,0,'o51_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($o51_codproj=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,6541,'$this->o51_codproj','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o51_codproj"]))
           $resac = pg_query("insert into db_acount values($acount,1076,6541,'".AddSlashes(pg_result($resaco,$conresaco,'o51_codproj'))."','$this->o51_codproj',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o51_data"]))
           $resac = pg_query("insert into db_acount values($acount,1076,6542,'".AddSlashes(pg_result($resaco,$conresaco,'o51_data'))."','$this->o51_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o51_id_usuario"]))
           $resac = pg_query("insert into db_acount values($acount,1076,6543,'".AddSlashes(pg_result($resaco,$conresaco,'o51_id_usuario'))."','$this->o51_id_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($o51_codproj=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,6541,'$this->o51_codproj','E')");
         $resac = pg_query("insert into db_acount values($acount,1076,6541,'','".AddSlashes(pg_result($resaco,$iresaco,'o51_codproj'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1076,6542,'','".AddSlashes(pg_result($resaco,$iresaco,'o51_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1076,6543,'','".AddSlashes(pg_result($resaco,$iresaco,'o51_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
