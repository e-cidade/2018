...
$sSqlMedida  = "select '10'    as tipo_de_registro, ";
$sSqlMedida .= "       $iIdDaEmpresa as id_da_empresa, ";
$sSqlMedida .= "       t67_sequencial as id_da_medida, ";
...
for ($i=0; $i<$iNumeroLinhas; $i++) {
	...
	$oLayoutTxt->setByLineOfDBUtils($oMedida,3,"10");
