  ...
  <tr> 
    <td align="center" valign="top"> 
      ...
      if( !empty($orc) && !isset($proc) ) {
      	...
      	$result_itemsol = $clpcorcamitemsol->sql_record($clpcorcamitemsol->sql_query_solicitem(null,null,"distinct pc11_numero as pesquisa_chave",""," pc22_codorc=$orc"));
	    ...
	    $result_itemproc = $clpcorcamitemproc->sql_record($clpcorcamitemproc->sql_query_solicitem(null,null,"distinct pc11_numero as pesquisa_chave",""," pc22_codorc=$orc"));
	...
	$campos = " distinct ".$campos;
        if(isset($chave_pc10_numero) && (trim($chave_pc10_numero)!="") ){
  	         $sql = $clsolicita->sql_query(null,$campos,"pc10_numero desc"," pc10_numero= $chave_pc10_numero $where_solicitacao");
        }else if(isset($chave_pc10_data) && (trim($chave_pc10_data)!="") ){
	         $sql = $clsolicita->sql_query("",$campos,"pc10_data desc"," pc10_data like '$chave_pc10_data%' $where_solicitacao");
        }else{
             $sql = $clsolicita->sql_query("",$campos,"pc10_numero desc"," 1=1 $where_solicitacao");
        }
	db_lovrot($sql,15,"()","",$funcao_js);	
      }else{
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $clsolicita->sql_record($clsolicita->sql_query(null,"*",""," pc10_numero=".$pesquisa_chave.$where_solicitacao));
