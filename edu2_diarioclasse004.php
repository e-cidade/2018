 ...
 if ($informadiasletivos == "S") {
  ...
  for ($y = 0; $y < $clmatricula->numrows; $y++) {
          ...
          if ($ed72_c_amparo == "S") {
            ...
            if ($ed81_i_justificativa != "") {
              ...
              if ($resultedu == "S") {
                ...
                $aprov = number_format($ed72_i_valornota,0);
              }
          ...
          if (trim($obtencao) == "ME") {
            ...
            if ($arredmedia == "S") {
              ...
              if ($resultedu == "S") {
                ...
                $notaprojetada = number_format(round($projetada),2,".",".");

              } else {

                $resfinal      = number_format(round($aprvto),0);
                $notaprojetada = number_format(round($projetada),0);
              ...
              if ($resultedu == "S") {
                ...
                $notaprojetada = number_format($projetada,2,".",".");

              } else {

                $resfinal      = number_format($aprvto,0);
                $notaprojetada = number_format($projetada,0);
      ...
      if ($amparo == "S") {
        ...
        if ($cldiarioavaliacao->numrows > 0) {
          ...
          if ($ed37_c_tipo == "NOTA" && $ed72_i_valornota != "") {
            ...
            if ($resultedu == "S") {
              $aprov_atual = number_format($ed72_i_valornota,2,".",".");
            } else {
              $aprov_atual = number_format($ed72_i_valornota,0);
            }
    ...
    //FALTAS
      ...
      $pdf->cell($clprocavaliacao->numrows*10+25+$largmp,4,trim(substr(Situacao($ed60_c_situacao,$ed60_i_codigo),0,11)),1,0,"C",0);
    }
    ...
    $pdf->setfont('arial','',8);
    if (trim($ed60_c_situacao) != "MATRICULADO") {
      $pdf->cell(18+($quadros*5),4,trim($ed60_c_situacao),1,1,"C",0);
    } else {
