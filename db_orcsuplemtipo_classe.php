...
class cl_orcsuplemtipo { 
   ...
   function incluir ($o48_tiposup){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,5352,'$this->o48_tiposup','I')");
       $resac = pg_query("insert into db_acount values($acount,775,5352,'','".AddSlashes(pg_result($resaco,0,'o48_tiposup'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,775,5353,'','".AddSlashes(pg_result($resaco,0,'o48_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,775,5354,'','".AddSlashes(pg_result($resaco,0,'o48_coddocsup'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,775,5355,'','".AddSlashes(pg_result($resaco,0,'o48_coddocred'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,775,6085,'','".AddSlashes(pg_result($resaco,0,'o48_arrecadmaior'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,775,6086,'','".AddSlashes(pg_result($resaco,0,'o48_superavit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($o48_tiposup=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,5352,'$this->o48_tiposup','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o48_tiposup"]))
           $resac = pg_query("insert into db_acount values($acount,775,5352,'".AddSlashes(pg_result($resaco,$conresaco,'o48_tiposup'))."','$this->o48_tiposup',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o48_descr"]))
           $resac = pg_query("insert into db_acount values($acount,775,5353,'".AddSlashes(pg_result($resaco,$conresaco,'o48_descr'))."','$this->o48_descr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o48_coddocsup"]))
           $resac = pg_query("insert into db_acount values($acount,775,5354,'".AddSlashes(pg_result($resaco,$conresaco,'o48_coddocsup'))."','$this->o48_coddocsup',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o48_coddocred"]))
           $resac = pg_query("insert into db_acount values($acount,775,5355,'".AddSlashes(pg_result($resaco,$conresaco,'o48_coddocred'))."','$this->o48_coddocred',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o48_arrecadmaior"]))
           $resac = pg_query("insert into db_acount values($acount,775,6085,'".AddSlashes(pg_result($resaco,$conresaco,'o48_arrecadmaior'))."','$this->o48_arrecadmaior',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o48_superavit"]))
           $resac = pg_query("insert into db_acount values($acount,775,6086,'".AddSlashes(pg_result($resaco,$conresaco,'o48_superavit'))."','$this->o48_superavit',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($o48_tiposup=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,5352,'$this->o48_tiposup','E')");
         $resac = pg_query("insert into db_acount values($acount,775,5352,'','".AddSlashes(pg_result($resaco,$iresaco,'o48_tiposup'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,775,5353,'','".AddSlashes(pg_result($resaco,$iresaco,'o48_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,775,5354,'','".AddSlashes(pg_result($resaco,$iresaco,'o48_coddocsup'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,775,5355,'','".AddSlashes(pg_result($resaco,$iresaco,'o48_coddocred'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,775,6085,'','".AddSlashes(pg_result($resaco,$iresaco,'o48_arrecadmaior'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,775,6086,'','".AddSlashes(pg_result($resaco,$iresaco,'o48_superavit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
