...
function getNomeLivro($iCodigo) {
  ...
  if ($iCodigo == 1) {
    return "Subst. e Medicamentos Entorpecentes (listas 'A1' e 'A2')";
  } elseif ($iCodigo == 2) {
    return "Subst. e Medicamentos Psicotrópicos (listas 'A3', 'B1' e 'B2')";
  } elseif ($iCodigo == 3) {
    return "Subst. e Medicamentos sujeitos a Controle Especial (listas 'C1', 'C2', 'C4' e 'C5')";
  }
  return  $livronome="Subst. e/ou Medicamento Imunossupressoras (lista 'C3')";
...
function imprimirRetirada($oPdf, $oRetirada, $dSaldo) {
  ...
  if ($oRetirada->fa04_i_codigo != "") {
  	...
  	$sDescricaoRetirada .= " - V: ".$oRetirada->s158_d_validade;
