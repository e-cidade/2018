...
$pdf->setx(60);
$pdf->setfont('arial', 'b', 12);
$pdf->cell(60, $alt +1, "Origem : ", 0, 0, "L", 0);
$pdf->setfont('arial', '', 12);
$pdf->cell(30, $alt +1, $tipo."/".$origem, 0, 0, "L", 0);
$pdf->setfont('arial', 'b', 12);
...
$pdf->setx(60);
$pdf->setfont('arial', 'b', 12);
$pdf->cell(60, $alt +1, "Nome/Razão Social : ", 0, 0, "L", 0);
$pdf->setfont('arial', '', 12);
$pdf->cell(110, $alt +1, ( $z01_nome==''?$nomeinscr:$z01_nome), 0, 1, "L", 0);
$pdf->setfont('arial', 'b', 12);

$pdf->setx(60);
$pdf->cell(60, $alt +1, "Endereço : ", 0, 0, "L", 0);
$pdf->setfont('arial', '', 12);
...
if (isset($mostraativ) && $mostraativ=='t'){
	$pdf->setx(60);
	$pdf->setfont('arial', 'b', 12);
	$pdf->cell(60, $alt +1, "Atividade Principal : ", 0, 0, "L", 0);
	$pdf->setfont('arial', '', 12);
...
$pdf->setx(60);
$pdf->setfont('arial', 'b', 12);
$pdf->cell(60, $alt +1, "Data : ", 0, 0, "L", 0);
$pdf->setfont('arial', '', 12);
