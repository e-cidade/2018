    ...
    <td height="63" align="center" valign="top">
        <table width="25%" border="0" align="center" cellspacing="0">
	     <form name="form1" method="post" action="" >
          <tr> 
            <td width="4%" align="right" nowrap title="<?=$Tve62_codigo?>">
              <?=$Lve62_codigo?>
            </td>
    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        if (isset($chave_ve37_sequencial) && trim($chave_ve37_sequencial) != "" && $chave_ve37_sequencial != "0"){
          ...
          $dbwhere = " (veiccadcentral.ve36_coddepto = ".db_getsession("DB_coddepto")." or 
                        veiccadcentraldepart.ve37_coddepto = ".db_getsession("DB_coddepto").") ";
        }

        if(isset($chave_ve62_codigo) && (trim($chave_ve62_codigo)!="") ){
	         $sql = $clveicmanut->sql_query(null,$campos,"ve62_codigo","ve62_codigo = $chave_ve62_codigo and $dbwhere");
        }else{
           $sql = $clveicmanut->sql_query("",$campos,"ve62_codigo","$dbwhere");
        }
        $repassa = array();
...
?>
<script>
js_tabulacaoforms("form2","chave_ve62_codigo",true,1,"chave_ve62_codigo",true);
</script>