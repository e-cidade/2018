...
?>
        if (lMostra) {
          ...
          js_OpenJanelaIframe('top.corpo','db_iframe_pagamentosefetivados',sUrl,'Pesquisa',true);
    ...
    function js_mostrareceitas(chave){
      ...
      top.corpo.db_iframe_pagamentosefetivados.hide();
    }
    ...
    function js_consultaOrigemAbatimento(iAbatimento) {
      ...
      js_OpenJanelaIframe('top.corpo','db_iframe_abatimento',sUrl,'Origem Pagamento Parcial',true);
    }
