   ...
   <tr> 
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        $sql = "select distinct j01_matric,j01_baixa,j40_refant,z01_nome,case when j39_numero is null then 'Terr' else 'Pred' end as Tipo,  case when ruase.j14_codigo is null then ruas.j14_nome else ruase.j14_nome end as j14_nome, case when j39_numero is null then 0 else j39_numero end as j39_numero,j39_compl,j34_setor,j34_quadra,j34_lote 
			         from iptubase 
...
//	         $sql = $cliptubase->sql_query($chave_j01_matric,$campos,"j01_matric");
              $sql2 .=" and j01_matric = $chave_j01_matric";			  

        }else if(isset($j40_refant) && (trim($j40_refant))!="" ){
	       $sql2 .= " and j40_refant like '$j40_refant%' ";
	       ...
	       $sql2 .= " and j39_codigo = $j14_codigo ";
           $sql3 = " order by j39_numero";			  
        }else if(isset($z01_nome) && (trim($z01_nome)!="") ){
		   $sql2 .= " and z01_nome like '$z01_nome%'";
