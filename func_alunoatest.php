 ...
 <tr>
  <td height="63" align="center" valign="top">
   <table width="55%" border="0" align="center" cellspacing="0">
    ...
    <tr>
     <td width="4%" align="right" nowrap title="<?=$Ted56_i_escola?>">
      <?=$Led56_i_escola?>
     </td>
     <td width="96%" align="left" nowrap>
      <?
      $result_esc = $clescola->sql_record($clescola->sql_query("","ed18_i_codigo,ed18_c_nome","ed18_c_nome"," ed18_i_codigo != $escola"));
  ...
  <td align="center" valign="top">
   ...
   if(!isset($pesquisa_chave)){
    $sql = "SELECT *
            FROM (
                  SELECT distinct on (aluno.ed47_i_codigo) aluno.ed47_i_codigo,
                         ...
                         serie.ed11_i_codigo as dl_codigoserie,
                         ...
                         (select ed60_d_datamatricula from matricula where ed60_i_aluno = ed56_i_aluno order by ed60_d_datamatricula desc limit 1) as ed60_d_datamatricula
                  FROM aluno
    ...
    if(isset($chave_ed47_i_codigo)){
     $repassa = array("chave_ed47_i_codigo"=>$chave_ed47_i_codigo,"chave_ed47_v_nome"=>$chave_ed47_v_nome,"chave_ed56_i_escola"=>$chave_ed56_i_escola);
    }
    if(isset($chave_ed47_i_codigo) && (trim($chave_ed47_i_codigo)!="") ){
     $sql .= " WHERE ed52_c_passivo = 'N' AND ed47_i_codigo = $chave_ed47_i_codigo AND ed56_i_escola != $escola AND ed56_c_situacao != 'TRANSFERIDO REDE' AND ed56_c_situacao != 'TRANSFERIDO FORA' AND ed56_c_situacao != 'CANDIDATO' AND ed56_c_situacao != 'FALECIDO' AND ed56_c_situacao != 'ENCERRADO') as x ORDER BY ed47_v_nome";
     db_lovrot(@$sql,12,"()","",$funcao_js,"","NoMe",$repassa);
    }else if(isset($chave_ed47_v_nome) && (trim($chave_ed47_v_nome)!="") ){
     $sql .= " WHERE ed52_c_passivo = 'N' AND ed47_v_nome like '$chave_ed47_v_nome%' AND ed56_i_escola != $escola AND ed56_c_situacao != 'TRANSFERIDO REDE' AND ed56_c_situacao != 'TRANSFERIDO FORA' AND ed56_c_situacao != 'CANDIDATO' AND ed56_c_situacao != 'FALECIDO' AND ed56_c_situacao != 'ENCERRADO') as x ORDER BY ed47_v_nome";
     db_lovrot(@$sql,12,"()","",$funcao_js,"","NoMe",$repassa);
    }else if(isset($chave_ed56_i_escola) && (trim($chave_ed56_i_escola)!="") ){
     $sql .= " WHERE ed52_c_passivo = 'N' AND ed56_i_escola = $chave_ed56_i_escola AND ed56_i_escola != $escola AND ed56_c_situacao != 'TRANSFERIDO REDE' AND ed56_c_situacao != 'TRANSFERIDO FORA' AND ed56_c_situacao != 'CANDIDATO' AND ed56_c_situacao != 'FALECIDO' AND ed56_c_situacao != 'ENCERRADO') as x ORDER BY ed47_v_nome";
     db_lovrot(@$sql,12,"()","",$funcao_js,"","NoMe",$repassa);
    }
   }else{
