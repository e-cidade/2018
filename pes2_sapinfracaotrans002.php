...
$head3 = "RELATÓRIO DE INFRAÇÕES DE TRÂNSITO";
...
where r14_anousu = $ano 
  and r14_mesusu = $mes
	ynd r14_instit = ".db_getsession("DB_instit")."
  and r14_rubric = '1755'
order by recurso
       ";
//echo $sql ; exit;
...
if ($xxnum == 0){
   db_redireciona('db_erros.php?fechar=true&db_erro=Não existem infrações de trânsito no período de '.$mes.' / '.$ano);
