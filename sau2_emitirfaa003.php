...
/*  $alt=$pdf->getY();
  ...
  $pdf->setX($lar+1);
  $pdf->MultiCell(55,4,"ENDEREÃ‡O: ".$est_ender,1,"L");
  $pdf->setX($lar+1);
  $pdf->MultiCell(55,8,"MUNICÃPIO: ".$est_munic,1,"L");
  $pdf->setX($lar+1);
  $pdf->MultiCell(55,8,"UF: ".$est_uf,1,"L");
  $pdf->setX($lar+1);
  $pdf->MultiCell(55,8,"CÃ“DIGO SIA/SUS: ".$sd02_c_siasus,1,"L");
...
*/  
  ...
  //$pdf->text( $pdf->getX()+116, $pdf->getY()+26, "PRESSÃƒO:".$sd24_v_pressao." TEMP.:".number_format($sd24_f_temperatura,2,'.','')." PESO:".number_format($sd24_f_peso,2,'.','') );
  ...
  //Linha 3 - 2Âª Retangulo DiagnÃ³stico
//Linha 4 - 2Âª Retangulo HORA
...
//Linha 4 - 2Âª Retangulo GRUPO TABELA
