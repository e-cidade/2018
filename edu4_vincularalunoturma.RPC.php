  ...
  switch ($oParam->exec) {
    ...
    case 'getAlunosVinculados':
      ...
      foreach ($oTurma->getAlunosProgressaoParcial() as $oProgressaoAluno) {
        ...
        $oDadosAluno->encerrado                = $oProgressaoAluno->isConcluida();
    ...
    case 'getDadosTurma':
      ...
      $oDadosTurma->iVagas            = $oTurma->getVagas();
      $oDadosTurma->iVagasOcupadas    = $oTurma->getVagasOcupadas();
      $oDadosTurma->iVagasDisponiveis = $oTurma->getVagasDisponiveis();
