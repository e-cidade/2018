...
for ($record_correto=0; $record_correto < pg_numrows($result_correto); $record_correto++) {
  ...
  for ($record_errado=0; $record_errado < pg_numrows($result_errado); $record_errado++) {
    ...
    if ($v_cgmcerto > 0) {
      ...
      $sql1 .= "   and db_sysarqcamp.codarq not in (736,737,511,1383,1015,1010143,2947,1382) ";
      $sql1 .= "   and db_sysarqcamp.codcam not in (5153,5159,216,7872,8213,8195,17180,16650,8205)";
