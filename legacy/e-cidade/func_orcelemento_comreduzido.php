...
<table height="100%" border="0"  align="center" cellspacing="0" bgcolor="#CCCCCC">
  ...
  <tr> 
    <td align="center" valign="top"> 
	  ...
	  $sql = $clorcelemento->sql_query_contascomreduzido(null,$campos,"o56_elemento"," o56_anousu = ".db_getsession("DB_anousu")." and o56_codele = $chave_o56_codele $dbwhere");
        }else if(isset($chave_o56_elemento) && (trim($chave_o56_elemento)!="") ){
	  $sql = $clorcelemento->sql_query_contascomreduzido("",$campos,"o56_elemento"," o56_anousu = ".db_getsession("DB_anousu")." and  o56_elemento like '$chave_o56_elemento%' $dbwhere ");
        }else if(isset($chave_o56_descr) && (trim($chave_o56_descr)!="") ){
	  $sql = $clorcelemento->sql_query_contascomreduzido("",$campos,"o56_elemento"," o56_anousu = ".db_getsession("DB_anousu")." and  o56_descr like '$chave_o56_descr%' $dbwhere ");
 
        }else{
           $sql = $clorcelemento->sql_query_contascomreduzido("",$campos,"o56_elemento"," o56_anousu = ".db_getsession("DB_anousu")."  $dbwhere");
        }
        db_lovrot($sql,15,"()","",$funcao_js);
      }else{
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
	  if(isset($tipo_pesquisa)){
            $result = $clorcelemento->sql_record($clorcelemento->sql_query_contascomreduzido(null,"*",''," o56_anousu = ".db_getsession("DB_anousu")." and o56_codele=$pesquisa_chave $dbwhere "));
	  }else{
            $result = $clorcelemento->sql_record($clorcelemento->sql_query_contascomreduzido(null,"*","o56_descr"," o56_anousu = ".db_getsession("DB_anousu")." and  o56_elemento = $pesquisa_chave $dbwhere"));
	  }  
