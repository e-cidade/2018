    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
       ...
       $sql = "select distinct
                ...
                where not exists(select q78_cancdebitos 
                                   from cancdebitosissplan 
                                  where q78_cancdebitos = cancdebitos.k20_codigo)";
        ...
        if(isset($chave_k20_codigo) && (trim($chave_k20_codigo)!="") ){
           ...
           $sql .= " and k20_data like '$chave_k20_data%' and k20_instit = $instit";
        }else if(isset($chave_k20_descr) && (trim($chave_k20_descr)!="") ){
           $sql .= " and k20_descr = '$chave_k20_descr'   and k20_instit = $instit";
        }else{
