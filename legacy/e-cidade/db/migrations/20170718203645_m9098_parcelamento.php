...
class M9098Parcelamento extends PostgresMigration
{
    
public function up()
{
  $this->atualizarFuncaoParcelamento();
  $this->criarFuncaoArredondamento();
}

public function criarFuncaoArredondamento()
{
  $this->execute("
set client_encoding = 'LATIN1';
create or replace function fc_arredondaminimomonetario(float8) 
returns float8
as $$
declare

  valorarredondar alias for $1;
  
  begin

    if valorarredondar > 0 and valorarredondar < 0.01 then
...
public function atualizarFuncaoParcelamento()
{
  $this->execute("
set client_encoding = 'LATIN1';
...
declare
  ...
  begin
    ...
    if v_teste between -0.01 and 0.5 and v_juronaultima is false then
...
");    
    ...
    public function down()
    {
        ...
        $this->execute("drop function fc_arredondaminimomonetario(float8);");
        $this->execute("set client_encoding = 'LATIN1';
