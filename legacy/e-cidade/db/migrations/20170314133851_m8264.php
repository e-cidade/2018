...
class M8264 extends PostgresMigration
{
    public function up()
    {
        $sSqlFichaCompensacao =
<<<EOL
...
declare
  ...
  rRetornoArreBanco tp_fichacompensacaoarrebanco;
...
begin
  ...
  if iTipoConvenio = 2 then
    ...
    rRetornoArreBanco := fc_fichacompensacaoarrebanco_old(iCodConvenio, iNumpre, iNumpar);

    sNumBanco := rRetornoArreBanco.numbanco;
    ...
    update arrebanco set k00_numbco = sNossoNumero
     where k00_numpre = iNumpre
       ...
       and k00_codbco = sBanco::integer
       and k00_codage = sAgencia
       and k00_numbco = rRetornoArreBanco.nossonumero;
...
EOL;
        ...
        $this->execute($sSqlFichaCompensacaoArrebancoType);
        $this->execute($sSqlFichaCompensacaoArrebanco);
        $this->execute($sSqlFichaCompensacao);
    }
