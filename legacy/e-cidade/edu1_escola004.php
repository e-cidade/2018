...
if(isset($censouf)){
 ?>
 <script>
 M = parent.document.form1.ed18_i_censomunic;
 D = parent.document.form1.ed18_i_censodistrito;
 O = parent.document.form1.ed18_i_censoorgreg;
 ...
 if($censouf==""){
  ?>
  <script>
  parent.document.form1.elements["ed18_i_censomunic"].options[0] = new Option("Selecione o Estado","");
  ...
  ?>
  <script>
  parent.document.form1.elements["ed18_i_censomunic"].options[0] = new Option("","");
