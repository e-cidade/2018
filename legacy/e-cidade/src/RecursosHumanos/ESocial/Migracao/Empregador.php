...
/**
 * Efetuar a migração das respostas de um formulário do Empregador para um novo layout
 *
...
class Empregador extends Migracao implements MigracaoInterface
{
    ...
    /**
     * Busca o ultimo preenchimento que o Empregador respondeu o formulário
     *
    ...
    protected function criarNovoPreenchimento($preenchimento)
    {
        ...
        if ($dao->erro_status == 0) {
            throw new \Exception("Ocorreu um erro ao vincular o cgm ao questionário.");
        }
