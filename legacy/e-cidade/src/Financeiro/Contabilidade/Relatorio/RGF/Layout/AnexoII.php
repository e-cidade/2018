...
class AnexoII extends RelatorioLegal implements InterfaceRelatorioLegal{
  ...
  public function header() {
    ...
    $this->oPdf->addHeaderDescription('DEMONSTRATIVO DA DÍVIDA CONSOLIDADA LÍQUIDA');
