...
use ECidade\Financeiro\Contabilidade\Relatorio\RGF\Layout\AnexoII as Layout;
...
class AnexoII {
   ...
   * @return ECidade\Financeiro\Contabilidade\Relatorio\RGF\Layout\AnexoII
   */
  public static function getInstance($iAno, \Periodo $oPeriodo) {
    ...
    $oDadosAnexo = new Anexo2017($iAno, $oPeriodo);
