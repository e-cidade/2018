...
use ECidade\Financeiro\Contabilidade\PlanoDeContas\PCASP\Importacao;
use ECidade\Financeiro\Contabilidade\PlanoDeContas\PCASP\ContaImportacao;
	...
	public function getContas() {
		...
		if (empty($this->aContas)) {
			...
			for ($i = 0; $i < $iContas; $i++) {
				...
				$oConta = new ContaImportacao();
				$oConta->setCodigo($oStdConta->c95_sequencial);
				$oConta->setModelo($oStdConta->c95_modeloplanoconta);
				...
				$oConta->setIndicardorSuperavit($oStdConta->c95_indicadorsuperavit);
