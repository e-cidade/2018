...
/**
 * Class BaseAbstract
 * Classe base para as regras de emissão do Licitacon.
 */
abstract class BaseAbstract {
	 ...
	 *
	 * @param DBDate $oDataGeracao Data de geração do arquivo para o Licitacon.
	 */
	...
	/**
	 * Retorna o código do layout do arquivo para a devida data de geração.
	 * @return int
	 */
