...
use ECidade\Tributario\Arrecadacao\EmissaoGeral\Registro\Padrao;
use ECidade\Tributario\Arrecadacao\EmissaoGeral\Registro\IPTU;

abstract class Factory {

  public static function getRegistro(EmissaoGeral $oEmissao) {
