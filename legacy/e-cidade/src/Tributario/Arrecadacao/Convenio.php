...
class Convenio {
  ...
  function __construct($iCodConvenio) {
    ...
    $this->iCodigoAgencia       = $oConvenio->codagencia;
  ...
  /**
   * @param integer $iCodigoAgencia
   */
  public function setCodigoAgencia($iCodigoAgencia) {
    $this->iCodigoAgencia = $iCodigoAgencia;
  }
