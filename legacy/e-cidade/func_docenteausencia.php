...
include("classes/db_docenteausencia_classe.php");
  ...
  <tr> 
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        $sCampos  = " ed321_sequencial, ed321_inicio, ed321_final, ed321_rechumano, ";
        $sCampos .= " case                                   ";
        ...
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $cldocenteausencia->sql_record($cldocenteausencia->sql_query($pesquisa_chave));
          if($cldocenteausencia->numrows!=0){
            db_fieldsmemory($result,0);
            echo "<script>".$funcao_js."('$ed321_sequencial',false);</script>";
          }else{
...
?>
<script>
js_tabulacaoforms("form2","chave_ed321_sequencial",true,1,"chave_ed321_sequencial",true);
</script>