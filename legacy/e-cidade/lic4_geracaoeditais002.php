...
$clagata = new cl_dbagata("licitacao/editais.agt");
$api     = $clagata->api;

$sCaminhoSalvoSxw = "tmp/edital_licitacao_{$oGet->iLicitacao}.sxw";
...
try {
	$oDocumentoTemplate = new documentoTemplate(4,$oGet->iCodDocumento); 
