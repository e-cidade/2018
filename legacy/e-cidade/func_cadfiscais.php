    ...
    <td align="center" valign="top">
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_id_usuario) && (trim($chave_id_usuario)!="") ){
	         ...
	         $sql = $clcadfiscais->sql_query($chave_id_usuario,$campos,"id_usuario");
        }else if(isset($chave_id_usuario) && (trim($chave_id_usuario)!="") ){
	         $sql = $clcadfiscais->sql_query("",$campos,"id_usuario"," id_usuario like '$chave_id_usuario%' ");
        }else{
           $sql = $clcadfiscais->sql_query("",$campos,"id_usuario","");
        }
