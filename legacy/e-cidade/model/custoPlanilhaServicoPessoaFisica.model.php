...
final class custoPlanilhaServicoPessoaFisica implements iCustoPlanilha {
  ...
  public function processarDados($iMesBase, $iAnoBase) {
    ...
    $sSqlCustos .= "   and o56_elemento like '3339036%' ";
  ...
  public function save($iPlanilha) {
    ...
    $sWhere         .= "and cc17_custoplanilhaorigem  = 5";      
    ...
    for ($iCusto = 0; $iCusto < $iNumRowsCustos; $iCusto++) {
      ...
      $oCustoRemover->setOrigem(5)->remover();
