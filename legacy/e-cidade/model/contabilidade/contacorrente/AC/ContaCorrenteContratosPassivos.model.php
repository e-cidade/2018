 ...
 * @version 1.0
 */
class ContaCorrenteContratosPassivos extends ContacorrenteBase implements IContaCorrente {

  /**
   * Registro na tabela contacorrente
   * @var integer
   */
  const CONTA_CORRENTE = 107;
  ...
  private function validarInformacoes() {
    ...
    if ( !$this->oContaCorrenteDetalhe->getAcordo() instanceof Acordo) {
      throw new ParameterException("Acordo não informado para execução do conta corrente {$this->oContaCorrente->getDescricao()}.");
    }
