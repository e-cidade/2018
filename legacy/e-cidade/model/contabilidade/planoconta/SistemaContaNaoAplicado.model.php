...
/**
* Classe responsável pelo comportamento do sistema de conta "Não Aplicado"
* @author dbseller
* @name SistemaContaNaoAplicado
...
class SistemaContaNaoAplicado implements ISistemaConta {
  ...
  private $iCodigo    = "0";
  private $sDescricao = 'NÃO SE APLICA';
 ...
 /**
	...
	*/
	...
	/**
	* Retorna o código do tipo Financeiro - Extra Orcamentaria
