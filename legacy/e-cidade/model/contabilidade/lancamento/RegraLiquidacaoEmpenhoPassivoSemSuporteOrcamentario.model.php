...
class RegraLiquidacaoEmpenhoPassivoSemSuporteOrcamentario {
  ...
  public function getRegraLancamento($iCodigoDocumento, $iCodigoLancamento, ILancamentoAuxiliar $oLancamentoAuxiliar) {
    ...
    for ($i = 0; $i < $oDaoTransacao->numrows; $i++) {
      ...
      if ($oDadosTransacao->c47_ref == 0  || 
          ($oDadosTransacao->c47_ref == $oLancamentoAuxiliar->getCodigoCompra() || $oDadosTransacao->c47_compara == 3)
         ){
