...
/**
 * Classe para impressão do modelo 2 (Todas disciplinas em uma página (Currículo)) do diário de classe
 * @author André Mello   <andre.mello@dbseller.com.br>
 *         Fábio Esteves <fabio.esteves@dbseller.com.br>
 * @package    educacao
 * @subpackage relatorio
 */
class RelatorioDiarioClasseGlobalizada extends RelatorioDiarioClasseBase {
  ...
  public function __construct( Turma $oTurma, Etapa $oEtapa, AvaliacaoPeriodica $oAvaliacaoPeriodica ) {
    ...
    $this->lTurmaGlobalizada = true;
    $this->lExibirAvaliacao  = true;
    $this->lExibirFaltas     = true;
  }
}