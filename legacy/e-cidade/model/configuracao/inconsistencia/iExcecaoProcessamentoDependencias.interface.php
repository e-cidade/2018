...
/**
 * Interface para as classes de exceção no Processamento de Inconsistências
 * Utilizado para processar dados aonde o procedimento padrao não atende
...
interface IExcecaoProcessamentoDependencias {
   ...
   * @param integer $iChaveIncorreta codigo da chave que deverá ser excluida/alterada
   * @return boolean
   */
