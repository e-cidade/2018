...
/**
* Constroi classe para importação de arquivo bancário, conforme o tipo informado
*/
class ImportacaoArquivoConsignadoFactory {
	
	/**
	 * Retorna classe para importação de acordo com o banco informado
	 */
