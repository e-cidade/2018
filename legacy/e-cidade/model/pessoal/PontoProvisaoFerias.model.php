...
/**
 * Definições sobrte ponto de provisao de Férias
 * 
 * @uses    Ponto
 * @package Pessoal 
 * @author  Renan Melo <renan@dbseller.com.br> 
 */
class PontoProvisaoFerias extends Ponto {

  /**
   * Nome da tabela para ponto de provisao de Férias 
   */
  const TABELA = Ponto::PROVISAO_FERIAS;

  /**
   * Sigla da tabela do ponto de provisao de Férias
   */
  const SIGLA_TABELA = 'r91';
