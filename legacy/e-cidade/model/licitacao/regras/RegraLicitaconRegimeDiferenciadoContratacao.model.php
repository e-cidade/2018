 ...
 */
class RegraLicitaconRegimeDiferenciadoContratacao extends RegraLicitacon {
  ...
  public function regra() {
    ...
    if (in_array($this->oLicitacao->getModalidade()->getSiglaTipoCompraTribunal(), $this->getModalidades())) {
      ...
      return !empty($this->aAtributosDinamicos[LicitacaoAtributosDinamicos::NOME_TIPO_EXECUCAO])
             && !empty($this->aAtributosDinamicos[LicitacaoAtributosDinamicos::NOME_TIPO_DISPUTA])
             && !empty($this->aAtributosDinamicos[LicitacaoAtributosDinamicos::NOME_PRE_QUALIFICACAO]);
    }
    return true;
  }
}