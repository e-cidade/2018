 ...
 */
final class AveriguacaoCadastroUnico extends ProcessarSituacaoCadastroUnico implements IProcessarSituacaoCadastroUnico {

  /**
   * Código do layout (PK db_layouttxt)
   * @var integer
   */
  protected $iCodArquivo = 208;
  
  /**
   * Tipo da Situacao 
   * @var integer
   */
  protected $iTipoSituacao = 1;
  
  /**
   * Nome do arquivo de log
   * @var string
   */
  protected $sNomeArquivoNaoProcessado = "tmp/logsAveriguacaoNaoProcessada.csv";
  ...
  public function processarArquivo() {
    ...
    while (!feof($rArquivo)) {
      ...
      $iNisPessoaArquivo = $oLinhaAtual->num_nis_pessoa_atual;
