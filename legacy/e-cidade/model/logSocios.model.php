...
class logsocios {
  ...
  private function setObservacao($oIssBaseLog) {
    ...
    switch ($oIssBaseLog->iOpcao) {
      ...
      case 1:
        ...
        if (isset($oIssBaseLog->issbaselogtipo) && $oIssBaseLog->issbaselogtipo == 3) {
          $this->sObservacao = "Incluнdo novo sуcio {$oIssBaseLog->socio} ";  
        }
        break;

      case 2:
        
        if (isset($oIssBaseLog->issbaselogtipo) && $oIssBaseLog->issbaselogtipo == 4) {
          $this->sObservacao  = "Alterado valor capital do sуcio {$oIssBaseLog->socio}";
          $this->sObservacao .= " de {$oIssBaseLog->valorcapantigo} para {$oIssBaseLog->valorcapnovo}";
        }
        break;
      ...
      case 3:
        ...
        if (isset($oIssBaseLog->issbaselogtipo) && $oIssBaseLog->issbaselogtipo == 3) {
          $this->sObservacao = "Excluнdo sуcio {$oIssBaseLog->socio} ";
        }
        break;
    }
  }
   ...
   * @param integer $iSocio novo socio
  ...
  public function identificaAlteracao($iInscricao = null, $iOpcao, $iLogTipo = null, $iSocio = "", 
    ...
    $oTipoAlteracao->socio          = $iSocio;
    $oTipoAlteracao->valorcapnovo   = $fValorCapNovo;
    $oTipoAlteracao->valorcapantigo = $fValorCapAntigo;
