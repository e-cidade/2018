...
$HTTP_SESSION_VARS['DB_nome_modulo'      ] = 'Configuraчѕes';
...
$HTTP_SERVER_VARS['SCRIPT_FILENAME']       = __DIR__.'/requisicao.webservice.php';
$HTTP_SERVER_VARS['SCRIPT_NAME']           = __DIR__.'/requisicao.webservice.php';
$HTTP_SERVER_VARS['PHP_SELF']              = ECIDADE_REQUEST_ROOT.'/webservices/requisicao.webservice.php';
