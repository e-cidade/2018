    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_e81_codmov) && (trim($chave_e81_codmov)!="") ){
	         $sql = $clempagemov->sql_query_ord(null,$campos,null , " e80_instit = " . db_getsession("DB_instit") . " and e81_codmov = $chave_e81_codmov ");
        }else if(isset($chave_e81_numemp) && (trim($chave_e81_numemp)!="") ){
	         $sql = $clempagemov->sql_query_ord(null,$campos,null ," e80_instit = " . db_getsession("DB_instit") . " and e81_numemp like '$chave_e81_numemp%'");
        } else {
           $sql = $clempagemov->sql_query_ord(null,$campos,null ," e80_instit = " . db_getsession("DB_instit"));
        }
        if (isset($e50_codord)) {
          $sql .= " and e53_codord =  $e50_codord ";
        }
        db_lovrot($sql,15,"()","",$funcao_js);
      }else{
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $clempagemov->sql_record($clempagemov->sql_query_ord($pesquisa_chave));
