	     ...
	     <form name="form2" method="post" action="" >
          ...
          <tr> 
            <td colspan="2" align="center" nowrap> 
              ...
              <input name="Fechar" type="button" id="fechar" value="Fechar" onClick="parent.db_iframe_cep.hide();">
             </td>
          </tr>
        </form>
        </table>
...
function js_limpar(){
//alert('oi');
document.form2.db10_cep.value="";
document.form2.db10_munic.value="";
document.form2.db11_logradouro.value="";
