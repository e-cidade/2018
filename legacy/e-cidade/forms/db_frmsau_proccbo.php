  ...
  if(mostra==true){
    js_OpenJanelaIframe('top.corpo','db_iframe_sau_procedimento','func_sau_procedimento.php?funcao_js=parent.js_mostrasau_procedimento1|sd63_i_codigo|sd63_c_nome','Pesquisa',true);
     ...
     if(document.form1.sd96_i_procedimento.value != ''){
        js_OpenJanelaIframe('top.corpo','db_iframe_sau_procedimento','func_sau_procedimento.php?pesquisa_chave='+document.form1.sd96_i_procedimento.value+'&funcao_js=parent.js_mostrasau_procedimento','Pesquisa',false);
     }else{
...
function js_pesquisasd96_i_cbo(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('top.corpo','db_iframe_rhcbo','func_rhcbo.php?funcao_js=parent.js_mostrarhcbo1|rh70_sequencial|rh70_descr','Pesquisa',true);
  }else{
     if(document.form1.sd96_i_cbo.value != ''){
        js_OpenJanelaIframe('top.corpo','db_iframe_rhcbo','func_rhcbo.php?pesquisa_chave='+document.form1.sd96_i_cbo.value+'&funcao_js=parent.js_mostrarhcbo','Pesquisa',false);
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('top.corpo','db_iframe_sau_proccbo','func_sau_proccbo.php?funcao_js=parent.js_preenchepesquisa|sd96_i_codigo','Pesquisa',true);
}
