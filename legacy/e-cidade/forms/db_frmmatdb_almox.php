  ...
  if(mostra==true){
    js_OpenJanelaIframe('','db_iframe_db_depart','func_db_depart.php?funcao_js=parent.js_mostradb_depart1|coddepto|descrdepto','Pesquisa',true);
     ...
     if(document.form1.m91_depto.value != ''){ 
        js_OpenJanelaIframe('','db_iframe_db_depart','func_db_depart.php?pesquisa_chave='+document.form1.m91_depto.value+'&funcao_js=parent.js_mostradb_depart','Pesquisa',false);
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('','db_iframe_almox','func_db_almox.php?funcao_js=parent.js_preenchepesquisa|m91_codigo|descrdepto|','Pesquisa',true);
}
