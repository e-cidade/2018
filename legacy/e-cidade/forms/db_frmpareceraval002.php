...
<table border="0" width="100%" cellspacing="0" cellpading="0">
 <tr>
  <td align="center">
   <iframe name="parecer" id="parecer" src="edu1_pareceraval005.php?ed93_i_diarioavaliacao=<?=$ed93_i_diarioavaliacao?>&periodo=<?=$periodo?>&nota=<?=$nota?>&aluno=<?=$aluno?>&faltas=<?=$faltas?>&encerrado=<?=$encerrado?>&turma=<?=$turma?>&codaluno=<?=$codaluno?>&codperiodo=<?=$codperiodo?>&conceito=<?=$conceito?>&modelo=<?=$modelo?>" width="95%" height="180" frameborder="0"></iframe>
  </td>
 </tr>
</table>
</fieldset>
 ...
 <tr>
  <td colspan="4" align="center">
   ...
   db_textarea('ed72_t_parecer',
                 ...
                 'text',
                 $db_opcao,
                 @$encerrado=="S"?"onblur=this.value = this.value.toUpperCase(); 
