...
//MODULO: material
$clnotifica->rotulo->label();
?>
<form name="form1" method="post" action="">
<center>
<table border="0">
  <tr>
    <td nowrap title="<?=@$Tm06_numdiv?>">
...
function js_pesquisa(){
  db_iframe.jan.location.href = 'func_notifica.php?funcao_js=parent.js_preenchepesquisa|0';
  db_iframe.mostraMsg();
  db_iframe.show();
  db_iframe.focus();
}
