  ...
  if(mostra==true){
    js_OpenJanelaIframe('top.corpo','db_iframe_cgm','func_cgm.php?funcao_js=parent.js_mostracgm1|z01_numcgm|z01_nome','Pesquisa',true);
     ...
     if(document.form1.t04_numcgm.value != ''){ 
        js_OpenJanelaIframe('top.corpo','db_iframe_cgm','func_cgm.php?pesquisa_chave='+document.form1.t04_numcgm.value+'&funcao_js=parent.js_mostracgm','Pesquisa',false);
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('top.corpo','db_iframe_benscadcedente','func_benscadcedente.php?funcao_js=parent.js_preenchepesquisa|t04_sequencial','Pesquisa',true);
}
