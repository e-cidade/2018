...
//MODULO: prefeitura
$cldb_confip->rotulo->label();
?>
<form name="form1" method="post" action="">
<center>
<table border="0">
  <tr>
    <td nowrap title="<?=@$Tw02_ip?>">
...
function js_pesquisa(){
  db_iframe.jan.location.href = 'func_db_confip.php?funcao_js=parent.js_preenchepesquisa|0';
  db_iframe.mostraMsg();
  db_iframe.show();
  db_iframe.focus();
}
