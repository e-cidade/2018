  ...
  if(mostra==true){
    js_OpenJanelaIframe('top.corpo','func_nome','func_cgm.php?funcao_js=parent.js_mostracgm1|z01_numcgm|z01_nome','Pesquisa',true);
     ...
     if(document.form1.cm17_i_funeraria.value != ''){
        js_OpenJanelaIframe('top.corpo','func_nome','func_cgm.php?pesquisa_chave='+document.form1.cm17_i_funeraria.value+'&funcao_js=parent.js_mostracgm','Pesquisa',false);
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('top.corpo','db_iframe_funerarias','func_funerarias.php?funcao_js=parent.js_preenchepesquisa|cm17_i_funeraria','Pesquisa',true);
}
