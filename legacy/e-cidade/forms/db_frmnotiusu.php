...
<script>
function js_pesquisak52_notifica(mostra){
  if(mostra==true){
    ...
    db_iframe.jan.location.href = 'func_notificacao.php?pesquisa_chave='+document.form1.k52_notifica.value+'&funcao_js=parent.js_mostranotificacao';
  }
}
function js_mostranotificacao(chave,erro){
  document.form1.k50_procede.value = chave; 
  if(erro==true){ 
    document.form1.k52_notifica.focus(); 
    document.form1.k52_notifica.value = ''; 
  }
}
function js_mostranotificacao1(chave1,chave2){
  document.form1.k52_notifica.value = chave1;
  document.form1.k50_procede.value = chave2;
  db_iframe.hide();
}
function js_pesquisak52_id_usuario(mostra){
  if(mostra==true){
    ...
    db_iframe.jan.location.href = 'func_db_usuarios.php?pesquisa_chave='+document.form1.k52_id_usuario.value+'&funcao_js=parent.js_mostradb_usuarios';
  }
}
function js_mostradb_usuarios(chave,erro){
  document.form1.nome.value = chave; 
  if(erro==true){ 
    document.form1.k52_id_usuario.focus(); 
    document.form1.k52_id_usuario.value = ''; 
  }
}
function js_mostradb_usuarios1(chave1,chave2){
  document.form1.k52_id_usuario.value = chave1;
  document.form1.nome.value = chave2;
  db_iframe.hide();
}
function js_pesquisa(){
  db_iframe.jan.location.href = 'func_notiusu.php?funcao_js=parent.js_preenchepesquisa|0';
  db_iframe.mostraMsg();
  db_iframe.show();
  db_iframe.focus();
}
