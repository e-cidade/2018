...
$cltipoconhecimento->rotulo->label();
$db_botao1 = false;
...
if($ed110_i_ptconhecimento==0 || $ed110_i_ptgeral==0){
 db_msgbox("Pontuação do Conhecimento ou Pontuação Geral está com valor zero! (Configurações)");
 $db_opcao = 3;
 $db_opcao1 = 3;
 $db_botao = false;
 $db_botao1 = false;
...
<table border="0">
 <tr>
  <td nowrap title="<?=@$Ted109_i_codigo?>">
   <?=@$Led109_i_codigo?>
  </td>
  <td>
 ...
 <tr>
  <td nowrap title="<?=@$Ted109_c_descr?>">
   <?=@$Led109_c_descr?>
  </td>
  <td>
