  ...
  <tr> 
    <td align="center" valign="top"> 
      ...
      if (!isset($pesquisa_chave)) {
        ...
        $campos = "q98_sequencial, q98_descricao,q98_tipovalidade";
        
        if (isset($chave_q98_sequencial) && (trim($chave_q98_sequencial)!="") ) {
        	
          $sql = $clisstipoalvara->sql_query($chave_q98_sequencial,$campos,"q98_sequencial", " q98_issgrupotipoalvara = {$oGET->grupo} {$sWere} ");
          
        } else if(isset($chave_q98_descricao) && (trim($chave_q98_descricao)!="") ) {
          
          if (isset($oGET->grupo)) {
          	
            $sql = $clisstipoalvara->sql_query("",$campos,"q98_descricao"," q98_descricao like '$chave_q98_descricao%' and q98_issgrupotipoalvara = {$oGET->grupo} {$sWere} "); 
          } else {
        ...
        if ($pesquisa_chave != null && $pesquisa_chave != "") {
          ...
          $result = $clisstipoalvara->sql_record($clisstipoalvara->sql_query($pesquisa_chave));
