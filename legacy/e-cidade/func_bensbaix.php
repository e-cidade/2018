    ...
    <td height="63" align="center" valign="top">
        <table width="35%" border="0" align="center" cellspacing="0">
	     <form name="form2" method="post" action="" >
          <tr>
            <td width="4%" align="right" nowrap title="<?=$Tt52_ident?>">
              <?=$Lt52_ident?>
            </td>
            <td width="96%" align="left" nowrap>
              <?
		       db_input("t52_ident",10, '', false,"text",1,"","chave_t52_ident");
		       ?>
            </td>
          </tr>
          <tr>
    ...
    <td align="center" valign="top">
      ...
      if(!isset($pesquisa_chave)){
        ...
        if (isset($chave_t52_ident) && (trim($chave_t52_ident)!="") ) {
          ...
          $sWhere = "t52_ident = '{$chave_t52_ident}'";
	        $sql = $clbensbaix->sql_query(null,$campos,"t55_codbem", $sWhere);
