    ...
    <td height="63" align="center" valign="top">
      <table width="35%" border="0" align="center" cellspacing="0">
        <form name="form2" method="post" action="" >
          ...
          <tr>
            <td width="4%" align="right" nowrap title="<?=$Tla54_c_descr?>">
              <?=$Lla54_c_descr?>
            </td>
            <td width="96%" align="left" nowrap>
              <?
    ...
    <td align="center" valign="top">
      ...
      if (!isset($pesquisa_chave)) {
        ...
        if (isset($chave_la54_i_codigo) && (trim($chave_la54_i_codigo)!="") ) {
          $aWhere[] = " la54_i_codigo = {$chave_la54_i_codigo}";
        } else if(isset($chave_la54_c_descr) && (trim($chave_la54_c_descr)!="") ){
          $aWhere[] = " la54_c_descr like '$chave_la54_c_descr%' ";
        }
        ...
        if ($pesquisa_chave!=null && $pesquisa_chave!="") {
          ...
          $result = $cllab_fechamento->sql_record($cllab_fechamento->sql_query(null, $campos, null, $sWhere));
          if ($cllab_fechamento->numrows!=0) {

            db_fieldsmemory($result,0);
            echo "<script>".$funcao_js."('$la54_c_descr',false);</script>";
          } else {
