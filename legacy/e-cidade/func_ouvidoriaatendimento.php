    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_ov01_sequencial) && (trim($chave_ov01_sequencial)!="") ){
	         $sql = $clouvidoriaatendimento->sql_query(null,$campos,"ov01_sequencial",$sWhere." and ov01_sequencial = {$chave_ov01_sequencial} ");
        }else if(isset($chave_ov01_numero) && (trim($chave_ov01_numero)!="") ){
	         $sql = $clouvidoriaatendimento->sql_query("",$campos,"ov01_numero",$sWhere." and ov01_numero like '$chave_ov01_numero%' ");
        }else{
        ...
        if($pesquisa_chave!=null && $pesquisa_chave!="") {
          ...
          $sWhere .= "and ov01_anousu = {$iAnoAtendimento}";
          
          $sSql   = $clouvidoriaatendimento->sql_query(null, $campos, null, $sWhere);
          
          $result = $clouvidoriaatendimento->sql_record($sSql);
          
          if ($clouvidoriaatendimento->numrows != 0) {
            db_fieldsmemory($result,0);
            
            if ( isset($requer) ) { 
              echo "<script>".$funcao_js."('$ov01_numero','$ov01_requerente',false, '$ov01_anousu');</script>";
            } else {
