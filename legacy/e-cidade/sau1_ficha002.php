...
$pdf->AliasNbPages();
 ...
 $head5 = "Hora: ".$sd23_c_hora2;
  ...
  $pdf->cell(190,4,"3. IDENTIFICAÇÃO DO PROFISSIONAL",1,1,"L",1);
  $pdf->cell(40,4,"NOME: ",1,0,"L",0);
  $pdf->cell(150,4,$sd03_c_nome,1,1,"L",0);
  $pdf->cell(190,4,"4. MOTIVO DO ATENDIMENTO",1,1,"L",1);
  $pdf->cell(190,4,"",1,1,"L",0);
  $pdf->cell(20,4,"5. Especialidade",1,0,"L",1);
  $pdf->cell(20,4,"6. Procedimento",1,0,"L",1);
  $pdf->cell(20,4,"7. Profissional",1,0,"L",1);
  $pdf->cell(80,4,"8. Tratamento/Descrição dos Procedimentos",1,0,"L",1);
  $pdf->cell(50,4,"9. Assinatura/Carimbo do Profissional",1,1,"L",1);
  for($x=0; $x < 10; $x++){
  ...
  $pdf->cell(30,4,"10. TIPO",1,0,"L",1);
  $pdf->cell(120,4,"11. DIAGNÓSTICO",1,0,"L",1);
  $pdf->cell(40,4,"12. POLEGAR",1,1,"L",1);
  $pdf->cell(30,8,"",1,0,"L",0);
  $pdf->cell(120,8,"",1,0,"L",0);
  $pdf->cell(40,4,"","R",1,"L",0);
  $pdf->cell(30,4,"13. GRUPO",1,0,"L",1);
  $pdf->cell(120,4,"14. ASSINATURA DO PACIENTE OU RESPONSÁVEL",1,0,"L",1);
  $pdf->cell(40,4,"","R",1,"L",0);
  $pdf->cell(30,8,"",1,0,"L",0);
  $pdf->cell(120,8,"",1,0,"L",0);
  $pdf->cell(40,4,"","R",1,"L",0);
  $pdf->cell(30,4,"15. DATA ATEND.",1,0,"L",1);
  $pdf->cell(120,4,"16. HORA ATEND.",1,0,"L",1);
  $pdf->cell(40,4,"","R",1,"L",0);
  $pdf->cell(30,4,$sd23_d_consulta,1,0,"L",0);
  $pdf->cell(120,4,$sd23_c_hora,1,0,"L",0);
  $pdf->cell(40,4,"","BR",0,"L",0);
$pdf->Output();
?>