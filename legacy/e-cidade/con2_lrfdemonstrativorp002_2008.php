...
$pdf->cell(80,$alt,'RESTOS A PAGAR (EXCETO INTRA-ORÇAMENTÁRIOS)(I)', "0", 0, "L", 0);
...
for ($x=0;$x<pg_numrows($result);$x++){
  ...
  if ($instit != $e60_instit) {
    ...
    if (!isset($arqinclude)){ // se este arquivo no esta incluido por outro
      ...
      $pdf->cell(80,$alt,$sPoder, "0", 0, "L", 0);
...
$pdf->cell(80,$alt,'RESTOS A PAGAR (INTRA-ORÇAMENTÁRIOS)(II)', "0", 0, "L", 0);
...
if (!isset($arqinclude)) { // se este arquivo no esta incluido por outro
  ...
  $pdf->cell(80,$alt,'TOTAL (III) = (I + II)', "RTB", 0, "L", 0);
...
function writeHeader($pdf, $alt){
  ...
  $pdf->cell(100,$alt,"RESTOS A PAGAR PROCESSADOS","LRTB",0,"C",0);
  ...
  $pdf->cell(80,$alt,"PODER/ORGÂO",0,0,"C",0);
  ...
  $pdf->cell(20,$alt,"A Pagar","LR",0,"C",0);
  $pdf->cell(20,$alt,"Exercícios","LR",0,"C",0);
  $pdf->cell(20,$alt,"dezembro de","LR",0,"C",0);
  $pdf->cell(20,$alt,"Cancelados","LR",0,"C",0);
  $pdf->cell(20,$alt,"Pagos","LR",0,"C",0);
  $pdf->cell(20,$alt,"A Pagar","L",1,"C",0);
  
  $pdf->cell(80,$alt,"","B",0,"C",0);
