...
$chave_db01_anousu = db_getsession('DB_anousu');
?>
<html>
<head>
  ...
  <tr> 
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        $campos = "distinct db01_orgao, o40_descr";
        ...
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $sql = $cldb_departorg->sql_query(null, 
                                            null,
                                             "*",
                                             "db01_coddepto",
                                             "db01_orgao = {$pesquisa_chave} and {$sWhere}");
          $result = $cldb_departorg->sql_record($sql);
          if($cldb_departorg->numrows!=0){
            db_fieldsmemory($result,0);
            if(isset($lBuscaCampoOrgao) && $lBuscaCampoOrgao){
              $descrdepto = $o40_descr;
            }
