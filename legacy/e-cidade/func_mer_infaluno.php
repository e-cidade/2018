	     ...
	     <form name="form2" method="post" action="" >
          <tr> 
            ...
            <td width="96%" align="left" nowrap> 
              <?
		       db_input("ed47_i_codigo",5,$Ied47_i_codigo,true,"text",4,"","chave_ed47_i_codigo");
		       ?>
            </td>
          </tr>
          <tr> 
          ...
          <tr> 
            <td colspan="2" align="center"> 
              ...
              <input name="Fechar" type="button" id="fechar" value="Fechar" 
                     onClick="parent.db_iframe_mer_infaluno.hide();">
             </td>
          </tr>
        </form>
        </table>
  ...
  <tr> 
    <td align="center" valign="top"> 
      ...
      if (!isset($pesquisa_chave)) {
        ...
        $campos = "me14_i_codigo,ed47_i_codigo,ed47_v_nome,me14_f_peso,me14_f_altura";
        if (isset($chave_ed47_i_codigo) && (trim($chave_ed47_i_codigo) != "")) {
          $sql = $clmer_infaluno->sql_query( "",
                                             $campos,
                                             "ed47_v_nome",
                                             "me14_i_aluno = $chave_ed47_i_codigo"
                                            );
        } else if (isset($chave_ed47_v_nome) && (trim($chave_ed47_v_nome) != "")) {
          $sql = $clmer_infaluno->sql_query( "",
                                             $campos,
                                             "ed47_v_nome",
                                             "ed47_v_nome like '$chave_ed47_v_nome%' "
                                           );
        } else {
          $sql = $clmer_infaluno->sql_query("",$campos,"ed47_v_nome","");
        }
        $repassa = array();
        ...
        if ($pesquisa_chave!=null && $pesquisa_chave != "") {
          ...
          $result = $clmer_infaluno->sql_record($clmer_infaluno->sql_query($pesquisa_chave));
          if ($clmer_infaluno->numrows != 0) {
          	
            db_fieldsmemory($result,0);
            echo "<script>".$funcao_js."('$me14_i_codigo',false);</script>";
