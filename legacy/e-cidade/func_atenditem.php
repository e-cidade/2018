    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_at05_seq) && (trim($chave_at05_seq)!="") ){
	         $sql = $clatenditem->sql_query($chave_at05_seq,$chave_at05_codatend,$campos,"at05_seq");
        }else if(isset($chave_at05_solicitado) && (trim($chave_at05_solicitado)!="") ){
	         $sql = $clatenditem->sql_query("","",$campos,"at05_solicitado"," at05_solicitado like '$chave_at05_solicitado%' ");
        }else{
           $sql = $clatenditem->sql_query("","",$campos,"at05_seq#at05_codatend","");
        }
        db_lovrot($sql,15,"()","",$funcao_js);
      }else{
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $clatenditem->sql_record($clatenditem->sql_query($pesquisa_chave));
