        ...
        <form name="form2" method="post" action="" >
         ...
         <tr> 
            <td colspan="2" align="center"> 
              ...
              <input name="Fechar" type="button" id="fechar" value="Fechar" onClick="parent.db_iframe_orcsuplem.hide();">
             </td>
          </tr>
        </form>
        </table>
    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_o46_codsup) && (trim($chave_o46_codsup)!="") ){
           $sql = $clorcsuplem->sql_query_sup($chave_o46_codsup,$campos,"o46_codsup","o49_codsup is null and to_char(o46_data,'YYYY')::int4 = ".db_getsession("DB_anousu"));
        }else if(isset($chave_o46_codlei) && (trim($chave_o46_codlei)!="") ){
           $sql = $clorcsuplem->sql_query_sup("",$campos,"o46_codlei"," o46_codlei like '$chave_o46_codlei%' and o49_codsup is null and to_char(o46_data,'YYYY')::int4 = ".db_getsession("DB_anousu"));
        }else{
           $sql = $clorcsuplem->sql_query_sup("",$campos,"o46_codsup","  o49_codsup is null and to_char(o46_data,'YYYY')::int4 = ".db_getsession("DB_anousu"));
        }
