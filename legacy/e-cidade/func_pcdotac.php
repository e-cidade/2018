    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_pc13_codigo) && (trim($chave_pc13_codigo)!="") ){
	         $sql = $clpcdotac->sql_query($chave_pc13_codigo,$chave_pc13_anousu,$chave_pc13_coddot,$campos,"pc13_codigo");
        }else if(isset($chave_pc13_quant) && (trim($chave_pc13_quant)!="") ){
	         $sql = $clpcdotac->sql_query("","","",$campos,"pc13_quant"," pc13_quant like '$chave_pc13_quant%' ");
        }else{
           $sql = $clpcdotac->sql_query("","","",$campos,"pc13_codigo#pc13_anousu#pc13_coddot","");
        }
