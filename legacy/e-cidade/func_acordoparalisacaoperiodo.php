	     ...
	     <form name="form2" method="post" action="" >
          <tr> 
            <td colspan="2" align="center"> 
              ...
              <input name="Fechar" type="button" id="fechar" value="Fechar" onClick="parent.db_iframe_acordoparalisacaoperiodo.hide();">
             </td>
          </tr>
        </form>
        </table>
      ...
      if(!isset($pesquisa_chave)){
        if(isset($campos)==false){
           ...
           $campos = "acordoparalisacaoperiodo.oid,acordoparalisacaoperiodo.*";
	         ...
	         $sql = $clacordoparalisacaoperiodo->sql_query();
        $repassa = array();
        db_lovrot($sql,15,"()","",$funcao_js,"","NoMe",$repassa);
      }else{
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $clacordoparalisacaoperiodo->sql_record($clacordoparalisacaoperiodo->sql_query($pesquisa_chave));
          if($clacordoparalisacaoperiodo->numrows!=0){
