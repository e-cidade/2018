...
$oAgata           = new cl_dbagata("compras/emissao_autorizacao_processo_compras.agt");
...
$oApiAgata->setParameter ('$iCodigoProcesso', $oGet->iCodigoProcesso);

try {
	$oDocumentoTemplate = new documentoTemplate(19, $iModeloImpressao);
