...
class calendario{
   ...
   function cria($dia,$mes,$ano,$marca=0){
      ...
      for($i=1;$i < ($last+1);$i++){       //; pega todos os dias do mes informado....
         ...
         if($marca != 0){  // marca o dia atual em laranja
            if($dia == $i){
               $sClass.= " class='diaatual' ";  // marcar o dia atual
            }
	       }
	       if($this->sem[$diasem] == 1 || $this->sem[$diasem] == 7){
            $sClass.=" class='fimsemana' ";
         }
          $str.=$sClass;"  bgcolor=#CCCCCC ";
         $str .="  width=\"25\">
  ...
  <body>
  <table class='dbdatepicker' border=\"1\"  cellspacing=\"0\" cellpadding=\"0\">
  <tr>
   <td>
     ...
     <tr align=\"center\">
       <td width=\"100%\" colspan=\"7\" nowrap>
        <FONT SIZE='1' FACE='Verdana' COLOR='black'>
         <a class='zeraData' onclick=\"return janela_zera();return false;\">Zera Data</a>
        </FONT>
       </td>
     </tr>
     <tr align=\"center\">
