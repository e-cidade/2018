...
<table height="100%" border="0"  align="center" cellspacing="0" bgcolor="#CCCCCC">
  ...
  <tr>
    <td align="center" valign="top">
      ...
      if (isset($tipo)) {
      	$sWhereTipoAbatimento = " k125_tipoabatimento = {$tipo} and k125_instit = {$iDBInstit}";
      }
      ...
      if (!isset($pesquisa_chave)) {
        ...
        if (isset($campos)==false) {
           ...
           if (file_exists("funcoes/db_func_abatimento.php")==true) {
             include(modification("funcoes/db_func_abatimento.php"));
           } else {
             $campos = "abatimento.*";
           }
        }
        ...
        if (isset($chave_k125_sequencial) && (trim($chave_k125_sequencial)!="") ) {
           $sql = $clabatimento->sql_query("",$campos,"k125_sequencial"," k125_sequencial = $chave_k125_sequencial ".($sWhereTipoAbatimento!=""?" and ".$sWhereTipoAbatimento:" and k125_instit = {$iDBInstit}"));
        } else {
