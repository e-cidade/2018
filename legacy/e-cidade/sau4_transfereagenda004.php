...
$clagendamentos->lancar_transf_individual = true;
$clagendamentos->cria_table($sd27_i_codigo, $chave_diasemana,$sd23_d_consulta, $clagendamentos,$clundmedhorario, $funcao_js);


?>
<script>
function js_lancar(id_ficha,sd23_c_hora, sd30_i_codigo,funcao_js){

	if( id_ficha != 0 ){
		x = funcao_js+"("+id_ficha+",'"+sd23_c_hora+"',"+sd30_i_codigo+")";
		eval( x );
		windows.close();
