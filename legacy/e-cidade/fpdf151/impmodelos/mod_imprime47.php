...
if ($this->tipoitbi == "urbano") {
  ...
  $this->objpdf->SetFont('Arial','B',8);
  $this->objpdf->cell(22,$altura,'Profundidade:'										,1,0,"L",$iPreencheFundo);
  $this->objpdf->SetFont('Arial','' ,8);
  $this->objpdf->cell(22,$altura,db_formatar($this->it18_prof,'f',' ' ,0,'e',3).'m'  ,1,0,"L",0);

  $this->objpdf->SetFont('Arial','B',8);
  $this->objpdf->cell(28,$altura,'Frente via Pública:',1,0,"L",$iPreencheFundo);
  $this->objpdf->SetFont('Arial','',8);
...
$this->objpdf->ln(2);
$this->objpdf->SetFont('Arial','B',8);
$this->objpdf->cell(170,$altura,'Observações',1,0,"L",$iPreencheFundo);
...
if ( $lExibeMsg ) {
  $this->objpdf->SetFont('Arial','B',6);
  $this->objpdf->setY($iPosicaoYCodBarra+5);
...
if ($this->codigo_barras != null) {
  // incluir o codigo de barras
  $this->objpdf->int25(14,$pos+1,$this->codigo_barras,10,0.3);
}
