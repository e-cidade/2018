...
//    if($this->dtparapag > $venc && $this->confirmdtpag == 't'){
  ...
  $this->objpdf->Text(175,$y-10,"GRM");
  $this->objpdf->Text(165,$y-7, "Guia de Recolhimento municipal");
  $this->objpdf->SetFont('Arial','B',6);
  $this->objpdf->Text(165,$y-3,"Data para pagamento : ".$this->dtparapag);
  $this->objpdf->SetFont('Arial','B',7);
  $this->objpdf->Text(70, $y-10,"GRM");
  $this->objpdf->Text(52, $y-7, "Guia de Recolhimento municipal");
  $this->objpdf->SetFont('Arial','B',6);
