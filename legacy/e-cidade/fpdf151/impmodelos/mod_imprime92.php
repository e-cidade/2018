...
if (empty($this->ufInstint)) {
  $this->ufInstint = $oDadosInstit->uf;
}
...
$this->objpdf->image($this->imagemlogo, 6, 9.5, 32, 7);
...
if ($this->banco == "CAIXA") {
  ...
  $sBancoMsgSac  = "SAC CAIXA: 0800 726 0101 (informações, reclamações, sugestões e elogios) ";
  $sBancoMsgSac .= "Para pessoas com deficiência auditiva ou de fala: 0800 726 2492 OUVIDORIA: 0800 725 7474 ";
  $sBancoMsgSac .= "caixa.gov.br";

} else if ($this->banco == "BANRISUL") {
  $sBancoMsgSac = "SAC BANRISUL: 0800 646 1515 OUVIDORIA BANRISUL: 0800 644 2200";
}

if (!empty($sBancoMsgSac)) {
  $this->objpdf->text(8, $xlin+130, $sBancoMsgSac);
}
