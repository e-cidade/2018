...
$this->objpdf->SetFont('Arial','B',8);
$this->objpdf->SetX(10);
$this->objpdf->Cell(60,4,  $this->tipodebito ,0,0,"C",0);
$this->objpdf->SetFont('Arial','B',6);


$this->objpdf->Cell(20,4,'1ª Via Contribuinte',0,0,"R",0);
$this->objpdf->SetFont('Arial','B',8);
$this->objpdf->SetX(105);
...
if ( $sObsVistorias != '' ) {
  $this->objpdf->multicell(70,3,$sObsVistorias );
}
...
if ( $sObsVistorias != '' ) {
  $this->objpdf->multicell(100,2,$sObsVistorias );
}
