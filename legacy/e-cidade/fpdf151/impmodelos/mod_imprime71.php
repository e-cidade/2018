...
$this->objpdf->SetX(17);
$this->objpdf->Text(17,$top+1,$this->prefeitura,0,0,"L",0); //sap
$this->objpdf->SetX(105);
$this->objpdf->Text(105,$top+1,$this->prefeitura,0,1,"L",0); //sap
$this->objpdf->SetX(170);
$this->objpdf->SetX(17);
$this->objpdf->SetFont('Arial','',5);
$this->objpdf->Text(17,$top+3,$this->secretaria,0,0,"L",0); //sap
$this->objpdf->SetX(105);
$this->objpdf->Text(105,$top+3,$this->secretaria,0,1,"L",0); //sap
$this->objpdf->Ln(2);
$this->objpdf->SetFont('Arial','',8);
$this->objpdf->SetX(10);
$this->objpdf->Cell(52,4,$this->tipodebito,0,0,"C",0); //sap
$this->objpdf->SetFont('Arial','',6);


$this->objpdf->Cell(24,4,'1ª Via Contribuinte',0,0,"R",0); //sap
$this->objpdf->SetFont('Arial','',8);
$this->objpdf->SetX(105);
$this->objpdf->Cell(90,4,$this->tipodebito,0,0,"C",0);
$this->objpdf->SetFont('Arial','',6);
$this->objpdf->Cell(06,4,'2ª Via Prefeitura',0,1,"R",0);  //sap

$y = $this->objpdf->GetY()-1;
$this->objpdf->Image('imagens/files/'.$this->logo,8,$y-10,7); //sap
$this->objpdf->Image('imagens/files/'.$this->logo,95,$y-10,7); //sap
...
$this->objpdf->Text(169,$y-3,"Data do pagamento: ".$this->dtparapag); //sap
$this->objpdf->Text(54 ,$y-3,"Data do pagamento: ".$this->dtparapag); //sap
$this->objpdf->SetFont('Times','',5);
...
$this->objpdf->Line(93,$y-25,93,$y+55); //sap linha tracejada vertical
$this->objpdf->SetDash();
$this->objpdf->Ln(70);
...
$this->objpdf->TextWithDirection(8,$y+33,$this->texto,'U'); //sap texto no canhoto do carne
...
if ($this->codigo_barras != null) {
  $this->objpdf->int25(95,$y+39,$this->codigo_barras,15,0.322); //sap
}

$this->objpdf->SetLineWidth(0.05);
$this->objpdf->SetDash(1,1);
$this->objpdf->Line(0,$this->objpdf->gety()-8,$this->objpdf->w ,$this->objpdf->gety()-8); //sap linha tracejada horizontal
$this->objpdf->SetDash();
