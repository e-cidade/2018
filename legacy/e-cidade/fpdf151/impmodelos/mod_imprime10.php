...
if (isset($this->licitacao->l03_descr)) {
  $sModalidadeLicitacao = $this->licitacao->l03_descr;
}

$iNumeroLicitacao = null;
if (isset($this->licitacao->e60_numerol)) {
  $iNumeroLicitacao = $this->licitacao->e60_numerol;
}

$this->objpdf->text(130, ($xlin+3), 'MODALIDADE DE LICITAÇÃO: ');
$this->objpdf->text(165, ($xlin+3) , $sModalidadeLicitacao);

$this->objpdf->text(130, ($xlin+6), 'NÚMERO DA LICITAÇÃO: ');
$this->objpdf->text(165, ($xlin+6) , $iNumeroLicitacao);
...
if (!empty($this->inscricaoestadualinstituicao)) {
