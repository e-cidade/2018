    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_q51_numnota) && (trim($chave_q51_numnota)!="") ){
	         $sql = $clissnotaavulsa->sql_query_cancelados(null,$campos,"q51_numnota","q51_numnota = $chave_q51_numnota");
        }else if(isset($chave_q02_inscr) && (trim($chave_q02_inscr)!="") ){
	         $sql = $clissnotaavulsa->sql_query_cancelados("",$campos,"q51_numnota"," $where q51_inscr = $chave_q02_inscr ");
        }else{
           $sql = $clissnotaavulsa->sql_query_cancelados("",$campos,"q51_numnota","$where2");
        }
        $repassa = array();
        ...
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $clissnotaavulsa->sql_record(
                    $clissnotaavulsa->sql_query_cancelados(null,"z01_nome,q51_sequencial",null," $where q51_numnota=$pesquisa_chave"));
