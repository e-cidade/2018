    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        if(isset($campos)==false){
           ...
           $campos = "agualeiturista.x16_numcgm,  cgm.z01_nome, agualeiturista.x16_dtini,agualeiturista.x16_dtfim";
           }
        }
	   ...
	   $sql = $clagualeiturista->sql_query("",$campos,"z01_nome"," z01_nome like '$chave_z01_nome%' ");
        }else{
