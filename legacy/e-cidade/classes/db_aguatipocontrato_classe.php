...
class cl_aguatipocontrato { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->x39_sequencial = ($this->x39_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["x39_sequencial"]:$this->x39_sequencial);
       $this->x39_descricao = ($this->x39_descricao == ""?@$GLOBALS["HTTP_POST_VARS"]["x39_descricao"]:$this->x39_descricao);
     }else{
       $this->x39_sequencial = ($this->x39_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["x39_sequencial"]:$this->x39_sequencial);
     }
   }
   // funcao para Inclusão
   function incluir ($x39_sequencial){ 
      $this->atualizacampos();
     if($this->x39_descricao == null ){ 
     ...
     if($x39_sequencial == "" || $x39_sequencial == null ){
       $result = db_query("select nextval('aguatipocontrato_x39_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: aguatipocontrato_x39_sequencial_seq do campo: x39_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $x39_sequencial)){
         ...
         $this->x39_sequencial = $x39_sequencial; 
       }
     }
     if(($this->x39_sequencial == null) || ($this->x39_sequencial == "") ){ 
       $this->erro_sql = " Campo x39_sequencial não declarado.";
     ...
     $sql = "insert into aguatipocontrato(
                                       x39_sequencial 
                                      ,x39_descricao 
                       )
                values (
     ...
     $this->erro_sql = "Inclusão efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->x39_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       $resaco = $this->sql_record($this->sql_query_file($this->x39_sequencial  ));
   ...
   public function alterar ($x39_sequencial=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($x39_sequencial!=null){
       $sql .= " x39_sequencial = $this->x39_sequencial";
     }
     $lSessaoDesativarAccount = db_getsession("DB_desativar_account", false);
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       && ($lSessaoDesativarAccount === false))) {
     ...
     if (!$result) { 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Tipo de Contrato não Alterado. Alteração Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->x39_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if (pg_affected_rows($result) == 0) {
         $this->erro_banco = "";
         $this->erro_sql = "Tipo de Contrato não foi Alterado. Alteração Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->x39_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   public function excluir ($x39_sequencial=null,$dbwhere=null) { 
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (empty($dbwhere)) {
         ...
         $resaco = $this->sql_record($this->sql_query_file($x39_sequencial));
       } else { 
     ...
     $sql = " delete from aguatipocontrato
                    where ";
     $sql2 = "";
     if (empty($dbwhere)) {
        if (!empty($x39_sequencial)){
          if (!empty($sql2)) {
            $sql2 .= " and ";
          }
          $sql2 .= " x39_sequencial = $x39_sequencial ";
        }
     } else {
       $sql2 = $dbwhere;
     }
     ...
     if ($result == false) { 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Tipo de Contrato não Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$x39_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if (pg_affected_rows($result) == 0) {
         $this->erro_banco = "";
         $this->erro_sql = "Tipo de Contrato não Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$x39_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   public function sql_record($sql) { 
     ...
     $this->numrows = pg_num_rows($result);
      if ($this->numrows == 0) {
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:aguatipocontrato";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
   ...
   // funcao do sql 
   public function sql_query ($x39_sequencial = null,$campos = "*", $ordem = null, $dbwhere = "") { 

     $sql  = "select {$campos}";
     $sql .= "  from aguatipocontrato ";
     $sql2 = "";
     if (empty($dbwhere)) {
       if (!empty($x39_sequencial)) {
         $sql2 .= " where aguatipocontrato.x39_sequencial = $x39_sequencial "; 
       } 
   ...
   // funcao do sql 
   public function sql_query_file ($x39_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "") {
