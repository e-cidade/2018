...
/**
 * Trecho adicionado para não instanciar novamente a classe caso ela já esteja declarada
 */
if (class_exists('cl_solicita')) {
  return;
}
...
function sql_query_estregistrosemquantidade ( $pc10_numero=null,$campos="*",$ordem=null,$dbwhere=""){
	$sql = "select ";
	if($campos != "*" ){
		$campos_sql = split("#",$campos);
		$virgula = "";
