...
//MODULO: ISSQN
//CLASSE DA ENTIDADE meiimportalinhaempresa
class cl_meiimportalinhaempresa { 
   ...
   var $campos = "
                 ...
                 q107_meiimportalinha = int4 = Linha de Importação do MEI 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->q107_meiimportalinha = ($this->q107_meiimportalinha == ""?@$GLOBALS["HTTP_POST_VARS"]["q107_meiimportalinha"]:$this->q107_meiimportalinha);
   ...
   function incluir ($q107_sequencial){
     ...
     if($this->q107_meiimportalinha == null ){ 
       $this->erro_sql = " Campo Linha de Importação do MEI nao Informado.";
       $this->erro_campo = "q107_meiimportalinha";
       $this->erro_banco = "";
     ...
     if($q107_sequencial == "" || $q107_sequencial == null ){
       $result = db_query("select nextval('meiimportalinhaempresa_q107_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: meiimportalinhaempresa_q107_sequencial_seq do campo: q107_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       $result = db_query("select last_value from meiimportalinhaempresa_q107_sequencial_seq");
     ...
     $sql = "insert into meiimportalinhaempresa(
                                       q107_sequencial 
                                      ,q107_municipio 
                                      ,q107_meiimportalinha 
                                      ,q107_cnpj 
                                      ,q107_cnpjmatriz 
                                      ,q107_nome 
                                      ,q107_capitalsocial 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2851,16251,'','".AddSlashes(pg_result($resaco,0,'q107_meiimportalinha'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
   ...
   function alterar ($q107_sequencial=null) { 
      $this->atualizacampos();
     $sql = " update meiimportalinhaempresa set ";
     $virgula = "";
     ...
     if(trim($this->q107_meiimportalinha)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q107_meiimportalinha"])){ 
       $sql  .= $virgula." q107_meiimportalinha = $this->q107_meiimportalinha ";
       $virgula = ",";
       if(trim($this->q107_meiimportalinha) == null ){ 
         $this->erro_sql = " Campo Linha de Importação do MEI nao Informado.";
         $this->erro_campo = "q107_meiimportalinha";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["q107_meiimportalinha"]) || $this->q107_meiimportalinha != "")
           $resac = db_query("insert into db_acount values($acount,2851,16251,'".AddSlashes(pg_result($resaco,$conresaco,'q107_meiimportalinha'))."','$this->q107_meiimportalinha',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
   ...
   function excluir ($q107_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2851,16251,'','".AddSlashes(pg_result($resaco,$iresaco,'q107_meiimportalinha'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     ...
     $sql = " delete from meiimportalinhaempresa
                    where ";
     $sql2 = "";
     if($dbwhere==null || $dbwhere ==""){
        if($q107_sequencial != ""){
   ...
   function sql_record($sql) { 
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:meiimportalinhaempresa";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $q107_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from meiimportalinhaempresa ";
     $sql .= "      inner join meiimportalinha  on  meiimportalinha.q105_sequencial = meiimportalinhaempresa.q107_meiimportalinha";
     $sql .= "      inner join meiimporta  on  meiimporta.q104_sequencial = meiimportalinha.q105_meiimporta";
     $sql2 = "";
     if($dbwhere==""){
       if($q107_sequencial!=null ){
         $sql2 .= " where meiimportalinhaempresa.q107_sequencial = $q107_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
