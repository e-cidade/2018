...
class cl_rhnaturezaregime { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->rh71_sequencial = ($this->rh71_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["rh71_sequencial"]:$this->rh71_sequencial);
       $this->rh71_descricao = ($this->rh71_descricao == ""?@$GLOBALS["HTTP_POST_VARS"]["rh71_descricao"]:$this->rh71_descricao);
     }else{
       $this->rh71_sequencial = ($this->rh71_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["rh71_sequencial"]:$this->rh71_sequencial);
     }
   }
   // funcao para inclusao
   function incluir ($rh71_sequencial){ 
      $this->atualizacampos();
     if($this->rh71_descricao == null ){ 
     ...
     if($rh71_sequencial == "" || $rh71_sequencial == null ){
       $result = db_query("select nextval('rhnaturezaregime_rh71_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: rhnaturezaregime_rh71_sequencial_seq do campo: rh71_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $rh71_sequencial)){
         ...
         $this->rh71_sequencial = $rh71_sequencial; 
       }
     }
     if(($this->rh71_sequencial == null) || ($this->rh71_sequencial == "") ){ 
       $this->erro_sql = " Campo rh71_sequencial nao declarado.";
     ...
     $sql = "insert into rhnaturezaregime(
                                       rh71_sequencial 
                                      ,rh71_descricao 
                       )
                values (
                                $this->rh71_sequencial 
                               ,'$this->rh71_descricao' 
                      )";
     $result = db_query($sql); 
     if($result==false){ 
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->rh71_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($rh71_sequencial=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($rh71_sequencial!=null){
       $sql .= " rh71_sequencial = $this->rh71_sequencial";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->rh71_sequencial));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Natureza do regime nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->rh71_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Natureza do regime nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->rh71_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($rh71_sequencial=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($rh71_sequencial));
     }else{ 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($rh71_sequencial != ""){
          ...
          $sql2 .= " rh71_sequencial = $rh71_sequencial ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Natureza do regime nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$rh71_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Natureza do regime nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$rh71_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
