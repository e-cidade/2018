...
class cl_db_sysfuncoescliente { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->db41_sysfuncoescliente = ($this->db41_sysfuncoescliente == ""?@$GLOBALS["HTTP_POST_VARS"]["db41_sysfuncoescliente"]:$this->db41_sysfuncoescliente);
       $this->db41_cliente = ($this->db41_cliente == ""?@$GLOBALS["HTTP_POST_VARS"]["db41_cliente"]:$this->db41_cliente);
       $this->db41_funcao = ($this->db41_funcao == ""?@$GLOBALS["HTTP_POST_VARS"]["db41_funcao"]:$this->db41_funcao);
     }else{
       $this->db41_sysfuncoescliente = ($this->db41_sysfuncoescliente == ""?@$GLOBALS["HTTP_POST_VARS"]["db41_sysfuncoescliente"]:$this->db41_sysfuncoescliente);
     }
   }
   // funcao para inclusao
   function incluir ($db41_sysfuncoescliente){ 
      $this->atualizacampos();
     if($this->db41_cliente == null ){ 
     ...
     if($db41_sysfuncoescliente == "" || $db41_sysfuncoescliente == null ){
       $result = db_query("select nextval('db_sysfuncoescliente_db41_sysfuncoescliente_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: db_sysfuncoescliente_db41_sysfuncoescliente_seq do campo: db41_sysfuncoescliente"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $db41_sysfuncoescliente)){
         ...
         $this->db41_sysfuncoescliente = $db41_sysfuncoescliente; 
       }
     }
     if(($this->db41_sysfuncoescliente == null) || ($this->db41_sysfuncoescliente == "") ){ 
       $this->erro_sql = " Campo db41_sysfuncoescliente nao declarado.";
     ...
     $sql = "insert into db_sysfuncoescliente(
                                       db41_sysfuncoescliente 
                                      ,db41_cliente 
                                      ,db41_funcao 
                       )
                values (
                                $this->db41_sysfuncoescliente 
                               ,$this->db41_cliente 
                               ,$this->db41_funcao 
                      )";
     $result = db_query($sql); 
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->db41_sysfuncoescliente;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($db41_sysfuncoescliente=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($db41_sysfuncoescliente!=null){
       $sql .= " db41_sysfuncoescliente = $this->db41_sysfuncoescliente";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->db41_sysfuncoescliente));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "db_sysfuncoescliente nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->db41_sysfuncoescliente;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "db_sysfuncoescliente nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->db41_sysfuncoescliente;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($db41_sysfuncoescliente=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($db41_sysfuncoescliente));
     }else{ 
     ...
     $sql2 = "";
     if($dbwhere==null || $dbwhere ==""){
        if($db41_sysfuncoescliente != ""){
          if($sql2!=""){
            $sql2 .= " and ";
          }
          $sql2 .= " db41_sysfuncoescliente = $db41_sysfuncoescliente ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "db_sysfuncoescliente nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$db41_sysfuncoescliente;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "db_sysfuncoescliente nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$db41_sysfuncoescliente;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $db41_sysfuncoescliente=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from db_sysfuncoescliente ";
     $sql .= "      inner join db_sysfuncoes  on  db_sysfuncoes.codfuncao = db_sysfuncoescliente.db41_funcao";
     $sql .= "      inner join clientes  on  clientes.at01_codcli = db_sysfuncoescliente.db41_cliente";
     $sql2 = "";
     if($dbwhere==""){
       if($db41_sysfuncoescliente!=null ){
         $sql2 .= " where db_sysfuncoescliente.db41_sysfuncoescliente = $db41_sysfuncoescliente "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
