...
class cl_db_carnescampos { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->posxmodelo = ($this->posxmodelo == ""?@$GLOBALS["HTTP_POST_VARS"]["posxmodelo"]:$this->posxmodelo);
       $this->posymodelo = ($this->posymodelo == ""?@$GLOBALS["HTTP_POST_VARS"]["posymodelo"]:$this->posymodelo);
       $this->nomecam = ($this->nomecam == ""?@$GLOBALS["HTTP_POST_VARS"]["nomecam"]:$this->nomecam);
       $this->tipocamp = ($this->tipocamp == "f"?@$GLOBALS["HTTP_POST_VARS"]["tipocamp"]:$this->tipocamp);
     }else{
     }
   }
   ...
   function incluir (){ 
     ...
     $sql = "insert into db_carnescampos(
                                       codmodelo 
                                      ,posxmodelo 
                                      ,posymodelo 
                                      ,nomecam 
...
$sql .= "oid = '$oid'";     $result = db_query($sql);
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Campos dos Carnes nao Alterado. Alteracao Abortada.\\n";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Campos dos Carnes nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
         $this->numrows_alterar = 0;
   ...
   function excluir ( $oid=null ,$dbwhere=null) { 
     $sql = " delete from db_carnescampos
                    where ";
     $sql2 = "";
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Campos dos Carnes nao Excluído. Exclusão Abortada.\\n";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Campos dos Carnes nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
         $this->numrows_excluir = 0;
