...
//MODULO: caixa
//CLASSE DA ENTIDADE sliptipooperacaovinculo
class cl_sliptipooperacaovinculo { 
   ...
   function cl_sliptipooperacaovinculo() { 
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("sliptipooperacaovinculo"); 
   ...
   function incluir ($k153_slip){ 
     ...
     $sql = "insert into sliptipooperacaovinculo(
                                       k153_slip 
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "sliptipooperacaovinculo ($this->k153_slip) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "sliptipooperacaovinculo já Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       }else{
         $this->erro_sql   = "sliptipooperacaovinculo ($this->k153_slip) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function alterar ($k153_slip=null) { 
      $this->atualizacampos();
     $sql = " update sliptipooperacaovinculo set ";
     $virgula = "";
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "sliptipooperacaovinculo nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->k153_slip;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "sliptipooperacaovinculo nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->k153_slip;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($k153_slip=null,$dbwhere=null) { 
     ...
     $sql = " delete from sliptipooperacaovinculo
                    where ";
     $sql2 = "";
     if($dbwhere==null || $dbwhere ==""){
        if($k153_slip != ""){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "sliptipooperacaovinculo nao Excluído. Exclusão Abortada.\\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "sliptipooperacaovinculo nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$k153_slip;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_record($sql) { 
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:sliptipooperacaovinculo";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $k153_slip=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from sliptipooperacaovinculo ";
     $sql .= "      inner join slip  on  slip.k17_codigo = sliptipooperacaovinculo.k153_slip";
     ...
     if($dbwhere==""){
       if($k153_slip!=null ){
         $sql2 .= " where sliptipooperacaovinculo.k153_slip = $k153_slip "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
