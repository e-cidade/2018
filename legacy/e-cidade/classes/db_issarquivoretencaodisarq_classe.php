...
class cl_issarquivoretencaodisarq {
   ...
   var $campos = "
                 ...
                 q145_issarquivoretencao = int4 = Código Arquivo de Retenção
   ...
   function incluir ($q145_sequencial){
     ...
     if($this->q145_disarq == null ){
       $this->erro_sql = " Campo Disarq não informado.";
     ...
     if($q145_sequencial == "" || $q145_sequencial == null ){
       ...
       if(($result != false) && (pg_result($result,0,0) < $q145_sequencial)){
         $this->erro_sql = " Campo q145_sequencial maior que último número da sequencia.";
     ...
     if(($this->q145_sequencial == null) || ($this->q145_sequencial == "") ){
       $this->erro_sql = " Campo q145_sequencial não declarado.";
     ...
     if($result==false){
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Arquivo de Retenção DisArq ($this->q145_sequencial) não Incluído. Inclusão Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "Arquivo de Retenção DisArq já Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       }else{
         $this->erro_sql   = "Arquivo de Retenção DisArq ($this->q145_sequencial) não Incluído. Inclusão Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   public function alterar ($q145_sequencial=null) {
     ...
     if (!$result) {
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Arquivo de Retenção DisArq não Alterado. Alteração Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->q145_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if (pg_affected_rows($result) == 0) {
         $this->erro_banco = "";
         $this->erro_sql = "Arquivo de Retenção DisArq não foi Alterado. Alteração Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->q145_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   public function excluir ($q145_sequencial=null,$dbwhere=null) {
     ...
     if ($result == false) {
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Arquivo de Retenção DisArq não Excluído. Exclusão Abortada.\\n";
       ...
       if (pg_affected_rows($result) == 0) {
         $this->erro_banco = "";
         $this->erro_sql = "Arquivo de Retenção DisArq não Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$q145_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
