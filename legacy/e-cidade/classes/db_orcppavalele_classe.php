...
class cl_orcppavalele { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->o25_codseqppa = ($this->o25_codseqppa == ""?@$GLOBALS["HTTP_POST_VARS"]["o25_codseqppa"]:$this->o25_codseqppa);
       $this->o25_codele = ($this->o25_codele == ""?@$GLOBALS["HTTP_POST_VARS"]["o25_codele"]:$this->o25_codele);
     }else{
       $this->o25_codseqppa = ($this->o25_codseqppa == ""?@$GLOBALS["HTTP_POST_VARS"]["o25_codseqppa"]:$this->o25_codseqppa);
       $this->o25_codele = ($this->o25_codele == ""?@$GLOBALS["HTTP_POST_VARS"]["o25_codele"]:$this->o25_codele);
     }
   ...
   function incluir ($o25_codseqppa,$o25_codele){ 
      $this->atualizacampos();
       $this->o25_codseqppa = $o25_codseqppa; 
       $this->o25_codele = $o25_codele; 
     if(($this->o25_codseqppa == null) || ($this->o25_codseqppa == "") ){ 
       $this->erro_sql = " Campo o25_codseqppa nao declarado.";
     ...
     if(($this->o25_codele == null) || ($this->o25_codele == "") ){ 
       $this->erro_sql = " Campo o25_codele nao declarado.";
       $this->erro_banco = "Chave Primaria zerada.";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->o25_codseqppa."-".$this->o25_codele;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($o25_codseqppa=null,$o25_codele=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($o25_codseqppa!=null){
       $sql .= " o25_codseqppa = $this->o25_codseqppa";
     }
     if($o25_codele!=null){
       $sql .= " and  o25_codele = $this->o25_codele";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->o25_codseqppa,$this->o25_codele));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Elementos PPA nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->o25_codseqppa."-".$this->o25_codele;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Elementos PPA nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->o25_codseqppa."-".$this->o25_codele;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($o25_codseqppa=null,$o25_codele=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($o25_codseqppa,$o25_codele));
     }else{ 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($o25_codseqppa != ""){
          ...
          $sql2 .= " o25_codseqppa = $o25_codseqppa ";
        }
        if($o25_codele != ""){
          if($sql2!=""){
            $sql2 .= " and ";
          }
          $sql2 .= " o25_codele = $o25_codele ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Elementos PPA nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$o25_codseqppa."-".$o25_codele;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Elementos PPA nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$o25_codseqppa."-".$o25_codele;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $o25_codseqppa=null,$o25_codele=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from orcppavalele ";
     $sql .= "      inner join orcelemento  on  orcelemento.o56_codele = orcppavalele.o25_codele and orcelemento.o56_anousu = ".db_getsession("DB_anousu");
     $sql .= "      inner join orcppaval  on  orcppaval.o24_codseqppa = orcppavalele.o25_codseqppa";
     $sql .= "      inner join orcppa  as a on   a.o23_codppa = orcppaval.o24_codppa";
     $sql2 = "";
     if($dbwhere==""){
       if($o25_codseqppa!=null ){
         $sql2 .= " where orcppavalele.o25_codseqppa = $o25_codseqppa "; 
       } 
       if($o25_codele!=null ){
         if($sql2!=""){
            $sql2 .= " and ";
         ...
         $sql2 .= " orcppavalele.o25_codele = $o25_codele "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
