...
class cl_regracalculocargahoraria { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->ed127_codigo = ($this->ed127_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["ed127_codigo"]:$this->ed127_codigo);
       $this->ed127_ano = ($this->ed127_ano == ""?@$GLOBALS["HTTP_POST_VARS"]["ed127_ano"]:$this->ed127_ano);
       $this->ed127_calculaduracaoperiodo = ($this->ed127_calculaduracaoperiodo == "f"?@$GLOBALS["HTTP_POST_VARS"]["ed127_calculaduracaoperiodo"]:$this->ed127_calculaduracaoperiodo);
       $this->ed127_escola = ($this->ed127_escola == ""?@$GLOBALS["HTTP_POST_VARS"]["ed127_escola"]:$this->ed127_escola);
     }else{
       $this->ed127_codigo = ($this->ed127_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["ed127_codigo"]:$this->ed127_codigo);
     }
   }
   // funcao para inclusao
   function incluir ($ed127_codigo){ 
      $this->atualizacampos();
     if($this->ed127_ano == null ){ 
     ...
     if($this->ed127_calculaduracaoperiodo == null ){ 
     ...
     if($ed127_codigo == "" || $ed127_codigo == null ){
       $result = db_query("select nextval('regracalculocargahoraria_ed127_codigo_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: regracalculocargahoraria_ed127_codigo_seq do campo: ed127_codigo"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $ed127_codigo)){
         ...
         $this->ed127_codigo = $ed127_codigo; 
       }
     }
     if(($this->ed127_codigo == null) || ($this->ed127_codigo == "") ){ 
       $this->erro_sql = " Campo ed127_codigo nao declarado.";
     ...
     $sql = "insert into regracalculocargahoraria(
                                       ed127_codigo 
                                      ,ed127_ano 
                                      ,ed127_calculaduracaoperiodo 
                                      ,ed127_escola 
                       )
                values (
                                $this->ed127_codigo 
                               ,$this->ed127_ano 
                               ,'$this->ed127_calculaduracaoperiodo' 
                               ,$this->ed127_escola 
                      )";
     $result = db_query($sql); 
     if($result==false){ 
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->ed127_codigo;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       $resaco = $this->sql_record($this->sql_query_file($this->ed127_codigo  ));
   ...
   public function alterar ($ed127_codigo=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($ed127_codigo!=null){
       $sql .= " ed127_codigo = $this->ed127_codigo";
     }
     $lSessaoDesativarAccount = db_getsession("DB_desativar_account", false);
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       && ($lSessaoDesativarAccount === false))) {
     ...
     if (!$result) { 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Regra Calculo Carga Horaria nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->ed127_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if (pg_affected_rows($result) == 0) {
         $this->erro_banco = "";
         $this->erro_sql = "Regra Calculo Carga Horaria nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->ed127_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   public function excluir ($ed127_codigo=null,$dbwhere=null) { 
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (empty($dbwhere)) {
         ...
         $resaco = $this->sql_record($this->sql_query_file($ed127_codigo));
       } else { 
     ...
     $sql = " delete from regracalculocargahoraria
                    where ";
     $sql2 = "";
     if (empty($dbwhere)) {
        if (!empty($ed127_codigo)){
          if (!empty($sql2)) {
            $sql2 .= " and ";
          }
          $sql2 .= " ed127_codigo = $ed127_codigo ";
        }
     } else {
       $sql2 = $dbwhere;
     }
     ...
     if ($result == false) { 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Regra Calculo Carga Horaria nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$ed127_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if (pg_affected_rows($result) == 0) {
         $this->erro_banco = "";
         $this->erro_sql = "Regra Calculo Carga Horaria nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$ed127_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   public function sql_record($sql) { 
     ...
     $this->numrows = pg_num_rows($result);
      if ($this->numrows == 0) {
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:regracalculocargahoraria";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
   ...
   // funcao do sql 
   public function sql_query ($ed127_codigo = null,$campos = "*", $ordem = null, $dbwhere = "") { 

     $sql  = "select {$campos}";
     $sql .= "  from regracalculocargahoraria ";
     $sql .= "      inner join escola  on  escola.ed18_i_codigo = regracalculocargahoraria.ed127_escola";
     ...
     if (empty($dbwhere)) {
       if (!empty($ed127_codigo)) {
         $sql2 .= " where regracalculocargahoraria.ed127_codigo = $ed127_codigo "; 
       } 
   ...
   // funcao do sql 
   public function sql_query_file ($ed127_codigo = null, $campos = "*", $ordem = null, $dbwhere = "") {
