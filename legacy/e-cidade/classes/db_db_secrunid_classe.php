...
class cl_db_secrunid { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->s_codigounidade = ($this->s_codigounidade == ""?@$GLOBALS["HTTP_POST_VARS"]["s_codigounidade"]:$this->s_codigounidade);
       $this->s_codigosecr = ($this->s_codigosecr == ""?@$GLOBALS["HTTP_POST_VARS"]["s_codigosecr"]:$this->s_codigosecr);
       $this->s_pagina = ($this->s_pagina == ""?@$GLOBALS["HTTP_POST_VARS"]["s_pagina"]:$this->s_pagina);
       $this->s_titulo = ($this->s_titulo == ""?@$GLOBALS["HTTP_POST_VARS"]["s_titulo"]:$this->s_titulo);
     }else{
     }
   }
...
$sql .= "oid = '$oid'";     $result = db_query($sql);
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Secretaria da Unidade nao Alterado. Alteracao Abortada.\\n";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Secretaria da Unidade nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
         $this->numrows_alterar = 0;
   ...
   function excluir ( $oid=null ,$dbwhere=null) { 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Secretaria da Unidade nao Excluído. Exclusão Abortada.\\n";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Secretaria da Unidade nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
         $this->numrows_excluir = 0;
