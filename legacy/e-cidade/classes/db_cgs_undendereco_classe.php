...
class cl_cgs_undendereco { 
   ...
   var $campos = "
                 sd109_sequencial = int4 = Código 
                 sd109_endereco = int4 = Código do Endereço 
   ...
   function incluir ($sd109_sequencial){ 
     ...
     if($this->sd109_endereco == null ){ 
       $this->erro_sql = " Campo Código do Endereço não informado.";
     ...
     if($sd109_sequencial == "" || $sd109_sequencial == null ){
       ...
       if(($result != false) && (pg_result($result,0,0) < $sd109_sequencial)){
         $this->erro_sql = " Campo sd109_sequencial maior que último número da sequencia.";
     ...
     if(($this->sd109_sequencial == null) || ($this->sd109_sequencial == "") ){ 
       $this->erro_sql = " Campo sd109_sequencial não declarado.";
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Endereços do CGS ($this->sd109_sequencial) não Incluído. Inclusão Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "Endereços do CGS já Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       }else{
         $this->erro_sql   = "Endereços do CGS ($this->sd109_sequencial) não Incluído. Inclusão Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   public function alterar ($sd109_sequencial=null) { 
     ...
     if (!$result) { 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Endereços do CGS não Alterado. Alteração Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->sd109_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if (pg_affected_rows($result) == 0) {
         $this->erro_banco = "";
         $this->erro_sql = "Endereços do CGS não foi Alterado. Alteração Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->sd109_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   public function excluir ($sd109_sequencial=null,$dbwhere=null) { 
     ...
     if ($result == false) { 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Endereços do CGS não Excluído. Exclusão Abortada.\\n";
       ...
       if (pg_affected_rows($result) == 0) {
         $this->erro_banco = "";
         $this->erro_sql = "Endereços do CGS não Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$sd109_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
