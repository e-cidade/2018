...
class cl_atolegalprevidencia { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->rh179_sequencial = ($this->rh179_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["rh179_sequencial"]:$this->rh179_sequencial);
       $this->rh179_descricao = ($this->rh179_descricao == ""?@$GLOBALS["HTTP_POST_VARS"]["rh179_descricao"]:$this->rh179_descricao);
     }else{
       $this->rh179_sequencial = ($this->rh179_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["rh179_sequencial"]:$this->rh179_sequencial);
     }
   }
   // funcao para Inclusão
   function incluir ($rh179_sequencial){ 
      $this->atualizacampos();
     if($this->rh179_descricao == null ){ 
     ...
     if($rh179_sequencial == "" || $rh179_sequencial == null ){
       $result = db_query("select nextval('atolegalprevidencia_rh179_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: atolegalprevidencia_rh179_sequencial_seq do campo: rh179_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $rh179_sequencial)){
         ...
         $this->rh179_sequencial = $rh179_sequencial; 
       }
     }
     if(($this->rh179_sequencial == null) || ($this->rh179_sequencial == "") ){ 
       $this->erro_sql = " Campo rh179_sequencial não declarado.";
     ...
     $sql = "insert into atolegalprevidencia(
                                       rh179_sequencial 
                                      ,rh179_descricao 
                       )
                values (
                                $this->rh179_sequencial 
                               ,'$this->rh179_descricao' 
                      )";
     $result = db_query($sql); 
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
     ...
     $this->erro_sql = "Inclusão efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->rh179_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       $resaco = $this->sql_record($this->sql_query_file($this->rh179_sequencial  ));
   ...
   public function alterar ($rh179_sequencial=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($rh179_sequencial!=null){
       $sql .= " rh179_sequencial = $this->rh179_sequencial";
     }
     $lSessaoDesativarAccount = db_getsession("DB_desativar_account", false);
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       && ($lSessaoDesativarAccount === false))) {
     ...
     if (!$result) { 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Ato Legal da Previdência não Alterado. Alteração Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->rh179_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if (pg_affected_rows($result) == 0) {
         $this->erro_banco = "";
         $this->erro_sql = "Ato Legal da Previdência não foi Alterado. Alteração Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->rh179_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   public function excluir ($rh179_sequencial=null,$dbwhere=null) { 
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (empty($dbwhere)) {
         ...
         $resaco = $this->sql_record($this->sql_query_file($rh179_sequencial));
       } else { 
     ...
     $sql = " delete from atolegalprevidencia
                    where ";
     $sql2 = "";
     if (empty($dbwhere)) {
        if (!empty($rh179_sequencial)){
          if (!empty($sql2)) {
            $sql2 .= " and ";
          }
          $sql2 .= " rh179_sequencial = $rh179_sequencial ";
        }
     } else {
       $sql2 = $dbwhere;
     }
     ...
     if ($result == false) { 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Ato Legal da Previdência não Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$rh179_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if (pg_affected_rows($result) == 0) {
         $this->erro_banco = "";
         $this->erro_sql = "Ato Legal da Previdência não Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$rh179_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   public function sql_record($sql) { 
     ...
     $this->numrows = pg_num_rows($result);
      if ($this->numrows == 0) {
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:atolegalprevidencia";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
   ...
   // funcao do sql 
   public function sql_query ($rh179_sequencial = null,$campos = "*", $ordem = null, $dbwhere = "") { 

     $sql  = "select {$campos}";
     $sql .= "  from atolegalprevidencia ";
     $sql2 = "";
     if (empty($dbwhere)) {
       if (!empty($rh179_sequencial)) {
         $sql2 .= " where atolegalprevidencia.rh179_sequencial = $rh179_sequencial "; 
       } 
   ...
   // funcao do sql 
   public function sql_query_file ($rh179_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "") {
