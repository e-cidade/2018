...
class cl_manuitem { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->u07_manut = ($this->u07_manut == ""?@$GLOBALS["HTTP_POST_VARS"]["u07_manut"]:$this->u07_manut);
       $this->u07_descr = ($this->u07_descr == ""?@$GLOBALS["HTTP_POST_VARS"]["u07_descr"]:$this->u07_descr);
       $this->u07_quant = ($this->u07_quant == ""?@$GLOBALS["HTTP_POST_VARS"]["u07_quant"]:$this->u07_quant);
       $this->u07_requi = ($this->u07_requi == ""?@$GLOBALS["HTTP_POST_VARS"]["u07_requi"]:$this->u07_requi);
     }else{
     }
   }
...
$sql .= "oid = '$oid'";     $result = db_query($sql);
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Pecas trocadas em oficinas, que nao estao sob cont nao Alterado. Alteracao Abortada.\\n";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Pecas trocadas em oficinas, que nao estao sob cont nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
         $this->numrows_alterar = 0;
   ...
   function excluir ( $oid=null ,$dbwhere=null) { 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Pecas trocadas em oficinas, que nao estao sob cont nao Excluído. Exclusão Abortada.\\n";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Pecas trocadas em oficinas, que nao estao sob cont nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
         $this->numrows_excluir = 0;
