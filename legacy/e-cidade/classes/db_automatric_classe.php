...
class cl_automatric { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->y53_codauto = ($this->y53_codauto == ""?@$GLOBALS["HTTP_POST_VARS"]["y53_codauto"]:$this->y53_codauto);
       $this->y53_matric = ($this->y53_matric == ""?@$GLOBALS["HTTP_POST_VARS"]["y53_matric"]:$this->y53_matric);
     }else{
       $this->y53_codauto = ($this->y53_codauto == ""?@$GLOBALS["HTTP_POST_VARS"]["y53_codauto"]:$this->y53_codauto);
     }
   }
   // funcao para inclusao
   function incluir ($y53_codauto){ 
      $this->atualizacampos();
     if($this->y53_matric == null ){ 
       ...
       $this->y53_codauto = $y53_codauto; 
     if(($this->y53_codauto == null) || ($this->y53_codauto == "") ){ 
       $this->erro_sql = " Campo y53_codauto nao declarado.";
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->y53_codauto;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($y53_codauto=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($y53_codauto!=null){
       $sql .= " y53_codauto = $this->y53_codauto";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->y53_codauto));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "automatric nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->y53_codauto;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "automatric nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->y53_codauto;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($y53_codauto=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($y53_codauto));
     }else{ 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "automatric nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$y53_codauto;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "automatric nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$y53_codauto;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $y53_codauto=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from automatric ";
     $sql .= "      inner join iptubase  on  iptubase.j01_matric = automatric.y53_matric";
     $sql .= "      inner join auto  on  auto.y50_codauto = automatric.y53_codauto";
     ...
     if($dbwhere==""){
       if($y53_codauto!=null ){
         $sql2 .= " where automatric.y53_codauto = $y53_codauto "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
