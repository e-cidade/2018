...
class cl_db_procedcadgrupos { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->at51_codigo = ($this->at51_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["at51_codigo"]:$this->at51_codigo);
       $this->at51_descr = ($this->at51_descr == ""?@$GLOBALS["HTTP_POST_VARS"]["at51_descr"]:$this->at51_descr);
     }else{
       $this->at51_codigo = ($this->at51_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["at51_codigo"]:$this->at51_codigo);
     }
   }
   // funcao para inclusao
   function incluir ($at51_codigo){ 
      $this->atualizacampos();
     if($this->at51_descr == null ){ 
     ...
     if($at51_codigo == "" || $at51_codigo == null ){
       $result = db_query("select nextval('db_projetoscadgrupos_at51_codigo_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: db_projetoscadgrupos_at51_codigo_seq do campo: at51_codigo"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $at51_codigo)){
         ...
         $this->at51_codigo = $at51_codigo; 
       }
     }
     if(($this->at51_codigo == null) || ($this->at51_codigo == "") ){ 
       $this->erro_sql = " Campo at51_codigo nao declarado.";
     ...
     $sql = "insert into db_procedcadgrupos(
                                       at51_codigo 
                                      ,at51_descr 
                       )
                values (
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->at51_codigo;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($at51_codigo=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($at51_codigo!=null){
       $sql .= " at51_codigo = $this->at51_codigo";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->at51_codigo));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Grupos de procedimentos nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->at51_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Grupos de procedimentos nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->at51_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($at51_codigo=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($at51_codigo));
     }else{ 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Grupos de procedimentos nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$at51_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Grupos de procedimentos nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$at51_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $at51_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from db_procedcadgrupos ";
     $sql2 = "";
     if($dbwhere==""){
       if($at51_codigo!=null ){
         $sql2 .= " where db_procedcadgrupos.at51_codigo = $at51_codigo "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
