...
class cl_conlancaminscrestosapagar {
   ...
   function incluir ($c108_sequencial){
     ...
     if($this->c108_inscricaorestosapagar == null ){
       $this->erro_sql = " Campo Inscrição Restos a Pagar não informado.";
     ...
     if(($this->c108_sequencial == null) || ($this->c108_sequencial == "") ){
       $this->erro_sql = " Campo c108_sequencial não declarado.";
     ...
     if($result==false){
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = " ($this->c108_sequencial) não Incluído. Inclusão Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
