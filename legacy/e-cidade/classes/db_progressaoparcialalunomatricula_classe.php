...
class cl_progressaoparcialalunomatricula { 
   ...
   var $campos = "
                 ed150_sequencial = int4 = Matricula Progressão 
                 ed150_progressaoparcialaluno = int4 = Codigó da Progressão 
                 ed150_ano = int4 = Ano 
   ...
   function incluir ($ed150_sequencial){ 
     ...
     if($this->ed150_progressaoparcialaluno == null ){ 
       $this->erro_sql = " Campo Codigó da Progressão não informado.";
     ...
     if($ed150_sequencial == "" || $ed150_sequencial == null ){
       ...
       if(($result != false) && (pg_result($result,0,0) < $ed150_sequencial)){
         $this->erro_sql = " Campo ed150_sequencial maior que último número da sequencia.";
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Matricula da Progressão Parcial ($this->ed150_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "Matricula da Progressão Parcial já Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       }else{
         $this->erro_sql   = "Matricula da Progressão Parcial ($this->ed150_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function alterar ($ed150_sequencial=null) { 
     ...
     if(trim($this->ed150_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed150_sequencial"])){ 
       ...
       if(trim($this->ed150_sequencial) == null ){ 
         $this->erro_sql = " Campo Matricula Progressão não informado.";
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Matricula da Progressão Parcial nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->ed150_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Matricula da Progressão Parcial nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->ed150_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($ed150_sequencial=null,$dbwhere=null) { 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Matricula da Progressão Parcial nao Excluído. Exclusão Abortada.\\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Matricula da Progressão Parcial nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$ed150_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
