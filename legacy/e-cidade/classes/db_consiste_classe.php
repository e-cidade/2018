...
class cl_consiste { 
   ...
   var $campos = "
                 ...
                 r46_valor = float8 = Valor (utilizado como work) 
                 r46_tipo = varchar(1) = Tipo verificação 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->r46_rubdig = ($this->r46_rubdig == ""?@$GLOBALS["HTTP_POST_VARS"]["r46_rubdig"]:$this->r46_rubdig);
       $this->r46_rubcon = ($this->r46_rubcon == ""?@$GLOBALS["HTTP_POST_VARS"]["r46_rubcon"]:$this->r46_rubcon);
       $this->r46_quant = ($this->r46_quant == ""?@$GLOBALS["HTTP_POST_VARS"]["r46_quant"]:$this->r46_quant);
       $this->r46_valor = ($this->r46_valor == ""?@$GLOBALS["HTTP_POST_VARS"]["r46_valor"]:$this->r46_valor);
       $this->r46_tipo = ($this->r46_tipo == ""?@$GLOBALS["HTTP_POST_VARS"]["r46_tipo"]:$this->r46_tipo);
       $this->r46_descr = ($this->r46_descr == ""?@$GLOBALS["HTTP_POST_VARS"]["r46_descr"]:$this->r46_descr);
     }else{
       $this->r46_rubdig = ($this->r46_rubdig == ""?@$GLOBALS["HTTP_POST_VARS"]["r46_rubdig"]:$this->r46_rubdig);
       $this->r46_rubcon = ($this->r46_rubcon == ""?@$GLOBALS["HTTP_POST_VARS"]["r46_rubcon"]:$this->r46_rubcon);
     }
   ...
   function incluir ($r46_rubdig,$r46_rubcon){ 
      $this->atualizacampos();
     if($this->r46_quant == null ){ 
     ...
     if($this->r46_descr == null ){ 
       ...
       $this->r46_rubdig = $r46_rubdig; 
       $this->r46_rubcon = $r46_rubcon; 
     if(($this->r46_rubdig == null) || ($this->r46_rubdig == "") ){ 
       $this->erro_sql = " Campo r46_rubdig nao declarado.";
     ...
     if(($this->r46_rubcon == null) || ($this->r46_rubcon == "") ){ 
       $this->erro_sql = " Campo r46_rubcon nao declarado.";
       $this->erro_banco = "Chave Primaria zerada.";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->r46_rubdig."-".$this->r46_rubcon;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($r46_rubdig=null,$r46_rubcon=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($r46_rubdig!=null){
       $sql .= " r46_rubdig = '$this->r46_rubdig'";
     }
     if($r46_rubcon!=null){
       $sql .= " and  r46_rubcon = '$this->r46_rubcon'";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->r46_rubdig,$this->r46_rubcon));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Consistencia de digitacao no ponto                 nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->r46_rubdig."-".$this->r46_rubcon;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Consistencia de digitacao no ponto                 nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->r46_rubdig."-".$this->r46_rubcon;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($r46_rubdig=null,$r46_rubcon=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($r46_rubdig,$r46_rubcon));
     }else{ 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($r46_rubdig != ""){
          ...
          $sql2 .= " r46_rubdig = '$r46_rubdig' ";
        }
        if($r46_rubcon != ""){
          if($sql2!=""){
            $sql2 .= " and ";
          }
          $sql2 .= " r46_rubcon = '$r46_rubcon' ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Consistencia de digitacao no ponto                 nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$r46_rubdig."-".$r46_rubcon;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Consistencia de digitacao no ponto                 nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$r46_rubdig."-".$r46_rubcon;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
