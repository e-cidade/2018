...
class cl_empagemovtipotransmissao {
   ...
   var $campos = "
                 e25_sequencial = int4 = Sequencial movimento tipo transmissão
                 e25_empagemov = int4 = Emp Ag Mov
                 e25_empagetipotransmissao = int4 = Tipo de Transmissão
                 ";
   ...
   function incluir ($e25_sequencial){
     ...
     if($this->e25_empagetipotransmissao == null ){
       $this->erro_sql = " Campo Tipo de Transmissão nao Informado.";
     ...
     if($e25_sequencial == "" || $e25_sequencial == null ){
       ...
       if(($result != false) && (pg_result($result,0,0) < $e25_sequencial)){
         $this->erro_sql = " Campo e25_sequencial maior que último número da sequencia.";
     ...
     if($result==false){
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Movimento e Tipo de Transmissão ($this->e25_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "Movimento e Tipo de Transmissão já Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       }else{
         $this->erro_sql   = "Movimento e Tipo de Transmissão ($this->e25_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function alterar ($e25_sequencial=null, $sWhere = null) {
     ...
     if(trim($this->e25_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e25_sequencial"])){
       ...
       if(trim($this->e25_sequencial) == null ){
         $this->erro_sql = " Campo Sequencial movimento tipo transmissão nao Informado.";
     ...
     if($result==false){
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Movimento e Tipo de Transmissão nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->e25_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Movimento e Tipo de Transmissão nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->e25_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($e25_sequencial=null,$dbwhere=null) {
     ...
     if($result==false){
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Movimento e Tipo de Transmissão nao Excluído. Exclusão Abortada.\\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Movimento e Tipo de Transmissão nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$e25_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
