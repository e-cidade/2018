...
class cl_cadmodcarne { 
   ...
   var $campos = "
                 ...
                 k47_descr = varchar(40) = Descrição do modelo 
                 k47_obs = text = Obs 
                 k47_altura = int4 = Altura da pagina 
                 k47_largura = int4 = Largura da pagina 
                 k47_orientacao = char(1) = Orientação da pagina 
   ...
   function incluir ($k47_sequencial){ 
     ...
     if($k47_sequencial == "" || $k47_sequencial == null ){
       ...
       if(($result != false) && (pg_result($result,0,0) < $k47_sequencial)){
         $this->erro_sql = " Campo k47_sequencial maior que último número da sequencia.";
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Cadastros de modelos de carnes/recibos ($this->k47_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "Cadastros de modelos de carnes/recibos já Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       }else{
         $this->erro_sql   = "Cadastros de modelos de carnes/recibos ($this->k47_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function excluir ($k47_sequencial=null,$dbwhere=null) { 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Cadastros de modelos de carnes/recibos nao Excluído. Exclusão Abortada.\\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Cadastros de modelos de carnes/recibos nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$k47_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
