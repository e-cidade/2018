...
class cl_biblioteca {
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->bi17_codigo = ($this->bi17_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["bi17_codigo"]:$this->bi17_codigo);
       $this->bi17_nome = ($this->bi17_nome == ""?@$GLOBALS["HTTP_POST_VARS"]["bi17_nome"]:$this->bi17_nome);
       $this->bi17_coddepto = ($this->bi17_coddepto == ""?@$GLOBALS["HTTP_POST_VARS"]["bi17_coddepto"]:$this->bi17_coddepto);
     }else{
       $this->bi17_codigo = ($this->bi17_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["bi17_codigo"]:$this->bi17_codigo);
     }
   }
   // funcao para inclusao
   function incluir ($bi17_codigo){
      $this->atualizacampos();
     if($this->bi17_nome == null ){
     ...
     if($bi17_codigo == "" || $bi17_codigo == null ){
       $result = db_query("select nextval('biblioteca_bi17_codigo_seq')");
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: biblioteca_bi17_codigo_seq do campo: bi17_codigo";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false;
       ...
       if(($result != false) && (pg_result($result,0,0) < $bi17_codigo)){
         ...
         $this->bi17_codigo = $bi17_codigo;
       }
     }
     if(($this->bi17_codigo == null) || ($this->bi17_codigo == "") ){
       $this->erro_sql = " Campo bi17_codigo nao declarado.";
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->bi17_codigo;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($bi17_codigo=null) {
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($bi17_codigo!=null){
       $sql .= " bi17_codigo = $this->bi17_codigo";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->bi17_codigo));
     if($this->numrows>0){
     ...
     if($result==false){
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Biblioteca nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->bi17_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Biblioteca nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->bi17_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($bi17_codigo=null,$dbwhere=null) {
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($bi17_codigo));
     }else{
     ...
     if($result==false){
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Biblioteca nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$bi17_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Biblioteca nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$bi17_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $bi17_codigo=null,$campos="*",$ordem=null,$dbwhere=""){
     ...
     if($dbwhere==""){
       if($bi17_codigo!=null ){
         $sql2 .= " where biblioteca.bi17_codigo = $bi17_codigo ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
  ...
  function buscaParametros( $bi17_codigo = null, $campos = "*", $ordem = null, $dbwhere = "" ) {

    $sql  = "select {$campos} ";
    $sql .= "   from biblioteca ";
    $sql .= "   left join bib_parametros ON bib_parametros.bi26_biblioteca = biblioteca.bi17_codigo";
    $sql .= "  inner join db_depart      ON db_depart.coddepto = biblioteca.bi17_coddepto";
    if (empty($dbwhere)) {

      if (!empty($bi17_codigo)) {
        $sql2 .= " where biblioteca.bi17_codigo = $bi17_codigo ";
      }
