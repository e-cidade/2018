	     ...
	     <form name="form2" method="post" action="" >
          ...
          <tr> 
            <td colspan="2" align="center"> 
              ...
              <input name="Fechar" type="button" id="fechar" value="Fechar" onClick="parent.db_iframe_caddocumentoatributo.hide();">
             </td>
          </tr>
        </form>
        </table>
    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        if(isset($campos)==false){
           if(file_exists("funcoes/db_func_caddocumentoatributo.php")==true){
             include("funcoes/db_func_caddocumentoatributo.php");
           }else{
           $campos = "caddocumentoatributo.*";
           }
        }
        if(isset($chave_db45_sequencial) && (trim($chave_db45_sequencial)!="") ){
	         $sql = $clcaddocumentoatributo->sql_query($chave_db45_sequencial,$campos,"db45_sequencial");
        }else if(isset($chave_db45_sequencial) && (trim($chave_db45_sequencial)!="") ){
	         $sql = $clcaddocumentoatributo->sql_query("",$campos,"db45_sequencial"," db45_sequencial like '$chave_db45_sequencial%' ");
        }else{
        ...
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $clcaddocumentoatributo->sql_record($clcaddocumentoatributo->sql_query($pesquisa_chave));
          if($clcaddocumentoatributo->numrows!=0){
