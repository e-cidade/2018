  ...
  <tr>
	...
	$campos = "distinct $campos";
        if(isset($chave_t93_codtran) && (trim($chave_t93_codtran)!="") ){
	         $sql = $clbenstransf->sql_query_departamento_destino($chave_t93_codtran,$campos,"t93_codtran");
        }else if(isset($chave_t93_data) && (trim($chave_t93_data)!="") ){
	         $sql = $clbenstransf->sql_query_departamento_destino("",$campos,"t93_data"," t93_data like '$chave_t93_data%' ");
        }else{
           $sql = $clbenstransf->sql_query_departamento_destino("",$campos,"t93_codtran","");
        }
        db_lovrot($sql,15,"()","",$funcao_js);
      }else{
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $clbenstransf->sql_record($clbenstransf->sql_query_departamento_destino($pesquisa_chave));
