...
for ($x = 0; $x < $clMatricula->numrows; $x++) {
  ...
  if ($iCodigo != $ed57_i_codigo) {   
    ...
    if ($x != 0) {
      ...
      $fpdf->setX(10);
      $fpdf->cell(65, 5, "Secretário(a) da Comissão proc. escolha Diretor Escolar", 0, 0,"L", 0);
      $fpdf->setX(130);
      $fpdf->cell(65, 5, "Presidente da Comissão proc. escolha Diretor Escolar", 0, 1, "L", 0); 
      $fpdf->setY(289);  
