...
if (!isset($pesquisa_chave)) {
  ...
  if (isset($chave_coddepto) && (trim($chave_coddepto) != "") ) {
    ...
    $sWhereAlmoxarifado = " and db_depart.coddepto in (select m91_depto from db_almox where db_depart.coddepto = m91_depto) ";
  	$sWhere = $where."(limite is null or limite >= '" . date("Y-m-d",db_getsession("DB_datausu"))."') ";
    $sql = $cldb_depart->sql_query_div("", $campos, "coddepto", $sWhere.$whereGeral.$sWhereAlmoxarifado);
  }
  ...
  if ($pesquisa_chave != null && $pesquisa_chave != "") {
    ...
    $result = $cldb_depart->sql_record($cldb_depart->sql_query_div(null, "*", null, $sWhere.$sWhereAlmoxarifado));
