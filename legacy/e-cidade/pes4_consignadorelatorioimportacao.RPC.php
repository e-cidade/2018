...
try {
  ...
  switch ($oParam->exec) {
     ...
     */
    case 'gerarRelatorioImportacaoConsignet':
      ...
      $oArquivo = ArquivoConsignetRepository::getUltimoArquivo($oIntituicao, $oCompetencia);
      ...
      $sCaminhoArquivo = 'tmp/RelatorioImportacaoConsignet_'. $iAno .'_'. $iMes .'.pdf';
      ...
      $aArquivo               = explode('/', $sCaminhoArquivo);
