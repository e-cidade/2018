  ...
  switch ($oParam->exec) {
    ...
    case 'getBancosConfigurados':
      ...
      if (count($aInstituicoes) == 0) {
        throw new BusinessException('Não existem configurações de consignações. Antes de importar configure em  Procedimentos > Manutenção de Parâmetros > Configuraçao Consignados');
      }
