...
$oPdf->addTableHeader('DESCRIÇÃO', 97, 4.5, 'C');
$oPdf->addTableHeader('CLASSIFICACÃO', 23, 4.5, 'C');
$oPdf->addTableHeader('DESCRIÇÃO', 50, 4.5, 'C');

$oPdf->addHeader('RELATÓRIO DE BENS POR LOTE');
