    ...
    <td height="63" align="center" valign="top">
        <table width="35%" border="0" align="center" cellspacing="0">
	     <form name="form2" method="post" action="" >
          <tr> 
            <td width="4%" align="right" nowrap title="<?=$Tob07_codconstr?>">
              <?=$Lob07_codconstr?>
            </td>
            <td width="96%" align="left" nowrap> 
              <?
		       db_input("ob07_codconstr",10,$Iob07_codconstr,true,"text",4,"","chave_ob07_codconstr");
		       ?>
            </td>
          </tr>
          <tr> 
            <td width="4%" align="right" nowrap title="<?=$Tob07_codobra?>">
              <?=$Lob07_codobra?>
            </td>
            <td width="96%" align="left" nowrap> 
              <?
		       db_input("ob07_codobra",10,$Iob07_codobra,true,"text",4,"","chave_ob07_codobra");
		       ?>
            </td>
          </tr>
          <tr> 
      ...
      if(!isset($pesquisa_chave)){
        if(isset($campos)==false){
           if(file_exists("funcoes/db_func_obrasender.php")==true){
             include("funcoes/db_func_obrasender.php");
           }else{
           $campos = "obrasender.*";
           }
        }
