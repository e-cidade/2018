    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_id_usuario) && (trim($chave_id_usuario)!="") ){
	         $sql = $cldb_usuarios->sql_query($chave_id_usuario,$campos,"id_usuario");
        }else if(isset($chave_nome) && (trim($chave_nome)!="") ){
	         $sql = $cldb_usuarios->sql_query("",$campos,"nome"," nome like '$chave_nome%' ");
        }else{
           $sql = $cldb_usuarios->sql_query("",$campos,"id_usuario","");
        }
        db_lovrot($sql,15,"()","",$funcao_js);
      }else{
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $cldb_usuarios->sql_record($cldb_usuarios->sql_query($pesquisa_chave));
