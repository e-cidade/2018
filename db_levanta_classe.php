...
class cl_levanta { 
   ...
   function incluir ($y60_codlev){ 
     ...
     if($y60_codlev == "" || $y60_codlev == null ){
       $result = @pg_query("select nextval('levanta_y60_codlev_seq')"); 
       if($result==false){
       ...
       $result = @pg_query("select last_value from levanta_y60_codlev_seq");
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,5014,'$this->y60_codlev','I')");
       $resac = pg_query("insert into db_acount values($acount,709,5014,'','".AddSlashes(pg_result($resaco,0,'y60_codlev'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,709,5015,'','".AddSlashes(pg_result($resaco,0,'y60_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,709,5016,'','".AddSlashes(pg_result($resaco,0,'y60_contato'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,709,5017,'','".AddSlashes(pg_result($resaco,0,'y60_dtini'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,709,5018,'','".AddSlashes(pg_result($resaco,0,'y60_dtfim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,709,5019,'','".AddSlashes(pg_result($resaco,0,'y60_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,709,6537,'','".AddSlashes(pg_result($resaco,0,'y60_importado'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,709,6551,'','".AddSlashes(pg_result($resaco,0,'y60_proces'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($y60_codlev=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,5014,'$this->y60_codlev','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y60_codlev"]))
           $resac = pg_query("insert into db_acount values($acount,709,5014,'".AddSlashes(pg_result($resaco,$conresaco,'y60_codlev'))."','$this->y60_codlev',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y60_data"]))
           $resac = pg_query("insert into db_acount values($acount,709,5015,'".AddSlashes(pg_result($resaco,$conresaco,'y60_data'))."','$this->y60_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y60_contato"]))
           $resac = pg_query("insert into db_acount values($acount,709,5016,'".AddSlashes(pg_result($resaco,$conresaco,'y60_contato'))."','$this->y60_contato',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y60_dtini"]))
           $resac = pg_query("insert into db_acount values($acount,709,5017,'".AddSlashes(pg_result($resaco,$conresaco,'y60_dtini'))."','$this->y60_dtini',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y60_dtfim"]))
           $resac = pg_query("insert into db_acount values($acount,709,5018,'".AddSlashes(pg_result($resaco,$conresaco,'y60_dtfim'))."','$this->y60_dtfim',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y60_obs"]))
           $resac = pg_query("insert into db_acount values($acount,709,5019,'".AddSlashes(pg_result($resaco,$conresaco,'y60_obs'))."','$this->y60_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y60_importado"]))
           $resac = pg_query("insert into db_acount values($acount,709,6537,'".AddSlashes(pg_result($resaco,$conresaco,'y60_importado'))."','$this->y60_importado',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y60_proces"]))
           $resac = pg_query("insert into db_acount values($acount,709,6551,'".AddSlashes(pg_result($resaco,$conresaco,'y60_proces'))."','$this->y60_proces',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($y60_codlev=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,5014,'$this->y60_codlev','E')");
         $resac = pg_query("insert into db_acount values($acount,709,5014,'','".AddSlashes(pg_result($resaco,$iresaco,'y60_codlev'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,709,5015,'','".AddSlashes(pg_result($resaco,$iresaco,'y60_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,709,5016,'','".AddSlashes(pg_result($resaco,$iresaco,'y60_contato'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,709,5017,'','".AddSlashes(pg_result($resaco,$iresaco,'y60_dtini'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,709,5018,'','".AddSlashes(pg_result($resaco,$iresaco,'y60_dtfim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,709,5019,'','".AddSlashes(pg_result($resaco,$iresaco,'y60_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,709,6537,'','".AddSlashes(pg_result($resaco,$iresaco,'y60_importado'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,709,6551,'','".AddSlashes(pg_result($resaco,$iresaco,'y60_proces'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
