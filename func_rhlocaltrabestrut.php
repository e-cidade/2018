    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_rh55_codigo) && (trim($chave_rh55_codigo)!="") ){
	         ...
	         $sql = $clrhlocaltrab->sql_query("",db_getsession("DB_instit"),$campos,"rh55_estrut"," rh55_estrut like '$chave_rh55_estrut%' ");
        }else if(isset($chave_rh55_descr) && (trim($chave_rh55_descr)!="") ){
	         $sql = $clrhlocaltrab->sql_query("",db_getsession("DB_instit"),$campos,"rh55_descr"," rh55_descr like '$chave_rh55_descr%' ");
        }else{
        ...
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $clrhlocaltrab->sql_record($clrhlocaltrab->sql_query(null,db_getsession("DB_instit"),"*","","rh55_estrut = '".$pesquisa_chave."'"));
