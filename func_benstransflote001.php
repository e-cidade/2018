    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        if(isset($chave_t93_codtran) && (trim($chave_t93_codtran)!="") ){
          $sql = $clbenstransf->sql_query(null,$campos,"t93_codtran"," t93_codtran $param (select t96_codtran from benstransfconf) and t93_codtran = $chave_t93_codtran $where_instit ");
        }else if(isset($chave_t93_data) && (trim($chave_t93_data)!="") ){
	        $sql = $clbenstransf->sql_query("",$campos,"t93_data","t93_codtran $param (select t96_codtran from benstransfconf) and t93_data like '$chave_t93_data' $where_instit ");
        }else{
          $sql = $clbenstransf->sql_query("",$campos,"t93_codtran","t93_codtran $param (select t96_codtran from benstransfconf) $where_instit ");
        }
        ...
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $clbenstransf->sql_record($clbenstransf->sql_query(null,$campos,"","t93_codtran $param (select t96_codtran from benstransfconf) and t93_codtran = $pesquisa_chave and t93_instit = ".db_getsession("DB_instit")));
