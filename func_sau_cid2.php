        ...
        <table width="35%" border="0" align="center" cellspacing="0">
          ...
          <tr>
            <td colspan="2" align="center">
              ...
              <input name="Fechar" type="button" id="fechar" value="Fechar" onClick="parent.db_iframe_sau_cid.hide();">
             </td>
          </tr>
        </form>
        </table>
    ...
    <td align="center" valign="top">
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_sd70_i_codigo) && (trim($chave_sd70_i_codigo)!="") ){
              $sql = $clsau_cid->sql_query($chave_sd70_i_codigo,$campos,"sd70_i_codigo");
        }else if(isset($chave_sd70_c_cid) && (trim($chave_sd70_c_cid)!="") ){
              $sql = $clsau_cid->sql_query("",$campos,"sd70_c_cid"," sd70_c_cid like '$chave_sd70_c_cid%' ");
        }else if(isset($chave_sd70_c_nome) && (trim($chave_sd70_c_nome)!="") ){
              $sql = $clsau_cid->sql_query("",$campos,"sd70_c_nome"," sd70_c_nome like '$chave_sd70_c_nome%' ");
        }else{
           $sql = $clsau_cid->sql_query("",$campos,"sd70_i_codigo","");
        }
        $repassa = array();
        ...
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          echo "<BR> ".$clsau_cid->sql_query(null,"*","sd70_c_cid = '$pesquisa_chave'");
          $result = $clsau_cid->sql_record($clsau_cid->sql_query(null,"*",null,"sd70_c_cid = '$pesquisa_chave'"));
