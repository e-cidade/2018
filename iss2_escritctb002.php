...
$sql = " select q86_numcgm
	...
	/* antigo sql
	 $sql = " select q86_numcgm
                   ...
                   from cadescrito
                  inner join cgm on q86_numcgm = z01_numcgm
                  inner join escrito on q10_numcgm = q86_numcgm" ;
	*/
...
//	 $pdf->Cell(15,4,"Inscrição",1,0,"C",1);
         $pdf->Cell(80,4,"Descricao",1,0,"C",1);
         $pdf->Cell(90,4,"Endereço",1,0,"C",1);
         $pdf->Cell(20,4,"Numero",1,0,"C",1);
//         $pdf->Cell(30,4,"Complemento",1,0,"C",1);	 
         $pdf->Cell(45,4,"Bairro",1,0,"C",1);	 
         $pdf->Cell(30,4,"Municipio",1,1,"C",1);	 
         $pdf->SetFont('Courier','B',8);
         $pdf->SetTextColor(0,0,0);
      }
      $pdf->Cell(12,4,pg_result($result,$i,"q86_numcgm"),0,0,"C",$p);
//      $pdf->Cell(15,4,pg_result($result,$i,"q10_inscr"),0,0,"C",$p);
...
//      $pdf->Cell(30,4,pg_result($result,$i,"z01_compl"),0,0,"L",$p);
