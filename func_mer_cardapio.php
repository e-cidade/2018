   ...
   <table width="35%" border="0" align="center" cellspacing="0">
    ...
    <tr>
     <td colspan="2" align="center">
      ...
      <input name="Fechar" type="button" id="fechar" value="Fechar" onClick="parent.db_iframe_mer_cardapio.hide();">
     </td>
    </tr>
    </form>
   </table>
  ...
  <td align="center" valign="top">
   ...
   if (!isset($pesquisa_chave)) {
    ...
    if (isset($campos)==false) {
     ...
     if (file_exists("funcoes/db_func_mer_cardapio.php")==true) {
      include("funcoes/db_func_mer_cardapio.php");
     } else {
       $campos = "mer_cardapio.*";
     }     
    }
    if (isset($chave_me01_c_nome) && (trim($chave_me01_c_nome)!="")) {
      $sql = $clmer_cardapio->sql_query("",
                                        "distinct on (me01_i_id)me01_i_codigo,me01_c_nome,me01_i_id,me01_f_versao",
                                        "me01_i_id,me01_f_versao desc",
                                        "  me01_c_nome like '$chave_me01_c_nome%'"
                                       );
    } else {
      $sql = $clmer_cardapio->sql_query("",
                                        "distinct on (me01_i_id)me01_i_codigo,me01_c_nome,me01_i_id,me01_f_versao",
    ...
    db_lovrot($sql,15,"()","",$funcao_js,"","NoMe",$repassa);
     ...
     $result = $clmer_cardapio->sql_record($clmer_cardapio->sql_query("",
                                                                      "",
                                                                      "",
                                                                      "
                                                                       me01_i_codigo = $pesquisa_chave"
                                                                     ));
     if ($clmer_cardapio->numrows!=0) {
     	
       db_fieldsmemory($result,0);
       echo "<script>".$funcao_js."('$me01_c_nome',false);</script>";
