...
echo "|<u>Atendimento: ".substr($sd23_c_atendimento,0,4)." | ".substr($sd23_c_atendimento,4,2)." | ".substr($sd23_c_atendimento,6,5)?> Data/Hora: <?=$sd23_d_consulta." /".$sd23_c_hora."                   </u>|<br>";
echo "|<u>1. UNIDADE PRESTADORA DE ATENDIMENTO                                          </u>|<br>";
...
echo "|<u>Sia/Sus ..:".str_pad(trim($sd02_c_siasus),67," ")."</u>|<br>";
echo "|<u>2. IDENTIFICAÇAO DO PACIENTE                                                  </u>|<br>";
...
echo "|<u>Familia ..:".str_pad(trim($sd01_i_familia),67," ")."</u>|<br>";
echo "|<u>3. IDENTIFICAÇAO DO PROFISSIONAL                                              </u>|<br>";
echo "|<u>".str_pad($sd03_i_id." - ".$sd03_c_nome,78," ")."</u>|<br>";
echo "|<u>4. MOTIVO DO ATENDIMENTO                                                      </u>|<br>";
echo "|______________________________________________________________________________|<br>";
echo "|<u>5.Especialidade|6.Procedimento|7.Profissional|8.Tratamento       |9.Assinatura</u>|<br>";
for($x=0; $x < 15; $x++){
echo "|               |              |              |                   |            |<br>";
echo "|_______________|______________|______________|___________________|____________|<br>";
}
echo "|<u>10.Tipo        |11.Diagnostico                                   |12.Polegar  </u>|<br>";
echo "|               |                                                 |            |<br>";
echo "|_______________|_________________________________________________|            |<br>";
echo "|<u>13.Grupo       |14.Assinatura                                    </u>|            |<br>";
echo "|               |                                                 |            |<br>";
echo "|_______________|_________________________________________________|____________|<br>";
echo "</pre>";
echo "</body>";
echo "</html>";
?>