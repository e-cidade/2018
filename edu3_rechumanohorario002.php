...
if ($oPost->sAction == 'MontaGrade') {
  ...
  for ($x = 0; $x < $cldiasemana->numrows; $x++) {
    ...
    $sCampos  .= "ed15_c_nome,ed17_h_inicio,ed17_h_fim,ed17_i_escola,ed20_i_codigo";
    ...
    $sCampos  .= "ed18_c_nome,turno.ed15_c_nome,ed17_h_inicio,ed17_h_fim,ed17_i_escola,ed20_i_codigo,";
    ...
    $result111 = $clturmaachorario->sql_record($clturmaachorario->sql_query("",
                                                                            $sCampos,
                                                                            $sOrder,
                                                                            $sWhere
                                                                           )
...
if ($oPost->sAction == 'MontaEscola') {
  ...
  $aResult    = db_utils::getColectionByRecord($resultano, false, false, true);
  $oJson      = new services_json();
