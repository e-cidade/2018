...
class cl_orcsuplemretif { 
   ...
   function incluir ($o48_seq){ 
     ...
     if($o48_seq == "" || $o48_seq == null ){
       $result = @pg_query("select nextval('orcsuplemretif_o48_seq_seq')"); 
       if($result==false){
       ...
       $result = @pg_query("select last_value from orcsuplemretif_o48_seq_seq");
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,7875,'$this->o48_seq','I')");
       $resac = pg_query("insert into db_acount values($acount,1319,7875,'','".AddSlashes(pg_result($resaco,0,'o48_seq'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1319,7876,'','".AddSlashes(pg_result($resaco,0,'o48_projeto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1319,7877,'','".AddSlashes(pg_result($resaco,0,'o48_retificado'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1319,7880,'','".AddSlashes(pg_result($resaco,0,'o48_texto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1319,7878,'','".AddSlashes(pg_result($resaco,0,'o48_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1319,7879,'','".AddSlashes(pg_result($resaco,0,'o48_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($o48_seq=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,7875,'$this->o48_seq','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o48_seq"]))
           $resac = pg_query("insert into db_acount values($acount,1319,7875,'".AddSlashes(pg_result($resaco,$conresaco,'o48_seq'))."','$this->o48_seq',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o48_projeto"]))
           $resac = pg_query("insert into db_acount values($acount,1319,7876,'".AddSlashes(pg_result($resaco,$conresaco,'o48_projeto'))."','$this->o48_projeto',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o48_retificado"]))
           $resac = pg_query("insert into db_acount values($acount,1319,7877,'".AddSlashes(pg_result($resaco,$conresaco,'o48_retificado'))."','$this->o48_retificado',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o48_texto"]))
           $resac = pg_query("insert into db_acount values($acount,1319,7880,'".AddSlashes(pg_result($resaco,$conresaco,'o48_texto'))."','$this->o48_texto',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o48_id_usuario"]))
           $resac = pg_query("insert into db_acount values($acount,1319,7878,'".AddSlashes(pg_result($resaco,$conresaco,'o48_id_usuario'))."','$this->o48_id_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o48_data"]))
           $resac = pg_query("insert into db_acount values($acount,1319,7879,'".AddSlashes(pg_result($resaco,$conresaco,'o48_data'))."','$this->o48_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($o48_seq=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,7875,'$o48_seq','E')");
         $resac = pg_query("insert into db_acount values($acount,1319,7875,'','".AddSlashes(pg_result($resaco,$iresaco,'o48_seq'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1319,7876,'','".AddSlashes(pg_result($resaco,$iresaco,'o48_projeto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1319,7877,'','".AddSlashes(pg_result($resaco,$iresaco,'o48_retificado'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1319,7880,'','".AddSlashes(pg_result($resaco,$iresaco,'o48_texto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1319,7878,'','".AddSlashes(pg_result($resaco,$iresaco,'o48_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1319,7879,'','".AddSlashes(pg_result($resaco,$iresaco,'o48_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
