	  ...
	  <form id='form1' name="form1" method="post" action="" >
	    <fieldset style="border:none; border-top:2px groove #FFF;">
	      ...
	      <table>
	        ...
	        <tr>
	          <td><b>Descrição:</b></td>
	          <td colspan="3"><? db_input('descr_lote', 80, '', true, 'text', 1, "onblue='js_ValidaMaiusculo(this,'t',event);'",
	          ...
	          <td>
	            <?
	              db_input('sPlaca', 10, "text", true, "text", 1, "onblue='js_ValidaMaiusculo(this,'t',event);'",
                         "", "", "text-transform: uppercase;" );
	              db_input('t41_placa', 10, "", true, "text", 1, "onkeypress=\"return js_mask(event, '0-9')\"");
	            ?>
	          </td>
	          <td colspan="2"></td>
	        </tr>
...
function js_carregaDadosNota() {
  ...
  if (typeof lViewNotasPendentes != "undefined" && !lViewNotasPendentes) {
    ...
    oObject.iEmpNotaItem = oUrl.iCodigoEmpNotaItem;
