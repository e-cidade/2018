...
<script>
 ...
 function js_verifica(){
   ...
   js_consultaEmpenhosFGTS();    
 
 }
 
 
 function js_consultaEmpenhosFGTS(){
   ...
   var oAjax   = new Ajax.Request( sUrl, {
                                            method: 'post', 
                                            parameters: js_getQueryTela('consultarEmpenhosFGTS'), 
 ...
 function js_geraEmpenhos(){
   ...
   var oAjax   = new Ajax.Request( sUrl, {
                                            method: 'post', 
                                            parameters: js_getQueryTela('gerarEmpenhosFGTS'), 
