...
<table>
  <tr>
		<td>
		<fieldset><legend><b>Diagnóstico</b></legend>
			<table>
			<!-- Prontuário -->
			<tr>
				...
				<!-- ATENDIDA / FATURADA -->
				<tr>
					<td nowrap title="<?=@$Tsd24_c_digitada?>">
						<?=@$Lsd24_c_digitada?>
					</td>
					<td>
						<?
						$x = array('S'=>'SIM','N'=>'NÃO');
						db_select('sd24_c_digitada',$x,true,$db_opcao,"onChange=js_keypress();");
						?>
					</td>
				</tr>				
			</table>
...
function js_gravaemite( opcao ){
	switch(opcao){
		...
		case 'grava':
			...
			strParam += '&sd24_t_diagnostico='+$F('sd24_t_diagnostico');
			strParam += '&sd24_c_digitada='+$F('sd24_c_digitada');
