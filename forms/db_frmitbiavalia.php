...
<form name="form1" method="post" action="" id="frm1">
  <table>
    ...
    <tr align="center"> 
      <td colspan="6">
		 <input name="liberar"   type="submit" id="liberar"   value="Libera Guia" <?=($db_botao==false?"disabled":"")?> onClick=" return js_validaCampos();">
		 <input name="visualizar" type="button" id="visualizar" value="Vizualizar Guia" onclick="js_visualizar(<?=$it14_guia?>);" <?=($db_botao==false?"disabled":"")?>>
