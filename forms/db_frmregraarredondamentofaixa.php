  ...
  <div style="display: table">
    <fieldset>
      ...
      <center>
        <table border="0">
          <tr>
            <td nowrap title="<?=@$Ted317_sequencial?>">
              <?=@$Led317_sequencial?>
            </td>
            <td>
              <?
                db_input('ed317_sequencial', 10, $Ied317_sequencial, true, 'text', 3, "");
              ?>
            </td>
          </tr>
...
<script>
  ...
  document.form1.ed317_inicial.maxLength = 3;
  document.form1.ed317_final.maxLength   = 3;
</script>