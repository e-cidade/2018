...
function js_pesquisarcompilacao (lMostrarRegistro) {
  ...
  if (lMostrarRegistro==true) {
    ...
    js_OpenJanelaIframe('',
                      ...
                      '&anuladas=1&trazapenascomlicitacao=1&estimativadepto=1&lDesabilitaFiltroInstituicaoCompilacao=true',
                      'Registros de Preço',
                       true
                      );
  } else {
     ...
     js_OpenJanelaIframe('',
                      ...
                      '&funcao_js=parent.js_mostracompilacao1&anuladas=1&trazapenascomlicitacao=1&estimativadepto=1&lDesabilitaFiltroInstituicaoCompilacao=true',
                      'Registros de Preço',
                      false
                      ); 
     } else {
