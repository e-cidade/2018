        ...
        <tr>
         ...
         <td>
          ...
          <select name="ed37_c_minimoaprovconc" <?=$db_opcao==3?"disabled":""?>
                  ...
                  <?=$oDaoConceito->numrows==0?"onclick=\"alert('Informar o mínimo para aprovação somente após'+
                                                                ' cadastrar os níveis desta forma de avaliação.\\nApós'+
                                                                ' a inclusão da Descrição e Tipo de Resultado,'+
                                                                ' aparecerá uma tela para o cadastro dos níveis.')\"":""?>>
