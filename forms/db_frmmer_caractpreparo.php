...
//MODULO: merenda
$clmer_caractpreparo->rotulo->label();
...
<table border="0">
 <tr>
  <td nowrap title="<?=@$Tme06_i_codigo?>">
   <?=@$Lme06_i_codigo?>
  </td>
  <td>
 ...
 <tr>
  <td nowrap title="<?=@$Tme06_c_graudificuldade?>">
 ...
 <tr>
  <td nowrap title="<?=@$Tme06_c_tempopreparo?>">
