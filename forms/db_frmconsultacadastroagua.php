	...
	<tr>
		...
		<table width="107%" border="0" >
			...
			<tr>
				...
				<td nowrap>
					<input type="text" name="x01_matric" id="x01_matric" value="" size="10" maxlength="10" autocomplete= "off" title="Matrícula do Imóvel Campo:x01_matric" onkeyUp="js_ValidaCampos(this,1,'Matrícula','f','f',event);" onkeyDown="return submitEnter(event);" />
				</td>
			</tr>
			<tr>
				...
				<td nowrap>
					<input type="text" name="z01_nome" id="z01_nome" value="" size="50" maxlength="40" autocomplete="off" title="Nome da pessoa ou Razao Social se for Empresa Campo:z01_nome" onblur="js_ValidaMaiusculo(this,'t',event);" onkeyup="js_ValidaCampos(this,3,'Nome/Razão Social','f','t',event);" onkeydown="return submitEnter(event);" style="text-transform: uppercase;" />
				</td>
			</tr>
			<tr>
				<td nowrap>&nbsp;</td>
				...
				<td nowrap>
					<input type="text" name="j14_codigo" id="j14_codigo" value="" size="10" autocomplete="off" maxlength="7" title="Código do logradouro cadastrado no sistema Campo:j14_codigo" onkeydown="return submitEnter(event);" onkeyup="js_ValidaCampos(this,1,'Código Logradouro','f','f',event);" />
				</td>
			</tr>
			<tr>
				<td nowrap>&nbsp;</td>
			...
			<tr>
				...
				<td nowrap>
					<input type="text" name="j13_codi" id="j13_codi" value="" size="10" maxlength="6" autocomplete="off" onkeydown="return submitEnter(event);" onkeyup="js_ValidaCampos(this,1,'Cód. do Bairro','t','f',event);" style="background-color: rgb(230, 228, 241);" title="Código do bairro Campo:j13_codi" />
				</td>
			</tr>
			<tr>
				<td nowrap>&nbsp;</td>
				...
				?>
				<input type="text" name="j13_descr" id="j13_descr" value="" size="50" maxlength="40" autocomplete="off" onkeydown="return submitEnter(event);" onkeyup="js_ValidaCampos(this,0,'Bairro','f','t',event);" onblur="js_ValidaMaiusculo(this,'t',event);" style="text-transform: uppercase;" title="Descrição do bairro Campo:j13_descr"/>
				</td>
			</tr>
			<tr>
