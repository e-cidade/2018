...
<table border="0">
  ...
  <tr>
    ...
    <td> 
      <?
      $x = array("f"=>"NAO","t"=>"SIM");
      db_select('o69_totalizador',$x,true,$db_opcao,"");
      ?>
    </td>
  </tr>
  </tr>
...
function js_pesquisa(){
  js_OpenJanelaIframe('top.corpo.iframe_orcparamseq','db_iframe_orcparamseq','func_orcparamseq.php?funcao_js=parent.js_preenchepesquisa|o69_codparamrel|o69_codseq','Pesquisa',true,'0','1');
}
