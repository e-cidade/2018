...
<table border="0">
  <tr>
    ...
    <td> 
<?
db_input('e44_tipo',8,$Ie44_tipo,true,'text',3)
?>
    </td>
  </tr>
  <tr>
    <td nowrap title="<?=@$Te44_descr?>">
       <?=@$Le44_descr?>
    </td>
    <td> 
<?
db_input('e44_descr',40,$Ie44_descr,true,'text',$db_opcao,"")
?>
    </td>
  </tr>
  <tr>
     <td nowrap title="<?=@$Te44_obriga?>">
      <?=@$Le44_obriga?>
     </td>
     <td>
      <?
        $arr = array("0"=>"Não presta","1"=>"Obriga Valores","2"=>"Obriga contas");
        db_select("e44_obriga",$arr,true,1);
      ?>
     </td>
  </tr>
