...
/**
 *  Se emtrar no formulário em modo de alteração, ao clicar na pesquisa deve-se preencher o form com os dados do bem
 * selecionado
 */
  if (dbOpcao != 1) {
...
function js_retornoBuscaBem(oJson) {
  ...
  if (oRetorno.status == 2) {
    ...
    /**
     * Nao é inclusao, exibe codigo da ultima placa, campo t52_ident da tabela bens. 
     */
