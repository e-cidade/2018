...
<tr>
<td>
<fieldset><legend><b>Prestadores</b></legend>
...
?>
  ...
  <tr>
    ...
    <td> 
<?
db_input('s110_i_numcgm',10,$Is110_i_numcgm,true,'text',$db_opcao," onchange='js_pesquisas110_i_numcgm(false);'")
?>
       <?
  ...
  if(mostra==true){
    js_OpenJanelaIframe('','db_iframe_cgm','func_cgm.php?funcao_js=parent.js_mostracgm1|z01_numcgm|z01_nome','Pesquisa',true);
     ...
     if(document.form1.s110_i_numcgm.value != ''){ 
        js_OpenJanelaIframe('','db_iframe_cgm','func_cgm.php?pesquisa_chave='+document.form1.s110_i_numcgm.value+'&funcao_js=parent.js_mostracgm','Pesquisa',false);
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('','db_iframe_sau_prestadores','func_sau_prestadores.php?funcao_js=parent.js_preenchepesquisa|s110_i_codigo','Pesquisa',true);
}
