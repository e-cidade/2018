...
?>
  ...
  <tr>
    <td nowrap title="<?=@$Tfa14_c_medanvisa?>">
       <?=@$Lfa14_c_medanvisa?>
    </td>
    <td> 
<?
...
function js_pesquisa(){
  js_OpenJanelaIframe('','db_iframe_far_medanvisa','func_far_medanvisa.php?funcao_js=parent.js_preenchepesquisa|fa14_i_codigo','Pesquisa',true);
}
