...
function js_pesquisak03_tipo(mostra) {
  ...
  if(mostra == true) {
    ...
    js_OpenJanelaIframe('top.corpo','db_iframe_cadtipo',sUrl,'Pesquisa',true);
  } else {
    ...
    if (document.form1.k03_tipo.value != '') {
      ...
      js_OpenJanelaIframe('top.corpo','db_iframe_cadtipo',sUrl,'Pesquisa',false);
    } else {
...
function js_pesquisak00_receitacredito(mostra) {
  ...
  if (mostra) {
    ...
    js_OpenJanelaIframe('top.corpo','db_iframe_tabrec',sUrl,'Pesquisa Receitas',true);
    ...
    if (document.form1.k00_receitacredito.value != '') {
      ...
      js_OpenJanelaIframe('top.corpo','db_iframe_tabrec',sUrl,'Pesquisa Receitas',false);
    } else {
...
function js_pesquisa() {
  ...
  js_OpenJanelaIframe('top.corpo','db_iframe_arretipo',sUrl,'Pesquisa',true);
}
