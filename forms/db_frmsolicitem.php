...
<form name="form1" method="post" action="" onsubmit = " return js_verificaServicoQuantidade(); ">
    <center>
        <table border="0" height="100%">
            ...
            <tr>
                <td nowrap title="<?=@$Tpc16_codmater?>">
                    ...
                    if ($iRegistroPreco != ""  && (isset($pc16_codmater) && trim($pc16_codmater) != "" )) {
                      ...
                      $pc11_vlrun     = $oFornecedor->valorunitario;
                      ...
                      if ($pc30_valoraproximadoautomatico == "t") {
                        if ($pc11_vlrun == "") {
                          $pc11_vlrun = itemSolicitacao::calculaMediaPrecoOrcamentos(
                                        itemSolicitacao::getUltimosOrcamentos($pc16_codmater, array($pc17_unid)));
                        }
                      }
                    }
                ...
                <td colspan="7">
                    ...
                    db_select("pc17_unid", $result_unidade, true, $db_opcaounidade, 
            ...
            if ($lMostraItensPacto) {
              ...
              echo "  </td>";
              echo "  <td>";
                     db_input('o103_pactovalor',8,$Io103_pactovalor,true,'text',
                              $tranca," onchange='js_pesquisao103_pactovalor(false);'");
              echo "  </td>";
              echo "  <td colspan=7>";                              
        ...
        <table border = "0" width="100%" height="50%">
            ...
            <tr>
                <td valign="top" align="center" width="100%">
                    ...
                    $sql_reservasaldo = $clorcreservasol->sql_query_saldo(null, null, "round(o80_valor,2)  as valorreserva,
...
<script>
    ...
    function js_mostrapcmater1(chave1,chave2,codele,lVeic, iRegistro){
      ...
      js_esconteVeic(lVeic);
    	if (iRegistro != null) {
    	 ...
    	 var oInputRegistro = document.createElement('input');
    	 oInputRegistro.setAttribute('id', 'codigoitemregistropreco');
       oInputRegistro.setAttribute('name', 'codigoitemregistropreco');
       oInputRegistro.setAttribute('type','hidden');
       oInputRegistro.setAttribute('value',iRegistro);
       document.form1.appendChild(oInputRegistro);
    	}
    ...
    function js_buscarQuantidadeRestanteItemEstimativa() {
      ...
      /**
       * Numero da solicitacao, busca o bampo da primeira aba, 'solicita' 
       */
      var iNumeroSolicitacao = top.corpo.iframe_solicita.document.getElementById('pc54_solicita').value;

      /**
       * Codigo do material
       */
      var iCodigoMaterial = $('pc16_codmater').value;

      var oParametros                = new Object(); 
      oParametros.exec               = "getQuantidadeRestanteItemEstimativa";
      oParametros.iNumeroSolicitacao = iNumeroSolicitacao;
      oParametros.iCodigoMaterial    = iCodigoMaterial;
