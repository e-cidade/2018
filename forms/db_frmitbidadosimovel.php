...
<center>
 ...
 <? if ( $db_opcao != 1 ) { ?>
   <input name="visualizar" type="button" id="visualizar" value="Vizualizar Guia" onclick="js_visualizar(<?=$it01_guia?>);" <?=($db_botao==false?"disabled":"")?>>
   ...
   <? if (   $lLiberar  && $lLiberaGuia) {
	      echo "<input name=\"liberar\" type=\"button\" id=\"liberar\" value=\"Libera Guia\"".($db_botao==false?"disabled":"")." onClick=\" return js_liberaguia(".@$it01_guia.");\">";
	    }
    } 
   ?>
  </form>
