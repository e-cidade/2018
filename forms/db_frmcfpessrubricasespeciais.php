...
<table border="0">
  ...
  <tr>
    <td>
      <fieldset>
        <legend><strong>13o. Salário</strong></legend>
        <table width="100%">
          <tr>
  ...
  <tr>
    <td>
      <fieldset>
        <legend><strong>Salário maternidade</strong></legend>
        <table width="100%">
          <tr>
  ...
  <tr>
    <td>
      <fieldset>
        <legend><strong>CÁLCULOS SOBRE O LÍQUIDO (BRUTO - OBRIGATÓRIOS)</strong></legend>
        <table width="100%">
          <tr>
