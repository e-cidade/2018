  ...
  <td colspan="3">
   <table border="0" align="left">
     ...
     <td>
      ...
      <?
      $result = $clcurso->sql_record($clcurso->sql_query_cursoescola("","ed29_i_codigo,ed29_c_descr",""," ed71_i_escola = $escola"));
      ?>
      <select name="curso" style="font-size:9px;width:200px;height:18px;" onchange="js_botao(this.value)">
       ...
       for($i=0;$i<$clcurso->numrows;$i++) {
        ...
        $selected = $ed29_i_codigo==$curso?"selected":"";
 ...
 <tr>
  ...
  <td valign="top">
   <table>
    <tr>
     <td valign="top">
      <b>Alunos para cancelar conclusão de curso:</b><br>
