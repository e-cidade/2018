...
<table border="0" cellpadding="0" cellspacing='0'>
  <tr>
    <td align='center'>  
<fieldset><legend align='center'><b>DADOS</b></legend>
<table border="0" cellpadding="0" cellspacing='0'>
  <tr>
...
?>
       <?
//db_input('y60_contato',30,$Iy60_contato,true,'text',3,'')
       ?>
    </td>
  </tr>
  <tr>
...
<?
if(empty($y63_mes)){
  // $y63_mes=date("m",db_getsession('DB_datausu'));
  $y63_mes = $arr_ini[1];
} 
...
//db_input('y63_bruto',10,$Iy63_bruto,true,'text',$db_op,"onchange='js_calcula(this);'")
...
db_input('y63_aliquota',10,$Iy63_aliquota,true,'text',$db_opcao,"onchange='js_calcula(this);'")
?>
...
<tr>
  ...
  <tr>
    <td nowrap title="<?=@$Ty63_bruto?>" colspan='2'>
       <b>Total Bruto</b>
<?
