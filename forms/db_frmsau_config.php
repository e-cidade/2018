...
<form name="form1" method="post" action="">
  <fieldset style="width: 450px; margin-top: 15px;">
    <legend><b>Parâmetros Globais:</b></legend>
    <table>
      <tr>
        <td nowrap  nowrap title="<?=@$Ts103_i_departamentos?>">
      ...
      <tr>
        <td nowrap  nowrap title="<?=@$Ts103_c_emitirfaa?>">
          <?=$Ls103_c_emitirfaa?>
        </td>
        <td nowrap > 
          <?
     ...
     <tr>
       <td nowrap  nowrap title="<?=@$Ts103_c_cancelafa?>">
         <?=$Ls103_c_cancelafa?>
       </td>
       <td nowrap > 
         <?
     ...
     <tr>
       <td nowrap  nowrap title="<?=@$Ts103_i_modalidade?>">
         <?
     ...
     <tr>
       <td nowrap  nowrap title="<?=@$Ts103_c_apareceragenda?>">
     ...
     <tr>
       <td nowrap  nowrap title="<?=@$Ts103_c_idadeproc?>">
         <?=$Ls103_c_idadeproc?>
       </td>
       <td nowrap > 
         <?
     ...
     <tr>
       <td nowrap  nowrap title="<?=@$Ts103_c_servicoproc?>">
         <?=$Ls103_c_servicoproc?>
       </td>
       <td nowrap > 
         <?
     ...
     <tr>
       <td nowrap  nowrap title="<?=@$Ts103_i_revisacgs?>">
         <?=$Ls103_i_revisacgs?>
       </td>
       <td nowrap > 
         <?
     ...
     <tr>
       <td nowrap  nowrap title="<?=@$Ts103_i_datahorafaa?>">
         <?=$Ls103_i_datahorafaa?>
       </td>
       <td nowrap >
         <?              
         $aX = array('1' => 'Atendimento', '2' => 'Emiss&atilde;o');
         db_select('s103_i_datahorafaa', $aX, true, 1);
         ?>
       </td>
     </tr>
     <tr>
       <td nowrap  nowrap title="<?=@$Ts103_i_modelorafaa?>">
         <?=$Ls103_i_modelofaa?>
       </td>
       <td nowrap >
         <?
     ...
     <tr>
       <td nowrap  nowrap title="<?=@$Ts103_i_todacomp?>">
     ...
     <tr>
       <td nowrap  colspan="2" align="center">
         ...
         >
         <!-- onclick="js_lancar();"   Ação retirada do botão, erro com variavel indefinida na funcao:"obj.unidadecentral é indefinida" -->
...
function js_pesquisa() {
  ...
  js_OpenJanelaIframe('top.corpo.iframe_a1','db_iframe_sau_config','func_sau_config.php?funcao_js=parent.js_preenchepesquisa|0','Pesquisa',true);
...
function js_pesquisas103_i_modalidade(mostra){
  ...
  if (mostra == true) {
    js_OpenJanelaIframe('top.corpo.iframe_a1','db_iframe_sau_modalidade','func_sau_modalidade.php?funcao_js=parent.js_mostrasau_modalidade1|sd82_i_codigo|sd82_c_modalidade|sd82_c_nome|sd82_i_anocomp|sd82_i_mescomp','Pesquisa',true);
  }
