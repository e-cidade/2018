...
?>
       <?
db_input('c10_nome',60,$Ic10_nome,true,'text',3,'')
       ?>
    </td>
  </tr>
  <tr>
...
?>
       <?
db_input('nomeinst',60,$Inomeinst,true,'text',3,'')
       ?>
    </td>
  </tr>
...
?>
  ...
  <tr>
    <td nowrap title="<?=@$Tc11_infleiame?>" valign="top">
       <?=@$Lc11_infleiame?>
    </td>
    <td> 
    <?
      db_textarea('c11_infleiame',10,72,$Ic11_infleiame,true,'text',$db_opcao,"")
    ?>
    </td>
  </tr>
