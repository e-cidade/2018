...
<table border="0">
 ...
 <tr>
  ...
  <td>
   ...
   <?db_input('ed57_i_base',40,@$Ied31_c_descrcont,true,'text',3,'')
   ?>
  </td>
 </tr>
</table>
...
<table width="100%">
 <tr>
  ...
  <?
   ...
   $chavepri= array("ed77_i_codigo"=>@$ed77_i_codigo,
...
function js_pesquisaed77_i_basecont(mostra){
 if(mostra==true){
  js_OpenJanelaIframe('','db_iframe_base','func_escolabasecont.php?base='+document.form1.ed77_i_base.value+'&funcao_js=parent.js_mostrabase1|ed31_i_codigo|ed31_c_descr','Pesquisa de Bases Curriculares',true);
 }else{
  if(document.form1.ed77_i_basecont.value != ''){
   js_OpenJanelaIframe('','db_iframe_base','func_escolabasecont.php?base='+document.form1.ed77_i_base.value+'&pesquisa_chave='+document.form1.ed77_i_basecont.value+'&funcao_js=parent.js_mostrabase','Pesquisa',false);
  }else{
