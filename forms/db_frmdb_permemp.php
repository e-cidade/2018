...
<?  
   ...
   $query="id_usuario=$id_usuario&nome=$nome";
?>
  <tr>
...
//  echo $clorcorgao->sql_query(null,null,"o40_orgao as db20_orgao,o40_descr","o40_orgao","o40_anousu=".db_getsession("DB_anousu")." and o40_instit=".db_getsession("DB_instit"));
  $result = $clorcorgao->sql_record($clorcorgao->sql_query(null,null,"distinct o40_orgao as db20_orgao,o40_descr","o40_orgao","o40_anousu=".db_getsession("DB_anousu")));
  ...
  <input name='excluir_todos' type="submit" value="Apagar todos">
...
//      echo $clorcunidade->sql_query(null,null,null,"o41_unidade as db20_unidade,o41_descr","o41_unidade","o41_anousu=".db_getsession("DB_anousu")."  and o41_orgao=$db20_orgao " );
  ...
  $result = $clorcdotacao->sql_record($clorcdotacao->sql_query(null,null,"distinct o52_funcao as db20_funcao,o52_descr","o52_funcao","o58_anousu=".db_getsession("DB_anousu")." $dbwhere"));
  ...
  $result = $clorcdotacao->sql_record($clorcdotacao->sql_query(null,null,"distinct o53_subfuncao as db20_subfuncao,o53_descr","o53_subfuncao","o58_anousu=".db_getsession("DB_anousu")." $dbwhere"));
  ...
  $result = $clorcdotacao->sql_record($clorcdotacao->sql_query(null,null,"distinct o54_programa as db20_programa,o54_descr","o54_programa","o58_anousu=".db_getsession("DB_anousu")." $dbwhere"));
  ...
  $result = $clorcdotacao->sql_record($clorcdotacao->sql_query(null,null,"distinct o55_projativ as db20_projativ,o55_descr","o55_projativ","o58_anousu=".db_getsession("DB_anousu")." $dbwhere"));
  ...
  $result = $clorcdotacao->sql_record($clorcdotacao->sql_query(null,null,"distinct o56_elemento,o56_descr","o56_elemento","o58_anousu=".db_getsession("DB_anousu")." $dbwhere"));
  ...
  $result = $clorcdotacao->sql_record($clorcdotacao->sql_query(null,null,"distinct o15_codigo as db20_codigo,o15_descr","o15_codigo","o58_anousu=".db_getsession("DB_anousu")." $dbwhere"));
...
if(isset($coddepto) && $coddepto!=''){
  ...
  $dbwhere .= "and db20_anousu=".db_getsession("DB_anousu");
    ...
    $cliframe_alterar_excluir->sql     = $cldb_permemp->sql_query_origem(null,"db20_codperm,db20_anousu,db20_orgao,db20_unidade,db20_funcao,db20_subfuncao,db20_programa,db20_projativ,db20_codele,db20_codigo,db20_tipoperm",'db20_orgao',"$dbwhere");
    $cliframe_alterar_excluir->campos  ="db20_anousu,db20_orgao,db20_unidade,db20_funcao,db20_subfuncao,db20_programa,db20_projativ,db20_codele,db20_codigo,db20_tipoperm";
...
<script>
function js_voltar(){
  location.href="con1_db_permemp001.php";
}  
function js_limpa(){
 location.href='con1_db_permemp001.php?<?=$query?>'; 
}
</script>