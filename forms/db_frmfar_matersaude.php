...
db_input('fa29_c_forma',40,@$Ifa29_c_forma,true,'text',3,'')
  ...
  <tr>
    ...
    <td> 
<?
db_input('fa01_i_concentracaomed',10,@$Ifa01_i_concentracaomed,true,'text',$db_opcao," onchange='js_pesquisafa01_i_concentracaomed(false);'")
?>
       <?
...
db_input('fa05_c_descr',40,@$Ifa05_c_descr,true,'text',3,'')
  ...
  <tr>
    ...
    <td>
      ...
      $sSql                       = $oDaoFarMedicamentoHiperdia->sql_query_file(null, 
                                                                                'fa43_i_codigo, fa43_c_descr', 
                                                                                'fa43_i_codigo'
                                                                               );
