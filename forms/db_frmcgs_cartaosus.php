...
<table border="0">
  <tr>
    <td nowrap title="<?=@$Ts115_i_codigo?>">
       <?=@$Ls115_i_codigo?>
    </td>
    <td> 
<?
...
<!--
  ...
  <tr>
    <td nowrap title="<?=@$Ts115_i_entrada?>">
       <?=@$Ls115_i_entrada?>
    </td>
    <td> 
<?
db_input('s115_i_entrada',2,$Is115_i_entrada,true,'text',$db_opcao,"")
?>
    </td>
  </tr>
-->
...
<br>
  ...
  if(isset($s115_i_cgs)&&@$s115_i_cgs!=""){
   $cliframe_alterar_excluir->sql = $clcgs_cartaosus->sql_query(null,'s115_i_codigo,s115_c_cartaosus,s115_c_tipo,s115_i_entrada,z01_v_nome',null,"s115_i_cgs=$s115_i_cgs");
  }
...
function js_pesquisas115_i_cgs(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('top.corpo','db_iframe_cgs','func_cgs_und.php?funcao_js=parent.js_mostracgs1|z01_i_cgsund|z01_v_nome','Pesquisa',true);
  }else{
     if(document.form1.s115_i_cgs.value != ''){ 
        js_OpenJanelaIframe('top.corpo','db_iframe_cgs','func_cgs_und.php?pesquisa_chave='+document.form1.s115_i_cgs.value+'&funcao_js=parent.js_mostracgs','Pesquisa',false);
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('top.corpo','db_iframe_cgs_cartaosus','func_cgs_cartaosus.php?funcao_js=parent.js_preenchepesquisa|s115_i_codigo','Pesquisa',true);
}
