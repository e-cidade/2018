        ...
        <table border="0" width="100%">
          ...
          <tr>
            ...
            <?php
              ...
              /**
               * Se for controlado com período comercial, retiramos a opcao de Divisao Mensal de Valores (dias)
               */
          ...
          <tr>
            <td nowrap="nowrap" colspan="4">
              <div id='info-tipo-controle' style="background-color: #FFF;">
                <b style='padding-left:10px;'>Divisão Mensal das Quantidades</b></br>
                <span style='padding-left:25px;'>
      	          Divide as quantidades automaticamente entre nos períodos informados.
                </span>
              </div>
            </td>
          </tr>
...
function js_openPrevisao(iCodigo) {
  ...
  oPrevisao              = new DBViewAcordoPrevisao(iCodigo, 'oPrevisao',
                                                    'Previsão de Execução do Contrato', 
                                                    true, true);
...
function js_montaWindowItensOrigens(){
  ...
  var sAjuda  = 'Para replicar as informações, selecione uma Forma de Controle e/ou preencha uma das previsões, ';
      sAjuda += 'selecionando as linhas que devem receber os dados preenchidos. Clique no botão Replicar.';
  ...
  /**
   * Chamada para montar as formas de controle do comboBox de replicação
   */
...
function js_preencheItensOrigem(oRetorno) {
  ...
  //var sMsgHelp  = "Escolha os Itens que farão parte do contrato ";
    var  sMsgHelp = "<div id='info-tipo-controle2' style='background-color: #FFF; height:100px;'>";
         sMsgHelp += "<b>Divisão Mensal das Quantidades Comercial</b></br>";
         sMsgHelp += "<span style='padding-left:10px;'>";
         sMsgHelp += "Divide as quantidades automaticamente entre nos períodos informados.</span>";
         sMsgHelp += "</div>";
  ...
  /*  
    ...
    ///oGridItensOrigem.aRows[iTotalLinhas].sEvents="onDblClick='js_fracionarItensOrigem("+iTotalLinhas+");'";
      ...
      oRow.fracionamentos.each(function(oRowFraciona, idLinha) {
        ...
        aLinha[7]  = oRowFraciona.servico=='t'?'Serviço':'Material';
      ...
      if (oRow.fracionamentos.length > 0) {
        ...
        if (nValorTotalFracionado != nValorTotalItem) {
          ...
          oMessageBoard.setHelp('O item <span style="color:red">'+oRow.material.urlDecode()+'</span> está Fracionado incorretamente.');
        }
      }
    }*/
  });
...
function js_verificaTipoControle(iTipoControle, lLicitacaoProcesso) {
  ...
  switch (iTipoControle) {
    ...
    case '1' : 
      sTipoCalculo  = "<b>Divisão Mensal das Quantidades Comercial</b></br>";
...
function js_windowItensEmpenho() {
  ...
  oWindowAuxEmpenho.setShutDownFunction(function() {
    ...
    var sTituloMsgBoard     = "";
 // var sHelpMsgBoard       = "Preencha um período de execução para todos os itens do(s) empenho(s) selecionado(s),";
 //   	sHelpMsgBoard      +=	"sem vínculo com contrato";

  var sHelpMsgBoard = "<div id='info-tipo-controle2' style='background-color: #FFF; height:100px;'>";
  sHelpMsgBoard += "<b>Divisão Mensal das Quantidades Comercial</b></br>";
  sHelpMsgBoard += "<span style='padding-left:10px;'>";
  sHelpMsgBoard += "Divide as quantidades automaticamente entre nos períodos informados.</span>";
  sHelpMsgBoard += "</div>";
...
function js_preencheGridItensEmpenhos(oAjax) {
  ...
  if (oRetorno.aItensEmpenhos == null) {
    ...
    oRetorno.aItensEmpenhos.each(function (oItem, iLinha) {
      ...
      oFormasdeControle.addItem(1,"Divisão Mensal das Quantidades");
      oFormasdeControle.addItem(2,"Divisão Mensal dos Valores (dias)");
      oFormasdeControle.addItem(3,"Divisão Mensal dos Valores (mês)");
