...
<table border="0">
  <tr>
    <td nowrap title="<?=@$Tw10_valor?>">
    <input name="oid" type="hidden" value="<?=@$oid?>">
       <?=@$Lw10_valor?>
    </td>
    <td> 
<?
db_input('w10_valor',15,$Iw10_valor,true,'text',$db_opcao,"")
?>
    </td>
  </tr>
  <tr>
    <td nowrap title="<?=@$Tw10_receit?>">
       <?
    ...
    <td> 
<?
db_input('w10_receit',4,$Iw10_receit,true,'text',$db_opcao," onchange='js_pesquisaw10_receit(false);'")
?>
       <?
db_input('k02_descr',15,$Ik02_descr,true,'text',3,'')
  ...
  <tr>
    ...
    <td> 
<?
db_input('w10_hist',4,$Iw10_hist,true,'text',$db_opcao," onchange='js_pesquisaw10_hist(false);'")
?>
       <?
...
db_input('k00_descr',40,$Ik00_descr,true,'text',3,'')
  ...
  <tr>
    <td nowrap title="<?=@$Tw10_dia?>">
       <?=@$Lw10_dia?>
    </td>
    <td> 
<?
db_input('w10_dia',2,$Iw10_dia,true,'text',$db_opcao,"")
?>
    </td>
  </tr>
  </table>
