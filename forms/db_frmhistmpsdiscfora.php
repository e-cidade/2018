...
<form name="form1">
  ...
  <table border="0" width="100%">
    ...
    <td>
     ...
     <input type="button" id="btnLancarDisciplina" name="btnLancarDisciplina" value="Lançar Disciplina"
...
function js_alunoAprovado(oSel) {
  ...
  if (oSel.value != 'A') {
    ...
    alert('O resultado final da etapa é aprovado, somente é possível alterar se o resultado final for reprovado.');
