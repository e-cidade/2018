...
db_input('y50_nome',40,$Iy50_nome,true,'text',3,'');
  ...
  <tr>
    ...
    <td> 
<?
db_input('y56_id_usuario',10,$Iy56_id_usuario,true,'text',$db_opcao," onchange='js_pesquisay56_id_usuario(false);'");
if($db_opcao == 2){
  db_input('y56_id_usuario',10,$Iy56_id_usuario,true,'hidden',$db_opcao,"","y56_id_usuario_old");
...
function js_pesquisay56_id_usuario(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('','db_iframe_db_usuarios','func_cadfiscaisdepto.php?funcao_js=parent.js_mostradb_usuarios1|id_usuario|nome','Pesquisa',true);
  }else{
    js_OpenJanelaIframe('','db_iframe_db_usuarios','func_cadfiscaisdepto.php?pesquisa_chave='+document.form1.y56_id_usuario.value+'&funcao_js=parent.js_mostradb_usuarios','Pesquisa',false);
  }
}
...
function js_pesquisa(){
  js_OpenJanelaIframe('','db_iframe_autousu','func_autousu.php?funcao_js=parent.js_preenchepesquisa|y56_codauto|1','Pesquisa',true);
}
function js_preenchepesquisa(chave,chave1){
  db_iframe_autousu.hide();
}
</script>
<?
