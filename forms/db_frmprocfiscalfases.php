...
function js_pesquisay108_procfiscal(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('top.corpo.iframe_procfiscalfases','db_iframe_procfiscal','func_procfiscal_tiaf.php?funcao_js=parent.js_mostraprocfiscal1|y100_sequencial|z01_nome','Pesquisa',true);
  }else{
     if(document.form1.y108_procfiscal.value != ''){ 
        js_OpenJanelaIframe('top.corpo.iframe_procfiscalfases','db_iframe_procfiscal','func_procfiscal_tiaf.php?pesquisa_chave='+document.form1.y108_procfiscal.value+'&funcao_js=parent.js_mostraprocfiscal','Pesquisa',false,'0','1','775','390');
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('top.corpo.iframe_procfiscalfases','db_iframe_procfiscalfases','func_procfiscalfasesTiaf.php?funcao_js=parent.js_preenchepesquisa|y108_sequencial','Pesquisa',true,'0','1','775','390');
}
