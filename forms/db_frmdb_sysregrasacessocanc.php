  ...
  if(mostra==true){
    js_OpenJanelaIframe('top.corpo','db_iframe_db_sysregrasacesso','func_db_sysregrasacesso.php?funcao_js=parent.js_mostradb_sysregrasacesso1|db46_idacesso|db46_observ','Pesquisa',true);
     ...
     if(document.form1.db49_idacesso.value != ''){ 
        js_OpenJanelaIframe('top.corpo','db_iframe_db_sysregrasacesso','func_db_sysregrasacesso.php?pesquisa_chave='+document.form1.db49_idacesso.value+'&funcao_js=parent.js_mostradb_sysregrasacesso','Pesquisa',false);
     }else{
  ...
  if(mostra==true){
    js_OpenJanelaIframe('top.corpo','db_iframe_db_usuarios','func_db_usuarios.php?funcao_js=parent.js_mostradb_usuarios1|id_usuario|nome','Pesquisa',true);
     ...
     if(document.form1.db49_id_usuario.value != ''){ 
        js_OpenJanelaIframe('top.corpo','db_iframe_db_usuarios','func_db_usuarios.php?pesquisa_chave='+document.form1.db49_id_usuario.value+'&funcao_js=parent.js_mostradb_usuarios','Pesquisa',false);
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('top.corpo','db_iframe_db_sysregrasacessocanc','func_db_sysregrasacessocanc.php?funcao_js=parent.js_preenchepesquisa|db49_idacesso','Pesquisa',true);
}
