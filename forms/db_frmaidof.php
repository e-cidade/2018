...
function js_pesquisay08_nota(mostra){ 
  if(mostra==true){
    js_OpenJanelaIframe('top.corpo','db_iframe_notasiss','func_notasiss.php?funcao_js=parent.js_mostranotasiss1|0|q09_descr','Pesquisa',true);
  }else{
...
function js_pesquisay08_login(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('top.corpo','db_iframe_db_usuarios','func_db_usuarios.php?funcao_js=parent.js_mostradb_usuarios1|0|1','Pesquisa',true);
  }else{
...
function js_pesquisay08_numcgm(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('top.corpo','db_iframe','func_graficas.php?funcao_js=parent.js_mostragraficas1|0|1&aidof=1','Pesquisa',true);
  }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('top.corpo','db_iframe_aidof','func_aidofalt.php?funcao_js=parent.js_preenchepesquisa|0','Pesquisa',true);
}
