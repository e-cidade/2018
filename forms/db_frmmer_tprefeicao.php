	       ...
	       <fieldset><legend><b>Ordenar</b></legend>
	        <table border="0">
	         <tr>
	           ...
	           <td>
	            <img style="cursor:hand"  onclick="js_cima()" src="imagens/seta_up.gif" width="20" height="20">
	          </td>
	         </tr>
	         <tr>
	          <td>
	         ...
	         <tr>
	          <td> 
	            <img style="cursor:hand" onclick="js_baixo()" src="imagens/seta_down.gif" width="20" height="20"> 
	          </td>
	         </tr>
	        </table>
	       </fieldset>
