...
db_input('descr_uni',40,'',true,'text',3)
  ...
  <tr>
    ...
    <td> 
      <?
      $m60_quantent=1;
      db_input('m60_quantent',15,$Im60_quantent,true,'text',3,"");
      ?>
    </td>
  </tr>
    </tr>
...
function js_pesquisaGrupo(mostra) {
  ...
  if (mostra == true) {
    js_OpenJanelaIframe('','db_iframe_grupo','func_materialestoquegrupo.php?iTipoConta=2&funcao_js=parent.js_mostraGrupo1|m65_sequencial|db121_descricao','Pesquisa',true);
  } else {
