     ...
     <table border="0">
       <tr>
         <td nowrap title="<?=@$sepultamento?>">
           <?db_ancora("<b>Sepultamento</b>","js_pesquisasepultamento();",$db_opcao);?>
         </td>
         <td>
          <?
...
//          die($clossoario->sql_query("","ossoario.*,cgm.z01_nome as nome_sepultamento","","cm06_i_sepultamento = $sepultamento"));
            ...
            if($clossoario->numrows > 0){
               ...
               if( $clrestosgavetas->numrows > 0){
                   ...
                   if( $clgavetas->numrows>0){
                       ...
                       //$result = $clretiradas->sql_record($clretiradas->sql_query("","retiradas.*, cgm.z01_nome ,cgm1.z01_nome as sep_nome","","cm08_i_sepultamento = $sepultamento"));
