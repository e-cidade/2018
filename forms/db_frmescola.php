         ...
         <table id="privada" colspan="top" border="0" style="visibility:<?=$visible3?>">
          <tr>
           ...
           <td nowrap valign="top">
            ...
            <input type="radio" name="ed18_i_categprivada" value="2" onclick='js_categoria(this.value);' <?=@$ed18_i_categprivada=="2"?"checked":""?>> Comunitária<br />
            ...
            <input type="radio" name="ed18_i_categprivada" value="4" onclick='js_categoria(this.value);' <?=@$ed18_i_categprivada=="4"?"checked":""?>> Filantrópica<br />
            <?
           ...
           <td nowrap valign="top">
             ...
             <legend><?=@$Led18_c_mantprivada?></legend>
              <input <?=substr(@$ed18_c_mantprivada,0,1)=="1"?"checked":""?> id="ed18_c_mantprivada" name="ed18_c_mantprivada[]" type="checkbox" value="1"> Empresas / Grupos Empresariais ou Pessoa Física<br>
              <input <?=substr(@$ed18_c_mantprivada,1,1)=="1"?"checked":""?> id="ed18_c_mantprivada" name="ed18_c_mantprivada[]" type="checkbox" value="2"> Sindicatos / Associações / Cooperativas<br>
              ...
              <input <?=substr(@$ed18_c_mantprivada,3,1)=="1"?"checked":""?> id="ed18_c_mantprivada" name="ed18_c_mantprivada[]" type="checkbox" value="4"> Instituições sem fins lucrativos<br>
    ...
    <tr>
     <td valign="top">
      <fieldset><legend><?=@$Led18_i_locdiferenciada?></legend>
       <input type="radio" name="ed18_i_locdiferenciada" value="1" <?=(@$ed18_i_locdiferenciada=="1"?"checked":"")?>>Área de assentamento<br/>
			 <input type="radio" name="ed18_i_locdiferenciada" value="2" <?=(@$ed18_i_locdiferenciada=="2"?"checked":"")?>>Terra indígena<br/>
			 <input type="radio" name="ed18_i_locdiferenciada" value="3" <?=(@$ed18_i_locdiferenciada=="3"?"checked":"")?>>Área remanescente de quilombos<br/>
		 	 <input type="radio" name="ed18_i_locdiferenciada" value="4" <?=(@$ed18_i_locdiferenciada=="4"?"checked":"")?>>Unidade de uso sustentável<br/>
			 <input type="radio" name="ed18_i_locdiferenciada" value="5" <?=(@$ed18_i_locdiferenciada=="5"?"checked":"")?>>Unidade de uso sustentável em Terra indígena<br/>
			 <input type="radio" name="ed18_i_locdiferenciada" value="6" <?=(@$ed18_i_locdiferenciada=="6"?"checked":"")?>>Unidade de uso sustentável em Área remanescente de quilombos<br/>
			 <input type="radio" name="ed18_i_locdiferenciada" value="7" <?=(@$ed18_i_locdiferenciada=="7"?"checked":"")?>>Não se aplica
      </fieldset>
     </td>
    ...
    <tr>
     <td colspan="2">
      <fieldset><legend><?=@$Led18_i_educindigena?></legend>
       ...
       <input type="radio" name="ed18_i_educindigena" value="0" <?=(@$ed18_i_educindigena=="0"?"checked":"")?> onclick="js_educingidena(this.value);"> NÃO
       <?
       ...
       ?>
       <fieldset id="linguaministrada" style="visibility:<?=$visibility1?>"><legend><b>Língua Ministrada</b></legend>
...
function js_pesquisaed18_i_linguaindigena(mostra){
 if(mostra==true){
  js_OpenJanelaIframe('','db_iframe_lingua','func_censolinguaindig.php?funcao_js=parent.js_mostralingua1|ed264_i_codigo|ed264_c_nome','Pesquisa Lingua Indígena',true);
 }
}
