...
<form class="container" name="form1" method="post" action="">
    <fieldset>
     ...
     <table class="form-container">
       <tr>
         <td nowrap title="<?=@$Tar11_sequencial?>" width="124px;">
          <?=@$Lar11_sequencial?>
        </td>
        <td> 
          <?
     ...
     <table id="formCobranca" class="form-container">
       <tr>
         <td nowrap title="<?=@$Tar13_bancoagencia?>"  width="124px">
           <?
            db_ancora("<b>Agencia</b>","js_pesquisaBancoAgenciaCobranc(true)",$db_opcao);
           ?>
         </td>
         <td> 
          <?
       ...
       <tr>
         ...
         <td id="carteiraSigcb" style="display:none"> 
           <?
             ...
             db_select('ar13_carteira_selsigcb',$aCarteiraSigcb,true,$db_opcao,"");
           ?>
         </td>                
      </tr>
      <tr>
...
function js_valida() {
  ...
  if ( iTipo == 7) {
    ...
    var iGrupoTaxa = $F('ar37_sequencial');
    if (iGrupoTaxa == null || iGrupoTaxa == '') {
      alert('Selecione um Grupo');
      $('ar37_sequencial').focus();
      return false;
    }
  ...
  if ( iTipo == 1 || iTipo == 2 || iTipo == 5  || iTipo == 6 || iTipo == 7) {
     ...
     if ( iTipo == 5 ) {
      ...
      if ( iTipo == 6 ) {
       ...
       if ( iTipo != 7) {
         document.form1.ar13_cedente.value     = new String(document.form1.ar13_cedente.value).substr(0,6);
       }
...
$("ar13_cedente")     .addClassName("field-size2");
