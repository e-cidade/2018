...
<table border="0" width="100%">
 ...
 <tr>
  ...
  <td>
   <?
   $x = array('P'=>'PERÍODOS','D'=>'DIAS LETIVOS');
...
function js_pesquisaed31_i_regimemat(mostra){
 if(document.form1.ed31_i_curso.value==""){
  ...
  if(mostra==true){
   js_OpenJanelaIframe('','db_iframe_regimemat','func_serieregimemat.php?codensino='+document.form1.ed29_i_ensino.value+'&funcao_js=parent.js_mostraregimemat1|ed218_i_codigo|ed218_c_nome|ed218_c_divisao','Pesquisa de Regimes de Matrícula',true);
  }else{
...
function js_replicar(codbase){
  js_OpenJanelaIframe('','db_iframe_replicacao','edu1_replicabase001.php?codbase='+codbase,'Replicação de Base Curricular',true);
}
</script>