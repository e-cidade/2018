...
$clclassiliteraria->rotulo->label();
$db_botao1 = false;
...
<table border="0">
 <tr>
  <td nowrap title="<?=@$Tbi03_codigo?>">
   <?=@$Lbi03_codigo?>
  </td>
  <td>
   <?db_input('bi03_codigo',10,$Ibi03_codigo,true,'text',3,"")?>
  </td>
 </tr>
 <tr>
  <td nowrap title="<?=@$Tbi03_classificacao?>">
   <?=@$Lbi03_classificacao?>
  </td>
  <td>
   <?db_input('bi03_classificacao',50,$Ibi03_classificacao,true,'text',$db_opcao,"")?>
  </td>
 </tr>
</table>
