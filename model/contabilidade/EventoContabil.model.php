...
class EventoContabil {
   ...
   * @var integer
	...
	/**
	 * O construtor buscará a transação informada na assinatura e todos os lançamentos desta transação
	...
	/**
	 * Executa o Lancamento contábil do documento
	 * @param ILancamentoAuxiliar $oLancamentoAuxiliar
	 */
	public function executaLancamento(ILancamentoAuxiliar $oLancamentoAuxiliar, $sDataLancamento = null) {
	  ...
	  //return true; modificado para retornar o codigo do lançamento
	...
	/**
	 * metodo que retornará a instancia pelo codigo da transação
	 * @param integer $iCodigo transação
	 */
