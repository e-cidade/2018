...
interface ISistemaConta {
  /**
   * Método responsável pelo comportamento do sistema de conta
  ...
  /**
  * Método responsável pela exclusão do sistema de conta
  ...
  */
  ...
  /**
   * 
   * Retorna o código do tipo do sistema de conta
   */
