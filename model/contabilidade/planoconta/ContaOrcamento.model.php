  ...
  */
  ...
  public function excluirReduzido() {
    ...
    for ($iAno = $iAnoUsu; $iAno <= $iMaximoAno; $iAno++) {
      ...
      /**
       * Verifica se a conta possui lançamento contábeis
      ...
      if ($this->hasSaldo($this->getReduzido(), $iAno)) {
        throw new Exception("Não pode-se excluir esta conta porque ela possui saldo inicial lançado ! ");
      }
      ...
      if ($this->getSistemaConta()->excluirDadosIntegrados($this)) {
        throw new Exception("Conta não pode ser excluida. Conta com movimentacao!");
      }
