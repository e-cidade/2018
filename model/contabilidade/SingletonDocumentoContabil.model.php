...
/**
 * Implementaзгo de Singleton com Register
 * Garante uma ъnica instancia para cada tipo de Documento Contбbil
 * @author Andrio Costa
...
class SingletonRegraDocumentoContabil {
  ...
  /**
   * Hack para nгo deixar ter uma segunda instancia de OperacaoContabil
   */
