...
class TransferenciaBens {
  ...
  /**
   * situaчуo do bem a ser transferido
   * @var integer
   */
  protected $iSituacao;
  ...
  /**
   * metodo que realizarс o recebimento de uma
  ...
  public function receberTransferencia(){
    ...
    if ( !db_utils::inTransaction() ) {
      throw new DBException("[ 1 - receberTransferencia ] - Nenhuma transaчуo encontrada!");
    }
  ...
  public function transferenciaAutomatica(){
    ...
    /**
     *  primeiro verificamos se o departamento atual do bem щ igual ao de destino
     *  se for o mesmo, щ desnecessario a transferencia
     */
    if ($iDepartamentoAtual != $this->getDepartamentoDestino()) {

      if ( !db_utils::inTransaction() ) {
        throw new DBException("[ 1 - transferenciaAutomatica ] - Nenhuma transaчуo encontrada!");
      }
