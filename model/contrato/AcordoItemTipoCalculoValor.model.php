...
/**
 * Model para efetuar o tipo de cбlculo por valor
 * @author  matheus.felini@dbseller.com.br
 * @package contrato
 * @version $Revision: 1.4 $
 */
class AcordoItemTipoCalculoValor implements IAcordoItemTipoCalculo {
  ...
  /**
   * Coleзгo de perнodos de um item
   * @var array
   */
   ...
   * @param $oParametro stdClass - Nгo utilizado
   * @param $iAcordo    integer  - Nгo utilizado
   */
