...
//   die($this->sqlFolhaPagamento($this->iInstit,$this->sDataIni,$this->sDataFim,$this->iDiaPagamento));
  ...
  function sqlFolhaPagamento($iInstit, $sDataini, $sDatafim, $iDiaPagamento) {
    ...
    $sSqlFolhaPagamento .= "        null                     as codigobancodepositofolhapagentidad, ";
    $sSqlFolhaPagamento .= "        null                     as codigoagencdepositofolhapagentidad, ";
    $sSqlFolhaPagamento .= "        null                     as codcontacorrbancodepfolhapagent, ";
