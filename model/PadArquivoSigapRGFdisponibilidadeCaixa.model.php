...
/**
 * Prove dados para a geração do arquivo dos dados da RGF disponibilidade caixa no periodo 
 * do municipio para o SIGAP
 * @package Pad
 * @author  Luiz Marcelo Schmitt
 * @version $Revision: 1.2 $
 */
final class PadArquivoSigapRGFdisponibilidadeCaixa extends PadArquivoSigap {
  ...
  public function __construct() {
    ...
    $this->sNomeArquivo = "RGFDisponibilidadeCaixa";
    $this->aDados       = array();
  }
  ...
  public function getNomeElementos() {
    ...
    $aElementos = array(
                         ...
                         "dcxMesAnoMovimento",
                         "dcxSinal",
                         "dcxDisponibilidadeCaixaBruta",
                         "dcxObrigacoesFinanceiras",
                         "dcxContaLRF",
                         "dcxDescricaoContaLRF",
                         "dcxConta",
                         "dcxRecursoVinculado"
                       );
    return $aElementos;  
