 ...
 */
  ...
  static function findCep($sCep, $sNomeBairro = null) {
    ...
    if (!empty($sCep)) {
      ...
      if ($rsQueryCep !== false) {
        ...
        $aRetorno = db_utils::getColectionByRecord($rsQueryCep,false,false,true);
  ...
  static function findPaisByName($sName, $sAlias=false) {
    ...
    if (!empty($sName)) {
      ...
      if ($rsQueryPais !== false) {
        ...
        $aRetorno  = db_utils::getColectionByRecord($rsQueryPais, false, false, true);
  ...
  static function getPaises() {
    ...
    $aRetorno = db_utils::getColectionByRecord($rsPais, false, false, true);
  ...
  static function findEstadoByCodigoPais($iCodigoPais) {
    ...
    if (!empty($iCodigoPais)) {
      ...
      if ($rsQueryEstado !== false) {
        ...
        $aRetorno  = db_utils::getColectionByRecord($rsQueryEstado, false, false, true);
  ...
  static function findRuasTipo() {
    ...
    if ($rsQueryRuasTipo !== false) {
      ...
      $aRetorno  = db_utils::getColectionByRecord($rsQueryRuasTipo, false, false, true);
  ...
  static function findMunicipioByEstado($iCodigoEstado) {
    ...
    if (!empty($iCodigoEstado)) {
      ...
      $aRetorno = db_utils::getColectionByRecord($rsMunicipio, false, false, true);
    }
  ...
  static function findMunicipioByName($sName, $iCodigoEstado, $sAlias=false) {
    ...
    if (!empty($sName) && !empty($iCodigoEstado)) {
      ...
      if ($rsQueryMunicipio !== false) {
        ...
        $aRetorno  = db_utils::getColectionByRecord($rsQueryMunicipio, false, false, true);
  ...
  static function findComplementoBairro($iCodigoBairro) {
    ...
    if (!empty($iCodigoBairro)) {
      ...
      if ($rsQueryBairro !== false) {
        ...
        $aRetorno  = db_utils::getColectionByRecord($rsQueryBairro, false, false, true);
      }
    }
  ...
  static function findRuaByCodigo($iCodigoRua, $iCodigoMunicipio) {
    ...
    if (!empty($iCodigoMunicipio) && !empty($iCodigoRua)) {
      ...
      if ($rsQueryRua !== false) {
        ...
        $aRetorno  = db_utils::getColectionByRecord($rsQueryRua, false, false, true);
  ...
  static function findNumeroByNumero($iCodigoNumero, $iCodigoBairro, $iCodigoRua ) {
    ...
    if (!empty($iCodigoNumero) && trim($iCodigoBairro) != '' && !empty($iCodigoRua)) {
      ...
      if ($rsQueryLocal !== false) {
        ...
        $aRetorno  = db_utils::getColectionByRecord($rsQueryLocal, false, false, true);
  ...
  static function findPaisDbConfig($iCodigoInstit) {
    ...
    if (!empty($iCodigoInstit)) {
      ...
      if ($rsQueryConfig !== false) {
        $aRetorno  = db_utils::getColectionByRecord($rsQueryConfig, false, false, true);
      }
    }
  ...
  static function findParametrosEndereco($lEncode=true) {
    ...
    if ($rsQueryParametros !== false) {
      ...
      $aRetorno  = db_utils::getColectionByRecord($rsQueryParametros, false, false, $lEncode);
  ...
  static function findCgmEnderecoByCgm($iNumCgm) {
    ...
    if( $rsQueryCgmEndereco !== false) {
      $aRetorno = db_utils::getColectionByRecord($rsQueryCgmEndereco, false, false, true);
    }
...
///      echo($oDaoEndereco->sql_query_completo(null,$sCampos,null,$sWhere));
      ...
      if( $rsQueryEndereco !== false) {
        $aRetorno = db_utils::getColectionByRecord($rsQueryEndereco, false, false, $lEncode);
      }
    }
    return $aRetorno;
  }
  ...
  static function buscaEnderecoCidadao($iOv02_sequencial, $iOv02_seq, $lEncode=true) {
    ...
    if (trim($iOv02_sequencial) != "" && trim($iOv02_seq) != "") {
      ...
      if( $rsQueryEnderecoCidadao !== false) {
        $aRetorno = db_utils::getColectionByRecord($rsQueryEnderecoCidadao, false, false, $lEncode);
      }
    }
    return $aRetorno;
  }  
  ...
  static function buscaBairroRuaMunicipio($iCodigoBairroMunicipio, $iCodigoRuaMunicipio, $lEncode=true) {
    ...
    if (trim($iCodigoBairroMunicipio) != "") {
      ...
      if( $rsQueryRuaBairro !== false) {
        $aRetorno = db_utils::getColectionByRecord($rsQueryRuaBairro, false, false, $lEncode);
      }
    }
    return $aRetorno;
  }
