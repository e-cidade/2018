...
/**
 * Prove dados para a geração do arquivo dados da RREO receita operação crédito despesa capital MDE no periodo 
 * do municipio para o SIGAP
 * @package Pad
 * @author  Luiz Marcelo Schmitt
 * @version $Revision: 1.2 $
 */
final class PadArquivoSigapRRreceitaOpeCreDespesaCapital extends PadArquivoSigap {
  ...
  public function __construct() {
    ...
    $this->sNomeArquivo = "RRReceitaOpeCreDespesaCapital";
    $this->aDados       = array();
  }
