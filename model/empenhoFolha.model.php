...
class empenhoFolha {
  ...
  function estornarEmpenho() {
    ...
    if ($this->temempenho) {
      ...
      $aItensEmpenho       = db_utils::getColectionByRecord($rsItensEmpenho);
  ...
  function getInfoEmpenho () {
    ...
    $aDadosEmpenhos       = db_utils::getColectionByRecord($rsDadosEmpenho, false, false, true);
    ...
    for ($iEmpenho = 0; $iEmpenho < $iTotalEmpenhos; $iEmpenho++) {
      ...
      $aRubricas      = db_utils::getColectionByRecord($rsRubricas, false, false, true);
  ...
  function alterarDados($iOrgao, $iUnidade, $iProjAtiv, $iElemento, $iRecurso, $iDotacao, $iCaract, $iSeqPes = '', $iPrograma = '', $iFuncao = '', $iSubFuncao = '', $iTabPrev = '' ) {
    ...
    if ($oDaoRhEmpenhoFolha->numrows  == 1) {
      ...
      $aRubricas         = db_utils::getColectionByRecord($rsEmpenhoRubricas);
