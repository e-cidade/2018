...
/**
 * Prove dados para a geração do arquivo dados da RREO projeção atual RPPS no periodo
 * do municipio para o SIGAP
 * @package Pad
 * @author  Luiz Marcelo Schmitt
 * @version $Revision: 1.2 $
 */
final class PadArquivoSigapRRprojecaoAtuarialRPPS extends PadArquivoSigap {
  ...
  public function __construct() {
    ...
    $this->sNomeArquivo = "RRProjecaoAtuarialRPPS";
    $this->aDados       = array();
  }
  ...
  public function getNomeElementos() {
    ...
    $aElementos = array(
                         ...
                         "parMesAnoMovimento",
                         "parExercicio",
                         "parReceitaPrevidenciaria",
                         "parConta",
                         "parDespesaPrevidenciaria"
                       );
    return $aElementos;  
  }
