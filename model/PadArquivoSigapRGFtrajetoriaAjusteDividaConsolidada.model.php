...
/**
 * Prove dados para a geração do arquivo dados da RGF trajetória do ajuste da dívida consolidada no periodo
 * do municipio para o SIGAP
 * @package Pad
 * @author  Luiz Marcelo Schmitt
 * @version $Revision: 1.2 $
 */
final class PadArquivoSigapRGFtrajetoriaAjusteDividaConsolidada extends PadArquivoSigap {
