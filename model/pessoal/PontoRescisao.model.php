...
/**
 * Definições sobrte ponto rescisao do Servidors
 * 
 * @uses    Ponto
 * @package Pessoal 
 * @author  Renan <renan@dbseller.com.br> 
 */
class PontoRescisao extends Ponto {

  /**
   * Nome da tabela para ponto rescisao 
   */
  const TABELA = Ponto::RESCISAO;

  /**
   * Sigla da tabela do ponto rescisao 
   */
  const SIGLA_TABELA = 'r19';
