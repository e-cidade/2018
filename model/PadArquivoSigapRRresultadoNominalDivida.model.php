...
/**
 * Prove dados para a geração do arquivo dados da RREO resultado nominal divída no periodo
 * do municipio para o SIGAP
 * @package Pad
 * @author  Luiz Marcelo Schmitt
 * @version $Revision: 1.2 $
 */
final class PadArquivoSigapRRresultadoNominalDivida extends PadArquivoSigap {
  ...
  public function __construct() {
    ...
    $this->sNomeArquivo = "RRResultadoNominalDivida";
    $this->aDados       = array();
  }
  ...
  public function getNomeElementos() {
    ...
    $aElementos = array(
                         ...
                         "rndMesAnoMovimento",
                         "rndSinal",
                         "rndSaldoExercicioAnterior",
                         "rndSaldoAteBimestre",
                         "rndSaldoBimestreAnterior",
                         "rndSaldoBimestre",
                         "rndValorUnico",
                         "rndContaLRF",
                         "rndDescricaoContaLRF"
                       );
    return $aElementos;  
  }
