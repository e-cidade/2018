...
/**
 * Prove dados para a geração do arquivo dados da RGF garantia contra garantia no periodo
 * do municipio para o SIGAP
 * @package Pad
 * @author  Luiz Marcelo Schmitt
 * @version $Revision: 1.2 $
 */
final class PadArquivoSigapRGFgarantiaContraGarantia extends PadArquivoSigap {
  ...
  public function __construct() {
    ...
    $this->sNomeArquivo = "RGFGarantiaContraGarantia";
    $this->aDados       = array();
  }
  ...
  public function getNomeElementos() {
    ...
    $aElementos = array(
                         ...
                         "gacMesAnoMovimento",
                         "gacSinal",
                         "gacSaldoExercicioAnterior",
                         "gacSaldoAte1oQuad",
                         "gacSaldoAte2oQuad",
                         "gacContaLRF",
                         "gacDescricaoContaLRF",
                         "gacConta"
                       );
    return $aElementos;  
  }
