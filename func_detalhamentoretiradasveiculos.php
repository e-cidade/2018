...
$sCampos            = "distinct ve60_codigo,ve60_datasaida,ve60_horasaida,ve60_destino,z01_nome,ve60_medidasaida";
...
<script type="text/javascript">
  function carregaDetalheRetirada(iCodRetirada) {
    ...
    js_OpenJanelaIframe('parent','func_veiculo_detalhes', sUrl,'Detalhes Retirada',true, '0', 0, iWidht, iHeight);
  }
</script>
</head>
  <body>
