...
$head3 = "SALARIO BASE DOS PROFESSORES";
...
$sql = "select rh01_regist as matricula,
               z01_nome as nome,
               to_char(rh01_admiss,'dd/mm/yyyy') as rh01_admiss,
               rh30_descr as Regime ,
               rh37_descr as Funç,
               rh03_padrao as padrã
               substr(db_fxxx(rh02_regist, rh02_anousu, rh02_mesusu,".db_getsession("DB_instit")."),111,11) as db_fxxx
       from rhpessoal
            ...
            inner join rhfuncao      on rh01_funcao = rhfuncao.rh37_funcao
			                              and rh02_instit = rhfuncao.rh37_instit
            inner join rhpespadrao   on rh03_seqpes = rh02_seqpes
            left join rhpesrescisao on rh02_seqpes = rh05_seqpes
            where rh05_recis is null
            and (rh37_funcao  between 0440 and 0446)
            order by ".$orderby;
;
...
for($x=0; $x<$qtd_linhas_sql; $x++){
  ...
  if ($pdf->gety() > $pdf->h - 30 || $imprime_cabecalho == true){
     ...
     $pdf->cell(25,$alt,'DATA DE ADMISSÃO',1,0,"C",1);
     $pdf->cell(20,$alt,'REGIME',1,0,"C",1);
     $pdf->cell(40,$alt,'FUNCÃO',1,0,"C",1);
     $pdf->cell(30,$alt,'PADRAO',1,0,"C",1);
     $pdf->cell(30,$alt,'SALARIO BASE',1,1,"C",1);
     $pre = 1;
  ...
  $pdf->cell(90,$alt,db_formatar($rh01_admiss,'d'),0,0,"L",$pre);
  $pdf->cell(90,$alt,$rh30_descr,0,0,"L",$pre);
  $pdf->cell(90,$alt,$rh37_descr,0,0,"L",$pre);
  $pdf->cell(90,$alt,$rh03_padrao,0,0,"L",$pre);
  $pdf->cell(40,$alt,$db_fxxx,0,1,"L",$pre);
}
