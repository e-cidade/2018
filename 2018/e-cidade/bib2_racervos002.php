...
if ($rel == "resumido") {
  ...
  $pdf->cell(90,4,"Título","BTR",0,"L",1);
  $pdf->cell(87,4,"Subtítulo","BTR",0,"L",1);
  $pdf->cell(15,4,"Ano Edição",1,0,"C",1);
...
for ($x = 0; $x < $clacervo->numrows; $x++) {
  ...
  if ($rel == "completo") {
    ...
    $pdf->setfont('arial','b',7);
    $pdf->cell(20,4,"Código Acervo",1,0,"C",1);
    $pdf->cell(90,4,"Título","RTB",0,"L",1);
    $pdf->cell(87,4,"Subtítulo","RTB",0,"L",1);
    $pdf->cell(15,4,"Ano Edição",1,0,"C",1);
    $pdf->cell(20,4,"Data Registro",1,0,"C",1);
    $pdf->cell(40,4,"Localização",1,0,"C",1);
    $pdf->cell(7,4,"Local",1,1,"C",1);
  ...
  $pdf->cell(90,4, $sTitulo, "RTB",0,"L",0);
  $pdf->cell(87,4,substr($bi06_subtitulo,0,63), "RTB",0,"L",0);
  $pdf->cell(15,4,$bi06_anoedicao, 1,0,"C",0);
  ...
  if ($rel == "completo") {
    ...
    $pdf->cell(119,3,$bi06_volume,"R",1,"L",0);
    ...
    $pdf->cell(119,3,$bi03_classificacao,"R",1,"L",0);
    ...
    $autores = implode(", ", $aAutores);
    $pdf->setfont('arial','',6);
    $pdf->cell(20,3,"",0,0,"C",0);
    $pdf->multicell(259,3, $autores,"LR",1,"L",0);
    $pdf->setfont('arial','b',7);
    $pdf->cell(20,4,"",0,0,"C",0);
    $pdf->cell(259,4,"Assuntos :","LRB",1,"L",0);
    $pdf->setfont('arial','',6);
    ...
    $pdf->cell(259,1,"","RL",1,"L",0);
    $pdf->setfont('arial','b',7);
    $pdf->cell(20,4,"",0,0,"C",0);
    $pdf->cell(259,4,"Exemplares :","LRB",1,"L",0);
    $pdf->setfont('arial','',6);
    ...
    for ($z = 0; $z < $clexemplar->numrows; $z++) {
      ...
      $pdf->cell(20,3,"",0,0,"C",0);
      $pdf->multicell(259,3,$bi23_codigo." - ".$bi23_codbarras." - Adquirido em ".db_formatar($bi23_dataaquisicao,'d')." - Situação: ".($bi23_situacao=="S"?"ATIVO":"INATIVO")." - Tipo de Aquisiçao: ".$bi04_forma.($sequencia!=""?$sequencia:""),"LR",1,"L",0);
    }
    $pdf->cell(20,1,"",0,0,"C",0);
    $pdf->cell(259,1,"","RBL",1,"L",0);
  }
}
