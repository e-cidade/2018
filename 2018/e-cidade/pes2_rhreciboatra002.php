...
$result_dados = $clrhpagocor->sql_record($clrhpagocor->sql_query_atraso(null,"rh58_codigo, rh58_valor, rh58_data, rh01_regist, z01_nome, rh57_ano, rh57_mes, rh57_saldo ",""," rh58_codigo = ".$movimento));
...
$pdf->sety($altura + 120);
$pdf->setfont('Arial','B',10);
$pdf->cell(105,5,"Valor do salário:      ",0,0,"R",0);
$pdf->Multicell(0,5,trim(db_formatar($rh58_valor,"f")),0,"L",0);
$pdf->cell(105,5,"Valor total:      ",0,0,"R",0);
$pdf->Multicell(0,5,trim(db_formatar($rh57_saldo,"f")),0,"L",0);
