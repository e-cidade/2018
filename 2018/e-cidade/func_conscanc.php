    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_z01_nome) && (trim($chave_z01_nome)!="") ){
          $sql = $clmarca->sql_query("",$campos,"",$where." and z01_nome like '$chave_z01_nome%' group by $campos");
        }
        db_lovrot(@$sql,15,"()","",$funcao_js);
      }else{
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $campos = "cgm.z01_numcgm,cgm.z01_nome";
          $result = $clmarca->sql_record($clmarca->sql_query("",$campos,"",$where." and z01_numcgm = $pesquisa_chave"));
