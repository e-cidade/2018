...
include("classes/db_meiimportalinha_classe.php");
	     ...
	     <form name="form2" method="post" action="" >
          ...
          <tr> 
            <td colspan="2" align="center"> 
              ...
              <input name="Fechar" type="button" id="fechar" value="Fechar" onClick="parent.db_iframe_meiimportalinha.hide();">
             </td>
          </tr>
        </form>
        </table>
    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        if(isset($campos)==false){
           if(file_exists("funcoes/db_func_meiimportalinha.php")==true){
             include("funcoes/db_func_meiimportalinha.php");
           }else{
           $campos = "meiimportalinha.*";
           }
        }
        if(isset($chave_q105_sequencial) && (trim($chave_q105_sequencial)!="") ){
	         $sql = $clmeiimportalinha->sql_query($chave_q105_sequencial,$campos,"q105_sequencial");
        }else if(isset($chave_q105_meiimporta) && (trim($chave_q105_meiimporta)!="") ){
	         $sql = $clmeiimportalinha->sql_query("",$campos,"q105_meiimporta"," q105_meiimporta like '$chave_q105_meiimporta%' ");
        }else{
        ...
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $clmeiimportalinha->sql_record($clmeiimportalinha->sql_query($pesquisa_chave));
          if($clmeiimportalinha->numrows!=0){
