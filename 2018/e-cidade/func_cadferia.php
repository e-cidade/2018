    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        if(isset($campos)==false){
           if(file_exists("funcoes/db_func_cadferia.php")==true){
             include("funcoes/db_func_cadferia.php");
           }else{
           $campos = "cadferia.oid,cadferia.*";
           }
        }
	         $sql = $clcadferia->sql_query();
        db_lovrot($sql,15,"()","",$funcao_js);
      }else{
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $clcadferia->sql_record($clcadferia->sql_query($pesquisa_chave));
