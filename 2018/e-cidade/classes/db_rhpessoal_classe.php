...
class cl_rhpessoal {
  ...
  function sql_query_func_rhpessoal( $rh01_regist=null,$campos="*",$ordem=null,$dbwhere="", $sQuery = null){
    ...
    switch ($sQuery) {
      ...
      case 4:
        ...
        $sql .= " left join rhferias on (rh109_regist = rh01_regist                                       ";
  ...
  function sql_query_com_temporarios ( $rh01_regist=null,$campos="*",$ordem=null,$dbwhere=""){
    ...
    /**
     * Sql base para o caso que o parâmetro de Estrutura Suplementar está ativado
     * @param string $sTabela      - tabela de cálculo do ponto escolhido ex.: gerfsal
     * @param string $sSigla       - sigla da tabela escolhida            ex.: r14
     * @param string $iAno         - ano competencia
     * @param string $iMes         - mes competencia
     ...
     * @return string
     */
    function sql_query_baseRelatoriosComplementar($sTabela = null, $sSigla = null, $iAno = null, $iMes = null, $iInstituicao = null, $sCampos = "*", $sWhere = "", $sOrderBy = "", $sCadAtual = null) {

        $sSQLBase = "select {$sCampos}                        ,                                                                     \n";
        $sSQLBase.= "       cast('rhhistoricocalculo' as char)     as tabela_ponto ,                                                        \n";
        $sSQLBase.= "       cast('rh143' as char)      as sigla_tabela ,                                                        \n";
        ...
        $sSQLBase.= "       rhhistoricocalculo.rh143_tipoevento as base_pd,                                                                     \n";
        $sSQLBase.= "       case when rhhistoricocalculo.rh143_tipoevento <> 3                                                                             \n";
        $sSQLBase.= "            then 'PD'                                                                                          \n";
        $sSQLBase.= "            else 'N'                                                                                           \n";
        $sSQLBase.= "       end as provdesc,                                                                                        \n";
        $sSQLBase.= "       case rh30_vinculo                                                                                       \n";
        ...
        $sSQLBase.= "       inner join rhhistoricocalculo  on rhhistoricocalculo.rh143_regist   = rhpessoal.rh01_regist                   \n";
        $sSQLBase.= "       inner join rhfolhapagamento    on rhfolhapagamento.rh141_sequencial = rhhistoricocalculo.rh143_folhapagamento \n";
        $sSQLBase.= "                                     and rhfolhapagamento.rh141_instit     = {$iInstituicao}                         \n";

        if($sCadAtual == null){
            $sSQLBase.= "                                    and rhfolhapagamento.rh141_anousu = rhpessoalmov.rh02_anousu             \n";
            $sSQLBase.= "                                    and rhfolhapagamento.rh141_mesusu = rhpessoalmov.rh02_mesusu             \n";
        }

        $sSQLBase.= "       left  join rhrubricas           on rhrubricas.rh27_rubric        = rhhistoricocalculo.rh143_rubrica::varchar \n";
        $sSQLBase.= "                                      and rhrubricas.rh27_instit        = {$iInstituicao}                      \n";
        $sSQLBase.= "       left  join rhrubelemento        on rh23_rubric                   = rh27_rubric                          \n";
        $sSQLBase.= "                                      and rh23_instit                   = rh27_instit                          \n";
        $sSQLBase.= "       left  join rhrubretencao        on rh75_rubric                   = rh27_rubric                          \n";
