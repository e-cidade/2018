...
class cl_empanuladolancam { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->e39_sequencial = ($this->e39_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["e39_sequencial"]:$this->e39_sequencial);
       $this->e39_empanulado = ($this->e39_empanulado == ""?@$GLOBALS["HTTP_POST_VARS"]["e39_empanulado"]:$this->e39_empanulado);
       $this->e39_codlan = ($this->e39_codlan == ""?@$GLOBALS["HTTP_POST_VARS"]["e39_codlan"]:$this->e39_codlan);
     }else{
       $this->e39_sequencial = ($this->e39_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["e39_sequencial"]:$this->e39_sequencial);
     }
   }
   // funcao para inclusao
   function incluir ($e39_sequencial){ 
      $this->atualizacampos();
     if($this->e39_empanulado == null ){ 
     ...
     if($e39_sequencial == "" || $e39_sequencial == null ){
       $result = db_query("select nextval('empanuladolancam_e39_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: empanuladolancam_e39_sequencial_seq do campo: e39_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $e39_sequencial)){
         ...
         $this->e39_sequencial = $e39_sequencial; 
       }
     }
     if(($this->e39_sequencial == null) || ($this->e39_sequencial == "") ){ 
       $this->erro_sql = " Campo e39_sequencial nao declarado.";
     ...
     $sql = "insert into empanuladolancam(
                                       e39_sequencial 
                                      ,e39_empanulado 
                                      ,e39_codlan 
                       )
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->e39_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($e39_sequencial=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($e39_sequencial!=null){
       $sql .= " e39_sequencial = $this->e39_sequencial";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->e39_sequencial));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Lançamentos da anulação de empenho nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->e39_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Lançamentos da anulação de empenho nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->e39_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($e39_sequencial=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($e39_sequencial));
     }else{ 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($e39_sequencial != ""){
          ...
          $sql2 .= " e39_sequencial = $e39_sequencial ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Lançamentos da anulação de empenho nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$e39_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Lançamentos da anulação de empenho nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$e39_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $e39_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from empanuladolancam ";
     $sql .= "      inner join conlancam  on  conlancam.c70_codlan = empanuladolancam.e39_codlan";
     $sql .= "      inner join empanulado  on  empanulado.e94_codanu = empanuladolancam.e39_empanulado";
     $sql .= "      inner join empempenho  on  empempenho.e60_numemp = empanulado.e94_numemp";
     $sql2 = "";
     if($dbwhere==""){
       if($e39_sequencial!=null ){
         $sql2 .= " where empanuladolancam.e39_sequencial = $e39_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
