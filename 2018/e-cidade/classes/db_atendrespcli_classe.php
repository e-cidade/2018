...
//MODULO: atendimento
//CLASSE DA ENTIDADE atendrespcli
class cl_atendrespcli { 
   ...
   var $at84_seq = 0; 
   var $at84_id_usuario = 0; 
   // cria propriedade com as variaveis do arquivo 
   var $campos = "
                 at84_seq = int4 = Código do responsável 
                 at84_id_usuario = int4 = Cod. Usuário 
                 ";
   //funcao construtor da classe 
   function cl_atendrespcli() { 
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("atendrespcli"); 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->at84_seq = ($this->at84_seq == ""?@$GLOBALS["HTTP_POST_VARS"]["at84_seq"]:$this->at84_seq);
       $this->at84_id_usuario = ($this->at84_id_usuario == ""?@$GLOBALS["HTTP_POST_VARS"]["at84_id_usuario"]:$this->at84_id_usuario);
     }else{
       $this->at84_seq = ($this->at84_seq == ""?@$GLOBALS["HTTP_POST_VARS"]["at84_seq"]:$this->at84_seq);
     }
   }
   // funcao para inclusao
   function incluir ($at84_seq){ 
      $this->atualizacampos();
     if($this->at84_id_usuario == null ){ 
       $this->erro_sql = " Campo Cod. Usuário nao Informado.";
       $this->erro_campo = "at84_id_usuario";
       $this->erro_banco = "";
     ...
     if($at84_seq == "" || $at84_seq == null ){
       ...
       if(($result != false) && (pg_result($result,0,0) < $at84_seq)){
         ...
         $this->at84_seq = $at84_seq; 
       }
     }
     if(($this->at84_seq == null) || ($this->at84_seq == "") ){ 
       $this->erro_sql = " Campo at84_seq nao declarado.";
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Responsáveis pelos atendimentos no cliente ($this->at84_seq) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "Responsáveis pelos atendimentos no cliente já Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       }else{
         $this->erro_sql   = "Responsáveis pelos atendimentos no cliente ($this->at84_seq) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->at84_seq;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($at84_seq=null) { 
      $this->atualizacampos();
     $sql = " update atendrespcli set ";
     $virgula = "";
     if(trim($this->at84_seq)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at84_seq"])){ 
       $sql  .= $virgula." at84_seq = $this->at84_seq ";
       $virgula = ",";
       if(trim($this->at84_seq) == null ){ 
         $this->erro_sql = " Campo Código do responsável nao Informado.";
         $this->erro_campo = "at84_seq";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
     ...
     if(trim($this->at84_id_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at84_id_usuario"])){ 
       $sql  .= $virgula." at84_id_usuario = $this->at84_id_usuario ";
       $virgula = ",";
       if(trim($this->at84_id_usuario) == null ){ 
         $this->erro_sql = " Campo Cod. Usuário nao Informado.";
         $this->erro_campo = "at84_id_usuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($result==false){ 
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Responsáveis pelos atendimentos no cliente nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->at84_seq;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($at84_seq=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($at84_seq));
     }else{ 
     ...
     if($result==false){ 
       ...
       $this->erro_sql .= "Valores : ".$at84_seq;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Responsáveis pelos atendimentos no cliente nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$at84_seq;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_record($sql) { 
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:atendrespcli";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
   ...
   // funcao do sql 
   function sql_query ( $at84_seq=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
   ...
   // funcao do sql 
   function sql_query_file ( $at84_seq=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = split("#",$campos);
       $virgula = "";
