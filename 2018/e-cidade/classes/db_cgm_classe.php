...
class cl_cgm {
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->z01_nomefanta = ($this->z01_nomefanta == "" ? (isset($GLOBALS["HTTP_POST_VARS"]["z01_nomefanta"]) ? $GLOBALS["HTTP_POST_VARS"]["z01_nomefanta"] : null) : $this->z01_nomefanta);
   ...
   function alterar ($z01_numcgm=null) {
     ...
     if ($this->z01_nomefanta === null) {
       $sql  .= $virgula." z01_nomefanta = null ";
       $virgula = ",";
     }
