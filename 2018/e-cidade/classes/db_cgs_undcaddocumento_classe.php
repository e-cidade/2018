<?
//MODULO: ambulatorial
//CLASSE DA ENTIDADE cgs_undcaddocumento
class cl_cgs_undcaddocumento { 
   ...
   var $sd108_cgs_und = 0; 
   var $sd108_caddocumento = 0; 
   // cria propriedade com as variaveis do arquivo 
   var $campos = "
                 sd108_sequencial = int4 = Sequencial 
                 sd108_cgs_und = int4 = CGS 
                 sd108_caddocumento = int4 = C?digo Documento 
                 ";
   //funcao construtor da classe 
   function cl_cgs_undcaddocumento() { 
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("cgs_undcaddocumento"); 
   ...
   function incluir (){ 
     ...
     if($this->sd108_caddocumento == null ){ 
       $this->erro_sql = " Campo C?digo Documento não informado.";
       $this->erro_campo = "sd108_caddocumento";
       $this->erro_banco = "";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
     ...
     if($sd108_sequencial == "" || $sd108_sequencial == null ){
       $result = db_query("select nextval('cgs_undcaddocumento_sd108_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: cgs_undcaddocumento_sd108_sequencial_seq do campo: sd108_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       $result = db_query("select last_value from cgs_undcaddocumento_sd108_sequencial_seq");
     ...
     $sql = "insert into cgs_undcaddocumento(
                                       sd108_sequencial 
                                      ,sd108_cgs_und 
                                      ,sd108_caddocumento 
                       )
                values (
                               ...
                               ,$this->sd108_cgs_und 
                               ,$this->sd108_caddocumento 
                      )";
     $result = db_query($sql); 
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Documentos () não Incluído. Inclusão Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   public function alterar ( $oid=null ) { 
      $this->atualizacampos();
     $sql = " update cgs_undcaddocumento set ";
     $virgula = "";
     ...
     if(trim($this->sd108_caddocumento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd108_caddocumento"])){ 
       $sql  .= $virgula." sd108_caddocumento = $this->sd108_caddocumento ";
       $virgula = ",";
       if(trim($this->sd108_caddocumento) == null ){ 
         $this->erro_sql = " Campo C?digo Documento não informado.";
         $this->erro_campo = "sd108_caddocumento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
...
$sql .= "oid = '$oid'";     $result = db_query($sql);
   ...
   public function excluir ( $oid=null ,$dbwhere=null) { 
     ...
     $sql = " delete from cgs_undcaddocumento
                    where ";
     $sql2 = "";
     if (empty($dbwhere)) {
       $sql2 = "oid = '$oid'";
   ...
   public function sql_record($sql) { 
     ...
     $this->numrows = pg_num_rows($result);
      if ($this->numrows == 0) {
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:cgs_undcaddocumento";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
   ...
   // funcao do sql 
   public function sql_query ($oid = null, $campos = "cgs_undcaddocumento.oid,*", $ordem = null, $dbwhere = "") { 

     $sql  = "select {$campos}";
     $sql .= "  from cgs_undcaddocumento ";
     $sql2 = "";
     if (empty($dbwhere)) {
       if (!empty($oid)) {
          $sql2 = " where cgs_undcaddocumento.oid = '$oid'";
       }
