...
class cl_aguadebconta { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->x05_matric = ($this->x05_matric == ""?@$GLOBALS["HTTP_POST_VARS"]["x05_matric"]:$this->x05_matric);
       $this->x05_conta = ($this->x05_conta == ""?@$GLOBALS["HTTP_POST_VARS"]["x05_conta"]:$this->x05_conta);
     }else{
       $this->x05_matric = ($this->x05_matric == ""?@$GLOBALS["HTTP_POST_VARS"]["x05_matric"]:$this->x05_matric);
     }
   }
   // funcao para inclusao
   function incluir ($x05_matric){ 
      $this->atualizacampos();
     if($this->x05_conta == null ){ 
       ...
       $this->x05_matric = $x05_matric; 
     if(($this->x05_matric == null) || ($this->x05_matric == "") ){ 
       $this->erro_sql = " Campo x05_matric nao declarado.";
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->x05_matric;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($x05_matric=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($x05_matric!=null){
       $sql .= " x05_matric = $this->x05_matric";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->x05_matric));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "aguadebconta nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->x05_matric;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "aguadebconta nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->x05_matric;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($x05_matric=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($x05_matric));
     }else{ 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "aguadebconta nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$x05_matric;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "aguadebconta nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$x05_matric;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
