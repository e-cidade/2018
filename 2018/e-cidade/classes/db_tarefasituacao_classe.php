...
class cl_tarefasituacao { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->at47_sequencial = ($this->at47_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["at47_sequencial"]:$this->at47_sequencial);
       $this->at47_tarefa = ($this->at47_tarefa == ""?@$GLOBALS["HTTP_POST_VARS"]["at47_tarefa"]:$this->at47_tarefa);
       $this->at47_situacao = ($this->at47_situacao == ""?@$GLOBALS["HTTP_POST_VARS"]["at47_situacao"]:$this->at47_situacao);
     }else{
       $this->at47_sequencial = ($this->at47_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["at47_sequencial"]:$this->at47_sequencial);
     }
   }
   // funcao para inclusao
   function incluir ($at47_sequencial){ 
      $this->atualizacampos();
     if($this->at47_tarefa == null ){ 
     ...
     if($at47_sequencial == "" || $at47_sequencial == null ){
       $result = db_query("select nextval('tarefasituacao_at47_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: tarefasituacao_at47_sequencial_seq do campo: at47_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $at47_sequencial)){
         ...
         $this->at47_sequencial = $at47_sequencial; 
       }
     }
     if(($this->at47_sequencial == null) || ($this->at47_sequencial == "") ){ 
       $this->erro_sql = " Campo at47_sequencial nao declarado.";
     ...
     $sql = "insert into tarefasituacao(
                                       at47_sequencial 
                                      ,at47_tarefa 
                                      ,at47_situacao 
                       )
                values (
                                $this->at47_sequencial 
                               ,$this->at47_tarefa 
                               ,$this->at47_situacao 
                      )";
     $result = db_query($sql); 
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->at47_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($at47_sequencial=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($at47_sequencial!=null){
       $sql .= " at47_sequencial = $this->at47_sequencial";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->at47_sequencial));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Situacao das tarefas nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->at47_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Situacao das tarefas nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->at47_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($at47_sequencial=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($at47_sequencial));
     }else{ 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($at47_sequencial != ""){
          ...
          $sql2 .= " at47_sequencial = $at47_sequencial ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Situacao das tarefas nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$at47_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Situacao das tarefas nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$at47_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $at47_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from tarefasituacao ";
     $sql .= "      inner join tarefa  on  tarefa.at40_sequencial = tarefasituacao.at47_tarefa";
     $sql .= "      inner join tarefacadsituacao  on  tarefacadsituacao.at46_codigo = tarefasituacao.at47_situacao";
     $sql .= "      inner join db_usuarios  on  db_usuarios.id_usuario = tarefa.at40_responsavel";
     $sql2 = "";
     if($dbwhere==""){
       if($at47_sequencial!=null ){
         $sql2 .= " where tarefasituacao.at47_sequencial = $at47_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
