...
class cl_aguacategoriaconsumo { 
   ...
   function incluir ($x13_sequencial){ 
     ...
     if(($this->x13_sequencial == null) || ($this->x13_sequencial == "") ){ 
       $this->erro_sql = " Campo x13_sequencial não declarado.";
   ...
   public function alterar ($x13_sequencial=null) { 
     ...
     if (!$result) { 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Categoria de Consumo não Alterado. Alteração Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->x13_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if (pg_affected_rows($result) == 0) {
         $this->erro_banco = "";
         $this->erro_sql = "Categoria de Consumo não foi Alterado. Alteração Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->x13_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   public function excluir ($x13_sequencial=null,$dbwhere=null) { 
     ...
     if ($result == false) { 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Categoria de Consumo não Excluído. Exclusão Abortada.\\n";
       ...
       if (pg_affected_rows($result) == 0) {
         $this->erro_banco = "";
         $this->erro_sql = "Categoria de Consumo não Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$x13_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
