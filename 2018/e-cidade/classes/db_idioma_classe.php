...
class cl_idioma { 
   ...
   function incluir ($bi22_sequencial){ 
      $this->atualizacampos();
     if($this->bi22_idioma == null ){ 
     ...
     if($bi22_sequencial == "" || $bi22_sequencial == null ){
       $result = db_query("select nextval('idioma_bi22_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: idioma_bi22_sequencial_seq do campo: bi22_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $bi22_sequencial)){
         ...
         $this->bi22_sequencial = $bi22_sequencial; 
       }
     }
     if(($this->bi22_sequencial == null) || ($this->bi22_sequencial == "") ){ 
       $this->erro_sql = " Campo bi22_sequencial não declarado.";
     ...
     $this->erro_sql = "Inclusão efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->bi22_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       $resaco = $this->sql_record($this->sql_query_file($this->bi22_sequencial  ));
   ...
   public function alterar ($bi22_sequencial=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($bi22_sequencial!=null){
       $sql .= " bi22_sequencial = $this->bi22_sequencial";
     }
     $lSessaoDesativarAccount = db_getsession("DB_desativar_account", false);
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       && ($lSessaoDesativarAccount === false))) {
     ...
     if (!$result) { 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Idioma não Alterado. Alteração Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->bi22_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if (pg_affected_rows($result) == 0) {
         $this->erro_banco = "";
         $this->erro_sql = "Idioma não foi Alterado. Alteração Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->bi22_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   public function excluir ($bi22_sequencial=null,$dbwhere=null) { 
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (empty($dbwhere)) {
         ...
         $resaco = $this->sql_record($this->sql_query_file($bi22_sequencial));
       } else { 
     ...
     $sql2 = "";
     if (empty($dbwhere)) {
        if (!empty($bi22_sequencial)){
          if (!empty($sql2)) {
            $sql2 .= " and ";
          }
          $sql2 .= " bi22_sequencial = $bi22_sequencial ";
        }
     } else {
       $sql2 = $dbwhere;
     }
     ...
     if ($result == false) { 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Idioma não Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$bi22_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if (pg_affected_rows($result) == 0) {
         $this->erro_banco = "";
         $this->erro_sql = "Idioma não Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$bi22_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   public function sql_record($sql) { 
     ...
     $this->numrows = pg_num_rows($result);
      if ($this->numrows == 0) {
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:idioma";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
   ...
   // funcao do sql 
   public function sql_query ($bi22_sequencial = null,$campos = "*", $ordem = null, $dbwhere = "") { 
     ...
     if (empty($dbwhere)) {
       if (!empty($bi22_sequencial)) {
         $sql2 .= " where idioma.bi22_sequencial = $bi22_sequencial "; 
       } 
   ...
   // funcao do sql 
   public function sql_query_file ($bi22_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "") {
