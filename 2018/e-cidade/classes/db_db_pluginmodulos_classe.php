...
class cl_db_pluginmodulos { 
   ...
   function incluir ($db152_sequencial){ 
     ...
     if(($this->db152_sequencial == null) || ($this->db152_sequencial == "") ){ 
       $this->erro_sql = " Campo db152_sequencial não declarado.";
   ...
   public function alterar ($db152_sequencial=null) { 
     ...
     if (!$result) { 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Plugin Módulos não Alterado. Alteração Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->db152_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if (pg_affected_rows($result) == 0) {
         $this->erro_banco = "";
         $this->erro_sql = "Plugin Módulos não foi Alterado. Alteração Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->db152_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   public function excluir ($db152_sequencial=null,$dbwhere=null) { 
     ...
     if ($result == false) { 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Plugin Módulos não Excluído. Exclusão Abortada.\\n";
       ...
       if (pg_affected_rows($result) == 0) {
         $this->erro_banco = "";
         $this->erro_sql = "Plugin Módulos não Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$db152_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
