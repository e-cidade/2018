...
class cl_porteatividadeimpacto {
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->am02_sequencial = ($this->am02_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["am02_sequencial"]:$this->am02_sequencial);
       $this->am02_descricao = ($this->am02_descricao == ""?@$GLOBALS["HTTP_POST_VARS"]["am02_descricao"]:$this->am02_descricao);
     }else{
       $this->am02_sequencial = ($this->am02_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["am02_sequencial"]:$this->am02_sequencial);
     }
   }
   // funcao para inclusao
   function incluir ($am02_sequencial){
      $this->atualizacampos();
     if($this->am02_descricao == null ){
     ...
     if($am02_sequencial == "" || $am02_sequencial == null ){
       $result = db_query("select nextval('porteatividadeimpacto_am02_sequencial_seq')");
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: porteatividadeimpacto_am02_sequencial_seq do campo: am02_sequencial";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false;
       ...
       if(($result != false) && (pg_result($result,0,0) < $am02_sequencial)){
         ...
         $this->am02_sequencial = $am02_sequencial;
       }
     }
     if(($this->am02_sequencial == null) || ($this->am02_sequencial == "") ){
       $this->erro_sql = " Campo am02_sequencial nao declarado.";
     ...
     $sql = "insert into porteatividadeimpacto(
                                       am02_sequencial
                                      ,am02_descricao
                       )
                values (
                                $this->am02_sequencial
                               ,'$this->am02_descricao'
                      )";
     $result = db_query($sql);
     if($result==false){
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->am02_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       $resaco = $this->sql_record($this->sql_query_file($this->am02_sequencial  ));
   ...
   public function alterar ($am02_sequencial=null) {
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($am02_sequencial!=null){
       $sql .= " am02_sequencial = $this->am02_sequencial";
     }
     $lSessaoDesativarAccount = db_getsession("DB_desativar_account", false);
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       && ($lSessaoDesativarAccount === false))) {
     ...
     if (!$result) {
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Cadastro de porte de atividade impacto nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->am02_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if (pg_affected_rows($result) == 0) {
         $this->erro_banco = "";
         $this->erro_sql = "Cadastro de porte de atividade impacto nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->am02_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   public function excluir ($am02_sequencial=null,$dbwhere=null) {
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (empty($dbwhere)) {
         ...
         $resaco = $this->sql_record($this->sql_query_file($am02_sequencial));
       } else {
     ...
     $sql = " delete from porteatividadeimpacto
                    where ";
     $sql2 = "";
     if (empty($dbwhere)) {
        if (!empty($am02_sequencial)){
          if (!empty($sql2)) {
            $sql2 .= " and ";
          }
          $sql2 .= " am02_sequencial = $am02_sequencial ";
        }
     } else {
       $sql2 = $dbwhere;
     }
     ...
     if ($result == false) {
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Cadastro de porte de atividade impacto nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$am02_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if (pg_affected_rows($result) == 0) {
         $this->erro_banco = "";
         $this->erro_sql = "Cadastro de porte de atividade impacto nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$am02_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   public function sql_record($sql) {
     ...
     $this->numrows = pg_num_rows($result);
      if ($this->numrows == 0) {
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:porteatividadeimpacto";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
   ...
   // funcao do sql
   public function sql_query ($am02_sequencial = null,$campos = "*", $ordem = null, $dbwhere = "") {

     $sql  = "select {$campos}";
     $sql .= "  from porteatividadeimpacto ";
     $sql2 = "";
     if (empty($dbwhere)) {
       if (!empty($am02_sequencial)) {
         $sql2 .= " where porteatividadeimpacto.am02_sequencial = $am02_sequencial ";
       }
   ...
   // funcao do sql
   public function sql_query_file ($am02_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "") {
