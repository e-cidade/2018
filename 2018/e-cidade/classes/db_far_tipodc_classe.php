...
class cl_far_tipodc { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->fa27_i_codigo = ($this->fa27_i_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["fa27_i_codigo"]:$this->fa27_i_codigo);
       $this->fa27_c_denominacao = ($this->fa27_c_denominacao == ""?@$GLOBALS["HTTP_POST_VARS"]["fa27_c_denominacao"]:$this->fa27_c_denominacao);
     }else{
       $this->fa27_i_codigo = ($this->fa27_i_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["fa27_i_codigo"]:$this->fa27_i_codigo);
     }
   }
   // funcao para inclusao
   function incluir ($fa27_i_codigo){ 
      $this->atualizacampos();
     if($this->fa27_c_denominacao == null ){ 
     ...
     if($fa27_i_codigo == "" || $fa27_i_codigo == null ){
       $result = db_query("select nextval('far_tipodc_fa27_codigo_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: far_tipodc_fa27_codigo_seq do campo: fa27_i_codigo"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $fa27_i_codigo)){
         ...
         $this->fa27_i_codigo = $fa27_i_codigo; 
       }
     }
     if(($this->fa27_i_codigo == null) || ($this->fa27_i_codigo == "") ){ 
       $this->erro_sql = " Campo fa27_i_codigo nao declarado.";
     ...
     $sql = "insert into far_tipodc(
                                       fa27_i_codigo 
                                      ,fa27_c_denominacao 
                       )
                values (
                                $this->fa27_i_codigo 
                               ,'$this->fa27_c_denominacao' 
                      )";
     $result = db_query($sql); 
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->fa27_i_codigo;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($fa27_i_codigo=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($fa27_i_codigo!=null){
       $sql .= " fa27_i_codigo = $this->fa27_i_codigo";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->fa27_i_codigo));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "far_tipodc nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->fa27_i_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "far_tipodc nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->fa27_i_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($fa27_i_codigo=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($fa27_i_codigo));
     }else{ 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($fa27_i_codigo != ""){
          ...
          $sql2 .= " fa27_i_codigo = $fa27_i_codigo ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "far_tipodc nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$fa27_i_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "far_tipodc nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$fa27_i_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $fa27_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     if($dbwhere==""){
       if($fa27_i_codigo!=null ){
         $sql2 .= " where far_tipodc.fa27_i_codigo = $fa27_i_codigo "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
