...
class cl_certidmovimentacao {
   ...
   var $campos = "
                 v32_sequencial = int4 = Código da Movimentação
                 v32_certidcartorio = int4 = Código Certidão Cartório
                 v32_datamovimentacao = date = Data Movimentação
   ...
   function incluir ($v32_sequencial){
     ...
     if($this->v32_datamovimentacao == null ){
       $this->erro_sql = " Campo Data Movimentação não informado.";
     ...
     if($v32_sequencial == "" || $v32_sequencial == null ){
       ...
       if(($result != false) && (pg_result($result,0,0) < $v32_sequencial)){
         $this->erro_sql = " Campo v32_sequencial maior que último número da sequencia.";
     ...
     if(($this->v32_sequencial == null) || ($this->v32_sequencial == "") ){
       $this->erro_sql = " Campo v32_sequencial não declarado.";
     ...
     if($result==false){
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Movimentação de Certidões ($this->v32_sequencial) não Incluído. Inclusão Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "Movimentação de Certidões já Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       }else{
         $this->erro_sql   = "Movimentação de Certidões ($this->v32_sequencial) não Incluído. Inclusão Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   public function alterar ($v32_sequencial=null) {
     ...
     if (!$result) {
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Movimentação de Certidões não Alterado. Alteração Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->v32_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if (pg_affected_rows($result) == 0) {
         $this->erro_banco = "";
         $this->erro_sql = "Movimentação de Certidões não foi Alterado. Alteração Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->v32_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   public function excluir ($v32_sequencial=null,$dbwhere=null) {
     ...
     if ($result == false) {
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Movimentação de Certidões não Excluído. Exclusão Abortada.\\n";
       ...
       if (pg_affected_rows($result) == 0) {
         $this->erro_banco = "";
         $this->erro_sql = "Movimentação de Certidões não Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$v32_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
