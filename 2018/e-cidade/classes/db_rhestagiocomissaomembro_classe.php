...
class cl_rhestagiocomissaomembro { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->h60_sequencial = ($this->h60_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["h60_sequencial"]:$this->h60_sequencial);
       $this->h60_regist = ($this->h60_regist == ""?@$GLOBALS["HTTP_POST_VARS"]["h60_regist"]:$this->h60_regist);
       $this->h60_rhestagiocomissao = ($this->h60_rhestagiocomissao == ""?@$GLOBALS["HTTP_POST_VARS"]["h60_rhestagiocomissao"]:$this->h60_rhestagiocomissao);
       $this->h60_tipo = ($this->h60_tipo == ""?@$GLOBALS["HTTP_POST_VARS"]["h60_tipo"]:$this->h60_tipo);
     }else{
       $this->h60_sequencial = ($this->h60_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["h60_sequencial"]:$this->h60_sequencial);
     }
   }
   // funcao para inclusao
   function incluir ($h60_sequencial){ 
      $this->atualizacampos();
     if($this->h60_regist == null ){ 
     ...
     if($this->h60_rhestagiocomissao == null ){ 
     ...
     if($h60_sequencial == "" || $h60_sequencial == null ){
       $result = db_query("select nextval('rhestagiocomissaomembro_h60_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: rhestagiocomissaomembro_h60_sequencial_seq do campo: h60_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $h60_sequencial)){
         ...
         $this->h60_sequencial = $h60_sequencial; 
       }
     }
     if(($this->h60_sequencial == null) || ($this->h60_sequencial == "") ){ 
       $this->erro_sql = " Campo h60_sequencial nao declarado.";
     ...
     $sql = "insert into rhestagiocomissaomembro(
                                       h60_sequencial 
                                      ,h60_regist 
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->h60_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($h60_sequencial=null) { 
      $this->atualizacampos();
     ...
     if($h60_sequencial!=null){
       $sql .= " h60_sequencial = $this->h60_sequencial";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->h60_sequencial));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Membros de comissão nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->h60_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Membros de comissão nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->h60_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($h60_sequencial=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($h60_sequencial));
     }else{ 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($h60_sequencial != ""){
          ...
          $sql2 .= " h60_sequencial = $h60_sequencial ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Membros de comissão nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$h60_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Membros de comissão nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$h60_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $h60_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from rhestagiocomissaomembro ";
     $sql .= "      inner join rhpessoal  on  rhpessoal.rh01_regist = rhestagiocomissaomembro.h60_regist";
     $sql .= "      inner join rhestagiocomissao  on  rhestagiocomissao.h59_sequencial = rhestagiocomissaomembro.h60_rhestagiocomissao";
