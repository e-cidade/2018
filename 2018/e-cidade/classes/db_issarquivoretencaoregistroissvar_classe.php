...
class cl_issarquivoretencaoregistroissvar {
   ...
   var $campos = "
                 ...
                 q146_issarquivoretencaoregistro = int4 = Código Registro Retencão
                 ";
   ...
   function incluir ($q146_sequencial){
     ...
     if($this->q146_issvar == null ){
       $this->erro_sql = " Campo IssVar não informado.";
     ...
     if($q146_sequencial == "" || $q146_sequencial == null ){
       ...
       if(($result != false) && (pg_result($result,0,0) < $q146_sequencial)){
         $this->erro_sql = " Campo q146_sequencial maior que último número da sequencia.";
     ...
     if(($this->q146_sequencial == null) || ($this->q146_sequencial == "") ){
       $this->erro_sql = " Campo q146_sequencial não declarado.";
     ...
     if($result==false){
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Arquivo de Retenção ISSVar ($this->q146_sequencial) não Incluído. Inclusão Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "Arquivo de Retenção ISSVar já Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       }else{
         $this->erro_sql   = "Arquivo de Retenção ISSVar ($this->q146_sequencial) não Incluído. Inclusão Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   public function alterar ($q146_sequencial=null) {
     ...
     if (!$result) {
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Arquivo de Retenção ISSVar não Alterado. Alteração Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->q146_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if (pg_affected_rows($result) == 0) {
         $this->erro_banco = "";
         $this->erro_sql = "Arquivo de Retenção ISSVar não foi Alterado. Alteração Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->q146_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   public function excluir ($q146_sequencial=null,$dbwhere=null) {
     ...
     if ($result == false) {
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Arquivo de Retenção ISSVar não Excluído. Exclusão Abortada.\\n";
       ...
       if (pg_affected_rows($result) == 0) {
         $this->erro_banco = "";
         $this->erro_sql = "Arquivo de Retenção ISSVar não Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$q146_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
