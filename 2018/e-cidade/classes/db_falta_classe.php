...
class cl_falta { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->ed245_i_codigo = ($this->ed245_i_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["ed245_i_codigo"]:$this->ed245_i_codigo);
       if($this->ed245_d_data == ""){
         $this->ed245_d_data_dia = ($this->ed245_d_data_dia == ""?@$GLOBALS["HTTP_POST_VARS"]["ed245_d_data_dia"]:$this->ed245_d_data_dia);
         $this->ed245_d_data_mes = ($this->ed245_d_data_mes == ""?@$GLOBALS["HTTP_POST_VARS"]["ed245_d_data_mes"]:$this->ed245_d_data_mes);
         $this->ed245_d_data_ano = ($this->ed245_d_data_ano == ""?@$GLOBALS["HTTP_POST_VARS"]["ed245_d_data_ano"]:$this->ed245_d_data_ano);
         if($this->ed245_d_data_dia != ""){
            $this->ed245_d_data = $this->ed245_d_data_ano."-".$this->ed245_d_data_mes."-".$this->ed245_d_data_dia;
         }
       }
       $this->ed245_i_diarioavaliacao = ($this->ed245_i_diarioavaliacao == ""?@$GLOBALS["HTTP_POST_VARS"]["ed245_i_diarioavaliacao"]:$this->ed245_i_diarioavaliacao);
     }else{
       $this->ed245_i_codigo = ($this->ed245_i_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["ed245_i_codigo"]:$this->ed245_i_codigo);
     }
   }
   // funcao para inclusao
   function incluir ($ed245_i_codigo){ 
      $this->atualizacampos();
     if($this->ed245_d_data == null ){ 
     ...
     if($this->ed245_i_diarioavaliacao == null ){ 
     ...
     if($ed245_i_codigo == "" || $ed245_i_codigo == null ){
       $result = db_query("select nextval('falta_ed245_i_codigo_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: falta_ed245_i_codigo_seq do campo: ed245_i_codigo"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $ed245_i_codigo)){
         ...
         $this->ed245_i_codigo = $ed245_i_codigo; 
       }
     }
     if(($this->ed245_i_codigo == null) || ($this->ed245_i_codigo == "") ){ 
       $this->erro_sql = " Campo ed245_i_codigo nao declarado.";
     ...
     $sql = "insert into falta(
                                       ed245_i_codigo 
                                      ,ed245_d_data 
                                      ,ed245_i_diarioavaliacao 
                       )
                values (
                                $this->ed245_i_codigo 
                               ,".($this->ed245_d_data == "null" || $this->ed245_d_data == ""?"null":"'".$this->ed245_d_data."'")." 
                               ,$this->ed245_i_diarioavaliacao 
                      )";
     $result = db_query($sql); 
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->ed245_i_codigo;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($ed245_i_codigo=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($ed245_i_codigo!=null){
       $sql .= " ed245_i_codigo = $this->ed245_i_codigo";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->ed245_i_codigo));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Falta nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->ed245_i_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Falta nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->ed245_i_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($ed245_i_codigo=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($ed245_i_codigo));
     }else{ 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($ed245_i_codigo != ""){
          ...
          $sql2 .= " ed245_i_codigo = $ed245_i_codigo ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Falta nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$ed245_i_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Falta nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$ed245_i_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
