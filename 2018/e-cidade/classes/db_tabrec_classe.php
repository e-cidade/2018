...
class cl_tabrec {
  ...
  /**
   * Método que retorna query para validação se receita esta vencida para o execício
   * @param  integer $iAnousu        Ano de exercicio do calculo
   * @param  integer $iCodigoReceita Código da receita
   * @return string
   */
  function sql_query_validaReceitaVencida( $iAnousu, $iCodigoReceita ){

    $sSql  = " select *                                     ";
    $sSql .= "   from tabrec                                ";
    $sSql .= "  where k02_codigo = $iCodigoReceita          ";
    $sSql .= "    and k02_limite < '{$iAnousu}-01-01'::date ";
