...
class cl_sau_prestadores {
  ...
  public function sql_query_prestadora_agenda ($s110_i_codigo = null,$campos = "*", $ordem = null, $dbwhere = "") {
    ...
    $sql .= "   left join grupoexameprestador   on sau_prestadorvinculos.s111_i_codigo         = age03_prestadorvinculos                 ";
    $sql .= "   left join grupoexame            on grupoexame.age02_sequencial                 = age03_grupoexame                        ";
