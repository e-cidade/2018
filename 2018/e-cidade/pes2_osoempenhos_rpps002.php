...
select r14_lotac as r01_lotac,
       ...
       round((case when r14_rubric = 'R992' then r14_valor else 0 end/100*$perc),2) as pat,
...
select r48_lotac as r01_lotac,
       ...
       round((case when r48_rubric = 'R992' then r48_valor else 0 end/100*$perc),2) as pat,
...
select r20_lotac as r01_lotac,
       ...
       round((case when r20_rubric = 'R992' then r20_valor else 0 end/100*$perc),2) as pat,
