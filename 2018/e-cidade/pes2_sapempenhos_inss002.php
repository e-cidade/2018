...
$res_prev = $clinssirf->sql_record($clinssirf->sql_query_file(null,
                                   ...
                                   "r33_nome limit 1","r33_anousu = $ano and r33_mesusu = $mes and r33_codtab = 3 and r33_instit = ". db_getsession("DB_instit")));
...
select
       ...
       ded,
       ded_eme,
       round(case when (rh26_orgao = 2 and rh26_unidade = 3) or (rh26_orgao = 13 and rh26_unidade = 4) then (inss)/100*20 else (inss)/100*$r33_ppatro end,2) as pat,
       round(case when (rh26_orgao = 2 and rh26_unidade = 3) or (rh26_orgao = 13 and rh26_unidade = 4) then (sub)/100*20 else (sub)/100*$r33_ppatro end,2) as pat_sub,
...
select rh02_regist as r01_regist,
       ...
       case when r14_rubric in ('R919','0255') then r14_valor else 0 end as ded
from gerfsal
...
where r14_anousu = $ano
  ...
  and r14_rubric in ('R992','R919','0255')
...
select rh02_regist as r01_regist,
       ...
       case when r48_rubric in ('R919','0255') then r48_valor else 0 end as ded
from gerfcom
...
where r48_anousu = $ano
  ...
  and r48_rubric in ('R992','R919','0255')
  and rh02_tbprev in (1,3)
...
select rh02_regist as r01_regist,
       ...
       case when r20_rubric in ('R919','0255') then r20_valor else 0 end as ded
from gerfres
...
where r20_anousu = $ano
  ...
  and r20_rubric in ('R992','R919','0255')
  and rh02_tbprev in (1,3)
