    ...
    <td align="center" valign="top">
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_ar18_sequencial) && (trim($chave_ar18_sequencial)!="") ){
	        $sql = $clsuspensao->sql_query("",$campos,"ar18_sequencial", " ar18_sequencial like '$chave_ar18_sequencial' and ar18_situacao = 1");
        }else if(isset($chave_ar18_procjur) && (trim($chave_ar18_procjur)!="") ){
	        $sql = $clsuspensao->sql_query("",$campos,"ar18_procjur"," ar18_procjur like '$chave_ar18_procjur%' and ar18_situacao = 1");
        }else if(isset($situacao) && trim($situacao) != ""){
          $sql = $clsuspensao->sql_query("",$campos,"ar18_sequencial"," ar18_situacao = {$situacao}");
        } else {
		      $sql = $clsuspensao->sql_query("",$campos,"ar18_sequencial","ar18_situacao = 1");
        }
