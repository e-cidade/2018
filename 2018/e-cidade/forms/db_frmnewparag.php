...
?>
  ...
  <tr>
    <td nowrap title="<?=@$Tdb02_alinhamento?>">
       <?=@$Ldb02_alinhamento?>
    </td>
    <td> 
    <?
...
function js_alinha(){
	...
	var ali = document.form1.db02_alinhamento.value;  
  var alinha = "center";
	if ( ali == 'J' ) {
	   alinha = "justify";
	}else if ( ali == 'C' ) {
	...
	document.form1.db02_texto.style.textAlign = alinha;  
