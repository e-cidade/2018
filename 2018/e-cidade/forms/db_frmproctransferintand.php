  ...
  if(mostra==true){
    js_OpenJanelaIframe('top.corpo','db_iframe_proctransferint','func_proctransferint.php?funcao_js=parent.js_mostraproctransferint1|p88_codigo|p88_codigo','Pesquisa',true);
     ...
     if(document.form1.p87_codtransferint.value != ''){ 
        js_OpenJanelaIframe('top.corpo','db_iframe_proctransferint','func_proctransferint.php?pesquisa_chave='+document.form1.p87_codtransferint.value+'&funcao_js=parent.js_mostraproctransferint','Pesquisa',false);
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('top.corpo','db_iframe_proctransferintand','func_proctransferintand.php?funcao_js=parent.js_preenchepesquisa|0','Pesquisa',true);
}
