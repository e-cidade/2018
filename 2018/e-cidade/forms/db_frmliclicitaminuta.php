...
if (isset($oPost->db_opcaoal)) {
  ...
  $db_botao = true;
  if(isset($oPost->novo) || isset($oPost->alterar) || 
...
<fieldset>
  ...
  <table border="0">
    <tr>
      ...
      <td> 
        <?
          db_input('l43_sequencial',10,"",true,'hidden',3,"");
    ...
    <tr>
      ...
      <td> 
        <?
          db_input("l43_arquivo",30,0,true,"file",1);
        ?>
      </td>
    </tr>
    <tr>
    <br>
      <td colspan=2 align=center>
       <input name="<?=($db_opcao==1?"incluir":($db_opcao==2?"alterar":"excluir"))?>" type="submit" 
              id="db_opcao" value="<?=($db_opcao==1?"Incluir":($db_opcao==2?"Alterar":"Excluir"))?>" 
  ...
  <tr>
    <td valign="top"  align="center">  
      <?
        ...
        $cliframe_alterar_excluir->legenda="Minutas Anexadas";
