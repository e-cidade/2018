...
function js_pesquisa(){
  db_iframe.jan.location.href = 'func_db_daealt.php?z01_numcgm='+document.form1.z01_numcgm.value+'&q02_inscr='+document.form1.q02_inscr.value+'&dia='+document.form1.w04_data_dia.value+'&mes='+document.form1.w04_data_mes.value+'&ano='+document.form1.w04_data_ano.value+'&funcao_js=parent.js_relatorio|0';
  db_iframe.mostraMsg();
  db_iframe.show();
  db_iframe.focus();
}
function js_relatorio(chave1){
  window.open('daerelatorio.php?codigo='+chave1,'','width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
//  db_iframe.hide();
}
