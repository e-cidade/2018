...
function js_pesquisa(){
 js_OpenJanelaIframe('top.corpo','db_iframe_progavalpedag','func_progavalpedag.php?funcao_js=parent.js_preenchepesquisa|ed112_i_rhpessoal|ed117_i_ano|ed117_c_tipo','Pesquisa de Avaliação Pedagógica',true);
}
