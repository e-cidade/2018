...
<table border="0">
 ...
 <tr>
  <td nowrap title="<?=@$Ted71_c_situacao?>">
   <?=@$Led71_c_situacao?>
  </td>
  <td>
   <?
 ...
 <tr>
  <td nowrap title="<?=@$Ted71_c_turmasala?>">
   <?=@$Led71_c_turmasala?>
  </td>
  <td>
   <?
...
<input name="ed71_i_codigo" type="hidden" value="<?=@$ed71_i_codigo?>">
