...
<td>
      <fieldset><legend><b>Geração do Ponto de Provisão</b></legend>
<table>
  <tr>
  ...
  <tr >
    <td align="left" nowrap title="Selecione o Tipo de Geração do Ponto de Provisão" >
    <strong>Tipo de Geração:</strong>
    </td>
    <td>
      <?
      /* é necessário definir um nome para o select */
