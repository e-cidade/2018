    ...
    <tr> 
      <td valign="top">
	      <?	        
	        ...
	        $sSqlSyscampo .= "   and  substring(conteudo,1,3) = 'int'                                      ";

	        $sWhere                          = "j124_iptutabelasconfig = {$j122_sequencial}";
	        $sSqlIptuTabelasConfigCampoChave = $cliptutabelasconfigcampochave->sql_query_file(null, "j124_codcam as codcam", 
	                                                                                          null, $sWhere);
	        ...
	        $cl_iframeseleciona->sql_marca     = $sSqlIptuTabelasConfigCampoChave;
