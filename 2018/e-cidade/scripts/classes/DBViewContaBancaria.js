...
DBViewContaBancaria = function(iCodigoContaBancaria, sInstance, lReadOnly) {
  ...
  var sLblAgencia = "<B><a href='#' onclick='" + me.instance
      + "js_pesquisaAgencia(true);'>Número da Agencia:</a> </B>";
  var sLblDvAgencia = "<B>DV Agência: </B>";
  var sLblConta = "<B><a href='#' onclick='" + me.instance
      + "js_pesquisaNumeroConta(true);'>Número da Conta:</a> </B>";
  ...
  this.js_pesquisaAgencia = function(lMostrar) {
    ...
    js_OpenJanelaIframe('', "db_iframe_bancoagenciaconta", sUrlAgencia, "Pesquisa Agência", lMostrar);
  ...
  this.js_pesquisaNumeroConta = function(lMostra) {
    ...
    js_OpenJanelaIframe('', "db_iframe_contabancaria", sUrlNumeroConta, "Pesquisa Número da Conta", lMostra);
