...
if(isset($oGet->k03_tipo)){
  $sWhereTipo = " and arretipo.k03_tipo in($oGet->k03_tipo) ";
}else{
  $sWhereTipo = '';
}
        ...
        <form name="form2" method="post" action="" >
          <tr>
            <td width="4%" align="right" nowrap title="<?php echo $Tk00_tipo; ?>">
              <strong><?php echo "Código do Tipo de Débito"; ?>:</strong>
            </td>
          ...
          <tr>
            <td width="4%" align="right" nowrap title="<?php echo $Tk00_descr; ?>">
              <strong><?php echo "Descrição do Tipo de Débito"; ?>:</strong>
            </td>
            <td width="96%" align="left" nowrap>
              <?php
          ...
          <tr>
            <td colspan="2" align="center">
              ...
              <input name="Fechar" type="button" id="fechar" value="Fechar" onClick="parent.db_iframe_arretipo_nova.hide();" />
            </td>
          </tr>
        </form>
      </table>
    ...
    <td align="center" valign="top">
      ...
      if (!isset($pesquisa_chave)) {
        ...
        if (isset($chave_k00_tipo) && (trim($chave_k00_tipo) != "")) {
           $sql = $clarretipo->sql_query("",$campos, "k00_tipo", "k00_tipo = $chave_k00_tipo {$sWhereTipo}");
        } else if (isset($chave_k00_descr) && (trim($chave_k00_descr)!="") ){
           $sql = $clarretipo->sql_query("", $campos, "k00_descr"," k00_descr like '$chave_k00_descr%' {$sWhereTipo} ");
        } else {
           $sql = $clarretipo->sql_query("", $campos, "k00_tipo"," 1=1 {$sWhereTipo}");
        }
        ...
        if ($pesquisa_chave != null && $pesquisa_chave != "") {
          ...
          $result = $clarretipo->sql_record($clarretipo->sql_query(null,"*",null,"k00_tipo=$pesquisa_chave {$sWhereTipo}"));
