 ...
 <tr>
  <td height="63" align="center" valign="top">
   <table width="35%" border="0" align="center" cellspacing="0">
    ...
    <tr>
     <td width="4%" align="right" nowrap title="<?=$Ted129_i_codigo?>">
      <?=$Led129_i_codigo?>
     </td>
    ...
    <tr>
     <td colspan="2" align="center">
      ...
      <input name="Fechar" type="button" id="fechar" value="Fechar" onClick="parent.db_iframe_escola_sequencias.hide();">
     </td>
    </tr>
   </form>
   </table>
   ...
   if(!isset($pesquisa_chave)){
    if(isset($campos)==false){
     if(file_exists("funcoes/db_func_escola_sequencias.php")==true){
      include("funcoes/db_func_escola_sequencias.php");
     }else{
      $campos = "escola_sequencias.*";
     }
    }
    if(isset($chave_ed129_i_codigo) && (trim($chave_ed129_i_codigo)!="") ){
     $sql = $clescola_sequencias->sql_query($chave_ed129_i_codigo,$campos,"ed129_i_numinicio");
    }else if(isset($chave_ed18_c_nome) && (trim($chave_ed18_c_nome)!="") ){
     $sql = $clescola_sequencias->sql_query("",$campos,"ed129_i_numinicio"," ed18_c_nome like '$chave_ed18_c_nome%' ");
    }else{
    ...
    if($pesquisa_chave!=null && $pesquisa_chave!=""){
     $result = $clescola_sequencias->sql_record($clescola_sequencias->sql_query("","*",""," ed129_i_escola = $pesquisa_chave"));
     if($clescola_sequencias->numrows!=0){
