...
/**
 * Driver de impressão para Bematech modelo 4200
 *
 * @package   impressoras
 * @author    Andrio Costa  - andrio.costa@dbseller.com.br
 * @version   $Revision: 1.2 $
 */
class Bematech4200 extends ImpressoraTermica {
  ...
  public function escrever($sTexto,$lQuebraLinha=false,$iNroCaracteres='',$sAlinhamento='') {
    ...
    parent::addComando(chr(27).chr(97). $this->getAlinhamento(strtoupper($sAlinhamento)));
