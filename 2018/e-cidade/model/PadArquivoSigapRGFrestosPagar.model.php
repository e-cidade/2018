...
/**
 * Prove dados para a geração do arquivo dados da RGF restos á pagar no periodo
 * do municipio para o SIGAP
 * @package Pad
 * @author  Luiz Marcelo Schmitt
 * @version $Revision: 1.2 $
 */
final class PadArquivoSigapRGFrestosPagar extends PadArquivoSigap {
  ...
  public function __construct() {
    ...
    $this->sNomeArquivo = "RGFRestosPagar";
    $this->aDados       = array();
  }
  ...
  public function getNomeElementos() {
    ...
    $aElementos = array(
                         ...
                         "resMesAnoMovimento",
                         "resSinal",
                         "resProcessadoExercicioAnterior",
                         "resProcessadoExercicioAtual",
                         "resNaoProcessadoExercicioAnterior",
                         "resNaoProcessadoExercicioAtual",
                         "resDisponibilidadeCaixaLiquida",
                         "resEmpenhosNaoLiquidadoCancelado",
                         "resContaLRF",
                         "resDescricaoContaLRF",
                         "resConta",
                         "resCodigoRecursoVinculado"
                       );
    return $aElementos;  
  }
