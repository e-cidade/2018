...
/**
 * Prove dados para a geração do arquivo dados da RREO receita de despesas SAUDE no periodo 
 * do municipio para o SIGAP
 * @package Pad
 * @author  Luiz Marcelo Schmitt
 * @version $Revision: 1.2 $
 */
final class PadArquivoSigapRRreceitaDespesaSAUDE extends PadArquivoSigap {
  ...
  public function __construct() {
    ...
    $this->sNomeArquivo = "RRReceitaDespesaSAUDE";
    $this->aDados       = array();
  }
  ...
  public function getNomeElementos() {
    ...
    $aElementos = array(
                         ...
                         "rdsSinal",
                         "rdsConta",
                         "rdsPrevisaoDotacaoInicial",
                         "rdsPrevisaoDotacaoAtualizada",
                         "rdsRealizadaLiquidadaAteSemestre",
                         "rdsRestosInscritoExercicioAnterior",
                         "rdsCanceladoExercicio",
                         "rdsContaLRF",
                         "rdsCodigoFuncao",
                         "rdsDescricaoContaLRF"
                       );
    return $aElementos;  
  }
