...
/**
 * Prove dados para a geração do arquivo dados da RREO receita de despesas MDE no periodo
 * do municipio para o SIGAP
 * @package Pad
 * @author  Luiz Marcelo Schmitt
 * @version $Revision: 1.2 $
 */
final class PadArquivoSigapRRreceitaDespesaMDE extends PadArquivoSigap {
  ...
  public function getNomeElementos() {
    ...
    $aElementos = array(
                         ...
                         "rdmSinal",
                         "rdmConta",
                         "rdmPrevisaoDotacaoInicial",
                         "rdmPrevisaoDotacaoAtualizada",
                         "rdmRealizadaLiquidadaBimestre",
                         "rdmRealizadaLiquidadaAteBimestre",
                         "rdmContaLRF",
                         "rdmSaldoAteBimestre",
                         "rdmValorUnico",
