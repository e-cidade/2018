 ...
 * Model para tratar a anulação dos contratos
 *
 * @package Contratos
 */
...
class AcordoAnulacao extends AcordoMovimentacao {
  ...
  /**
   * Seta o tipo de acordo para a anulação, alterado para protected para nao poder atribuir um novo valor
   *
  ...
  public function save() {
    ...
    foreach ($oContrato->getAutorizacoes() as $oAutorizacao) {
      ...
      if ($oAutorizacao->dataanulacao == "") {
        throw new Exception("O contrato possui autorizações em aberto.\noContrato não poderá ser anulado");
      }
    }
    parent::save();
  ...
  /**
   * Cancela o cancelamento da anulação
   *
   * @return AcordoAnulacao
   */
  public function desfazerCancelamento() {
    ...
    /**
     * Inclui um novo cancelamento cancelado de anulação
     */
