...
/**
 * Prove dados para a geração do arquivo dados da RREO restos utilidade orçamentária no periodo
 * do municipio para o SIGAP
 * @package Pad
 * @author  Luiz Marcelo Schmitt
 * @version $Revision: 1.2 $
 */
final class PadArquivoSigapRRrestosUnidadeOrcamentaria extends PadArquivoSigap {
  ...
  public function __construct() {
    ...
    $this->sNomeArquivo = "RRRestosUnidadeOrcamentaria";
    $this->aDados       = array();
  }
  ...
  public function getNomeElementos() {
    ...
    $aElementos = array(
                         "ruoCodigoEntidade",
                         "ruoMesAnoMovimento",
                         "ruoCodigoUnidadeOrcamentaria",
                         "ruoExercicio",
                         "ruoProcessadoInscrito",
                         "ruoProcessadoCancelado",
                         "ruoProcessadoPago",
                         "ruoProcessadoPagar",
                         "ruoSaldoBimestre",
                         "ruoNaoProcessadoIscrito",
                         "ruoNaoProcessadoCancelado",
                         "ruoNaoProcessadoPago",
                         "ruoNaoProcessadoPagar",
                         "ruoNraOrcamentario"
                       );
    return $aElementos;  
  }
