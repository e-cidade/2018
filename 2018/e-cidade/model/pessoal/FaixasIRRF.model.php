...
class FaixasIRRF {
  ...
  /**
   * Representa o valor de Dedução da faixa do IRRF
   */
  private $nValorDedução;
  ...
  /**
   * Define o valor do percentual de alíquota da faixa
   * @param Number
   */
  ...
  /**
   * Retorna o valor do percentual de alíquota da faixa
   * @return Number
   */
  ...
  /**
   * Define o valor da dedução do imposto da respectiva faixa
   * @param Number
   */
  public function setDeducao ($nValorDedução) {
    $this->nValorDedução = $nValorDedução;
  }
  
  /**
   * Retorna o valor da dedução do imposto da respectiva faixa
   * @return Number
   */
  public function getDeducao () {
    return $this->nValorDedução; 
  }
}