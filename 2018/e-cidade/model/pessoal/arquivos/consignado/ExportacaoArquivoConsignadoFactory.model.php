...
/**
* Constroi classe para exportação de arquivo bancário, conforme o tipo informado
*/
class ExportacaoArquivoConsignadoFactory {
	
	/**
	 * Retorna classe para exportação de acordo com o banco informado
	 */
