 ...
 */
class ArquivoSiprevTempoSemContribuicao extends ArquivoSiprevBase {

  protected $sNomeArquivo = "15-TempoSemContribuicao";
  ...
  public function pesquisarServidores() {
    ...
    $sSql.= "                                      and h16_assent                  = h36_temposemcontribuicao ";
    $sSql.= "                                      and (";
    ...
    foreach ($servidores as $servidor) {
      ...
      if ($aErrosRegistro = $this->validarDados($servidor)) {
        ...
        foreach ($aErrosRegistro as $erro) {
          ArquivoSiprevBase::$aErrosProcessamento["15"][] = $erro;
        }
