...
/**
 * Definiões sobre o Adiantamento de salario de um servidor em uma competencia
 * 
 * @uses    Ponto
 * @package Pessoal 
 ...
 */
class CalculoFolhaAdiantamento extends CalculoFolha {
	
	const TABELA       = 'gerfadi';
	const SIGLA_TABELA = 'r22'; 
