...
/**
 * Definições sobrte ponto salario do Servidor
 * 
 * @uses    Ponto
 * @package Pessoal 
 * @author  Jeferson Belmiro <jeferson.belmiro@dbseller.com.br> 
 */
class PontoSalario extends Ponto {

  /**
   * Nome da tabela para ponto salario 
   */
  const TABELA = Ponto::SALARIO;

  /**
   * Sigla da tabela do ponto salario 
   */
  const SIGLA_TABELA = 'r10';
