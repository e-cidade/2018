...
/**
* Classe responsбvel pelo comportamento do sistema de conta "Financeiro Extra Orзгmentбria"
* @author dbseller
* @name SistemaContaFinanceiroExtraOrcamentario
...
class SistemaContaFinanceiroExtraOrcamentaria implements ISistemaConta {
	
  private $iCodigo    = 7;
  private $sDescricao = 'FINANCEIRO - EXTRA ORЗAMENTARIO';
  
	/**
	 * Mйtodo que define o comportamento do sistema de conta
	 *
	...
	/** 
	 * Retorna o cуdigo do tipo Financeiro - Extra Orcamentaria
