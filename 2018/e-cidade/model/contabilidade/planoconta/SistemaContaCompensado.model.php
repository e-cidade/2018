...
/**
* Classe responsável pelo comportamento do sistema de conta "Compensado"
* @author dbseller
* @name SistemaContaCompensado
...
class SistemaContaCompensado implements ISistemaConta {
  
  private $iCodigo = 4;
	private $sDescricao = 'COMPENSADO';
	/**
 ...
 /**
	...
	*/
	...
	/** Retorna o código do tipo Compensado
