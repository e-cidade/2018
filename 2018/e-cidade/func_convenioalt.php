  ...
  <tr> 
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_r56_codrel) && (trim($chave_r56_codrel)!="") ){
	         ...
	         $sql = $clconvenio->sql_query("",db_getsession('DB_instit'),$campos,"r56_descr"," r56_instit = ".db_getsession('DB_instit')." and r56_descr like '$chave_r56_descr%' ");
        }else{
	...
	//echo $sql;
        ...
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $clconvenio->sql_record($clconvenio->sql_query($pesquisa_chave));
          if($clconvenio->numrows!=0){
            db_fieldsmemory($result,0);
            echo "<script>".$funcao_js."('$r56_descr','$r56_dirarq',false);</script>";
          }else{
