...
<div class="container"> 
  <?php  
    ...
    $sCampos  = " distinct		 	                                                              ";
    $sCampos .= " it03_nome,		                                                              ";
    $sCampos .= " case when it03_princ is true then 'Sim' else 'Não' end as it03_princ,	      ";
    ...
    $sCampos .=  "it03_mail 		                                                              ";      
    $sSqlDadosNome = $clitbinome->sql_query(null,$sCampos,null," it03_guia = {$oGet->guia} and it03_tipo = 'T'");
