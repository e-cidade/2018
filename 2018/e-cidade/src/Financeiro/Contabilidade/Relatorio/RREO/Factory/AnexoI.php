...
use ECidade\Financeiro\Contabilidade\Relatorio\RREO\V2017\AnexoI as Anexo;
...
class AnexoI {
   ...
   * @return \AnexoIBalancoOrcamentario|Anexo
   */
  public static function getInstance($iAno, \Periodo $oPeriodo) {
    ...
    return new \AnexoIBalancoOrcamentario($iAno, \AnexoIBalancoOrcamentario::CODIGO_RELATORIO, $oPeriodo->getCodigo());
  }
}
