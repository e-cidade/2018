...
final class BalancoOrcamentarioDCASP2017 extends RelatoriosLegaisBase
{
     ...
     * @var array
     */
    private $aLinhasNegrito = array(1, 10, 16, 17, 18, 21, 24, 25, 26, 27, 31, 35, 39, 40, 41, 42, 45, 48, 49, 50, 52, 56, 60, 61, 65, 69);
    ...
    private function escreverCabecalhoPrincipal()
    {
        ...
        } elseif ($this->valorNoIntervalo($this->oLinha->ordem, self::QUADRO_PRINCIPAL_DESPESAS_INICIO, self::QUADRO_PRINCIPAL_DESPESAS_FIM)) {
     ...
     * @return \stdClass
     */
    private function processarLinha($iLinha)
    {
    ...
    public function emitir()
    {
        ...
        $this->oPdf->showPDF('balancoOrcamentarioDCASP2017_' . time());
    }
}
