...
for ($i = 0; $i < 2; $i++) {
   ...
   if ( $this->tipoguia == "n" ) {
     ...
     $sMensagemRecibo = 'Pagável nos bancos conveniados HSBC, CEF, Itaú, Banco do Brasil e Lotéricas.';
     if( !empty($this->sMensagemRecibo) ){
       $sMensagemRecibo = $this->sMensagemRecibo;
     }
     $this->objpdf->SetFont('Arial','',6);
     $this->objpdf->cell(60,$altura,$sMensagemRecibo,0,1,"C",0);
   }
   $this->objpdf->SetFont('Arial','B',10);
