...
for($i = 0; $i < 2; $i++){
   ...
   $this->objpdf->SetFont('Arial','B', 9);
   $this->objpdf->Text(140, $this->objpdf->gety() + 9, 'Código de Arrecadação: ');  
   $this->objpdf->SetFont('Arial','', 9);
   ...
   $this->objpdf->setx(30);
   $this->objpdf->MultiCell(180,3,'Tipo de Transmissão : '.$this->it04_descr,0,'L',0,0);
   $this->objpdf->sety($iY1);
   ...
   $this->objpdf->cell(96,$altura,'Identificação do Adquirente',1,1,"C",$iPreencheFundo);
   ...
   if ($this->tipoitbi == "urbano"){
     $this->objpdf->cell(106,$altura,'Dados das Construções',1,1,"C",$iPreencheFundo);
   } else {
