...
for ($contador = 0; $contador < $numrows_solicita; $contador++) {
	...
	$sCampos .= " m61_abrev, m61_descr, pc17_quant, pc01_codmater, pc01_descrmater,";
	$sCampos .= " case when pc11_vlrun is not null and pc11_vlrun > 0 then pc11_vlrun else (pc13_valor / pc13_quant) end as pc13_valtot, ";
