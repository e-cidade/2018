...
$clrotulo->label("ed114_i_ano");
$clrotulo->label("ed114_i_tipoconhecimento");
?>
<html>
<head>
   ...
   <table width="35%" border="0" align="center" cellspacing="0">
    ...
    <tr>
     <td colspan="2" align="center">
      ...
      <input name="Fechar" type="button" id="fechar" value="Fechar" onClick="parent.db_iframe_progconhec.hide();">
     </td>
    </tr>
   </form>
   </table>
   ...
   if(!isset($pesquisa_chave)){
    if(isset($campos)==false){
     if(file_exists("funcoes/db_func_progconhec.php")==true){
      include("funcoes/db_func_progconhec.php");
     }else{
      $campos = "progconhec.*";
     }
    }
    if(isset($chave_z01_nome) && (trim($chave_z01_nome)!="") ){
     $sql = $clprogconhec->sql_query("",$campos,"z01_nome,ed114_i_ano desc,ed114_d_data desc"," z01_nome like '$chave_z01_nome%' ");
    }elseif(isset($chave_ed114_i_ano) && (trim($chave_ed114_i_ano)!="") ){
     $sql = $clprogconhec->sql_query("",$campos,"z01_nome,ed114_i_ano desc"," ed114_i_ano = $chave_ed114_i_ano ");
    }elseif(isset($chave_ed114_i_tipoconhecimento) && (trim($chave_ed114_i_tipoconhecimento)!="") ){
     $sql = $clprogconhec->sql_query("",$campos,"z01_nome,ed114_i_ano desc"," ed114_i_tipoconhecimento = $chave_ed114_i_tipoconhecimento ");
    }else{
    ...
    if($pesquisa_chave!=null && $pesquisa_chave!=""){
     $result = $clprogconhec->sql_record($clprogconhec->sql_query($pesquisa_chave));
     if($clprogconhec->numrows!=0){
      db_fieldsmemory($result,0);
      echo "<script>".$funcao_js."('$ed114_i_codigo',false);</script>";
     }else{
