...
$oDaoagendamentos->lancar_transf_geral = true;
$oDaoagendamentos->lado_transf = 'de';
$oDaoagendamentos->lMarcaTodasChekBox = false;
$oDaoagendamentos->lTrazerAusencias = true;
$oDaoagendamentos->cria_table($sd27_i_codigo, $chave_diasemana, $sd23_d_consulta, $oDaoagendamentos, $oDaoundmedhorario, null);
