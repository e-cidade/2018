    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_e85_codmov) && (trim($chave_e85_codmov)!="") ){
					...
					if (isset($chave_e85_codmov)) {
						$where .= " and e85_codmov = $chave_e85_codmov";
					}
					if (isset($chave_e85_codmov)) {
						$where .= " and e85_codtipo = $chave_e85_codmov";
					}
	         $sql = $clempagepag->sql_query(null,null,$campos,"e85_codmov",$where);
        }else if(isset($chave_e85_codmov) && (trim($chave_e85_codmov)!="") ){
	         $sql = $clempagepag->sql_query("","",$campos,"e85_codmov"," e80_instit = " . db_getsession("DB_instit") . " and e85_codmov like '$chave_e85_codmov%' ");
        }else{
           $sql = $clempagepag->sql_query("","",$campos,"e85_codmov#e85_codtipo"," e80_instit = " . db_getsession("DB_instit"));
        }
