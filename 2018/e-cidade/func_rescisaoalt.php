      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_r59_regime) && (trim($chave_r59_regime)!="")){
          ...
          if(isset($chave_r59_causa) && (trim($chave_r59_causa)!="")){
     	      $causa_chave = $chave_r59_causa;
	        }
	         $sql = $clrescisao->sql_query($chave_r59_anousu,$chave_r59_mesusu,$chave_r59_regime,$causa_chave,null,null,$instit,$campos,"r59_regime");
        }else if(isset($chave_r59_causa) && (trim($chave_r59_causa)!="")){
	         $sql = $clrescisao->sql_query($chave_r59_anousu,$chave_r59_mesusu,$chave_r59_regime,$r59_causa,null           ,null,$instit,$campos,"r59_causa");
        ...
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          ...
          if($clrescisao->numrows!=0){
            ...
            echo "<script>".$funcao_js."('$r59_descr','$r59_caub','$r59_descr1',false);</script>";
          }else{
