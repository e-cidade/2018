	     ...
	     <form name="form2" method="post" action="" >
          ...
          <tr> 
            <td colspan="2" align="center"> 
              ...
              <input name="Fechar" type="button" id="fechar" value="Fechar" onClick="parent.db_iframe_issbaselog.hide();">
             </td>
          </tr>
        </form>
        </table>
    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_q102_sequencial) && (trim($chave_q102_sequencial)!="") ){
	         $sql = $clissbaselog->sql_query($chave_q102_sequencial,$campos,"q102_sequencial");
        }else if(isset($chave_q102_sequencial) && (trim($chave_q102_sequencial)!="") ){
	         $sql = $clissbaselog->sql_query("",$campos,"q102_sequencial"," q102_sequencial like '$chave_q102_sequencial%' ");
        }else{
           $sql = $clissbaselog->sql_query("",$campos,"q102_sequencial","");
        }
        $repassa = array();
        ...
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $clissbaselog->sql_record($clissbaselog->sql_query($pesquisa_chave));
