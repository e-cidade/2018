...
class M9704IptuVvtTaquari2018 extends PostgresMigration
{
    public function up()
    {
        $sSql = <<<VVT
...
VVT;
    ...
    {
        $this->execute("drop function fc_iptu_calculavvt_taquari_2018 ( integer, integer, integer, numeric, numeric, boolean, boolean)");
    }
}
