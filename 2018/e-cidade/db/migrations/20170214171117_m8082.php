...
class M8082 extends PostgresMigration
{

  public function up()
  {
    $this->execute("update db_syscampo set descricao  = 'Beneficiário', rotulo = 'Beneficiário', rotulorel = 'Beneficiário', tamanho = 13 where codcam = 12532");
