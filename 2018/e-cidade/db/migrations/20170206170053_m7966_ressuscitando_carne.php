...
class M7966RessuscitandoCarne extends PostgresMigration
{
    public function up()
    {
        $this->fichaCompensacaoUp();
        $this->fichaCompensacaoArrebancoUp();
    }

    public function down()
    {
        $this->fichaCompensacaoDown();
        $this->fichaCompensacaoArrebancoDown();
    }

    /**
     * Função que atualiza a função fc_fichacompensacao
     */
    private function fichaCompensacaoUp()
    {
  ...
  if iTipoConvenio = 2 then
    ...
    update arrebanco set k00_numbco = sNossoNumero
     where k00_numpre = iNumpre
       ...
       and k00_numbco = (sNumBanco::integer)::text;
...
EOL;
    ...
    /**
     * Função que retorna a função fc_fichacompensacao ao seu estado anterior
     */
    private function fichaCompensacaoDown()
    {
        $fichaCompensacao = <<<EOL
create or replace function fc_fichacompensacao(integer, integer, integer, date, float8) returns tp_fichacompensacao  as
$$
...
EOL;
    ...
    /**
     * Função que atualiza a função fc_fichacompensacaoarrebanco
     */
    private function fichaCompensacaoArrebancoUp()
    {
        $fichaCompensacaoArrebanco = <<<EOL
...
EOL;
        ...
        $this->execute($fichaCompensacaoArrebanco);
    }

    /**
     * Função que retorna a função fc_fichacompensacaoarrebanco ao seu estado anterior
     */
    private function fichaCompensacaoArrebancoDown()
    {
        $fichaCompensacaoArrebanco = <<<EOL
create or replace function fc_fichacompensacaoarrebanco(integer, integer, integer) returns varchar  as
$$
