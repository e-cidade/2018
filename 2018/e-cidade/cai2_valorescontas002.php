...
$dbwhere = " e80_instit = " . db_getsession("DB_instit") . " and (e92_processa = 't' and e92_sequencia <> 35) or () and e60_instit = ".db_getsession("DB_instit");
$valorin = "";
...
$result_valores = $clempage->sql_record($clempage->sql_query_pagam(null,"e53_valor,e53_vlranu,e53_vlrpag,e87_codgera,e87_descgera,e87_data,e87_hora,e83_descr,e83_conta,pc63_conta,pc63_dataconf,pc63_conta_dig,pc63_agencia,pc63_agencia_dig,e75_arquivoret,e76_lote,e76_movlote,e76_dataefet,e76_valorefet,e81_codmov,e60_codemp,e82_codord,e86_codmov,case when a.z01_numcgm='' or a.z01_numcgm is null then cgm.z01_numcgm else a.z01_numcgm end as z01_numcgm,case when a.z01_nome='' or a.z01_nome is null then cgm.z01_nome else a.z01_nome end as z01_nome,e81_valor,e83_codtipo,e83_descr","e83_codtipo,e87_codgera,z01_nome",$dbwhere));
