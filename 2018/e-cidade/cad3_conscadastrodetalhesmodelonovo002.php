...
if ( isset($oGet->caracteristicaslote) ) {
  ...
  if ( count($aDadosCaractLote) > 0 ) {
    ...
    $pdf->cell(10, $iAlt, 'Cód.'                                                                  ,0,0,"L",0);
    $pdf->cell(30, $iAlt, 'Grupo'                                                                 ,0,0,"L",0);
	        ...
	        $pdf->cell(20, $iAlt, $oDadoCaractLote->iPonto                                            ,0,1,"L",0);
      		...
      		if ($iTotalCaracteristicaLote == 6) {
      			...
      			$pdf->SetX(110);
				    ...
				    $pdf->cell(10, $iAlt, 'Cód.'                                                                  ,0,0,"L",0);
				    $pdf->cell(30, $iAlt, 'Grupo'                                                                 ,0,0,"L",0);
				    $pdf->cell(10, $iAlt, 'Ponto'                                                                 ,0,1,"L",0);
      		}
      		$pdf->SetX(110);
          $pdf->setfont('arial','',$iFontDados);
          $pdf->cell(10, $iAlt, $oDadoCaractLote->iCodigo                                           ,0,0,"L",0);
  ...
  if ( count($aDadosAverbacoes) > 0 ) {
    ...
    foreach ( $aDadosAverbacoes as $aAverbacoes ) {
      ...
      foreach ( $aAverbacoes as $oAverbacao ) {
        ...
        $xPosMultiCell = $pdf->GetX() + 63;
        $pdf->MultiCell(63, $iAlt, $oAverbacao->sObservacao, 0, 'T');
        $yPosMultiCell = $pdf->GetY();
        $pdf->SetY($yInicioLinha);
        $pdf->SetX($xPosMultiCell);
        $pdf->cell(30, $iAlt, $oAverbacao->sSituacao                                              ,0,1,"L",0);
        $pdf->SetY($yPosMultiCell);
      }
