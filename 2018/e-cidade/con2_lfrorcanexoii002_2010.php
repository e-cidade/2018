...
$pdf->cell(40,$alt,"DESPESAS (INTRA-ORÇAMENTÁRIAS)(II)","R",0,"L",0);
$pdf->setfont('arial','B',5);
...
$pdf->cell(40,$alt,"TOTAL (III) = (I + II)","RTB",0,"L",0);
...
function cabecalho($bimestre, $pdf,$sTipoPeriodo) {
  ...
  if ($bimestre != "6B") {
    ...
    $pdf->cell(20,$alt,"{$sTipoPeriodo}","BLR",0,"C",0);
    $pdf->cell(20,$alt,"{$sTipoPeriodo}","BLR",0,"C",0);
    $pdf->cell(17,$alt,"{$sTipoPeriodo}","BLR",0,"C",0);
    $pdf->cell(17,$alt,"{$sTipoPeriodo}(b)","BLR",0,"C",0);
    $pdf->setfont('arial','',5);
