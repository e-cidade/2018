...
$iAno               = (integer) db_getsession("DB_anousu");
$iCodigoPeriodo     = (integer) $oGet->periodo;
...
try {
  ...
  $oRelatorio = new MutacoesPatrimonioLiquidoDCASP($iAno, MutacoesPatrimonioLiquidoDCASP::CODIGO_RELATORIO, $iCodigoPeriodo);
  $oRelatorio->setInstituicoes($sListaInstituicoes);
  $oRelatorio->emitir();
