    ...
    <td align="center" valign="top">
      ...
      if (!isset($pesquisa_chave)) {
        ...
        if ($pesquisa_chave != null && $pesquisa_chave!="") {
          ...
          $sql = $clsaltes->sql_query_anousu(null, "*", "", "{$where} k13_conta={$pesquisa_chave} and c61_instit = ".db_getsession("DB_instit"));
          /** [Extensão] Filtro da Despesa */
          ...
          if ($clsaltes->numrows !=0 ) {
            ...
            echo "<script>".$funcao_js."('$k13_conta','$k13_descr','$c61_codigo',false);</script>";
          } else {
