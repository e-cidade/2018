    ...
    <td align="center" valign="top">
      ...
      if (!isset($pesquisa_chave)) {
        ...
        if (isset($chave_pc10_numero) && (trim($chave_pc10_numero)!="") ) {
          $sql = $clsolicita->sql_query_estregistrosemquantidade(null,$campos,"pc10_numero desc "," pc10_numero=$chave_pc10_numero $where_depart ");
        } else if (isset($chave_pc10_data) && (trim($chave_pc10_data)!="") ) {
          $sql = $clsolicita->sql_query_estregistrosemquantidade("",$campos,"pc10_numero desc "," pc10_data like '$chave_pc10_data%' $where_depart ");
        } else {
          $sql = $clsolicita->sql_query_estregistrosemquantidade("",$campos,"pc10_numero desc "," 1=1 $where_depart");
        }
         
        db_lovrot($sql,15,"()","",$funcao_js,"","NoMe",array(),false);
      } else {
        if ($pesquisa_chave!=null && $pesquisa_chave!="") {
          $result = $clsolicita->sql_record($clsolicita->sql_query_estregistrosemquantidade(null,"distinct *",""," pc10_numero=$pesquisa_chave $where_depart "));
