  ...
  function processa($instit=1,$data_ini="",$data_fim="",$orgaotrib=null,$subelemento="") {
    ...
    if ($oDaoArquivosPad->numrows > 0 ){
       ...
       $sSql = "select o58_orgao,
	     	               ...
	     	               round( sum(case when c70_data >= '$anousu-01-01' and c70_data < '$anousu-03-01' and c71_coddoc = 1 then c70_valor end) ,2)       as emp1,
	     	               round( sum(case when c70_data >= '$anousu-01-01' and c70_data < '$anousu-03-01' and c71_coddoc = 2 then c70_valor end) ,2)       as eemp1,
	     	               round( sum(case when c70_data >= '$anousu-01-01' and c70_data < '$anousu-03-01' and c71_coddoc in (3,23) then c70_valor end) ,2) as liq1,
	     	               round( sum(case when c70_data >= '$anousu-01-01' and c70_data < '$anousu-03-01' and c71_coddoc in (4,24) then c70_valor end) ,2) as eliq1,
	     	               ...
	     	               round( sum(case when c70_data >= '$anousu-03-01' and c70_data < '$anousu-05-01' and c71_coddoc = 1 then c70_valor end) ,2)       as emp2,
	     	               round( sum(case when c70_data >= '$anousu-03-01' and c70_data < '$anousu-05-01' and c71_coddoc = 2 then c70_valor end) ,2)       as eemp2,
	     	               round( sum(case when c70_data >= '$anousu-03-01' and c70_data < '$anousu-05-01' and c71_coddoc in (3,23) then c70_valor end) ,2) as liq2,
	     	               round( sum(case when c70_data >= '$anousu-03-01' and c70_data < '$anousu-05-01' and c71_coddoc in (4,24) then c70_valor end) ,2) as eliq2,
	     	               ...
	     	               round( sum(case when c70_data >= '$anousu-05-01' and c70_data < '$anousu-07-01' and c71_coddoc = 1 then c70_valor end) ,2)       as emp3,
	     	               round( sum(case when c70_data >= '$anousu-05-01' and c70_data < '$anousu-07-01' and c71_coddoc = 2 then c70_valor end) ,2)       as eemp3,
	     	               round( sum(case when c70_data >= '$anousu-05-01' and c70_data < '$anousu-07-01' and c71_coddoc in (3,23) then c70_valor end) ,2) as liq3,
	     	               round( sum(case when c70_data >= '$anousu-05-01' and c70_data < '$anousu-07-01' and c71_coddoc in (4,24) then c70_valor end) ,2) as eliq3,
	     	               ...
	     	               round( sum(case when c70_data >= '$anousu-07-01' and c70_data < '$anousu-09-01' and c71_coddoc = 1 then c70_valor end) ,2)       as emp4,
	     	               round( sum(case when c70_data >= '$anousu-07-01' and c70_data < '$anousu-09-01' and c71_coddoc = 2 then c70_valor end) ,2)       as eemp4,
	     	               round( sum(case when c70_data >= '$anousu-07-01' and c70_data < '$anousu-09-01' and c71_coddoc in (3,23) then c70_valor end) ,2) as liq4,
	     	               round( sum(case when c70_data >= '$anousu-07-01' and c70_data < '$anousu-09-01' and c71_coddoc in (4,24) then c70_valor end) ,2) as eliq4,
	     	               ...
	     	               round( sum(case when c70_data >= '$anousu-09-01' and c70_data < '$anousu-11-01' and c71_coddoc = 1 then c70_valor end) ,2)       as emp5,
	     	               round( sum(case when c70_data >= '$anousu-09-01' and c70_data < '$anousu-11-01' and c71_coddoc = 2 then c70_valor end) ,2)       as eemp5,
	     	               round( sum(case when c70_data >= '$anousu-09-01' and c70_data < '$anousu-11-01' and c71_coddoc in (3,23) then c70_valor end) ,2) as liq5,
	     	               round( sum(case when c70_data >= '$anousu-09-01' and c70_data < '$anousu-11-01' and c71_coddoc in (4,24) then c70_valor end) ,2) as eliq5,
	     	               ...
	     	               round( sum(case when c70_data >= '$anousu-11-01' and c70_data <= '$anousu-12-31' and c71_coddoc = 1 then c70_valor end) ,2)       as emp6,
	     	               round( sum(case when c70_data >= '$anousu-11-01' and c70_data <= '$anousu-12-31' and c71_coddoc = 2 then c70_valor end) ,2)       as eemp6,
	     	               round( sum(case when c70_data >= '$anousu-11-01' and c70_data <= '$anousu-12-31' and c71_coddoc in (3,23) then c70_valor end) ,2) as liq6,
	     	               round( sum(case when c70_data >= '$anousu-11-01' and c70_data <= '$anousu-12-31' and c71_coddoc in (4,24) then c70_valor end) ,2) as eliq6,
