    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        $sql = " select distinct
                        ...
                        j39_compl, j34_setor, j34_quadra, j34_lote 
                   from iptubase 
...
function js_mostraruas(mostra) {
  ...
  if(mostra==true){
    ...
    db_iframe.jan.location.href = 'func_ruas.php?pesquisa_chave='+document.form1.j14_codigo.value+'&funcao_js=parent.js_preencheruas&iptu=true';  
  }
}
