...
class cl_acordo {
   ...
   function incluir ($ac16_sequencial){
     ...
     if($this->ac16_acordosituacao == null ){
       $this->erro_sql = " Campo Acordo Situação nao Informado.";
     ...
     if($this->ac16_qtdrenovacao == null ){
       $this->erro_sql = " Campo Quantidade de Renovação nao Informado.";
     ...
     if($this->ac16_deptoresponsavel == null ){
       $this->erro_sql = " Campo Departamento Responsável nao Informado.";
     ...
     if($this->ac16_periodocomercial == null ){
       $this->erro_sql = " Campo Período Comercial nao Informado.";
  ...
  /**
   * Retorna as movimentações do acordo de origem manual
   */
