...
class cl_db_itensmenu { 
   ...
   function incluir ($id_item){ 
     ...
     if($this->itemativo == null ){ 
       $this->erro_sql = " Campo Ítem ativo nao Informado.";
     ...
     if($this->desctec == null ){ 
       $this->erro_sql = " Campo Descrição Técnica nao Informado.";
     ...
     if($this->libcliente == null ){ 
       $this->erro_sql = " Campo Se item de menu está liberado para cliente nao Informado.";
   ...
   function alterar ($id_item=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["help"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["funcao"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["itemativo"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["manutencao"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["desctec"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["libcliente"]))
