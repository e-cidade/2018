...
class cl_db_auditoria { 
  ...
  function sql_query_acessos( $sCampos = null, $iCodigoAcesso = null, $aParametros ) {
    ...
    /**
     * Join para consultar as modificações de acordo com os filtros selecionados, comparando com o logacesso da 
     * tabela db_logsacessa
     */
    $sLeft .= "   left join configuracoes.fc_auditoria_consulta_mudancas('{$dDataInicio} {$sHoraInicio}',\n";
    $sLeft .= "                                                          '{$dDataFim} {$sHoraFim}',      \n";
    $sLeft .= "                                                          {$sEsquema},                    \n";
    $sLeft .= "                                                          {$sTabela},                     \n";
    $sLeft .= "                                                          {$sUsuario},                    \n";
    $sLeft .= "                                                          null,                           \n";
    ...
    $sLeft .= "                                                          {$sCampo},                      \n";
    $sLeft .= "                                                          {$mValor},                      \n";
    $sLeft .= "                                                          {$mValor}) as fc_auditoria      \n";
    $sLeft .= "   on fc_auditoria.logsacessa = db_logsacessa.codsequen                                   \n";
    
    $sSql = "select {$sCampos},                                                                                      \n";
    $sSql.= "       db_itensmenu.descricao as descricao_menu,                                                        \n";
    $sSql.= "       exists(select 1                                                                                  \n";
    $sSql.= "                from configuracoes.db_auditoria                                                         \n";
    $sSql.= "               where configuracoes.db_auditoria.logsacessa = db_logsacessa.codsequen                    \n";
    $sSql.= "                 and configuracoes.db_auditoria.instit     = {$iInstituicao}                            \n";
    $sSql.= "                 and configuracoes.db_auditoria.usuario    = db_usuarios.login                          \n";
    $sSql.= "                 and configuracoes.db_auditoria.datahora_sessao between '{$dDataInicio} {$sHoraInicio}' \n";
    $sSql.= "                                                                    and '{$dDataFim} {$sHoraFim}'       \n";
    $sSql.= "             ) as modificacoes                                                                          \n";
    ...
    $sSql.= "       {$sLeft}";
    $sSql.= " where db_logsacessa.instit     = {$iInstituicao}                                                       \n";
    $sSql.= "   and db_logsacessa.data between '{$dDataInicio}' and '{$dDataFim}'                                    \n";
    ...
    if ( array_key_exists( "iModulo", $aParametros ) && !empty( $aParametros["iModulo"] ) ) {
      ...
      /**
       * Caso tenha sido selecionado um esquema, buscamos a existência de registro na PL de auditoria, retornando somente
       * mudanças realizadas
       */
      if ( $lTemEsquema ) {
      
        $sWhere .= "   and exists (select 1 ";
        $sWhere .= "                 from configuracoes.fc_auditoria_consulta_mudancas('{$dDataInicio} {$sHoraInicio}',\n";
        $sWhere .= "                                                                   '{$dDataFim} {$sHoraFim}',      \n";
        $sWhere .= "                                                                   {$sEsquema},                    \n";
        $sWhere .= "                                                                   {$sTabela},                     \n";
        $sWhere .= "                                                                   {$sUsuario},                    \n";
        $sWhere .= "                                                                   null,                           \n";
        ...
        $sWhere .= "                                                                   {$sCampo},                      \n";
        $sWhere .= "                                                                   {$mValor},                      \n";
        $sWhere .= "                                                                   {$mValor}) as fc_auditoria2     \n"; 
        $sWhere .= "               where  fc_auditoria2.logsacessa = db_logsacessa.codsequen )                         \n";
      }
    }
  ...
  function sql_query_modificacoes($iCodigoAcesso, $dDataAcesso) {
    ...
    $sSql.= "  from configuracoes.fc_auditoria_consulta_mudancas('{$dDataAcesso} 00:00:00.000000',   \n";
    $sSql.= "                                                    '{$dDataAcesso} 23:59:59.999999',   \n";
    $sSql.= "                                                    null,                               \n";
    $sSql.= "                                                    null,                               \n";
    $sSql.= "                                                    null,                               \n";
    $sSql.= "                                                    {$iCodigoAcesso},                   \n";
    $sSql.= "                                                    1)  AS fc_auditoria                 \n";
