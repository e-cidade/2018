...
//MODULO: empenho
//CLASSE DA ENTIDADE empprestatip
class cl_empprestatip { 
   ...
   function incluir ($e44_tipo){ 
     ...
     if($this->e44_descr == null ){ 
       $this->erro_sql = " Campo Descrição do evento nao Informado.";
     ...
     if($this->e44_obriga == null ){ 
       $this->erro_sql = " Campo Obriga nao Informado.";
   ...
   function alterar ($e44_tipo=null) { 
      $this->atualizacampos();
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["e44_tipo"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["e44_descr"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["e44_obriga"]))
   ...
   function excluir ($e44_tipo=null,$dbwhere=null) { 
   ...
   function sql_query ( $e44_tipo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
   ...
   function sql_query_file ( $e44_tipo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = split("#",$campos);
       $virgula = "";
