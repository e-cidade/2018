...
class cl_contacorrente {
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->c17_sequencial = ($this->c17_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["c17_sequencial"]:$this->c17_sequencial);
       $this->c17_contacorrente = ($this->c17_contacorrente == ""?@$GLOBALS["HTTP_POST_VARS"]["c17_contacorrente"]:$this->c17_contacorrente);
       $this->c17_descricao = ($this->c17_descricao == ""?@$GLOBALS["HTTP_POST_VARS"]["c17_descricao"]:$this->c17_descricao);
     }else{
       $this->c17_sequencial = ($this->c17_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["c17_sequencial"]:$this->c17_sequencial);
     }
   }
   // funcao para inclusao
   function incluir ($c17_sequencial){
      $this->atualizacampos();
     if($this->c17_contacorrente == null ){
     ...
     if($c17_sequencial == "" || $c17_sequencial == null ){
       $result = db_query("select nextval('contacorrente_c17_sequencial_seq')");
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: contacorrente_c17_sequencial_seq do campo: c17_sequencial";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false;
       ...
       if(($result != false) && (pg_result($result,0,0) < $c17_sequencial)){
         ...
         $this->c17_sequencial = $c17_sequencial;
       }
     }
     if(($this->c17_sequencial == null) || ($this->c17_sequencial == "") ){
       $this->erro_sql = " Campo c17_sequencial nao declarado.";
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->c17_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($c17_sequencial=null) {
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($c17_sequencial!=null){
       $sql .= " c17_sequencial = $this->c17_sequencial";
     }
     $lSessaoDesativarAccount = db_getsession("DB_desativar_account", false);
     if (isset($lSessaoDesativarAccount) && $lSessaoDesativarAccount === false) {
     ...
     if($result==false){
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Conta Corrente nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->c17_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Conta Corrente nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->c17_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($c17_sequencial=null,$dbwhere=null) {
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($c17_sequencial));
     }else{
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($c17_sequencial != ""){
          ...
          $sql2 .= " c17_sequencial = $c17_sequencial ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Conta Corrente nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$c17_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Conta Corrente nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$c17_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $c17_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     ...
     $sql .= " from contacorrente ";
     $sql2 = "";
     if($dbwhere==""){
       if($c17_sequencial!=null ){
         $sql2 .= " where contacorrente.c17_sequencial = $c17_sequencial ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
