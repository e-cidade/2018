...
class cl_cgs { 
   ...
   function incluir ($z01_i_numcgs){ 
     ...
     if(($this->z01_i_numcgs == null) || ($this->z01_i_numcgs == "") ){ 
       $this->erro_sql = " Campo z01_i_numcgs nao declarado.";
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "cgs ($this->z01_i_numcgs) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function alterar ($z01_i_numcgs=null) { 
      $this->atualizacampos();
     $sql = " update cgs set ";
     $virgula = "";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["z01_i_numcgs"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["z01_i_tiposangue"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["z01_i_fatorrh"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["z01_v_familia"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["z01_v_microarea"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["z01_c_municipio"]))
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "cgs nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->z01_i_numcgs;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "cgs nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->z01_i_numcgs;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($z01_i_numcgs=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1010142,1008863,'','".AddSlashes(pg_result($resaco,$iresaco,'z01_c_cartaosus'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "cgs nao Excluído. Exclusão Abortada.\\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "cgs nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$z01_i_numcgs;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $z01_i_numcgs=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
   ...
   function sql_query_file ( $z01_i_numcgs=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = split("#",$campos);
       $virgula = "";
