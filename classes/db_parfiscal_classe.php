...
class cl_parfiscal { 
   ...
   var $campos = "
                 y32_instit = int4 = Cod. Instituição 
                 y32_tipo = int4 = tipo de debito 
                 y32_hist = int4 = Hist.Calc. 
                 y32_impdatas = bool = Imprime datas do alvara sanitário 
                 y32_impcodativ = bool = Código atividade do alvara sanitario 
                 y32_impobs = bool = Imprime observação do alvara Sanitario 
                 y32_impobslanc = bool = Observação do Lancamento 
                 ...
                 y32_sanidepto = int4 = Controla Sanitário por Depto. 
                 y32_sanbaixadiv = int4 = Permite baixa de sanitario com dívida 
   ...
   function incluir ($y32_instit){ 
     ...
     if($this->y32_impdatas == null ){ 
       $this->erro_sql = " Campo Imprime datas do alvara sanitário nao Informado.";
     ...
     if($this->y32_impcodativ == null ){ 
       $this->erro_sql = " Campo Código atividade do alvara sanitario nao Informado.";
     ...
     if($this->y32_impobs == null ){ 
       $this->erro_sql = " Campo Imprime observação do alvara Sanitario nao Informado.";
     ...
     if($this->y32_impobslanc == null ){ 
       $this->erro_sql = " Campo Observação do Lancamento nao Informado.";
     ...
     if($this->y32_sanidepto == null ){ 
       $this->erro_sql = " Campo Controla Sanitário por Depto. nao Informado.";
     ...
     if($this->y32_sanbaixadiv == null ){ 
       $this->erro_sql = " Campo Permite baixa de sanitario com dívida nao Informado.";
