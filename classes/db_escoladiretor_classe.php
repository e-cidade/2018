...
class cl_escoladiretor {
   ...
   function incluir ($ed254_i_codigo){
     ...
     if($this->ed254_i_atolegal == null ){
       ...
       $this->erro_campo = "ed254_i_atolegal";
       $this->erro_banco = "";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
   ...
   function alterar ($ed254_i_codigo=null) {
     ...
     if(trim($this->ed254_i_atolegal)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed254_i_atolegal"])){
       ...
       $virgula = ",";
       if(trim($this->ed254_i_atolegal) == null ){
         $this->erro_sql = " Campo Ato Legal nao Informado.";
         $this->erro_campo = "ed254_i_atolegal";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function sql_query ( $ed254_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){
     ...
     $sql .= "      inner join atolegal  on  atolegal.ed05_i_codigo = escoladiretor.ed254_i_atolegal";
