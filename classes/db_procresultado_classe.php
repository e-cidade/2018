...
class cl_procresultado { 
   ...
   function incluir ($ed43_i_codigo){ 
     ...
     if($this->ed43_c_obtencao == null ){ 
       $this->erro_sql = " Campo Forma de Obtenção nao Informado.";
     ...
     if($this->ed43_c_reprovafreq == null ){ 
       $this->erro_sql = " Campo Reprova por Frequência nao Informado.";
     ...
     if($this->ed43_c_arredmedia == null ){ 
       $this->erro_sql = " Campo Arredondar Média nao Informado.";
