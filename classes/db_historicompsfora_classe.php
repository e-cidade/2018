...
class cl_historicompsfora { 
   ...
   function alterar ($ed99_i_codigo=null) { 
      $this->atualizacampos();
   ...
   function excluir ($ed99_i_codigo=null,$dbwhere=null) { 
   ...
   // funcao do sql 
   function sql_query ( $ed99_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
   ...
   // funcao do sql 
   function sql_query_file ( $ed99_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = split("#",$campos);
       $virgula = "";
