...
class cl_caiparametro { 
   ...
   var $campos = "
                 ...
                 k29_datasaldocontasextra = date = Data Implatação Saldo Extra 
                 k29_trazdatacheque = bool = Trazer data cheques pagamentos agenda 
                 k29_contassemmovimento = bool = Traz Contas sem Movimento 
                 ";
   ...
   function incluir ($k29_instit){ 
     ...
     if($this->k29_contassemmovimento == null ){ 
       $this->erro_sql = " Campo Traz Contas sem Movimento nao Informado.";
