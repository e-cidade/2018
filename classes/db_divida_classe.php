...
class cl_divida { 
   ...
   function incluir_adivida (){
    ...
    $sql_inclui_adivida = "
                          ...
                          ";
     $result = @pg_exec($sql_inclui_adivida);
     if($result==false){
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql = " ($this->v01_coddiv) nao Incluído. Inclusao Abortada.";
  ...
  function getExercicioDivida($iNumpre, $iCadTipo, $iAnoDefult) {
    ...
    switch ($iCadTipo) {
      ...
      case 1 :  //iptu           iptunump
        ...
        $sSqlExercicio = $oDaoIptuNump->sql_query_file(null, null, "j20_anousu as exercicio",
                                                       null, "j20_numpre = {$iNumpre}");
      break;  
