...
class cl_rhpessoalmov {
   ...
   function incluir ($rh02_seqpes,$rh02_instit){
     ...
     if($this->rh02_equip == null ){
       $this->erro_sql = " Campo Equiparação nao Informado.";
     ...
     if($this->rh02_deficientefisico == null ){
       $this->erro_sql = " Campo Deficiente Físico nao Informado.";
     ...
     if($this->rh02_portadormolestia == null ){
       $this->erro_sql = " Campo Portador de Moléstia nao Informado.";
     ...
     if($result==false){
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Cadastro de pessoal ($this->rh02_seqpes."-".$this->rh02_instit) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function excluir ($rh02_seqpes=null,$rh02_instit=null,$dbwhere=null) {
     ...
     if($result==false){
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Cadastro de pessoal nao Excluído. Exclusão Abortada.\\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Cadastro de pessoal nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$rh02_seqpes."-".$rh02_instit;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
