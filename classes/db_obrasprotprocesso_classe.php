...
//MODULO: projetos
//CLASSE DA ENTIDADE obrasprotprocesso
...
class cl_obrasprotprocesso { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->ob25_sequencial = ($this->ob25_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["ob25_sequencial"]:$this->ob25_sequencial);
       $this->ob25_obras = ($this->ob25_obras == ""?@$GLOBALS["HTTP_POST_VARS"]["ob25_obras"]:$this->ob25_obras);
       $this->ob25_protprocesso = ($this->ob25_protprocesso == ""?@$GLOBALS["HTTP_POST_VARS"]["ob25_protprocesso"]:$this->ob25_protprocesso);
     }else{
       $this->ob25_sequencial = ($this->ob25_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["ob25_sequencial"]:$this->ob25_sequencial);
     }
   }
   // funcao para inclusao
   function incluir ($ob25_sequencial){ 
      $this->atualizacampos();
     if($this->ob25_obras == null ){ 
     ...
     if($this->ob25_protprocesso == null ){ 
     ...
     if($ob25_sequencial == "" || $ob25_sequencial == null ){
       $result = db_query("select nextval('obrasprotprocesso_ob25_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: obrasprotprocesso_ob25_sequencial_seq do campo: ob25_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $ob25_sequencial)){
         ...
         $this->ob25_sequencial = $ob25_sequencial; 
       }
     }
     if(($this->ob25_sequencial == null) || ($this->ob25_sequencial == "") ){ 
       $this->erro_sql = " Campo ob25_sequencial nao declarado.";
     ...
     $sql = "insert into obrasprotprocesso(
                                       ob25_sequencial 
                                      ,ob25_obras 
                                      ,ob25_protprocesso 
                       )
                values (
                                $this->ob25_sequencial 
                               ,$this->ob25_obras 
                               ,$this->ob25_protprocesso 
                      )";
     $result = db_query($sql); 
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->ob25_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($ob25_sequencial=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($ob25_sequencial!=null){
       $sql .= " ob25_sequencial = $this->ob25_sequencial";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->ob25_sequencial));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Processo da Obra nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->ob25_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Processo da Obra nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->ob25_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($ob25_sequencial=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($ob25_sequencial));
     }else{ 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($ob25_sequencial != ""){
          ...
          $sql2 .= " ob25_sequencial = $ob25_sequencial ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Processo da Obra nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$ob25_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Processo da Obra nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$ob25_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $ob25_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from obrasprotprocesso ";
     $sql .= "      inner join protprocesso  on  protprocesso.p58_codproc = obrasprotprocesso.ob25_protprocesso";
     $sql .= "      inner join obras  on  obras.ob01_codobra = obrasprotprocesso.ob25_obras";
     ...
     if($dbwhere==""){
       if($ob25_sequencial!=null ){
         $sql2 .= " where obrasprotprocesso.ob25_sequencial = $ob25_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
