...
class cl_prontuarios { 
   ...
   var $campos = "
                 ...
                 sd24_d_cadastro = date = Data Cadastro 
                 sd24_c_cadastro = varchar(20) = Hora Cadastro 
   ...
   function incluir ($sd24_i_codigo){ 
     ...
     if($this->sd24_i_unidade == null ){ 
       $this->erro_sql = " Campo UPS nao Informado.";
     ...
     if($this->sd24_c_cadastro == null ){ 
       $this->erro_sql = " Campo Hora Cadastro nao Informado.";
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Prontuários ($this->sd24_i_codigo) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function alterar ($sd24_i_codigo=null) { 
      $this->atualizacampos();
   ...
   function excluir ($sd24_i_codigo=null,$dbwhere=null) { 
   ...
   // funcao do sql 
   function sql_query ( $sd24_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
...
//     $sql .= "      left join unidades  as a on   a.sd02_i_codigo = unidademedicos.sd04_i_unidade";
   ...
   // funcao do sql 
   function sql_query_file ( $sd24_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = split("#",$campos);
       $virgula = "";
