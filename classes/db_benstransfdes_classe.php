...
class cl_benstransfdes { 
   ...
   var $campos = "
                 t94_codtran = int8 = Transferência 
                 t94_depart = int4 = Departamento destino 
                 t94_divisao = int4 = Divisão 
                 ";
   ...
   function incluir ($t94_codtran,$t94_depart){ 
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Departamento de destino da transferência ($this->t94_codtran."-".$this->t94_depart) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
