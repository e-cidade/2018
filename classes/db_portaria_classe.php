...
class cl_portaria { 
   ...
   function incluir ($h31_sequencial){ 
     ...
     if($this->h31_dtportaria == null ){ 
       $this->erro_sql = " Campo Data da Portaria nao Informado.";
   ...
   function alterar ($h31_sequencial=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["h31_sequencial"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["h31_portariatipo"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["h31_usuario"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["h31_numero"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["h31_anousu"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["h31_dtportaria"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["h31_dtinicio"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["h31_dtlanc"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["h31_amparolegal"]))
