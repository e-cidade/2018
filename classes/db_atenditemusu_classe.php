...
class cl_atenditemusu { 
   ...
   var $campos = "
                 ...
                 at21_atenditem = int4 = Sequência do atenditem 
                 at21_codatend = int4 = Código de atendimento 
   ...
   function incluir ($at21_sequencial){ 
     ...
     if($this->at21_atenditem == null ){ 
       $this->erro_sql = " Campo Sequência do atenditem nao Informado.";
     ...
     if($at21_sequencial == "" || $at21_sequencial == null ){
       ...
       if(($result != false) && (pg_result($result,0,0) < $at21_sequencial)){
         $this->erro_sql = " Campo at21_sequencial maior que último número da sequencia.";
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Usuarios envolvidos no item de atendimento ($this->at21_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "Usuarios envolvidos no item de atendimento já Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       }else{
         $this->erro_sql   = "Usuarios envolvidos no item de atendimento ($this->at21_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function excluir ($at21_sequencial=null,$dbwhere=null) { 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Usuarios envolvidos no item de atendimento nao Excluído. Exclusão Abortada.\\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Usuarios envolvidos no item de atendimento nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$at21_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
