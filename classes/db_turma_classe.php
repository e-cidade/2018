...
class cl_turma {
   ...
   var $ed57_i_turno = 0;
   var $ed57_i_sala = 0;
   var $ed57_i_numvagas = 0;
   var $ed57_i_nummatr = 0;
   ...
   var $campos = "
                 ...
                 ed57_c_descr = char(10) = Nome da Turma
                 ed57_i_base = int8 = Base Curricular
                 ed57_i_turno = int8 = Turno
                 ed57_i_sala = int8 = Sala
                 ed57_i_numvagas = int4 = Vagas
                 ed57_i_nummatr = int4 = Alunos Matriculados
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->ed57_i_numvagas = ($this->ed57_i_numvagas == ""?@$GLOBALS["HTTP_POST_VARS"]["ed57_i_numvagas"]:$this->ed57_i_numvagas);
       $this->ed57_i_nummatr = ($this->ed57_i_nummatr == ""?@$GLOBALS["HTTP_POST_VARS"]["ed57_i_nummatr"]:$this->ed57_i_nummatr);
       ...
       $this->ed57_censoprogramamaiseducacao = ($this->ed57_censoprogramamaiseducacao == ""?@$GLOBALS["HTTP_POST_VARS"]["ed57_censoprogramamaiseducacao"]:$this->ed57_censoprogramamaiseducacao);
     }else{
       $this->ed57_i_codigo = ($this->ed57_i_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["ed57_i_codigo"]:$this->ed57_i_codigo);
     }
   }
   ...
   function incluir ($ed57_i_codigo){
     ...
     if($this->ed57_i_numvagas == null ){
       $this->erro_sql = " Campo Vagas nao Informado.";
       $this->erro_campo = "ed57_i_numvagas";
       $this->erro_banco = "";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
     ...
     if($this->ed57_i_nummatr == null ){
       $this->ed57_i_nummatr = "0";
     }
     ...
     if($this->ed57_i_censoetapa == null ){
       $this->erro_sql = " Campo Etapa Censo nao Informado.";
       $this->erro_campo = "ed57_i_censoetapa";
       $this->erro_banco = "";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
     ...
     if(($this->ed57_i_codigo == null) || ($this->ed57_i_codigo == "") ){
       $this->erro_sql = " Campo ed57_i_codigo nao declarado.";
     ...
     if($result==false){
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Cadastro de Turmas ($this->ed57_i_codigo) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1010083,1008492,'','".AddSlashes(pg_result($resaco,0,'ed57_i_numvagas'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1010083,1008493,'','".AddSlashes(pg_result($resaco,0,'ed57_i_nummatr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
   ...
   function alterar ($ed57_i_codigo=null) {
      $this->atualizacampos();
     ...
     if(trim($this->ed57_i_numvagas)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed57_i_numvagas"])){
       $sql  .= $virgula." ed57_i_numvagas = $this->ed57_i_numvagas ";
       $virgula = ",";
       if(trim($this->ed57_i_numvagas) == null ){
         $this->erro_sql = " Campo Vagas nao Informado.";
         $this->erro_campo = "ed57_i_numvagas";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim($this->ed57_i_nummatr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed57_i_nummatr"])){
       $sql  .= $virgula." ed57_i_nummatr = $this->ed57_i_nummatr ";
       $virgula = ",";
       if(trim($this->ed57_i_nummatr) == null ){
         $this->erro_sql = " Campo Alunos Matriculados nao Informado.";
         $this->erro_campo = "ed57_i_nummatr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
     ...
     if(trim($this->ed57_i_censoetapa)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed57_i_censoetapa"])){
       $sql  .= $virgula." ed57_i_censoetapa = $this->ed57_i_censoetapa ";
       $virgula = ",";
       if(trim($this->ed57_i_censoetapa) == null ){
         $this->erro_sql = " Campo Etapa Censo nao Informado.";
         $this->erro_campo = "ed57_i_censoetapa";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed57_i_codigo"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed57_i_escola"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed57_i_calendario"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed57_c_descr"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed57_i_base"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed57_i_turno"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed57_i_sala"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed57_i_numvagas"]))
           $resac = db_query("insert into db_acount values($acount,1010083,1008492,'".AddSlashes(pg_result($resaco,$conresaco,'ed57_i_numvagas'))."','$this->ed57_i_numvagas',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed57_i_nummatr"]))
           $resac = db_query("insert into db_acount values($acount,1010083,1008493,'".AddSlashes(pg_result($resaco,$conresaco,'ed57_i_nummatr'))."','$this->ed57_i_nummatr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed57_c_medfreq"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed57_t_obs"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed57_i_codigoinep"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed57_i_tipoatend"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed57_i_ativqtd"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed57_i_censocursoprofiss"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed57_i_tipoturma"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed57_i_censoetapa"]))
     ...
     if($result==false){
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Cadastro de Turmas nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->ed57_i_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Cadastro de Turmas nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->ed57_i_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($ed57_i_codigo=null,$dbwhere=null) {
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1010083,1008492,'','".AddSlashes(pg_result($resaco,$iresaco,'ed57_i_numvagas'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010083,1008493,'','".AddSlashes(pg_result($resaco,$iresaco,'ed57_i_nummatr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     ...
     if($result==false){
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Cadastro de Turmas nao Excluído. Exclusão Abortada.\\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Cadastro de Turmas nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$ed57_i_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   // funcao do sql 
   function sql_query ( $ed57_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
   ...
   // funcao do sql 
   function sql_query_file ( $ed57_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = split("#",$campos);
       $virgula = "";
   ...
   function sql_query_turmaserie($iCodigo = null, $sCampos = '*', $sOrdem = null, $sDbWhere = '') { 
    ...
    $sSql .= "      left  join censoetapa  on  censoetapa.ed266_i_codigo = turma.ed57_i_censoetapa";
    $sSql2 = '';
    if ($sDbWhere == '') {
