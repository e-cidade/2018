...
class cl_cfiptu { 
   ...
   var $campos = "
                 ...
                 j18_tipoisen = int4 = Codigo da isenção 
   ...
   function incluir ($j18_anousu){ 
     ...
     if($this->j18_vlrref == null ){ 
       $this->erro_sql = " Campo Valor referência nao Informado.";
     ...
     if($this->j18_logradauto == null ){ 
       $this->erro_sql = " Campo Código do Logradouro Automático nao Informado.";
     ...
     if($this->j18_excconscalc == null ){ 
       $this->erro_sql = " Campo Excluir construção do Cálculo nao Informado.";
     ...
     if($this->j18_utilizaloc == null ){ 
       $this->erro_sql = " Campo Utilizar informações de localização nao Informado.";
     ...
     if($this->j18_dadoscertisen == null ){ 
       $this->erro_sql = " Campo Dados da certidão de isenção nao Informado.";
     ...
     if($this->j18_utilpontos == null ){ 
       $this->erro_sql = " Campo Utilizar pontuação por construção nao Informado.";
     ...
     if($this->j18_iptuhistisen == null ){ 
       $this->erro_sql = " Campo Código do histórico de isenção nao Informado.";
