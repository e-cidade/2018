      ...
      if(!isset($pesquisa_chave)){
        if(isset($campos)==false){
           if(file_exists("funcoes/db_func_iptucadtaxaexe.php")==true){
             include("funcoes/db_func_iptucadtaxaexe.php");
           }else{
           $campos = "iptucadtaxaexe.*";
           }
        }
        if(isset($chave_j08_iptucadtaxaexe) && (trim($chave_j08_iptucadtaxaexe)!="") ){
	         $sql = $cliptucadtaxaexe->sql_query($chave_j08_iptucadtaxaexe,$campos,"j08_iptucadtaxaexe");
        }else if(isset($chave_j08_iptucadtaxa) && (trim($chave_j08_iptucadtaxa)!="") ){
	         $sql = $cliptucadtaxaexe->sql_query("",$campos,"j08_iptucadtaxa"," j08_iptucadtaxa like '$chave_j08_iptucadtaxa%' ");
        }else{
        ...
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $cliptucadtaxaexe->sql_record($cliptucadtaxaexe->sql_query($pesquisa_chave));
          if($cliptucadtaxaexe->numrows!=0){
            db_fieldsmemory($result,0);
            echo "<script>".$funcao_js."('$j08_iptucadtaxa',false);</script>";
          }else{
