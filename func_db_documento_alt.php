    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_db03_docum) && (trim($chave_db03_docum)!="") ){
	         $sql = $cldb_documento->sql_query("",$campos,"db03_docum","db03_docum = $chave_db03_docum and db03_tipodoc = 1700 ");
        }else if(isset($chave_db03_descr) && (trim($chave_db03_descr)!="") ){
	         $sql = $cldb_documento->sql_query("",$campos,"db03_descr"," db03_descr like '$chave_db03_descr%' and db03_tipodoc = 1700 ");
        }else{
           $sql = $cldb_documento->sql_query("",$campos,"db03_docum"," db03_tipodoc = 1700");
        }
//	echo $sql;
