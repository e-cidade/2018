  ...
  <tr> 
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        }else if(isset($chave_ac02_sequencial) && (trim($chave_ac02_sequencial)!="") ){
	         $sql = $clacordogrupo->sql_query("",$campos,"ac02_sequencial"," ac02_sequencial like '$chave_ac02_sequencial%' ");
        }else{
           $sql = $clacordogrupo->sql_query("",$campos,"ac02_sequencial","");
        }
        $repassa = array();
        if(isset($chave_ac02_sequencial)){
          $repassa = array("chave_ac02_sequencial"=>$chave_ac02_sequencial,"chave_ac02_sequencial"=>$chave_ac02_sequencial);
        }
