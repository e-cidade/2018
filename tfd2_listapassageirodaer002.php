...
$sCampos .= 'tf03_f_distancia, tf18_i_veiculo, tf18_c_localsaida, tf18_i_codigo, z01_v_cgccpf, ';
...
$sSql    = $oDaoTfdVeiculoDestino->sql_query_lista_daer(null, $sCampos, null,	$sWhere.' and tf19_i_colo = 2 and tf01_i_situacao = 1' );
$rs      = $oDaoTfdVeiculoDestino->sql_record($sSql);
$iQtdLinhasPassageiros = $oDaoTfdVeiculoDestino->numrows;

/* Busca os passageiros de colo */
$sSql        = $oDaoTfdVeiculoDestino->sql_query_lista_daer(null, $sCampos, null,	$sWhere.' and tf19_i_colo = 1 and tf01_i_situacao = 1' );
...
$sSql           = $oDaoTfdPassageiroRetorno->sql_query2(null, $sCampos, 'z01_v_nome',	$sWhere.' and tf31_i_valido = 1' );
...
<table width='100%'>
	<tr>
		<td align='center'><font color='#FF0000' face='arial'> <b>Nenhum registro encontrado</b><br> <input type='button' value='Fechar' onclick='window.close()'></b>
		</font>
		</td>
	</tr>
</table>
