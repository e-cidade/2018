...
class cl_orcprojeto {
	...
	function incluir($o39_codproj) {
		...
		if ($o39_codproj == "" || $o39_codproj == null) {
			$result = @ pg_query("select nextval('orcprojeto_o39_codproj_seq')");
			if ($result == false) {
			...
			$result = @ pg_query("select last_value from orcprojeto_o39_codproj_seq");
		...
		if (($resaco != false) || ($this->numrows != 0)) {
			...
			$resac = pg_query("insert into db_acountkey values($acount,6037,'$this->o39_codproj','I')");
			$resac = pg_query("insert into db_acount values($acount,969,6037,'','".AddSlashes(pg_result($resaco, 0, 'o39_codproj'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
			$resac = pg_query("insert into db_acount values($acount,969,6038,'','".AddSlashes(pg_result($resaco, 0, 'o39_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
			$resac = pg_query("insert into db_acount values($acount,969,6039,'','".AddSlashes(pg_result($resaco, 0, 'o39_codlei'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
			$resac = pg_query("insert into db_acount values($acount,969,6040,'','".AddSlashes(pg_result($resaco, 0, 'o39_tipoproj'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
			$resac = pg_query("insert into db_acount values($acount,969,6101,'','".AddSlashes(pg_result($resaco, 0, 'o39_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
			$resac = pg_query("insert into db_acount values($acount,969,6358,'','".AddSlashes(pg_result($resaco, 0, 'o39_numero'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
			$resac = pg_query("insert into db_acount values($acount,969,6359,'','".AddSlashes(pg_result($resaco, 0, 'o39_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
			$resac = pg_query("insert into db_acount values($acount,969,6559,'','".AddSlashes(pg_result($resaco, 0, 'o39_lei'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
			$resac = pg_query("insert into db_acount values($acount,969,6560,'','".AddSlashes(pg_result($resaco, 0, 'o39_leidata'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
			$resac = pg_query("insert into db_acount values($acount,969,6659,'','".AddSlashes(pg_result($resaco, 0, 'o39_texto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
		}
		return true;
	}
	...
	function alterar($o39_codproj = null) {
		...
		if ($this->numrows > 0) {
			for ($conresaco = 0; $conresaco < $this->numrows; $conresaco ++) {
				$resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
				$acount = pg_result($resac, 0, 0);
				$resac = pg_query("insert into db_acountkey values($acount,6037,'$this->o39_codproj','A')");
				if (isset ($GLOBALS["HTTP_POST_VARS"]["o39_codproj"]))
					$resac = pg_query("insert into db_acount values($acount,969,6037,'".AddSlashes(pg_result($resaco, $conresaco, 'o39_codproj'))."','$this->o39_codproj',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
				if (isset ($GLOBALS["HTTP_POST_VARS"]["o39_descr"]))
					$resac = pg_query("insert into db_acount values($acount,969,6038,'".AddSlashes(pg_result($resaco, $conresaco, 'o39_descr'))."','$this->o39_descr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
				if (isset ($GLOBALS["HTTP_POST_VARS"]["o39_codlei"]))
					$resac = pg_query("insert into db_acount values($acount,969,6039,'".AddSlashes(pg_result($resaco, $conresaco, 'o39_codlei'))."','$this->o39_codlei',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
				if (isset ($GLOBALS["HTTP_POST_VARS"]["o39_tipoproj"]))
					$resac = pg_query("insert into db_acount values($acount,969,6040,'".AddSlashes(pg_result($resaco, $conresaco, 'o39_tipoproj'))."','$this->o39_tipoproj',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
				if (isset ($GLOBALS["HTTP_POST_VARS"]["o39_anousu"]))
					$resac = pg_query("insert into db_acount values($acount,969,6101,'".AddSlashes(pg_result($resaco, $conresaco, 'o39_anousu'))."','$this->o39_anousu',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
				if (isset ($GLOBALS["HTTP_POST_VARS"]["o39_numero"]))
					$resac = pg_query("insert into db_acount values($acount,969,6358,'".AddSlashes(pg_result($resaco, $conresaco, 'o39_numero'))."','$this->o39_numero',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
				if (isset ($GLOBALS["HTTP_POST_VARS"]["o39_data"]))
					$resac = pg_query("insert into db_acount values($acount,969,6359,'".AddSlashes(pg_result($resaco, $conresaco, 'o39_data'))."','$this->o39_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
				if (isset ($GLOBALS["HTTP_POST_VARS"]["o39_lei"]))
					$resac = pg_query("insert into db_acount values($acount,969,6559,'".AddSlashes(pg_result($resaco, $conresaco, 'o39_lei'))."','$this->o39_lei',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
				if (isset ($GLOBALS["HTTP_POST_VARS"]["o39_leidata"]))
					$resac = pg_query("insert into db_acount values($acount,969,6560,'".AddSlashes(pg_result($resaco, $conresaco, 'o39_leidata'))."','$this->o39_leidata',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
				if (isset ($GLOBALS["HTTP_POST_VARS"]["o39_texto"]))
					$resac = pg_query("insert into db_acount values($acount,969,6659,'".AddSlashes(pg_result($resaco, $conresaco, 'o39_texto'))."','$this->o39_texto',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
			}
		}
		db_msgbox($sql);
		$result = @ pg_exec($sql);
	...
	function excluir($o39_codproj = null, $dbwhere = null) {
		...
		if (($resaco != false) || ($this->numrows != 0)) {
			for ($iresaco = 0; $iresaco < $this->numrows; $iresaco ++) {
				$resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
				$acount = pg_result($resac, 0, 0);
				$resac = pg_query("insert into db_acountkey values($acount,6037,'$o39_codproj','E')");
				$resac = pg_query("insert into db_acount values($acount,969,6037,'','".AddSlashes(pg_result($resaco, $iresaco, 'o39_codproj'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
				$resac = pg_query("insert into db_acount values($acount,969,6038,'','".AddSlashes(pg_result($resaco, $iresaco, 'o39_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
				$resac = pg_query("insert into db_acount values($acount,969,6039,'','".AddSlashes(pg_result($resaco, $iresaco, 'o39_codlei'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
				$resac = pg_query("insert into db_acount values($acount,969,6040,'','".AddSlashes(pg_result($resaco, $iresaco, 'o39_tipoproj'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
				$resac = pg_query("insert into db_acount values($acount,969,6101,'','".AddSlashes(pg_result($resaco, $iresaco, 'o39_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
				$resac = pg_query("insert into db_acount values($acount,969,6358,'','".AddSlashes(pg_result($resaco, $iresaco, 'o39_numero'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
				$resac = pg_query("insert into db_acount values($acount,969,6359,'','".AddSlashes(pg_result($resaco, $iresaco, 'o39_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
				$resac = pg_query("insert into db_acount values($acount,969,6559,'','".AddSlashes(pg_result($resaco, $iresaco, 'o39_lei'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
				$resac = pg_query("insert into db_acount values($acount,969,6560,'','".AddSlashes(pg_result($resaco, $iresaco, 'o39_leidata'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
				$resac = pg_query("insert into db_acount values($acount,969,6659,'','".AddSlashes(pg_result($resaco, $iresaco, 'o39_texto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
			}
		}
