    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_pc04_codsubgrupo) && (trim($chave_pc04_codsubgrupo)!="") ){
	         $sql = $clpcsubgrupo->sql_query($chave_pc04_codsubgrupo,$campos,"pc04_codsubgrupo");
        }else if(isset($chave_pc04_descrsubgrupo) && (trim($chave_pc04_descrsubgrupo)!="") ){
	         $sql = $clpcsubgrupo->sql_query("",$campos,"pc04_descrsubgrupo"," pc04_descrsubgrupo like '$chave_pc04_descrsubgrupo%' ");
        }else{
           $sql = $clpcsubgrupo->sql_query("",$campos,"pc04_codsubgrupo","");
        }
        db_lovrot($sql,15,"()","",$funcao_js);
      }else{
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $clpcsubgrupo->sql_record($clpcsubgrupo->sql_query($pesquisa_chave));
