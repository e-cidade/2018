...
/*
  ...
  if($nivela >= 1){
    $sele_work .= " and w.o58_orgao = t.o58_orgao ";
  }
  if($nivela >= 2){
    $sele_work .= "  and w.o58_unidade = t.o58_unidade ";
  }
  if($nivela >= 3){
    $sele_work .= " and w.o58_funcao = t.o58_funcao ";
  }
  if($nivela >= 4){
    $sele_work .= " and w.o58_subfuncao = t.o58_subfuncao ";
  }
  if($nivela >= 5){
    $sele_work .= " and w.o58_programa = t.o58_programa ";
  }
  if($nivela >= 6){
    $sele_work .= " and w.o58_projativ = t.o58_projativ ";
  }
  if($nivela >= 7){
    $sele_work .= " and e.o56_elemento = t.o58_elemento ";
  }
  if($nivela >= 8){
    $sele_work .= " and w.o58_codigo = t.o58_codigo ";
  }
...
*/
pg_exec("create temp table t as select * from  orcdotacao where o58_orgao = $o40_orgao and o58_unidade = $unidade ");
