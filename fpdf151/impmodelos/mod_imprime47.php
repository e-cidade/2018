...
//$this->objpdf->settopmargin(5);
   ...
   $this->objpdf->SetFont('Arial','',8);
   $this->objpdf->cell(80,$altura,substr($this->z01_ender.' - BAIRRO: '.$this->z01_bairro,0,46) ,1,0,"L",0);
   $this->objpdf->cell(97,$altura,substr($this->enderecocomprador.','.$this->numerocomprador.' / '.$this->complcomprador,0,50) . ' - BAIRRO: '.$this->bairrocomprador  ,1,1,"L",0);
   $this->objpdf->SetFont('Arial','B',8);
   ...
   $this->objpdf->cell(97,$altura,$this->municipiocomprador.'('.$this->ufcomprador.') - CEP: '.$this->cepcomprador  ,1,1,"L",0);
   $this->objpdf->Ln(2);
   $this->objpdf->SetFont('Arial','B',8);
   ...
   $this->objpdf->ln(2);
   $this->objpdf->SetFont('Arial','B',8);
   $this->objpdf->cell(170,$altura,'Observações',1,0,"L",1);
   $this->objpdf->cell(27,$altura,'V I S T O',1,1,"C",1);
   $this->objpdf->SetFont('Arial','',8);
   $y = $this->objpdf->gety();
   $this->objpdf->cell(170,$altura,'',"TLR",0,"L",0);
   $this->objpdf->cell(27, $altura,'',"TLR",1,"L",0);
   $this->objpdf->cell(170,$altura,'',"LBR",0,"l",0);
   ...
   $this->objpdf->cell(25,$altura,"Tipo"			  ,1,0,"C",1);
   $this->objpdf->cell(23,$altura,"Informado"		,1,0,"C",1);
   $this->objpdf->cell(23,$altura,"Avaliado"		,1,0,"C",1);
   $iPosicaoXFormaPgto = $this->objpdf->getX();
   $this->objpdf->ln();
   
   if ($this->tipoitbi == "urbano") {
     $this->objpdf->cell(25,$altura,"Terreno"  							  ,1,0,"L",1);
   } else {
   	 $this->objpdf->cell(25,$altura,"Terra"  								  ,1,0,"L",1);
   }
   ...
   if ($this->tipoitbi == "urbano") {
     $this->objpdf->cell(25,$altura,"Construção"							  ,1,0,"L",1);
   } else {
   	 $this->objpdf->cell(25,$altura,"Benfeitoria"							  ,1,0,"L",1);
   }
   ...
   $this->objpdf->SetFont('Arial','B',6);      
   $this->objpdf->cell(25,$altura,"Total"	  								  ,1,0,"L",1);
   $this->objpdf->SetFont('Arial','',6);   
   ...
   $this->objpdf->cell(39,$altura,"Forma de Pagamento",1,0,"C",1);
   ...
   if( count($this->aDadosFormasPgto) > 0 ){
     foreach ( $this->aDadosFormasPgto as $iInd => $aDadosFormas ){
       if ( $iInd <= 2 ) {
         ...
         $this->objpdf->SetFont('Arial','B',6);
         $this->objpdf->cell(39,$altura,$aDadosFormas['Descricao']  		      ,1,0,"L",1);
         $this->objpdf->SetFont('Arial','',6);
   ...
   $this->objpdf->SetFont('Arial','B',6);
   $this->objpdf->cell(39,$altura,"Total" 					 		        ,1,0,"L",1);
   $this->objpdf->SetFont('Arial','',6);
