<?php
  ...
  global $contapagina;
	...
	////////// MODELO 891  - ANULAÇÃO REQUISIÇÃO DE SAÍDA DE MATERIAIS 
...
for ($i = 0;$i < $iVias;$i++){
	  ...
	  $this->objpdf->text(110,$xlin-13,'ANULAÇÃO REQUISIÇÃO DE MATERIAIS N'.chr(176).' '.$this->Rnumero);
    ...
    $this->objpdf->Setfont('Arial','',6);
	  ...
	  $this->objpdf->text($xcol+183,$xlin+24,'ANULADO');
