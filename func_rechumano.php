   ...
   <table width="750" border="0" align="center" cellspacing="0">
    ...
    <tr>
     <td nowrap title="<?=$Ted20_i_codigo?>">
      <b>Matrícula:</b>
      <?db_input("ed284_i_rhpessoal",10,@$Ied284_i_rhpessoal,true,"text",4,"onFocus=\"nextfield='pesquisar2'\"","chave_ed284_i_rhpessoal");?>
      <b>CGM:</b>
  ...
  <td align="center" valign="top">
   ...
   if(!isset($pesquisa_chave)){
    ...
    if(isset($chave_ed284_i_rhpessoal)){
     $repassa = array("chave_ed284_i_rhpessoal"=>$chave_ed284_i_rhpessoal,"chave_ed285_i_cgm"=>$chave_ed285_i_cgm,"chave_z01_nome"=>$chave_z01_nome,"subgrupo"=>@$subgrupo,"grupo"=>@$grupo,"atividaderh"=>@$atividaderh);
    }
    if($termo==true){
    ...
    if($pesquisa_chave!=null && $pesquisa_chave!=""){
     $campos = "ed20_i_codigo,
                ...
                rh37_descr
               ";
     $result = $clrechumano->sql_record($clrechumano->sql_query_escola("",$campos,"z01_nome"," ed20_i_codigo = $pesquisa_chave AND ed75_i_escola = $escola"));
