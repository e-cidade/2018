...
if($oGet->tipoDebito){
  ...
  $sqlleft  = " left join cancdebitosprocconcarpeculiar on k74_cancdebitosproc = k23_codigo ";
  $sqlleft .= " left join concarpeculiar                on k74_concarpeculiar  = c58_sequencial ";
  $campo    = " c58_sequencial, c58_descr,";
}

$sSqlCancProc  = " select  k00_numcgm,                                                                                ";
...
$sSqlCancProc .= "         inner join arrecant           on k21_numpre                = k00_numpre                    ";
$sSqlCancProc .= "                                      and k21_numpar                = k00_numpar                    ";
...
$sSqlCancProc .= "         inner join cgm                on z01_numcgm                = k00_numcgm                    ";
...
/* 
echo "<pre>";
print_r(db_utils::getcollectionbyrecord($rsCancProc));
echo "</pre>";
die();
 */
...
// mudar para if elseif
($oGet->seltipo == "c" || $oGet->seltipo == "rc" ? $head5 = "Tipo: Completo" : $head5 = "Tipo: Resumido");
$head6 = "Tipo de cancelamento:".($oGet->tipoDebito==1?"Normal":($oGet->tipoDebito==2?"Renuncia":"Todos"));
