 ...
 */
$sSqlInstit   = "select codigo,nomeinst from db_config where codigo in ({$sInstituicao}) ";
 ...
 * Monta Cabeçalho
 */
$head3 = "RELATÓRIO DE RECEITA MENSAL";
...
$oReceitaSaldoMes               = db_utils::getColectionByRecord($rsReceitaSaldoMes);
