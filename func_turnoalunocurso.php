   ...
   if(!isset($pesquisa_chave)){
    ...
    $sql = "SELECT $campos
            FROM turno
             ...
             inner join cursoturno on cursoturno.ed85_i_turno = turno.ed15_i_codigo
            WHERE periodoescola.ed17_i_escola = $escola
            AND cursoturno.ed85_i_curso = $curso
            AND cursoturno.ed85_i_escola = $escola
            $where
            GROUP BY $campos
           ";
    ...
    if($pesquisa_chave!=null && $pesquisa_chave!=""){
     $sql = "SELECT $campos
             FROM turno
              inner join periodoescola on periodoescola.ed17_i_turno = turno.ed15_i_codigo
             WHERE periodoescola.ed17_i_escola = $escola
             AND turno.ed15_i_codigo = $pesquisa_chave
             $where1
             GROUP BY $campos
            ";
     $result = pg_query($sql);
