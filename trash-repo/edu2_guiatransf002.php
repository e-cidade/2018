...
for ($x=0;$x<$linhas;$x++) {
  ...
  */
 $sSqlProgressaoParcialAluno = $clprogressaoparcialaluno->sql_query_aluno_em_progressao(null,
                                                                                        'ed232_c_descr, ed114_ano, ed11_c_descr',
                                                                                        'ed114_ano',
                                                                                        "ed114_aluno = {$ed47_i_codigo}");
  ...
  foreach ($aDisciplinas as $sIndice => $sDisciplina) {
    ...
    if ($lQuebraLinha) {
      $lQuebraLinha = false;
      $sObsProgressaoParcialAluno = "O aluno possui progressão na etapa {$aIndice[1]} no ano {$aIndice[0]} nas disciplinas {$sDisciplina}.";
    } else {
