...
class cl_orcsuplemrec { 
   ...
   function incluir ($o85_codsup,$o85_codrec){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,6087,'$this->o85_codsup','I')");
       $resac = pg_query("insert into db_acountkey values($acount,6088,'$this->o85_codrec','I')");
       $resac = pg_query("insert into db_acount values($acount,978,6087,'','".AddSlashes(pg_result($resaco,0,'o85_codsup'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,978,6088,'','".AddSlashes(pg_result($resaco,0,'o85_codrec'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,978,6089,'','".AddSlashes(pg_result($resaco,0,'o85_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,978,6090,'','".AddSlashes(pg_result($resaco,0,'o85_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($o85_codsup=null,$o85_codrec=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,6087,'$this->o85_codsup','A')");
         $resac = pg_query("insert into db_acountkey values($acount,6088,'$this->o85_codrec','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o85_codsup"]))
           $resac = pg_query("insert into db_acount values($acount,978,6087,'".AddSlashes(pg_result($resaco,$conresaco,'o85_codsup'))."','$this->o85_codsup',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o85_codrec"]))
           $resac = pg_query("insert into db_acount values($acount,978,6088,'".AddSlashes(pg_result($resaco,$conresaco,'o85_codrec'))."','$this->o85_codrec',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o85_anousu"]))
           $resac = pg_query("insert into db_acount values($acount,978,6089,'".AddSlashes(pg_result($resaco,$conresaco,'o85_anousu'))."','$this->o85_anousu',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["o85_valor"]))
           $resac = pg_query("insert into db_acount values($acount,978,6090,'".AddSlashes(pg_result($resaco,$conresaco,'o85_valor'))."','$this->o85_valor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($o85_codsup=null,$o85_codrec=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,6087,'$this->o85_codsup','E')");
         $resac = pg_query("insert into db_acountkey values($acount,6088,'$this->o85_codrec','E')");
         $resac = pg_query("insert into db_acount values($acount,978,6087,'','".AddSlashes(pg_result($resaco,$iresaco,'o85_codsup'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,978,6088,'','".AddSlashes(pg_result($resaco,$iresaco,'o85_codrec'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,978,6089,'','".AddSlashes(pg_result($resaco,$iresaco,'o85_anousu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,978,6090,'','".AddSlashes(pg_result($resaco,$iresaco,'o85_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
   ...
   function sql_query ( $o85_codsup=null,$o85_codrec=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= "      inner join orcfontes  as c on   c.o57_codfon = orcreceita.o70_codfon";
     $sql2 = "";
     if($dbwhere==""){
       if($o85_codsup!=null ){
