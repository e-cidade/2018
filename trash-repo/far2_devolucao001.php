...
$resultpref          = pg_exec($sSqlpref);//resultset da do sql da prefeitura
...
$sCamposDev2 = "fa22_d_data, fa22_i_cgsund ,fa23_i_quantidade ,fa23_c_motivo, fa22_i_codigo, fa23_i_cancelamento,fa01_i_codigo,m60_descr";
...
for ($iContador = 0; $iContador < $iLinhasDev; $iContador++) {
  ...
  $oPdf1->rquantdeitens = "fa23_i_quantidade";
