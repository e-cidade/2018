...
$sSqlLogo     = $oDaoDbConfig->sql_query_file(db_getsession('DB_instit'), "logo");
$rsLogo       = $oDaoDbConfig->sql_record($sSqlLogo);

$sLogoInstituicao = '';
if ($oDaoDbConfig->numrows > 0) {
	$sLogoInstituicao = "imagens/" .db_utils::fieldsMemory($rsLogo, 0)->logo;	
} 
...
for ($x = 0; $x < $iLinhasRegencia; $x++) {
   ...
   * Adiciona o logo
   */
  $pdf->Image($sLogoInstituicao, 10, 8, 20);
