...
for($i = 0; $i < $numrows; $i ++) {
  ...
  $iInicio = $pdf->gety();
  $nTotalLicitação = 0;
  $sSqlParticipantes = $clpcorcamjulg->sql_query_gerautlic(null, null, "distinct z01_numcgm,
                                                                     z01_nome,
                                                                     pcorcam.pc20_dtate,
  ...
  if ($clpcorcamjulg->numrows > 0) {
    ...
    $aParticipantes = db_utils::getColectionByRecord($rsParticipantes);
    ...
    if ($clpcorcamjulg->numrows > 0) {
      ...
      $aVencedores = db_utils::getColectionByRecord($rsVencedores);
