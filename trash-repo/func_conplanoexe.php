    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $clconplanoexe->sql_record($clconplanoexe->sql_descr("","","c60_descr, c60_estrut",null,"c62_reduz=$pesquisa_chave and c62_anousu = $anousu and c61_instit= $instit "));
