  ...
  <tr> 
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){      	
		$campos = "distinct bensguarda.t21_codigo,bensguarda.t21_numcgm,bensguarda.t21_tipoguarda,bensguarda.t21_data,bensguarda.t21_obs";        
        if(isset($chave_t21_codigo) && (trim($chave_t21_codigo)!="") ){
	         $sql = $clbensguarda->sql_query_dev($chave_t21_codigo,$campos,"t21_codigo"," t21_codigo=$chave_t21_codigo and $where $where_instit");
        }else{
           $sql = $clbensguarda->sql_query_dev("",$campos,"t21_codigo","$where $where_instit");
        }
        $repassa = array();
        ...
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $clbensguarda->sql_record($clbensguarda->sql_query_dev($pesquisa_chave,"*",null,"t21_codigo=$pesquisa_chave and $where $where_instit"));
