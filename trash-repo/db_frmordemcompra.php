...
if (isset($e60_numemp) && $e60_numemp!='' ){
  $where1= " and e60_numemp in ($e60_numemp)";
  $pesqemp='true';
}
    ...
    <tr>
     ...
     ?>  
      <table>
        <tr>
         <td>
           <iframe name="itens" id="itens" src="forms/db_frmordemcompraitem.php?e60_numcgm=<?=$e60_numcgm?>&erro=false&e60_codemp=<?=@$e60_codemp?>&e60_numemp=<?=@$e60_numemp?>" width="720" height="220" marginwidth="0" marginheight="0" frameborder="0"></iframe>
         </td>
        </tr>
      </table>
     <?
