  ...
  <tr> 
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_codfuncao) && (trim($chave_codfuncao)!="") ){
	         $sql = $cldb_sysfuncoes->sql_query($chave_codfuncao,$campos,"codfuncao");
        }else if(isset($chave_nomefuncao) && (trim($chave_nomefuncao)!="") ){
	         $sql = $cldb_sysfuncoes->sql_query("",$campos,"nomefuncao"," nomefuncao like '$chave_nomefuncao%' ");
        }else{
           $sql = $cldb_sysfuncoes->sql_query("",$campos,"codfuncao","");
        }
        $repassa = array();
