   ...
   <table width="35%" border="0" align="center" cellspacing="0">
    ...
    <tr>
     <td colspan="2" align="center">
      ...
      <input name="Fechar" type="button" id="fechar" value="Fechar" onClick="parent.db_iframe_progmatricula.hide();">
     </td>
    </tr>
    </form>
   </table>
  ...
  <td align="center" valign="top">
   ...
   if(!isset($pesquisa_chave)){
    if(isset($campos)==false){
     if(file_exists("funcoes/db_func_progmatricula.php")==true){
      include("funcoes/db_func_progmatricula.php");
     }else{
      $campos = "progmatricula.*";
     }
    }
    if(isset($chave_ed20_i_codigo) && (trim($chave_ed20_i_codigo)!="") ){
     $sql = $clprogmatricula->sql_query("",$campos,"z01_nome"," ed112_i_rhpessoal = $chave_ed20_i_codigo AND ed112_c_situacao = 'A'");
    }else if(isset($chave_z01_nome) && (trim($chave_z01_nome)!="") ){
     $sql = $clprogmatricula->sql_query("",$campos,"z01_nome"," z01_nome like '$chave_z01_nome%' AND ed112_c_situacao = 'A'");
    }else{
    ...
    if($pesquisa_chave!=null && $pesquisa_chave!=""){
     $result = $clprogmatricula->sql_record($clprogmatricula->sql_query("","*",""," ed112_i_codigo = $pesquisa_chave AND ed112_c_situacao = 'A'"));
