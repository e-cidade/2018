...
//      }
      ...
      if(!isset($pesquisa_chave)){
        ...
        $campos2 = "distinct on (x.rh01_regist) x.rh01_regist,
                    ...
                    r45_dtafas as db_r45_dtafas,
                    r45_dtreto as db_r45_dtreto
                   ";
        $clgersubsql->subsqlano = "anousu";
        $clgersubsql->subsqlmes = "mesusu";
        $clgersubsql->subsqlreg = "rh01_regist";
        $repassa = array("chave_z01_nome"=>@$chave_z01_nome,"chave_rh01_regist"=>@$chave_rh01_regist,"chave_rh01_numcgm"=>@$chave_rh01_numcgm,"rh02_instit"=>@$instit);
