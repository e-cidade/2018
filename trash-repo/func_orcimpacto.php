    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_o90_codimp) && (trim($chave_o90_codimp)!="") ){
	         $sql = $clorcimpacto->sql_query_compl($chave_o90_codimp,$campos,"o90_codimp");
        }else if(isset($chave_o90_anoexe) && (trim($chave_o90_anoexe)!="") ){
	         $sql = $clorcimpacto->sql_query_compl("",$campos,"o90_anoexe"," o90_anoexe like '$chave_o90_anoexe%' ");
		...
		$dbw = " and o90_unidade = $chave_o90_unidade ";
	      ...
	      $sql = $clorcimpacto->sql_query_compl("",$campos,"o90_anoexe"," o90_orgao = $chave_o90_orgao $dbw");
	      	 
        }else{
           $sql = $clorcimpacto->sql_query_compl("",$campos,"o90_codimp","");
        }
        db_lovrot($sql,15,"()","",$funcao_js);
      }else{
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $clorcimpacto->sql_record($clorcimpacto->sql_query_compl($pesquisa_chave));
