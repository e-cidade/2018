...
class cl_bairro { 
   ...
   var $campos = "
                 ...
                 j13_descr = varchar(40) = Nome Bairro 
   ...
   function incluir ($j13_codi){ 
     ...
     if($this->j13_descr == null ){ 
       $this->erro_sql = " Campo Nome Bairro nao Informado.";
     ...
     if($j13_codi == "" || $j13_codi == null ){
       $result = @pg_query("select nextval('bairro_j13_codi_seq')"); 
       if($result==false){
       ...
       $result = @pg_query("select last_value from bairro_j13_codi_seq");
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,50,'$this->j13_codi','I')");
       $resac = pg_query("insert into db_acount values($acount,11,50,'','".pg_result($resaco,0,'j13_codi')."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,11,51,'','".pg_result($resaco,0,'j13_descr')."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,11,52,'','".pg_result($resaco,0,'j13_codant')."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($j13_codi=null) { 
     ...
     $virgula = "";
     if($this->j13_codi!="" || isset($GLOBALS["HTTP_POST_VARS"]["j13_codi"])){ 
     ...
     if($this->j13_descr!="" || isset($GLOBALS["HTTP_POST_VARS"]["j13_descr"])){ 
     ...
     if($this->j13_codant!="" || isset($GLOBALS["HTTP_POST_VARS"]["j13_codant"])){ 
...
";
     ...
     if($this->numrows>0){       $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
       $acount = pg_result($resac,0,0);
       $resac = pg_query("insert into db_acountkey values($acount,50,'$this->j13_codi','A')");
       if(isset($GLOBALS["HTTP_POST_VARS"]["j13_codi"]))
         $resac = pg_query("insert into db_acount values($acount,11,50,'".pg_result($resaco,0,'j13_codi')."','$this->j13_codi',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       if(isset($GLOBALS["HTTP_POST_VARS"]["j13_descr"]))
         $resac = pg_query("insert into db_acount values($acount,11,51,'".pg_result($resaco,0,'j13_descr')."','$this->j13_descr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       if(isset($GLOBALS["HTTP_POST_VARS"]["j13_codant"]))
         $resac = pg_query("insert into db_acount values($acount,11,52,'".pg_result($resaco,0,'j13_codant')."','$this->j13_codant',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     $result = @pg_exec($sql);
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
   ...
   function excluir ($j13_codi=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
       $acount = pg_result($resac,0,0);
       $resac = pg_query("insert into db_acountkey values($acount,50,'$this->j13_codi','E')");
       $resac = pg_query("insert into db_acount values($acount,11,50,'','".pg_result($resaco,0,'j13_codi')."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,11,51,'','".pg_result($resaco,0,'j13_descr')."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,11,52,'','".pg_result($resaco,0,'j13_codant')."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
