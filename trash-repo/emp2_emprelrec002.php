...
// monta sql
   ...
   if (isset($lista)){
       if (isset($ver) and $ver=="com"){
           $txt_where= $txt_where." and o15_codigo in  $w";
       } else {
           $txt_where= $txt_where." and o15_codigo not in  $w";
       }	 
   }  
...
if ($tipo =="a") { // relatorios analiticos
       if ($quebra == "g"){
            ...
            $ordem = "o15_codigo, o58_orgao, e60_emiss";
       } else if ($quebra =="u"){
            $ordem = "o15_codigo, o58_orgao, o58_unidade, e60_emiss";
       }	 
...
// é sintético monta sql direto 
   if($quebra =="g"){
        $sql = "select o15_codigo, o15_descr,
         ...
         if (isset($lista)){
              if (isset($ver) and $ver=="com"){
                 $sql = $sql ." and o15_codigo in  $w";
              } else {
                 $sql = $sql ." and o15_codigo not in  $w";
              }	 
         }  
	 ...
	 $res=$clempempenho->sql_record($sql);
       ...
       /*  sintético por orgao */
        $sql = "select o15_codigo, o15_descr,
           ...
           $sql = $sql ." group by o15_codigo, o15_descr, o40_orgao, o40_descr 
	                  order by o15_codigo, o40_orgao ";
           // echo $sql;
	   // exit;
	   $res=$clempempenho->sql_record($sql);
           if ($clempempenho->numrows > 0 ){
      ...
      /* unidade sintética */
       ...
       /*  sintético por orgao */
        $sql = "select o15_codigo, o15_descr,
           ...
           $sql = $sql ." group by o15_codigo, o15_descr, o40_orgao, o40_descr, o41_unidade, o41_descr 
	                  order by o15_codigo, o40_orgao, o41_unidade ";
           // echo $sql;
	   // exit;
	   $res=$clempempenho->sql_record($sql);
           if ($clempempenho->numrows > 0 ){
       ...
       for ($x=0; $x < $rows;$x++){
            ...
            if ($imprime_header==true)
    	    {
	         ...
	         $pdf->Cell(20,$tam,strtoupper($RLe60_codemp),1,0,"C",1);	 
                 ...
                 $pdf->Cell(100,$tam,strtoupper($RLDBtxt_estrutural),1,1,"L",1); // cod+estrut dotatao // quebra linha
		 // 
		...
		$pdf->SetFont('Arial','B',9);	
                $pdf->Cell(20,$tam,"$o15_codigo",0,0,"R",0);
                $pdf->Cell(100,$tam,"$o15_descr",0,1,"L",0);  //quebra inha
  		$pdf->SetFont('Arial','',7);	
	    }
	    ...
	    $pdf->Cell(100,$tam,"$o58_coddot - $dl_estrutural",0,1,"L",0); //quebra linha
...
if ($quebra=="g" and $tipo=="s"){
       ...
       for ($x=0; $x < $rows;$x++){
	    ...
	    /* ----------- */
	    $pdf->Ln(1);
            $pdf->Cell(20,$tam,db_formatar($o15_codigo,'recurso'),0,0,"R",0);
 	    $pdf->Cell(100,$tam,$o15_descr,0,0,"L",0);
	    ...
	    if ($repete != $o15_codigo){
		 ...
		 //
	         ...
	         $pdf->Ln();
                 ...
                 $pdf->Cell(20,$tam,db_formatar($o15_codigo,'recurso'),0,0,"R",0);
 	         $pdf->Cell(100,$tam,$o15_descr,0,1,"L",0); //quebra linha
                 $pdf->SetFont('Arial','',7);	 
	    }
