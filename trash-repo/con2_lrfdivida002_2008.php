  ...
  for($x = 0; $x < $clconrelinfo->numrows; $x ++) {
    ...
    if ($c83_codigo == 362) {
      if (! isset($c83_periodo)) {
        ...
        if ($periodo == "3Q" || $periodo == "212110200022S") {
...
if ($anousu_ant > 2007) {
  $total_rcl_ant = calcula_rcl2($anousu_ant, $anousu_ant . '-01-01', $anousu_ant . '-12-31', $todasinstit, false, 27, $data);
} else {
...
if ($usa_datas == false) {
  ...
  $matriz_rcl = calcula_rcl2($anousu_ant, $anousu_ant . '-01-01', $anousu_ant . '-12-31', $todasinstit, $matriz, 27, $data);
  ...
  $total_rcl = calcula_rcl2($anousu, $anousu . '-01-01', $sDataFinal, $todasinstit, false, 27);
  if ($periodo != "1S") {
  ...
  if ($anousu_ant > 2007) {
    $total_rcl = calcula_rcl2($anousu_ant, $dtini_ant, $dtfin_ant, $todasinstit, false, 27, $data);
  } else {
