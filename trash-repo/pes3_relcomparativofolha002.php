...
foreach (array_reverse($oGet->objeto2) as $sTipoFolha){
	...
	switch ($sTipoFolha){ 
	  ...
	  break;
	  case 'gerfres':
	     $aTipoFolha[$sTipoFolha]['sTitulo'] = 'RESCISÄO';
       $aTitulo[1]                         = 'Rescisão';          
	     $sSigla                             = 'r20';
	  break;
	  case 'gerfs13':
	  ...
	  break;
	  case 'gerffer':
	     $aTipoFolha[$sTipoFolha]['sTitulo'] = 'FÉRIAS';
       $aTitulo[4]                         = 'Férias';          
	     $sSigla                             = 'r31';
	  break;
	}
...
$head5  = "Ano/Mês Base: ".$oGet->iAnoBase."/".$oGet->iMesBase;
$head6  = "Ano/Mês a Comparar: ".$oGet->iAnoCompara."/".$oGet->iMesCompara;
