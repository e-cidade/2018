...
$discglob = false;
$result = $clturma->sql_record($clturma->sql_query("","ed57_i_codigo,ed57_i_calendario,ed57_c_descr,ed29_i_codigo,ed29_c_descr,ed52_c_descr,fc_nomeetapaturma(ed57_i_codigo) as ed11_c_descr",""," ed57_i_codigo = $turma"));
...
for($x=0;$x<$linhas;$x++){
 ...
 $pdf->cell(60+$larguracolunas+45,4,@$dataperiodo,0,1,"C",1);
 ...
 $sql1 = $clmatricula->sql_query("","ed60_i_aluno,ed60_i_codigo,ed60_i_numaluno,ed47_v_nome,ed60_c_situacao,ed11_c_abrev ",
                                 "ed11_i_sequencia,ed60_i_numaluno,to_ascii(ed47_v_nome),ed60_c_ativa",
                                 " ed60_i_turma = $ed57_i_codigo $condicao");
 ...
 for($y=0;$y<$clmatricula->numrows;$y++){
  ...
  if(trim($ed60_c_situacao)=="MATRICULADO"){
   ...
   $pdf->setfont('arial','b',11);
   $pdf->cell(35,4,trim(Situacao($ed60_c_situacao,$ed60_i_codigo)),1,1,"C",0);
   $pdf->setfont('arial','b',8);
  }
