...
for($i = 0; $i<$numrows; $i++){
  ...
  $result_dados = $clativid->sql_record($clativid->sql_query_file(null,"q03_ativ,q03_descr","$order","q03_ativ in (select q80_ativ from ativtipo where q80_tipcal=$q80_tipcal)"));
  ...
  for($ii = 0; $ii<$numrows2; $ii++){
    ...
    $pdf->setfont('arial','',7);
    $pdf->cell(28,$alt,"","L",0,"C",$c);
    $pdf->cell(30,$alt,$q03_ativ,   0,0,"C",$c);
    $pdf->cell(132,$alt,$q03_descr,  "R",1,"L",$c);
    $total++;
  }  
  $pdf->setfont('arial','b',8);
