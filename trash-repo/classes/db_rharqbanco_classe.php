...
class cl_rharqbanco { 
   ...
   var $campos = "
                 ...
                 rh34_where = varchar(50) = Condição 
   ...
   function incluir ($rh34_codarq,$rh34_instit){ 
     ...
     if($this->rh34_descr == null ){ 
       $this->erro_sql = " Campo Descrição do Cadastro nao Informado.";
     ...
     if($this->rh34_dvagencia == null ){ 
       $this->erro_sql = " Campo Dígito da Agência nao Informado.";
     ...
     if($this->rh34_dvconta == null ){ 
       $this->erro_sql = " Campo Dígito da Conta nao Informado.";
   ...
   function alterar ($rh34_codarq=null,$rh34_instit=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh34_instit"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh34_codarq"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh34_descr"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh34_codban"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh34_agencia"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh34_dvagencia"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh34_conta"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh34_dvconta"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh34_convenio"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh34_sequencial"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh34_where"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh34_ativo"]))
