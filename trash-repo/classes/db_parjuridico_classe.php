...
class cl_parjuridico { 
   ...
   function incluir ($v19_anousu,$v19_instit){ 
     ...
     if($this->v19_templateinicialquitada == null ){ 
       $this->v19_templateinicialquitada = "Documento Template ";
     }
     if($this->v19_templateparcelamento == null ){ 
       $this->v19_templateparcelamento = "Documento Template";
     }
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acount values($acount,2029,19708,'','".AddSlashes(pg_result($resaco,0,'v19_urlwebservice'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,2029,19709,'','".AddSlashes(pg_result($resaco,0,'v19_login'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,2029,19710,'','".AddSlashes(pg_result($resaco,0,'v19_senha'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,2029,19711,'','".AddSlashes(pg_result($resaco,0,'v19_codorgao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["v19_urlwebservice"]) || $this->v19_urlwebservice != "")
          $resac = pg_query("insert into db_acount values($acount,2029,19708,'".AddSlashes(pg_result($resaco,$conresaco,'v19_urlwebservice'))."','$this->v19_urlwebservice',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["v19_login"]) || $this->v19_login != "")
          $resac = pg_query("insert into db_acount values($acount,2029,19709,'".AddSlashes(pg_result($resaco,$conresaco,'v19_login'))."','$this->v19_login',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["v19_senha"]) || $this->v19_senha != "")
          $resac = pg_query("insert into db_acount values($acount,2029,19710,'".AddSlashes(pg_result($resaco,$conresaco,'v19_senha'))."','$this->v19_senha',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["v19_codorgao"]) || $this->v19_codorgao != "")
          $resac = pg_query("insert into db_acount values($acount,2029,19711,'".AddSlashes(pg_result($resaco,$conresaco,'v19_codorgao'))."','$this->v19_codorgao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
   ...
   function excluir ($v19_anousu=null,$v19_instit=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = pg_query("insert into db_acount values($acount,2029,19708,'','".AddSlashes(pg_result($resaco,$iresaco,'v19_urlwebservice'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,2029,19709,'','".AddSlashes(pg_result($resaco,$iresaco,'v19_login'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,2029,19710,'','".AddSlashes(pg_result($resaco,$iresaco,'v19_senha'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,2029,19711,'','".AddSlashes(pg_result($resaco,$iresaco,'v19_codorgao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
