...
class cl_pactoacoes { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->o79_sequencial = ($this->o79_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["o79_sequencial"]:$this->o79_sequencial);
       $this->o79_pactoplano = ($this->o79_pactoplano == ""?@$GLOBALS["HTTP_POST_VARS"]["o79_pactoplano"]:$this->o79_pactoplano);
       $this->o79_descricao = ($this->o79_descricao == ""?@$GLOBALS["HTTP_POST_VARS"]["o79_descricao"]:$this->o79_descricao);
       $this->o79_obs = ($this->o79_obs == ""?@$GLOBALS["HTTP_POST_VARS"]["o79_obs"]:$this->o79_obs);
     }else{
       $this->o79_sequencial = ($this->o79_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["o79_sequencial"]:$this->o79_sequencial);
     }
   }
   // funcao para inclusao
   function incluir ($o79_sequencial){ 
      $this->atualizacampos();
     if($this->o79_pactoplano == null ){ 
     ...
     if($o79_sequencial == "" || $o79_sequencial == null ){
       $result = db_query("select nextval('pactoacoes_o79_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: pactoacoes_o79_sequencial_seq do campo: o79_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $o79_sequencial)){
         ...
         $this->o79_sequencial = $o79_sequencial; 
       }
     }
     if(($this->o79_sequencial == null) || ($this->o79_sequencial == "") ){ 
       $this->erro_sql = " Campo o79_sequencial nao declarado.";
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->o79_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($o79_sequencial=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($o79_sequencial!=null){
       $sql .= " o79_sequencial = $this->o79_sequencial";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->o79_sequencial));
     if($this->numrows>0){
   ...
   function excluir ($o79_sequencial=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($o79_sequencial));
     }else{ 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($o79_sequencial != ""){
          ...
          $sql2 .= " o79_sequencial = $o79_sequencial ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       ...
       $this->erro_sql .= "Valores : ".$o79_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
   ...
   function sql_query ( $o79_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from pactoacoes ";
     $sql .= "      inner join pactoplano  on  pactoplano.o74_sequencial = pactoacoes.o79_pactoplano";
     $sql .= "      inner join orctiporecconvenio  on  orctiporecconvenio.o16_sequencial = pactoplano.o74_orctiporecconvenio";
     $sql2 = "";
     if($dbwhere==""){
       if($o79_sequencial!=null ){
         $sql2 .= " where pactoacoes.o79_sequencial = $o79_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
