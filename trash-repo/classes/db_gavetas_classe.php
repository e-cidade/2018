...
class cl_gavetas { 
   ...
   function incluir ($cm27_i_codigo){ 
     ...
     if($this->cm27_d_exumfeita == null ){ 
       $this->erro_sql = " Campo Exumação Feita nao Informado.";
       $this->erro_campo = "cm27_d_exumfeita_dia";
       $this->erro_banco = "";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
     ...
     if($this->cm27_i_gaveta == null ){ 
       $this->erro_sql = " Campo N da Gaveta nao Informado.";
       $this->erro_campo = "cm27_i_gaveta";
       $this->erro_banco = "";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
   ...
   function alterar ($cm27_i_codigo=null) { 
     ...
     if(trim($this->cm27_d_exumfeita)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cm27_d_exumfeita_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["cm27_d_exumfeita_dia"] !="") ){ 
       ...
       $virgula = ",";
       if(trim($this->cm27_d_exumfeita) == null ){ 
         $this->erro_sql = " Campo Exumação Feita nao Informado.";
         $this->erro_campo = "cm27_d_exumfeita_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       ...
       if(isset($GLOBALS["HTTP_POST_VARS"]["cm27_d_exumfeita_dia"])){ 
         $sql  .= $virgula." cm27_d_exumfeita = null ";
         $virgula = ",";
         if(trim($this->cm27_d_exumfeita) == null ){ 
           $this->erro_sql = " Campo Exumação Feita nao Informado.";
           $this->erro_campo = "cm27_d_exumfeita_dia";
