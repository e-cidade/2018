...
class cl_db_versaousucliente { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->db27_sequencial = ($this->db27_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["db27_sequencial"]:$this->db27_sequencial);
       $this->db27_codusu = ($this->db27_codusu == ""?@$GLOBALS["HTTP_POST_VARS"]["db27_codusu"]:$this->db27_codusu);
       $this->db27_codcli = ($this->db27_codcli == ""?@$GLOBALS["HTTP_POST_VARS"]["db27_codcli"]:$this->db27_codcli);
     }else{
       $this->db27_sequencial = ($this->db27_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["db27_sequencial"]:$this->db27_sequencial);
     }
   }
   // funcao para inclusao
   function incluir ($db27_sequencial){ 
      $this->atualizacampos();
     if($this->db27_codusu == null ){ 
     ...
     if($this->db27_codcli == null ){ 
       ...
       $this->db27_sequencial = $db27_sequencial; 
     if(($this->db27_sequencial == null) || ($this->db27_sequencial == "") ){ 
       $this->erro_sql = " Campo db27_sequencial nao declarado.";
     ...
     $sql = "insert into db_versaousucliente(
                                       db27_sequencial 
                                      ,db27_codusu 
                                      ,db27_codcli 
                       )
                values (
                                $this->db27_sequencial 
                               ,$this->db27_codusu 
                               ,$this->db27_codcli 
                      )";
     $result = db_query($sql); 
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->db27_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($db27_sequencial=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($db27_sequencial!=null){
       $sql .= " db27_sequencial = $this->db27_sequencial";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->db27_sequencial));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Mensagem específica para o cliente nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->db27_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Mensagem específica para o cliente nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->db27_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($db27_sequencial=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($db27_sequencial));
     }else{ 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($db27_sequencial != ""){
          ...
          $sql2 .= " db27_sequencial = $db27_sequencial ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Mensagem específica para o cliente nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$db27_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Mensagem específica para o cliente nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$db27_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $db27_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from db_versaousucliente ";
     $sql2 = "";
     if($dbwhere==""){
       if($db27_sequencial!=null ){
         $sql2 .= " where db_versaousucliente.db27_sequencial = $db27_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
