...
class cl_avaliacaoestruturaregra { 
   ...
   var $ed318_regraarredondamento = 0; 
   ...
   function incluir ($ed318_sequencial){ 
     ...
     if($this->ed318_avaliacaoestruturanota == null ){ 
       $this->erro_sql = " Campo Avaliação Estrutura Nota nao Informado.";
     ...
     if($this->ed318_regraarredondamento == null ){ 
       ...
       $this->erro_campo = "ed318_regraarredondamento";
       $this->erro_banco = "";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
   ...
   function alterar ($ed318_sequencial=null) { 
     ...
     if(trim($this->ed318_regraarredondamento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed318_regraarredondamento"])){ 
       ...
       $virgula = ",";
       if(trim($this->ed318_regraarredondamento) == null ){ 
         $this->erro_sql = " Campo Regra de Arredondamento nao Informado.";
         $this->erro_campo = "ed318_regraarredondamento";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function sql_query ( $ed318_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= "      inner join regraarredondamento  on  regraarredondamento.ed316_sequencial = avaliacaoestruturaregra.ed318_regraarredondamento";
