...
class cl_censoregradisc { 
   ...
   function alterar ($ed272_i_codigo=null) { 
      $this->atualizacampos();
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed272_i_codigo"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed272_i_censoetapa"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed272_i_censodisciplina"]))
   ...
   function excluir ($ed272_i_codigo=null,$dbwhere=null) { 
   ...
   // funcao do sql 
   function sql_query ( $ed272_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
     ...
     $sql .= "      inner join censoetapa  on  censoetapa.ed266_i_codigo = censoregradisc.ed272_i_censoetapa";
     $sql2 = "";
     if($dbwhere==""){
       if($ed272_i_codigo!=null ){
   ...
   // funcao do sql 
   function sql_query_file ( $ed272_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = split("#",$campos);
       $virgula = "";
