...
class cl_sau_prestadorhorarios { 
   ...
   function incluir ($s112_i_codigo){ 
     ...
     if($this->s112_i_prestadorvinc == null ){ 
       $this->erro_sql = " Campo Prestador Vinculo nao Informado.";
     ...
     if(($this->s112_i_codigo == null) || ($this->s112_i_codigo == "") ){ 
       $this->erro_sql = " Campo s112_i_codigo nao declarado.";
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Prestador Horários ($this->s112_i_codigo) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function alterar ($s112_i_codigo=null) { 
      $this->atualizacampos();
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["s112_i_codigo"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["s112_i_prestadorvinc"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["s112_i_diasemana"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["s112_c_horaini"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["s112_c_horafim"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["s112_i_fichas"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["s112_i_reservas"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["s112_c_tipograde"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["s112_i_tipoficha"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["s112_d_valinicial"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["s112_d_valfinal"]))
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Prestador Horários nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->s112_i_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Prestador Horários nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->s112_i_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($s112_i_codigo=null,$dbwhere=null) { 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Prestador Horários nao Excluído. Exclusão Abortada.\\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Prestador Horários nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$s112_i_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   // funcao do sql 
   function sql_query ( $s112_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
   ...
   // funcao do sql 
   function sql_query_file ( $s112_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = split("#",$campos);
       $virgula = "";
