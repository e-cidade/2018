...
class cl_solicitaregistropreco { 
   ...
   function incluir ($pc54_sequencial){ 
     ...
     if($this->pc54_datatermino == null ){ 
       $this->erro_sql = " Campo Data do Termino nao Informado.";
   ...
   function alterar ($pc54_sequencial=null) { 
      $this->atualizacampos();
   ...
   function excluir ($pc54_sequencial=null,$dbwhere=null) { 
   ...
   // funcao do sql 
   function sql_query ( $pc54_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
   ...
   // funcao do sql 
   function sql_query_file ( $pc54_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = split("#",$campos);
       $virgula = "";
