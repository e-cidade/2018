...
class cl_historicomps { 
   ...
   var $campos = "
                 ...
                 ed62_percentualfrequencia = numeric(5) = Percentual de Frequência 
   ...
   function alterar ($ed62_i_codigo=null) { 
      $this->atualizacampos();
   ...
   function excluir ($ed62_i_codigo=null,$dbwhere=null) { 
   ...
   // funcao do sql 
   function sql_query ( $ed62_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
   ...
   // funcao do sql 
   function sql_query_file ( $ed62_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = split("#",$campos);
       $virgula = "";
