...
class cl_abatimentoarreckey { 
  ...
  function sql_query_buscaAbatimento($sCampos, $sOrdem, $sWhere) { 
    ...
    $sSql .= "     inner join arreckey           on arreckey.k00_sequencial        = k128_arreckey           ";
    ...
    $sSql .= "     inner join abatimento         on abatimento.k125_sequencial     = k128_abatimento         ";
    $sSql .= "     inner join db_config          on db_config.codigo               = k125_instit             ";
    $sSql .= "     inner join db_usuarios        on db_usuarios.id_usuario         = k125_usuario            ";
    $sSql .= "     inner join tipoabatimento     on tipoabatimento.k126_sequencial = k125_tipoabatimento     ";
    $sSql .= "     inner join abatimentosituacao on k165_sequencial                = k125_abatimentosituacao ";
