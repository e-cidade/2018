...
class cl_autolancancanc { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->y89_codtermo = ($this->y89_codtermo == ""?@$GLOBALS["HTTP_POST_VARS"]["y89_codtermo"]:$this->y89_codtermo);
       if($this->y89_datacanc == ""){
         $this->y89_datacanc_dia = ($this->y89_datacanc_dia == ""?@$GLOBALS["HTTP_POST_VARS"]["y89_datacanc_dia"]:$this->y89_datacanc_dia);
         $this->y89_datacanc_mes = ($this->y89_datacanc_mes == ""?@$GLOBALS["HTTP_POST_VARS"]["y89_datacanc_mes"]:$this->y89_datacanc_mes);
         $this->y89_datacanc_ano = ($this->y89_datacanc_ano == ""?@$GLOBALS["HTTP_POST_VARS"]["y89_datacanc_ano"]:$this->y89_datacanc_ano);
         if($this->y89_datacanc_dia != ""){
            $this->y89_datacanc = $this->y89_datacanc_ano."-".$this->y89_datacanc_mes."-".$this->y89_datacanc_dia;
         }
       }
       $this->y89_motivo = ($this->y89_motivo == ""?@$GLOBALS["HTTP_POST_VARS"]["y89_motivo"]:$this->y89_motivo);
     }else{
     }
   }
   ...
   function incluir (){ 
     ...
     $sql = "insert into autolancancanc(
                                       y89_codtermo 
                                      ,y89_datacanc 
                                      ,y89_motivo 
                       )
                values (
                                $this->y89_codtermo 
                               ,".($this->y89_datacanc == "null" || $this->y89_datacanc == ""?"null":"'".$this->y89_datacanc."'")." 
                               ,'$this->y89_motivo' 
                      )";
     $result = db_query($sql); 
     if($result==false){ 
...
$sql .= "oid = '$oid'";     $result = db_query($sql);
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Cancelamento de auto de lançamento nao Alterado. Alteracao Abortada.\\n";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Cancelamento de auto de lançamento nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
         $this->numrows_alterar = 0;
   ...
   function excluir ( $oid=null ,$dbwhere=null) { 
     $sql = " delete from autolancancanc
                    where ";
     $sql2 = "";
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Cancelamento de auto de lançamento nao Excluído. Exclusão Abortada.\\n";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Cancelamento de auto de lançamento nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
         $this->numrows_excluir = 0;
