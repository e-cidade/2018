...
class cl_arrecontr { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->k00_contr = ($this->k00_contr == ""?@$GLOBALS["HTTP_POST_VARS"]["k00_contr"]:$this->k00_contr);
     }else{
     }
   }
   ...
   function incluir (){ 
     ...
     if($this->k00_contr == null ){ 
       $this->erro_sql = " Campo contribuicao nao Informado.";
       $this->erro_campo = "k00_contr";
       $this->erro_banco = "";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
   ...
   function alterar ( $oid=null ) { 
     ...
     if(trim($this->k00_contr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k00_contr"])){ 
       $sql  .= $virgula." k00_contr = $this->k00_contr ";
       $virgula = ",";
       if(trim($this->k00_contr) == null ){ 
         $this->erro_sql = " Campo contribuicao nao Informado.";
         $this->erro_campo = "k00_contr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
...
$sql .= "oid = '$oid'";     $result = db_query($sql);
   ...
   function sql_record($sql) { 
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:arrecontr";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
