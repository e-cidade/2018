...
//MODULO: educação
//CLASSE DA ENTIDADE alunos_turma
class cl_alunos_turma { 
   ...
   var $ed32_i_codigo = 0; 
   var $ed32_i_matricula = 0; 
   var $ed32_i_turma = 0; 
   // cria propriedade com as variaveis do arquivo 
   var $campos = "
                 ed32_i_codigo = int8 = Código 
                 ed32_i_matricula = int8 = Matricula 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->ed32_i_matricula = ($this->ed32_i_matricula == ""?@$GLOBALS["HTTP_POST_VARS"]["ed32_i_matricula"]:$this->ed32_i_matricula);
       $this->ed32_i_turma = ($this->ed32_i_turma == ""?@$GLOBALS["HTTP_POST_VARS"]["ed32_i_turma"]:$this->ed32_i_turma);
     }else{
       $this->ed32_i_codigo = ($this->ed32_i_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["ed32_i_codigo"]:$this->ed32_i_codigo);
     }
   }
   ...
   function incluir ($ed32_i_codigo){ 
      $this->atualizacampos();
     if($this->ed32_i_matricula == null ){ 
       $this->erro_sql = " Campo Matricula nao Informado.";
       $this->erro_campo = "ed32_i_matricula";
       $this->erro_banco = "";
     ...
     if($this->ed32_i_turma == null ){ 
       $this->erro_sql = " Campo Turma nao Informado.";
       $this->erro_campo = "ed32_i_turma";
       $this->erro_banco = "";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "turma dos alunos ($this->ed32_i_codigo) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "turma dos alunos já Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       }else{
         $this->erro_sql   = "turma dos alunos ($this->ed32_i_codigo) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function alterar ($ed32_i_codigo=null) { 
     ...
     if(trim($this->ed32_i_matricula)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed32_i_matricula"])){ 
       $sql  .= $virgula." ed32_i_matricula = $this->ed32_i_matricula ";
       $virgula = ",";
       if(trim($this->ed32_i_matricula) == null ){ 
         $this->erro_sql = " Campo Matricula nao Informado.";
         $this->erro_campo = "ed32_i_matricula";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim($this->ed32_i_turma)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed32_i_turma"])){ 
       $sql  .= $virgula." ed32_i_turma = $this->ed32_i_turma ";
       $virgula = ",";
       if(trim($this->ed32_i_turma) == null ){ 
         $this->erro_sql = " Campo Turma nao Informado.";
         $this->erro_campo = "ed32_i_turma";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($result==false){ 
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "turma dos alunos nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->ed32_i_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($ed32_i_codigo=null,$dbwhere=null) { 
     ...
     if($result==false){ 
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "turma dos alunos nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$ed32_i_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_record($sql) { 
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:alunos_turma";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $ed32_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from alunos_turma ";
     $sql .= "      inner join turmas  on  turmas.ed05_i_codigo = alunos_turma.ed32_i_turma";
     $sql .= "      inner join matriculas  on  matriculas.ed09_i_codigo = alunos_turma.ed32_i_matricula";
     $sql .= "      inner join escolas  on  escolas. = turmas.ed05_i_escola";
     ...
     if($dbwhere==""){
       if($ed32_i_codigo!=null ){
         $sql2 .= " where alunos_turma.ed32_i_codigo = $ed32_i_codigo "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
