...
class cl_sepultamentos { 
   ...
   var $campos = "
                 cm01_i_codigo = int4 = Sepultamento 
   ...
   function incluir ($cm01_i_codigo){ 
     ...
     if($this->cm01_i_hospital == null ){ 
       $this->erro_sql = " Campo Hospital não informado.";
       $this->erro_campo = "cm01_i_hospital";
       $this->erro_banco = "";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
     ...
     if($this->cm01_i_funeraria == null ){ 
       $this->erro_sql = " Campo Funeraria não informado.";
       $this->erro_campo = "cm01_i_funeraria";
       $this->erro_banco = "";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
     ...
     if(($this->cm01_i_codigo == null) || ($this->cm01_i_codigo == "") ){ 
       $this->erro_sql = " Campo cm01_i_codigo nao declarado.";
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Sepultamentos ($this->cm01_i_codigo) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function alterar ($cm01_i_codigo=null) { 
      $this->atualizacampos();
     ...
     if(trim($this->cm01_i_medico)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cm01_i_medico"])){ 
       $sql  .= $virgula." cm01_i_medico = $this->cm01_i_medico ";
       $virgula = ",";
       if(trim($this->cm01_i_medico) == null ){ 
         $this->erro_sql = " Campo Médico não informado.";
         $this->erro_campo = "cm01_i_medico";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim($this->cm01_i_hospital)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cm01_i_hospital"])){ 
       $sql  .= $virgula." cm01_i_hospital = $this->cm01_i_hospital ";
       $virgula = ",";
       if(trim($this->cm01_i_hospital) == null ){ 
         $this->erro_sql = " Campo Hospital não informado.";
         $this->erro_campo = "cm01_i_hospital";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim($this->cm01_i_funeraria)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cm01_i_funeraria"])){ 
       $sql  .= $virgula." cm01_i_funeraria = $this->cm01_i_funeraria ";
       $virgula = ",";
       if(trim($this->cm01_i_funeraria) == null ){ 
         $this->erro_sql = " Campo Funeraria não informado.";
         $this->erro_campo = "cm01_i_funeraria";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim($this->cm01_c_livro)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cm01_c_livro"])){ 
       $sql  .= $virgula." cm01_c_livro = '$this->cm01_c_livro' ";
       $virgula = ",";
       if(trim($this->cm01_c_livro) == null ){ 
         $this->erro_sql = " Campo Livro não informado.";
         $this->erro_campo = "cm01_c_livro";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
     ...
     if(trim($this->cm01_i_folha)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cm01_i_folha"])){ 
       $sql  .= $virgula." cm01_i_folha = $this->cm01_i_folha ";
       $virgula = ",";
       if(trim($this->cm01_i_folha) == null ){ 
         $this->erro_sql = " Campo Folha não informado.";
         $this->erro_campo = "cm01_i_folha";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
     ...
     if(trim($this->cm01_i_registro)!="" || isset($GLOBALS["HTTP_POST_VARS"]["cm01_i_registro"])){ 
       $sql  .= $virgula." cm01_i_registro = $this->cm01_i_registro ";
       $virgula = ",";
       if(trim($this->cm01_i_registro) == null ){ 
         $this->erro_sql = " Campo Registro não informado.";
         $this->erro_campo = "cm01_i_registro";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
   ...
   function excluir ($cm01_i_codigo=null,$dbwhere=null) { 
   ...
   // funcao do sql 
   function sql_query_file ( $cm01_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = split("#",$campos);
       $virgula = "";
