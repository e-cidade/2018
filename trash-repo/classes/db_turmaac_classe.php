...
class cl_turmaac {
   ...
   function incluir ($ed268_i_codigo){
     ...
     if($ed268_i_codigo == "" || $ed268_i_codigo == null ){
       $result = db_query("select nextval('turmaac_ed268_i_codigo_seq')");
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: turmaac_ed268_i_codigo_seq do campo: ed268_i_codigo";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false;
       ...
       $result = db_query("select last_value from turmaac_ed268_i_codigo_seq");
