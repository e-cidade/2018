...
class cl_parissqn { 
   ...
   function incluir (){ 
     ...
     if($this->q60_codvencvar == null ){ 
       $this->erro_sql = " Campo Código do vencimento nao Informado.";
     ...
     if($this->q60_modalvara == null ){ 
       $this->erro_sql = " Campo Modelo Alvará nao Informado.";
     ...
     if($this->q60_notaavulsavlrmin == null ){ 
       $this->erro_sql = " Campo Valor Mínimo a ser pago nao Informado.";
     ...
     if($this->q60_tipopermalvara == null ){ 
       $this->erro_sql = " Campo Permissao para alterar alvará com CNPJ nao Informado.";
     ...
     if($this->q60_isstipoalvaraper == null ){ 
       $this->erro_sql = " Campo Alvará Permanente nao Informado.";
     ...
     if($this->q60_isstipoalvaraprov == null ){ 
       $this->erro_sql = " Campo Alvará Provisório nao Informado.";
