...
class cl_notaavaliacao { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->ed241_i_codigo = ($this->ed241_i_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["ed241_i_codigo"]:$this->ed241_i_codigo);
       $this->ed241_f_nota = ($this->ed241_f_nota == ""?@$GLOBALS["HTTP_POST_VARS"]["ed241_f_nota"]:$this->ed241_f_nota);
       $this->ed241_i_avaliacao = ($this->ed241_i_avaliacao == ""?@$GLOBALS["HTTP_POST_VARS"]["ed241_i_avaliacao"]:$this->ed241_i_avaliacao);
       $this->ed241_i_diarioavaliacao = ($this->ed241_i_diarioavaliacao == ""?@$GLOBALS["HTTP_POST_VARS"]["ed241_i_diarioavaliacao"]:$this->ed241_i_diarioavaliacao);
     }else{
     }
   }
   ...
   function incluir (){ 
     ...
     if($this->ed241_i_avaliacao == null ){ 
     ...
     if($this->ed241_i_diarioavaliacao == null ){ 
     ...
     if($ed241_i_codigo == "" || $ed241_i_codigo == null ){
       $result = db_query("select nextval('notaavaliacao_ed241_i_codigo_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: notaavaliacao_ed241_i_codigo_seq do campo: ed241_i_codigo"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $ed241_i_codigo)){
         ...
         $this->ed241_i_codigo = $ed241_i_codigo; 
       }
     }
     $sql = "insert into notaavaliacao(
                                       ed241_i_codigo 
                                      ,ed241_f_nota 
                                      ,ed241_i_avaliacao 
                                      ,ed241_i_diarioavaliacao 
                       )
                values (
                                $this->ed241_i_codigo 
                               ,$this->ed241_f_nota 
                               ,$this->ed241_i_avaliacao 
                               ,$this->ed241_i_diarioavaliacao 
                      )";
     $result = db_query($sql); 
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
...
$sql .= "oid = '$oid'";     $result = db_query($sql);
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Nota Avaliacao nao Alterado. Alteracao Abortada.\\n";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Nota Avaliacao nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
         $this->numrows_alterar = 0;
   ...
   function excluir ( $oid=null ,$dbwhere=null) { 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Nota Avaliacao nao Excluído. Exclusão Abortada.\\n";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Nota Avaliacao nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
         $this->numrows_excluir = 0;
