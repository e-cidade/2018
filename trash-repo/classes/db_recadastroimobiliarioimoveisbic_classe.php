...
class cl_recadastroimobiliarioimoveisbic { 
   ...
   var $campos = "
                 ie29_sequencial = int8 = Código 
                 ie29_arquivobic = oid = Arquivo Bic 
                 ie29_iptubase = int4 = Matrícula do Imóvel 
                 ";
   ...
   function incluir ($ie29_sequencial){ 
     ...
     if($ie29_sequencial == "" || $ie29_sequencial == null ){
       ...
       if(($result != false) && (pg_result($result,0,0) < $ie29_sequencial)){
         $this->erro_sql = " Campo ie29_sequencial maior que último número da sequencia.";
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "recadastroimobiliarioimoveisbic ($this->ie29_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "recadastroimobiliarioimoveisbic já Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       }else{
         $this->erro_sql   = "recadastroimobiliarioimoveisbic ($this->ie29_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function excluir ($ie29_sequencial=null,$dbwhere=null) { 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "recadastroimobiliarioimoveisbic nao Excluído. Exclusão Abortada.\\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "recadastroimobiliarioimoveisbic nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$ie29_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
