...
class cl_pontocom { 
   ...
   function alterar ($r47_anousu=null,$r47_mesusu=null,$r47_regist=null,$r47_rubric=null,$where="") { 
      $this->atualizacampos();
   ...
   function excluir ($r47_anousu=null,$r47_mesusu=null,$r47_regist=null,$r47_rubric=null,$dbwhere=null) { 
   ...
   function sql_query ( $r47_anousu=null,$r47_mesusu=null,$r47_regist=null,$r47_rubric=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
     ...
     $sql .= "      inner join lotacao  on  lotacao.r13_anousu = pontocom.r47_anousu 
		                                   and  lotacao.r13_mesusu = pontocom.r47_mesusu 
																			 and  lotacao.r13_codigo = pontocom.r47_lotac
																			 and  lotacao.r13_instit = pontocom.r47_instit ";
     $sql .= "      inner join pessoal  on  pessoal.r01_anousu = pontocom.r47_anousu 
		                                   and  pessoal.r01_mesusu = pontocom.r47_mesusu 
																			 and  pessoal.r01_regist = pontocom.r47_regist
																			 and  pessoal.r01_instit = pontocom.r47_instit ";
     $sql .= "      inner join rubricas  on  rubricas.r06_anousu = pontocom.r47_anousu 
		                                    and  rubricas.r06_mesusu = pontocom.r47_mesusu 
																				and  rubricas.r06_codigo = pontocom.r47_rubric
																				and  rubricas.r06_instit = pontocom.r47_instit ";
