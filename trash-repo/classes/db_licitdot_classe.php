...
class cl_licitdot { 
   ...
   var $campos = "
                 ...
                 l06_quant = float8 = Qtda lancada na dotacao 
                 l06_orcam = int4 = Codigo reduzido da Dotacao 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->l06_tipo = ($this->l06_tipo == ""?@$GLOBALS["HTTP_POST_VARS"]["l06_tipo"]:$this->l06_tipo);
       $this->l06_numero = ($this->l06_numero == ""?@$GLOBALS["HTTP_POST_VARS"]["l06_numero"]:$this->l06_numero);
       $this->l06_item = ($this->l06_item == ""?@$GLOBALS["HTTP_POST_VARS"]["l06_item"]:$this->l06_item);
       $this->l06_quant = ($this->l06_quant == ""?@$GLOBALS["HTTP_POST_VARS"]["l06_quant"]:$this->l06_quant);
       $this->l06_orcam = ($this->l06_orcam == ""?@$GLOBALS["HTTP_POST_VARS"]["l06_orcam"]:$this->l06_orcam);
       $this->l06_valor = ($this->l06_valor == ""?@$GLOBALS["HTTP_POST_VARS"]["l06_valor"]:$this->l06_valor);
     }else{
     }
   }
...
$sql .= "oid = '$oid'";     $result = db_query($sql);
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Cadastro das dotacoes de cada item                 nao Alterado. Alteracao Abortada.\\n";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Cadastro das dotacoes de cada item                 nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
         $this->numrows_alterar = 0;
   ...
   function excluir ( $oid=null ,$dbwhere=null) { 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Cadastro das dotacoes de cada item                 nao Excluído. Exclusão Abortada.\\n";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Cadastro das dotacoes de cada item                 nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
         $this->numrows_excluir = 0;
