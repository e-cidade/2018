...
class cl_itbi { 
   ...
   var $campos = "
                 ...
                 it01_valorterreno = float4 = Valor Terreno 
                 it01_valorconstr = float4 = Valor Construção 
   ...
   function incluir ($it01_guia){ 
     ...
     if($this->it01_tipotransacao == null ){ 
       $this->erro_sql = " Campo Tipo de Transação nao Informado.";
     ...
     if($this->it01_envia == null ){ 
       $this->erro_sql = " Campo Enviado para Liberação nao Informado.";
