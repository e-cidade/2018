...
class cl_conhistdoctipo { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->c57_sequencial = ($this->c57_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["c57_sequencial"]:$this->c57_sequencial);
       $this->c57_descricao = ($this->c57_descricao == ""?@$GLOBALS["HTTP_POST_VARS"]["c57_descricao"]:$this->c57_descricao);
     }else{
       $this->c57_sequencial = ($this->c57_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["c57_sequencial"]:$this->c57_sequencial);
     }
   }
   // funcao para inclusao
   function incluir ($c57_sequencial){ 
      $this->atualizacampos();
     if($this->c57_descricao == null ){ 
       ...
       $this->c57_sequencial = $c57_sequencial; 
     if(($this->c57_sequencial == null) || ($this->c57_sequencial == "") ){ 
       $this->erro_sql = " Campo c57_sequencial nao declarado.";
     ...
     $sql = "insert into conhistdoctipo(
                                       c57_sequencial 
                                      ,c57_descricao 
                       )
                values (
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->c57_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($c57_sequencial=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($c57_sequencial!=null){
       $sql .= " c57_sequencial = $this->c57_sequencial";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->c57_sequencial));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Tipo de Documento nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->c57_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Tipo de Documento nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->c57_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($c57_sequencial=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($c57_sequencial));
     }else{ 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($c57_sequencial != ""){
          ...
          $sql2 .= " c57_sequencial = $c57_sequencial ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Tipo de Documento nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$c57_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Tipo de Documento nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$c57_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $c57_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from conhistdoctipo ";
     $sql2 = "";
     if($dbwhere==""){
       if($c57_sequencial!=null ){
         $sql2 .= " where conhistdoctipo.c57_sequencial = $c57_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
