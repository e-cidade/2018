...
class cl_rhslipfolha { 
  ...
  function sql_query_slip( $rh79_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= "      left  join rhslipfolhaslip               on rh82_rhslipfolha           = rh79_sequencial
                    left  join slip                          on k17_codigo                 = rh82_slip  
                    inner join orctiporec                    on o15_codigo                 = rh79_recurso
                    inner join rhslipfolharhemprubrica       on rh80_rhslipfolha           = rh79_sequencial 
                    inner join rhempenhofolharubrica         on rh73_sequencial            = rh80_rhempenhofolharubrica 
                    inner join rhempenhofolharubricaretencao on rh78_rhempenhofolharubrica = rh73_sequencial
                    inner join retencaotiporec               on e21_sequencial             = rh78_retencaotiporec
                    left  join retencaotiporeccgm            on e48_retencaotiporec        = e21_sequencial
                    inner join tabrec                        on tabrec.k02_codigo          = e21_receita
                    inner join tabplan                       on tabplan.k02_codigo         = tabrec.k02_codigo    
                                                            and tabplan.k02_anousu         = rh79_anousu
                    inner join conplanoreduz                 on c61_reduz                  = k02_reduz
                                                            and c61_anousu                 = tabplan.k02_anousu
                    inner join conplano                      on conplano.c60_codcon        = conplanoreduz.c61_codcon
                                                            and c61_anousu                 = c60_anousu
                    left  join rhcontasrec                   on rh41_codigo                = rh79_recurso ";
