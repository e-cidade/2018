...
if ($iNumRows == 0){
   db_redireciona('db_erros.php?fechar=true&db_erro=Nใo existem registros cadastrados.');
}
...
$head2  = "MUNICอPIO DE {$oMunicipio->munic}";
$head3  = "RELATำRIO RESUMIDO DA EXECUวรO ORวAMENTมRIA";
$head4  = "DEMONSTRATIVO DA RECEITA DE ALIENAวรO DE ATIVOS E APLICAวรO DOS RECURSOS";
$head5  = "ORวAMENTOS FISCAL E DA SEGURIDADE SOCIAL";
...
$oPdf->Cell(130, $iAltCell, 'RREO - ANEXO XIV(LRF, art. 53, ง 1o, inciso III )', 'B', 0, "L", 0);
$oPdf->Cell(60, $iAltCell, 'R$ 1,00',                                      'B', 1, "R", 0);
    
$oPdf->Cell(64, $iAltCell+9, 'RECEITAS',                   'TBR', 0, "C", 0);
$oPdf->Cell(42, $iAltCell+9, 'PREVISรO ATUALIZADA (a)',    'TBRL', 0, "C", 0);
...
$oPdf->Cell(42, $iAltCell+12, 'DOTAวรO ATUALIZADA (d)',         'TBRL', 0, "C", 0);
...
$oPdf->Cell(49, $iAltCell, 'At้ o Bimestre', 'B', 0, "C", 0);
...
$oPdf->Cell(24.5, $iAltCell, 'NรO PROCESSADOS (f)', 'L', 1, "C", 0);
