  ...
  $head3      = "Art. 13, da Lei Complementar 101/2000";
	...
	for ($iInd = 0; $iInd < $iNumRows; $iInd++) {
		...
		for ($jInd = 0; $jInd < $iNumRowsDados; $jInd++) {
			...
			$aRelatorio[$iInd]->aMetas->getValues = round($aReceitas[$iInd]->o70_valor);
		}
	}
  ...
  $head3      = "Art. 13, da Lei Complementar 101/2000";
	...
	for ($iInd = 0; $iInd < $iNumRows; $iInd++) {
		...
		if (array_key_exists($aReceitas[$iInd]->o70_codigo, $aRelatorio)) {
			...
			$iNumRowsDados                                                 = count($aReceitas[$iInd]->aMetas->dados);
			$aRelatorio[$aReceitas[$iInd]->o70_codigo]->aMetas->getValues += round($aReceitas[$iInd]->o70_valor);
			for ($jInd = 0; $jInd < $iNumRowsDados; $jInd++) {
	...
	for ($iInd = 0; $iInd < $iNumRows; $iInd++) {
		...
		for ($jInd = 0; $jInd < $iNumRowsDados; $jInd++) {
			...
			if ($jInd%2==0 || $jInd == 0) {
				...
				$aRelatorio[$iInd]->aMetas->getValues            += round($aRelatorio[$iInd]->aMetas->dados[$indice]->valor);
				if (!empty($aReceitas[$iInd]->o70_codigo)) {
		...
		if (array_key_exists($aReceitas[$iInd]->o70_codigo, $aRelatorio)) {
			...
			for($jInd = 0; $jInd < ($iNumRowsDados); $jInd++) {
				...
				if ($jInd%2==0 || $jInd==0) {
					...
					$aRelatorio[$aReceitas[$iInd]->o70_codigo]->aMetas->getValues             += round($soma);
					if (!empty($aReceitas[$iInd]->o70_codigo)) {
