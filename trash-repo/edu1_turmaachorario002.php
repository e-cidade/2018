...
if (isset($chavepesquisa)) {
  ...
  try {
    ...
    if ($oDaoRecHumanoHoraDisp->numrows <= 0) {
      ...
      throw new Exception('Regente não tem este horário disponível na escola!\n'.
    ...
    if ($oDaoCalendario->numrows <= 0) {
      ...
      throw new Exception('Erro ao obter o ano do calendário. Erro da classe: '.
  ...
  try {
    ...
    if ($rechumano != 0) {
      ...
      if ($oDaoRechumano->numrows <= 0) {
        ...
        throw new Exception('Não foi possível obter o CGM do regente. '.
                            'Erro da classe: '.
                            $oDaoCalendario->erro_msg
                           );
      ...
      if ($oDaoCalendario->numrows <= 0) {
        ...
        throw new Exception('Não foi possível obter o ano do calendário para verificar '.
