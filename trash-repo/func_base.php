  ...
  <td align="center" valign="top">
   ...
   if(!isset($pesquisa_chave)){
    ...
    if(isset($chave_ed31_i_codigo) && (trim($chave_ed31_i_codigo)!="") ){
     $sql = $clbase->sql_query_base("",$campos,"ed29_c_descr,ed31_c_descr"," ed31_i_codigo = $chave_ed31_i_codigo AND ed77_i_escola = $escola".$where);
    }else if(isset($chave_ed31_i_codigo) && (trim($chave_ed31_i_codigo)!="") ){
     $sql = $clbase->sql_query_base("",$campos,"ed29_c_descr,ed31_c_descr"," ed31_i_codigo like '$chave_ed31_i_codigo%' AND ed77_i_escola = $escola".$where);
    }else{
     $sql = $clbase->sql_query_base("",$campos,"ed29_c_descr,ed31_c_descr"," ed77_i_escola = $escola".$where);
    }
    db_lovrot($sql,15,"()","",$funcao_js);
   }else{
    if($pesquisa_chave!=null && $pesquisa_chave!=""){
     $result = $clbase->sql_record($clbase->sql_query_base("","*","",$where." ed31_i_codigo = $pesquisa_chave AND ed77_i_escola = $escola"));
     if($clbase->numrows!=0){
