...
include_once ("classes/db_conlancam_classe.php");
include_once ("classes/db_conlancamdot_classe.php");
include_once ("classes/db_conlancamsup_classe.php");
include_once ("classes/db_conlancamdoc_classe.php");
include_once ("classes/db_conlancamrec_classe.php");
include_once ("classes/db_conlancamval_classe.php");
include_once ("classes/db_conlancamretif_classe.php");
include_once ("classes/db_orcsuplem_classe.php");
include_once ("classes/db_orcsuplemlan_classe.php");
include_once ("classes/db_orcprojeto_classe.php");
