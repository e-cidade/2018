...
*/
    ...
    if($this->mostrar_botao_lancar == true)
      echo "  document.form1.".$this->nome_botao.".onclick = '';\n";
    echo "  if(chave){\n";
    echo "    js_OpenJanelaIframe('".($this->localjan != "top.corpo"?$this->localjan:"top.corpo")."','".$this->nomeiframe."','".$this->func_arquivo."?funcao_js=parent.".$this->funcao_js."|".$this->codigo."|".$this->descr.$this->passar_query_string_para_func."'".($this->parametros != ""?$this->parametros:"").",'Pesquisa',true".($this->top!=null?",'".$this->top."'":"").");\n";
    echo "  }else{\n";
