...
if (isset($idCentral) && trim($idCentral)!=0 && isset($ve01_codigo) && trim($ve01_codigo)!=""){
	if ($dbwhere != ""){
    $dbwhere .= $and;
  }
...
$result  = $clveicabast->sql_record($clveicabast->sql_query_abast(null,"",$ordem,$dbwhere,$iCoddepto));
