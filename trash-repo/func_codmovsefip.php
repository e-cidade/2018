    ...
    <td height="63" align="center" valign="top">
        <table width="35%" border="0" align="center" cellspacing="0">
	     <form name="form2" method="post" action="" >
          <tr> 
            <td width="4%" align="right" nowrap title="<?=$Tr66_mesusu?>">
              <?=$Lr66_mesusu?>
            </td>
            <td width="96%" align="left" nowrap> 
              <?
		       db_input("r66_mesusu",2,$Ir66_mesusu,true,"text",4,"","chave_r66_mesusu");
		       ?>
            </td>
          </tr>
          <tr> 
  ...
  <tr> 
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_r66_mesusu) && (trim($chave_r66_mesusu)!="") ){
	         $sql = $clcodmovsefip->sql_query(db_getsession('DB_anousu'),$chave_r66_mesusu,$chave_r66_codigo,$campos,"r66_mesusu");
        }else if(isset($chave_r66_descr) && (trim($chave_r66_descr)!="") ){
	         $sql = $clcodmovsefip->sql_query(db_getsession('DB_anousu'),"","",$campos,"r66_descr"," r66_descr like '$chave_r66_descr%' ");
        }else{
           $sql = $clcodmovsefip->sql_query(db_getsession('DB_anousu'),"","",$campos,"r66_anousu#r66_mesusu#r66_codigo","");
        }
        $repassa = array();
        if(isset($chave_r66_descr)){
          $repassa = array("chave_r66_anousu"=>$chave_r66_anousu,"chave_r66_descr"=>$chave_r66_descr);
        }
        db_lovrot($sql,15,"()","",$funcao_js,"","NoMe",$repassa);
      }else{
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $clcodmovsefip->sql_record($clcodmovsefip->sql_query(db_getsession("DB_anousu"),$pesquisa_chave));
