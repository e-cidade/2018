...
<table height="100%" border="0" width="600" align="center" cellspacing="0" bgcolor="#CCCCCC">
  ...
  <tr> 
      ...
      if(!isset($pesquisa_chave)){
        if(isset($campos)==false){
           if(file_exists("funcoes/db_func_divida.php")==true){
             include("funcoes/db_func_divida.php");
           }else{
	...
	//	echo "<br><br><br><b>a k i !!!</b>";
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $cldivida->sql_record($cldivida->sql_query($pesquisa_chave,"*",null,"v01_instit = ".db_getsession('DB_instit')." and v01_coddiv = $pesquisa_chave " ));
