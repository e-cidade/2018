...
?>
       <?
db_input('y50_nome',10,$Iy50_nome,true,'text',3,'');
       ?>
    </td>
  </tr>
  <tr>
    ...
    <td> 
<?
db_input('y56_id_usuario',5,$Iy56_id_usuario,true,'text',$db_opcao," onchange='js_pesquisay56_id_usuario(false);'");
if($db_opcao == 2){
  db_input('y56_id_usuario',5,$Iy56_id_usuario,true,'hidden',$db_opcao,"","y56_id_usuario_old");
...
function js_pesquisay56_id_usuario(mostra){
  if(mostra==true){
    ...
    js_OpenJanelaIframe('','db_iframe_db_usuarios','func_db_usuarios.php?pesquisa_chave='+document.form1.y56_id_usuario.value+'&funcao_js=parent.js_mostradb_usuarios','Pesquisa',false);
  }
}
