...
require_once("classes/db_situacao_classe.php");
      ...
      if(!isset($pesquisa_chave)){
        if(isset($campos)==false){
           if(file_exists("funcoes/db_func_situacao.php")==true){
             include("funcoes/db_func_situacao.php");
           }else{
           $campos = "situacao.*";
           }
        }
        if(isset($chave_v52_codsit) && (trim($chave_v52_codsit)!="") ){
	         $sql = $clsituacao->sql_query($chave_v52_codsit,$campos,"v52_codsit", "v52_tpsit = '2'");
        }else if(isset($chave_v52_descr) && (trim($chave_v52_descr)!="") ){
	         $sql = $clsituacao->sql_query("",$campos,"v52_descr","v52_descr like '$chave_v52_descr%' and v52_tpsit = '2' ");
        }else{
        ...
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $clsituacao->sql_record($clsituacao->sql_query("", "*", null, "v52_codsit = {$pesquisa_chave} and v52_tpsit = '2'"));
...
?>
<script>
js_tabulacaoforms("form2","chave_v52_descr",true,1,"chave_v52_descr",true);
</script>