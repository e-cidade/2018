...
function js_pesquisaInscricao(lMostra) {
  ...
  if (lMostra) {
    ...
    js_OpenJanelaIframe('top.corpo','db_iframe_inscr','func_issbase.php?funcao_js=parent.js_mostraInscricao|q02_inscr|z01_nome&calculo=sim','Pesquisa',true);
    
  } else {

    js_OpenJanelaIframe('top.corpo','db_iframe_inscr','func_issbase.php?pesquisa_chave='+iInscricao+'&funcao_js=parent.js_mostraInscricaoHide&calculo=sim','Pesquisa',false);
