  ...
  <tr> 
    <td height="63" align="center" valign="top">
     <table width="35%" border="0" align="center" cellspacing="0">
      ...
      <tr>
       <td width="4%" align="right" nowrap title="<?=$Tcm05_c_numero?>">
        <?=$Lcm05_c_numero?>
       </td>
       <td width="96%" align="left" nowrap>
        <? db_input("cm05_c_numero",10,$Icm05_c_numero,true,"text",4,"","chave_cm05_c_numero");?>
       </td>
      </tr>
     ...
     <tr>
      ...
      <td width="96%" align="left" nowrap>
       <? db_input("cm05_c_quadra",10,@$cm05_c_quadra,true,"text",4,"","chave_cm05_c_quadra");?>
      </td>
     </tr>
     ...
     <tr>
      ...
      <td width="96%" align="left" nowrap>
       <? db_input("cm05_i_lote",10,$Icm05_i_lote,true,"text",4,"","chave_cm05_i_lote");?>
      </td>
     </tr>
  ...
  <tr> 
    <td align="center" valign="top"> 
     ...
     if(!isset($pesquisa_chave)){
      ...
      }else if(isset($chave_cm05_i_lote) && (trim($chave_cm05_i_lote)!="") ){
       $sql = $clsepulturas->sql_query("",$campos,"cm05_i_codigo desc","cm23_i_lotecemit = $chave_cm05_i_lote ".@$and.@$where);
      }else {
