...
include("classes/db_issgruposervico_classe.php");
db_postmemory($_POST);
  ...
  <tr> 
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        $campos = "issgruposervico.q126_sequencial,db_estruturavalor.db121_estrutural, db_estruturavalor.db121_descricao::varchar(90)";
        if(isset($chave_q126_sequencial) && (trim($chave_q126_sequencial)!="") ){
	         $sql = $clissgruposervico->sql_query_Estrutural($chave_q126_sequencial,$campos,"db121_estrutural", $sWhere );
        }else if(isset($chave_q126_sequencial) && (trim($chave_q126_sequencial)!="") ){
	         $sql = $clissgruposervico->sql_query_Estrutural("",$campos,"db121_estrutural"," q126_sequencial like '$chave_q126_sequencial%' and {$sWhere} ");
        }else{
           $sql = $clissgruposervico->sql_query_Estrutural("",$campos,"db121_estrutural",$sWhere );
        }
        $repassa = array();
