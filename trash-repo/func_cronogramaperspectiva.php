    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_o124_sequencial) && (trim($chave_o124_sequencial)!="") ){
	         $sql = $clcronogramaperspectiva->sql_query($chave_o124_sequencial,$campos,"o124_sequencial");
        }else if(isset($chave_o124_descricao) && (trim($chave_o124_descricao)!="") ){
	         $sql = $clcronogramaperspectiva->sql_query("",$campos,"o124_descricao"," o124_descricao like '$chave_o124_descricao%' ");
        }else{
           $sql = $clcronogramaperspectiva->sql_query("",$campos,"o124_sequencial","");
        }
        $repassa = array();
        ...
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $clcronogramaperspectiva->sql_record($clcronogramaperspectiva->sql_query($pesquisa_chave));
