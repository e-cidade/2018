...
if (isset($licitacao)&&trim($licitacao)!=""){
     ...
     if ($clliclicita->numrows > 0){
          ...
          if ($l08_altera == "t"){
               ...
               $erro_msg = "Licitacao ja julgada.";
          }else{

               $erro_msg = "Licitacao não pode ser altera\\nAlteração não permitida.";
...
?>
   ...
   function js_novo(){
       ...
       js_OpenJanelaIframe('top.corpo.iframe_liclicitemlote','db_iframe_lotenovo','lic1_liclicitemlotenovo.php?licitacao='+licitacao,'Novo',true,"0");
   }

   function js_excluir(){
       var licitacao = itens_lote.document.form1.licitacao.value;

       js_OpenJanelaIframe('top.corpo.iframe_liclicitemlote','db_iframe_loteexcluir','lic1_liclicitemlote003.php?licitacao='+licitacao,'Excluir',true,"0");
   }
</script>
<?
  if ($selecionado==0){
