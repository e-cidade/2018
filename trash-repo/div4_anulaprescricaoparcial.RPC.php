...
k30_multa, 
k30_desconto, 
(k30_vlrcorr+k30_vlrjuros+k30_multa-k30_desconto) as total 
from prescricaolista 
join listadeb on listadeb.k61_codigo = prescricaolista.k122_lista 
inner join arreprescr on arreprescr.k30_numpre = listadeb.k61_numpre and arreprescr.k30_numpar = listadeb.k61_numpar 
inner join tabrec on tabrec.k02_codigo = arreprescr.k30_receit 
inner join divida on divida.v01_numpre = listadeb.k61_numpre and divida.v01_numpar = listadeb.k61_numpar 
inner join arrenumcgm on arrenumcgm.k00_numpre = divida.v01_numpre 
where  k30_anulado is false; 
*/
