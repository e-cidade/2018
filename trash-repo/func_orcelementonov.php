...
<table height="100%" border="0"  align="center" cellspacing="0" bgcolor="#CCCCCC">
  ...
  <tr> 
    <td align="center" valign="top"> 
      <?
	$dbwhere = "";
	$dbwhere = " and orcelemento.o56_anousu=".db_getsession("DB_anousu");
	if(isset($o50_subelem) and ($o50_subelem=='f')){
	  ...
	  $sql = $clorcelemento->sql_query_nov(null,$campos,"o56_elemento"," o56_elemento like '$chave_o56_elemento%' $dbwhere ");
        }else if(isset($chave_o56_descr) && (trim($chave_o56_descr)!="") ){
	  $sql = $clorcelemento->sql_query_nov(null,$campos,"o56_elemento"," o56_descr like '$chave_o56_descr%' $dbwhere ");
 
        }else{
           $sql = $clorcelemento->sql_query_nov(null,$campos,"o56_elemento"," 1 = 1 $dbwhere");
        }
        //echo $sql;
