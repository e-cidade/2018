    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        if(isset($chave_z01_numcgm) && (trim($chave_z01_numcgm)!="") ){
                 $sql = $clconlancamcgm->sql_query(null,$campos,"c76_numcgm","c76_numcgm = $chave_z01_numcgm"); 
		 
        }else if(isset($chave_z01_nome) && (trim($chave_z01_nome)!="") ){
                $sql = $clconlancamcgm->sql_query(null,$campos,"c76_numcgm"," z01_nome like '$chave_z01_nome%' " ); 
        }else{
	       $sql = $clconlancamcgm->sql_query(null,$campos,"c76_numcgm"); 
        }
	//echo $sql;
	  ...
	  $result = $clconlancamcgm->sql_record($clconlancamcgm->sql_query(null,$campos,"c76_numcgm","c76_numcgm = $pesquisa_chave")); 
