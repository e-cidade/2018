...
$head5 = "PERÍODO: ".$dDataini." até ".$dDatafim;
$iCont = 0;
$oPdf->ln(5);
$oPdf->addpage('L');
$oPdf->setfont('arial', 'b', 10);
$oPdf->cell(24, 4, "Requisição ", 1, 0, "L", 0);
$oPdf->cell(20, 4, "Data ", 1, 0, "L", 0);
$oPdf->cell(80, 4, "Paciente ", 1, 0, "L", 0);
$oPdf->cell(50, 4, "Exame ", 1, 0, "L", 0);
$oPdf->cell(45, 4, "Material ", 1, 0, "L", 0);
$oPdf->cell(20, 4, "Coleta ", 1, 0, "L", 0);
$oPdf->cell(20, 4, "Resultado ", 1, 0, "L", 0);
$oPdf->cell(20, 4, "Entrega ", 1, 1, "L", 0);
...
for ($iI = 0; $iI < $oDaoLabRequiItem->numrows; $iI++) {
  ...
  if ($iCont == 35) {
    ...
    $oPdf->addpage('L');
    $oPdf->setfont('arial', 'b', 10);
    $oPdf->cell(24, 4, "Requisição ", 1, 0, "R", 0);
    $oPdf->cell(20, 4, "Data ", 1, 0, "L", 0);
    $oPdf->cell(80, 4, "Paciente ", 1, 0, "L", 0);
    $oPdf->cell(50, 4, "Exame ", 1, 0, "L", 0);
    $oPdf->cell(45, 4, "Material ", 1, 0, "L", 0);
  ...
  $oPdf->cell(50, 4, substr($oDataRequiItem->la08_c_descr, 0, 16), 1, 0, "L", 0);
  $oPdf->cell(45, 4, substr($oDataRequiItem->la15_c_descr, 0, 40), 1, 0, "L", 0);
