      ...
      if(!isset($pesquisa_chave)){
        if(isset($campos)==false){
           if(file_exists("funcoes/db_func_atendrequi.php")==true){
             include("funcoes/db_func_atendrequi.php");
           }else{
           $campos = "atendrequi.*";
           }
        }
        ...
        if(isset($chave_m42_codigo) && (trim($chave_m42_codigo)!="") ){
	         $sql = $clatendrequi->sql_query_requi($chave_m42_codigo,$campos,"m42_codigo");
        }else if(isset($chave_m40_codigo) && (trim($chave_m40_codigo)!="") ){
	         $sql = $clatendrequi->sql_query_requi("",$campos,"m42_codigo"," m40_codigo = $chave_m40_codigo");
        }else{
           $sql = $clatendrequi->sql_query_requi("",$campos,"m42_codigo","");
        }
