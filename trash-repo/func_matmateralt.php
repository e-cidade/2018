    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_m60_codmater) && (trim($chave_m60_codmater)!="") ){
	         ...
	         $sql = $clmatmater->sql_query("",$campos,"m60_descr"," m60_descr like '$chave_m60_descr%' ");
        }else{
           $sql = $clmatmater->sql_query("",$campos,"m60_codmater");
        }
        db_lovrot($sql,15,"()","",$funcao_js);
      }else{
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $clmatmater->sql_record($clmatmater->sql_query($pesquisa_chave));
