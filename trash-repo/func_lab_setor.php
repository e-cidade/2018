  ...
  <tr> 
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_la23_i_codigo) && (trim($chave_la23_i_codigo)!="") ){
	         $sql = $cllab_setor->sql_query($chave_la23_i_codigo,$campos,"la23_i_codigo");
        }else if(isset($chave_la23_c_descr) && (trim($chave_la23_c_descr)!="") ){
	         $sql = $cllab_setor->sql_query("",$campos,"la23_c_descr"," la23_c_descr like '$chave_la23_c_descr%' ");
        }else{
           $sql = $cllab_setor->sql_query("",$campos,"la23_i_codigo","");
        }
        $repassa = array();
