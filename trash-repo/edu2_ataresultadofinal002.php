...
switch($oFiltroRelatorio->iModelo) {
  ...
  case ($oFiltroRelatorio->iModelo == 1 || $oFiltroRelatorio->iModelo == 2):
    ...
    for ($iContadorTurma = 0; $iContadorTurma < count($aTurmas); $iContadorTurma++) {
      ...
      $head2  = "Aos {$oTurma->oDadosEscola->iDia} dias do mês de {$oTurma->oDadosEscola->iMes} ";
      $head2 .= "de {$oTurma->oDadosEscola->iAno} conclui-se a apuração final do rendimento escolar, ";
...
function cabecalhoScpf($oPdf, Turma $oTurma, $oFiltroRelatorio, $iCodigoEtapa) {
  ...
  $sTermo  = "Aos {$oTurma->oDadosEscola->iDia} dias do mês de {$oTurma->oDadosEscola->iMes} de ";
  $sTermo .= " {$oTurma->oDadosEscola->iAno}, concluiu-se a apuração final do rendimento escolar dos alunos";
