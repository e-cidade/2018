    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_e54_autori) && (trim($chave_e54_autori)!="") ){
	         $sql = $clempautoriza->sql_query($chave_e54_autori,$campos,"e54_autori");
        }else if(isset($chave_e54_anousu) && (trim($chave_e54_anousu)!="") ){
	         $sql = $clempautoriza->sql_query("",$campos,"e54_anousu"," e54_anousu like '$chave_e54_anousu%' ");
        }else{
           $sql = $clempautoriza->sql_query("",$campos,"e54_autori","");
        }
        db_lovrot($sql,15,"()","",$funcao_js);
      }else{
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $clempautoriza->sql_record($clempautoriza->sql_query($pesquisa_chave));
