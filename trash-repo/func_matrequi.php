    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_m40_codigo) && (trim($chave_m40_codigo)!="") ){
	         $sql = $clmatrequi->sql_query($chave_m40_codigo,$campos,"m40_codigo");
        }else{
           $sql = $clmatrequi->sql_query("",$campos,"m40_codigo","");
        }
        db_lovrot($sql,15,"()","",$funcao_js);
      }else{
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $clmatrequi->sql_record($clmatrequi->sql_query($pesquisa_chave));
