	     ...
	     <form name="form2" method="post" action="" >
          ...
          <tr> 
            <td colspan="2" align="center"> 
              ...
              <input name="Fechar" type="button" id="fechar" value="Fechar" onClick="parent.db_iframe_face.hide();">
             </td>
          </tr>
        </form>
        </table>
    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        if(isset($campos)==false){
           $campos = "j37_face,j37_setor,j30_descr,j37_quadra,j37_codigo,j14_nome,j37_lado,j37_valor,j37_exten,j37_profr,j37_outros,j37_vlcons,j37_zona";
        }
        ...
        if($clface->numrows!=0){
          ...
          echo "<script>".$funcao_js."('$j37_setor','$j30_descr','$j37_quadra',false);</script>";
        }else{
