...
try {
  ...
  switch ($oParam->exec) {
    ...
    case "getContasCreditoDebito":
      ...
      $oRegraLancamento   = $aLancamentos[0]->getRegrasLancamento();
      $oPlanoContaDebito  = new ContaPlanoPCASP(null, $iAnoSessao, $oRegraLancamento[0]->getContaDebito());
      $oPlanoContaCredito = new ContaPlanoPCASP(null, $iAnoSessao, $oRegraLancamento[0]->getContaCredito());
      
      $oRetorno->iContaDebito  = $oRegraLancamento[0]->getContaDebito();
      $oRetorno->sContaDebito  = urlencode($oPlanoContaDebito->getDescricao());
      $oRetorno->iContaCredito = $oRegraLancamento[0]->getContaCredito();
