  ...
  <tr> 
    <td height="63" align="center" valign="top">
        <table width="35%" border="0" align="center" cellspacing="0">
          ...
          <tr> 
            <td width="4%" align="right" nowrap title="<?=$Tsd72_i_procedimento?>">
              <?=$Lsd72_i_procedimento?>
            </td>
            <td width="96%" align="left" nowrap> 
              <?
                 db_input("sd72_i_procedimento",5,$Isd72_i_procedimento,true,"text",4,"","chave_sd72_i_procedimento");
                 ?>
            </td>
          </tr>
          <tr> 
            <td colspan="2" align="center"> 
              ...
              <input name="Fechar" type="button" id="fechar" value="Fechar" onClick="parent.db_iframe_sau_proccid.hide();">
             </td>
          </tr>
        </form>
        </table>
      ...
      if(!isset($pesquisa_chave)){
        if(isset($campos)==false){
           if(file_exists("funcoes/db_func_sau_proccid.php")==true){
             include("funcoes/db_func_sau_proccid.php");
           }else{
           $campos = "sau_proccid.*";
           }
        }
        if(isset($chave_sd72_i_codigo) && (trim($chave_sd72_i_codigo)!="") ){
              $sql = $clsau_proccid->sql_query($chave_sd72_i_codigo,$campos,"sd72_i_codigo");
           ...
           $sql = $clsau_proccid->sql_query("",$campos,"sd72_i_codigo","");
        }
        $repassa = array();
        if(isset($chave_sd72_i_procedimento)){
          $repassa = array("chave_sd72_i_codigo"=>$chave_sd72_i_codigo,"chave_sd72_i_procedimento"=>$chave_sd72_i_procedimento);
        }
...
js_tabulacaoforms("form2","chave_sd72_i_procedimento",true,1,"chave_sd72_i_procedimento",true);
</script>