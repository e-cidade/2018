   ...
   <table width="35%" border="0" align="center" cellspacing="0">
    ...
    <tr>
     <td colspan="2" align="center">
      ...
      <input name="Fechar" type="button" id="fechar" value="Fechar" onClick="parent.db_iframe_serieidade.hide();">
     </td>
    </tr>
    </form>
   </table>
  ...
  <td align="center" valign="top">
   ...
   if(!isset($pesquisa_chave)){
    ...
    if(isset($chave_ed11_i_codigo) && (trim($chave_ed11_i_codigo)!="") ){
     $sql = $clserie->sql_query("",$campos,"ed11_i_ensino,ed11_i_sequencia",$where." AND ed11_i_codigo = $chave_ed11_i_codigo");
    }else if(isset($chave_ed11_c_descr) && (trim($chave_ed11_c_descr)!="") ){
     $sql = $clserie->sql_query("",$campos,"ed11_i_ensino,ed11_i_sequencia",$where." AND ed11_c_descr like '$chave_ed11_c_descr%' ");
    }else{
     $sql = $clserie->sql_query("",$campos,"ed11_i_ensino,ed11_i_sequencia",$where);
    }
    $repassa = array();
    ...
    if($pesquisa_chave!=null && $pesquisa_chave!=""){
     $result = $clserie->sql_record($clserie->sql_query("","*","",$where." AND ed11_i_codigo = $pesquisa_chave"));
     if($clserie->numrows!=0){
      db_fieldsmemory($result,0);
      echo "<script>".$funcao_js."('$ed11_c_descr','$ed10_i_codigo','$ed10_c_descr',false);</script>";
     }else{
