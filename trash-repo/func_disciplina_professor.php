...
include("classes/db_disciplina_professor_classe.php");
  ...
  <tr> 
    <td height="63" align="center" valign="top">
        <table width="35%" border="0" align="center" cellspacing="0">
          ...
          <tr> 
            <td width="4%" align="right" nowrap title="<?=$Ted12_f_ch?>">
          ...
          <tr> 
            <td colspan="2" align="center"> 
              ...
              <input name="Fechar" type="button" id="fechar" value="Fechar" onClick="parent.db_iframe_disciplina_professor.hide();">
             </td>
          </tr>
        </form>
        </table>
      ...
      if(!isset($pesquisa_chave)){
        if(isset($campos)==false){
           if(file_exists("funcoes/db_func_disciplina_professor.php")==true){
             include("funcoes/db_func_disciplina_professor.php");
           }else{
        ...
        if(isset($chave_ed12_i_codigo) && (trim($chave_ed12_i_codigo)!="") ){
                 ...
                 $sql = $cldisciplina_professor->sql_query("",$campos,"ed27_c_nome"," ed27_c_nome like '$chave_ed27_c_nome%' ");
        }else{
           $sql = $cldisciplina_professor->sql_query("",$campos,"ed12_i_codigo","");
        }
        db_lovrot($sql,15,"()","",$funcao_js);
      }else{
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $cldisciplina_professor->sql_record($cldisciplina_professor->sql_query($pesquisa_chave));
          if($cldisciplina_professor->numrows!=0){
