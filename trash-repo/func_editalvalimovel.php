    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_d01_codedi) && (trim($chave_d01_codedi)!="") ){
	         $sql = $cledital->sql_query_servicos($chave_d01_codedi,$campos,"d01_codedi");
        }else if(isset($chave_d01_descr) && (trim($chave_d01_descr)!="") ){
	         $sql = $cledital->sql_query_servicos("",$campos,"d01_descr"," d01_descr like '$chave_d01_descr%' ");
        }else{
           $sql = $cledital->sql_query_servicos("",$campos,"d01_codedi desc","");
        }
        db_lovrot($sql,15,"()","",$funcao_js);
      }else{

        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $sql = $cledital->sql_query_servicos($pesquisa_chave,$campos,"d01_descr");
          db_lovrot($sql,15,"()","",$funcao_js);
        }
