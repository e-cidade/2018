...
function js_Impressao1() { 
  window.open('agu3_conscadastro_impressao.php?tipo=1&parametro=<?=$cod_matricula?>&<?=db_getsession()?>','','location=0,HEIGHT=600,WIDTH=600');
}
function js_Impressao() { 
  var geracalculo = confirm('Imprimir Demonstrativo de Cálculo?');
  window.open('agu3_conscadastro_impressao.php?tipo=2&geracalculo='+geracalculo+'&parametro=<?=$cod_matricula?>&<?=db_getsession()?>','','location=0,HEIGHT=600,WIDTH=600');
}
</script>
</head>
