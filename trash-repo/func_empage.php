    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_e80_codage) && (trim($chave_e80_codage)!="") ){
	         $sql = $clempage->sql_query(null,$campos,"e80_codage desc", " e80_instit = " . db_getsession("DB_instit") . " and e80_codage = $chave_e80_codage");
        }else if(isset($chave_e80_data) && (trim($chave_e80_data)!="") ){
	         $sql = $clempage->sql_query(null,$campos,"e80_data desc"," e80_instit = " . db_getsession("DB_instit") . " and e80_data like '$chave_e80_data%'");
        }else{
           $sql = $clempage->sql_query(null,$campos,"e80_codage desc"," e80_instit = " . db_getsession("DB_instit"));
        }
