...
function imprimirCabecalhoAcordos($oPdf, $oDado, $lImprime, $iFonte, $iAlt) {
  ...
  $oPdf->SetFillColor(220);
  $oPdf->SetFont('Arial','B',$iFonte);
  $oPdf->Cell(35 ,$iAlt,'Código do Acordo: '                                                                ,0,0,'R',0);
  $oPdf->SetFont('Arial','',$iFonte-1);
  ...
  $oPdf->SetFont('Arial','',$iFonte-1);
  $oPdf->Cell(107 ,$iAlt,$oDado->numeroprocesso                                                             ,0,1,'L',0);
  ...
  $oPdf->SetFont('Arial','',$iFonte-1);
  $oPdf->Cell(107 ,$iAlt,$oDado->getVigencia                                                                ,0,1,'L',0);
    /* 
  $oPdf->SetFont('Arial','B',$iFonte);
  $oPdf->Cell(35 ,$iAlt,'Origem: '                                                                          ,0,0,'R',0);
  $oPdf->SetFont('Arial','',$iFonte-1);
  ...
  $oPdf->SetFont('Arial','',$iFonte-1);
  $oPdf->Cell(107 ,$iAlt,$oDado->getAssinatura                                                              ,0,1,'L',0);
  ...
  $oPdf->SetFont('Arial','',$iFonte-1);
  $oPdf->Cell(107 ,$iAlt,urldecode($oDado->getGrupoAcordo)                                                  ,0,1,'L',0);
  ...
  $oPdf->SetFont('Arial','B',$iFonte);
  $oPdf->Cell(32 ,$iAlt,'Número do Acordo: '                                                                ,0,0,'R',0);
  $oPdf->SetFont('Arial','',$iFonte-1);
  $oPdf->Cell(107 ,$iAlt,$oDado->getNumeroAcordo                                                            ,0,1,'L',0);
  ...
  $oPdf->SetFont('Arial','',$iFonte-1);
  $oPdf->Cell(107 ,$iAlt,urldecode($oDado->getDepartamento)                                                 ,0,1,'L',0);
  ...
  $oPdf->Cell(35 ,$iAlt,'Origem: '                                                                          ,0,0,'R',0);
  $oPdf->SetFont('Arial','',$iFonte-1);
  $oPdf->MultiCell(107,$iAlt,urldecode($oDado->getOrigem)                                               ,0,"L",0);
  

  $oPdf->SetFont('Arial','B',$iFonte);
  $oPdf->Cell(35 ,$iAlt,'Comissão: '                                                                          ,0,0,'R',0);
  $oPdf->SetFont('Arial','',$iFonte-1);
  $oPdf->Cell(107 ,$iAlt,urldecode($oDado->getComissao)                                                       ,0,1,'L',0);
