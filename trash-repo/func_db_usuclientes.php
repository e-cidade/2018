	     ...
	     <form name="form2" method="post" action="" >
          ...
          <tr> 
            <td colspan="2" align="center"> 
              ...
              <input name="Fechar" type="button" id="fechar" value="Fechar" onClick="parent.db_iframe_db_usuclientes.hide();">
             </td>
          </tr>
        </form>
        </table>
    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_at10_codigo) && (trim($chave_at10_codigo)!="") ){
	         $sql = $cldb_usuclientes->sql_query($chave_at10_codigo,$campos,"at10_codigo");
        }else if(isset($chave_at10_codcli) && (trim($chave_at10_codcli)!="") ){
	         $sql = $cldb_usuclientes->sql_query("",$campos,"at10_codcli"," at10_codcli like '$chave_at10_codcli%' ");
        }else{
           $sql = $cldb_usuclientes->sql_query("",$campos,"at10_codigo","");
        }
        db_lovrot($sql,15,"()","",$funcao_js);
      }else{
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $cldb_usuclientes->sql_record($cldb_usuclientes->sql_query($pesquisa_chave));
          if($cldb_usuclientes->numrows!=0){
            db_fieldsmemory($result,0);
            echo "<script>".$funcao_js."('$at10_codcli',false);</script>";
          }else{
