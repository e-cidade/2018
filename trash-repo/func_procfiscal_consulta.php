    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
				...
				$sql = "  select distinct y100_sequencial,y100_dtinicial,y100_dtfinal,y33_descricao,descrdepto, z01_nome
								  	from procfiscal
								         ...
								         left  join procfiscalsani    on y104_procfiscal    = y100_sequencial
												 left  join procfiscalprot    on y105_procfiscal    = y100_sequencial
        ...
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
						...
						$sql = "
							select distinct y100_sequencial,y100_dtinicial,y100_dtinicial,y33_descricao,descrdepto, z01_nome
							from procfiscal
							inner join db_depart       on db_depart.coddepto = procfiscal.y100_coddepto 
							inner join procfiscalcgm   on y101_procfiscal    = y100_sequencial
							inner join cgm             on cgm.z01_numcgm     = y101_numcgm
