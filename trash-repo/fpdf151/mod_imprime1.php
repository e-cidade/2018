...
//        echo("if <br>");
       ...
       $this->objpdf->Text(57 ,$y-5,"Data para pagamento : ".$this->dtparapag);
       $this->objpdf->SetFont('Times','',5);
...
//:   }
    ...
    $this->objpdf->SetFont('Arial','',5);
	$this->objpdf->Text(71,$y+3,$this->titulo5); // Parcela
	$this->objpdf->SetFont('Arial','B',7);
	$this->objpdf->Text(74,$y+6,$this->descr5); // Parcela inicial e total de parcelas
	...
	$this->objpdf->Text(25,$y+19,$this->descr17); // SQL
  ...
  $this->objpdf->SetFont('Arial','',5);
	...
	$this->objpdf->SetFont('Arial','',6);
	$this->objpdf->Text(109,$y+19,$this->descr17); // SQL
