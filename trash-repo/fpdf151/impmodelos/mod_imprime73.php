...
// 	$this->objpdf->Text($x+141, $y+37,$this->valtotal);          // valor do documento
  ...
  if(@$this->mora_multa!=""){
	...
	$this->objpdf->SetFont('Arial','',8);   //RAQUEL ALTEROU PARA JANETE (antes era fonte 6)
  $this->objpdf->multicell(133,4,$instrucao); // Instrução// RAQUEL ALTEROU (antes era 133,2)
  $this->objpdf->SetFont('Arial','',10);
