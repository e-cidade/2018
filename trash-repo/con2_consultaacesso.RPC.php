...
try {
  ...
  switch ($oParametros->sExecucao) {
    ...
    case "getModificacoes":
      ...
      $aParametros["dDataAcesso"]   = $oParametros->dDataAcesso;
      
      $oDaoDBAuditoria           = new cl_db_auditoria();
      $sSqlBuscaModificacoes     = $oDaoDBAuditoria->sql_query_modificacoes(
                                                                            $oParametros->iCodigoAcesso, 
                                                                            $oParametros->dDataAcesso,
                                                                            $aParametros
                                                                           );
