  ...
  <tr> 
    <td height="63" align="center" valign="top">
        <table width="35%" border="0" align="center" cellspacing="0">
          ...
          <tr> 
            <td width="4%" align="right" nowrap title="<?=$Ted80_i_codigo?>">
              <?=$Led80_i_codigo?>
            </td>
          ...
          <tr> 
            <td colspan="2" align="center"> 
              ...
              <input name="Fechar" type="button" id="fechar" value="Fechar" onClick="parent.db_iframe_abonofalta.hide();">
             </td>
          </tr>
        </form>
        </table>
  ...
  <tr> 
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_ed80_i_codigo) && (trim($chave_ed80_i_codigo)!="") ){
                 $sql = $clabonofalta->sql_query($chave_ed80_i_codigo,$campos,"ed80_i_codigo");
        }else if(isset($chave_ed80_i_codigo) && (trim($chave_ed80_i_codigo)!="") ){
                 $sql = $clabonofalta->sql_query("",$campos,"ed80_i_codigo"," ed80_i_codigo like '$chave_ed80_i_codigo%' ");
        }else{
