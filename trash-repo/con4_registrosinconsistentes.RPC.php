...
switch ($oParam->sExec) {
  ...
  case 'processar' :
    ...
    try {
      ...
      $aInconsistencias = db_utils::getColectionByRecord($rsInconsistencias);
      ...
      $lProcessamentoOK = $oIncosistencia->processar();
      $sMensagemRetorno = $lProcessamentoOK ? "Inconsistências processadas." : "Nem todas as inconsistências foram processadas, verifique log.";
      db_fim_transacao(false);
