...
<table style="margin-top: 20px;" width="790">
        ...
        <table>
          ...
          <tr id="trConsultaFamilia" style="display:none">
            <td style="font-weight: bold;">
              <?php
                db_ancora("<b>Responsável da Família: </b>", "js_pesquisaCidadaoFamilia(true);", 1);
              ?>
            </td>
            <td>
            	<?php
	...
	<fieldset>
		<table>
			<tr><td>
				<fieldset id="fieldset_cidadao"><legend><b>Cadastro Cidadão</b></legend>
				<table>
				<tr>
...
<div id="cadastroAvaliacaoSocioEconomicaCidadao" style="<?php echo $sStylelTelaSocial; ?>">
  <center>
    <fieldset style="width:700px;height:500px">
      <legend><b>Avaliação Sócio Econômica - Cidadão</b></legend>
...
<div id="cadastroAvaliacaoSocioEconomicaFamilia" style="<?php echo $sStylelTelaSocial; ?>">
  <center>
    <fieldset style="width:700px;height:500px">
      <legend><b>Avaliação Sócio Econômica - Família</b></legend>
