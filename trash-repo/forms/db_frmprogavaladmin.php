...
function js_pesquisa(){
 js_OpenJanelaIframe('top.corpo','db_iframe_progavaladmin','func_progavaladmin.php?funcao_js=parent.js_preenchepesquisa|ed116_i_codigo','Pesquisa de Avaliação Administrativa',true);
}
