...
<form name="form1" method="post" action="">
  <center>
    <fieldset style='width: 96%;'> 
      ...
      <table style="width: 70%; padding-left: 5px;" align="left">
        <tr>
          ...
          <td nowrap> 
            <?
            db_input('tf10_i_centralagend', 10, $Itf10_i_centralagend, true, 'text', $db_opcao,
                     " onchange='js_pesquisatf10_i_centralagend(false);'"
                    );
        ...
        <tr>
          ...
          <td nowrap> 
            <?
            db_input('tf10_i_prestadora', 10, $Itf10_i_prestadora, true, 'text', $db_opcao,
                     " onchange='js_pesquisatf10_i_prestadora(false);'"
                    );
        ...
        <tr>
          <td colspan="3">
            <fieldset>
              <legend><b>Endereço da Prestadora:</b></legend>
...
function js_cria_datagrid() {
  ...
  oDBGrid.setCellWidth(new Array('5%', '20%', '10%', '10%', '20%', '20%', '0%'));
