 ...
 if($linhas>0){
  for($x=0;$x<$linhas;$x++){
   ...
   <tr bgcolor="<?=$cor?>">
    ...
    <td align="center">
     <input type="text" size="3" name="ed97_i_diasletivos" id="ed97_i_diasletivos" value="<?=@$ed97_i_diasletivos?>" style="text-transform:uppercase;background:<?=@$ed97_i_codigo==''?'#DEB887':'#E6E4F1'?>;text-align:center;" <?=@$ed97_i_codigo==""?"disabled":""?> onKeyUp="js_ValidaCampos(this,1,'Dias Letivos','f','f',event);">
    </td>
    <td align="center">
    ...
    <td align="center">
     <input type="text" size="3" name="ed97_i_faltanjust" id="ed97_i_faltanjust" value="<?=@$ed97_i_faltanjust?>" style="text-transform:uppercase;background:<?=@$ed97_i_codigo==''?'#DEB887':'#E6E4F1'?>;text-align:center;" <?=@$ed97_i_codigo==""?"disabled":""?> onKeyUp="js_ValidaCampos(this,1,'Faltas não Justificadas','f','f',event);">
    </td>
    <td align="center">
    ...
    ?>
    <td align="center">
     <textarea name="ed97_t_horario" id="ed97_t_horario" rows="1" cols="8" style="font-size:11px;text-transform:uppercase;background:<?=@$ed97_i_codigo==''?'#DEB887':'#E6E4F1'?>;" <?=@$ed97_i_codigo==""?"disabled":""?>><?=@$ed97_t_horario?></textarea>
    </td>
    <td align="center">
...
function Salvar(linhas){
 ...
 if(alguem==false){
  ...
  if(linhas==1){
   ...
   registro += sep+marcado+";"+F.ed97_i_codigo.value+";"+F.ed97_i_rechumano.value+";"+F.ed97_i_diasletivos.value+";"+F.ed97_i_faltaabon.value+";"+F.ed97_i_faltanjust.value+";"+F.ed97_t_licenca.value+";"+F.ed97_t_horario.value+";"+F.ed97_t_obs.value;
  }else{
   for(i=0;i<linhas;i++){
    if(F.individual[i].checked==true){
     marcado = "true";
    ...
    registro += sep+marcado+";"+F.ed97_i_codigo[i].value+";"+F.ed97_i_rechumano[i].value+";"+F.ed97_i_diasletivos[i].value+";"+F.ed97_i_faltaabon[i].value+";"+F.ed97_i_faltanjust[i].value+";"+F.ed97_t_licenca[i].value+";"+F.ed97_t_horario[i].value+";"+F.ed97_t_obs[i].value;
    sep = "|";
   }
  }
