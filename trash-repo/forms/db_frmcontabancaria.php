  ...
  <legend>
	...
	<table border="0">
	  ...
	  <tr>
	    ...
	    <td> 
				<?
				  db_input('db83_identificador',14,$Idb83_identificador,true,'text',$db_opcao,"");
				?>
	    </td>
	  </tr>
	  <tr>
	  ...
	  <tr>
	    ...
	    <td> 
				<?
				  ...
				  db_select('db83_tipoconta',$x,true,$db_opcao,"");
				?>
	    </td>
	  </tr>
	  <tr>
	    ...
	    <td> 
				<?php
				  ...
				  db_select('db83_contaplano', $aContaPlano, true, $db_opcao,"");
				?>
	    </td>
	  </tr>
  </table>
