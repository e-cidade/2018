...
?>
<form name="form1" method="post" action="sec1_sec_parametros001.php?lMensagem=true">
  <center>
    <table border="0">
      <tr>   
        <td> 
          <?db_input('ed290_sequencial', 10, @$Ied290_sequencial, true, 'hidden', 3, "")?>
        </td>
      </tr>
      <tr>
        <td nowrap title="<?=@$Ted290_importcenso?>">
          <?=@$Led290_importcenso?>
        </td>
        <td> 
          <?
      ...
      <tr>
        <td nowrap title="<?=@$Ted290_controleprogressaoparcial?>">
