  ...
  if(mostra==true){
    js_OpenJanelaIframe('top.corpo','db_iframe_itbi','func_itbi.php?funcao_js=parent.js_mostraitbi1|it01_guia|it01_guia','Pesquisa',true);
     ...
     if(document.form1.it08_guia.value != ''){
        js_OpenJanelaIframe('top.corpo','db_iframe_itbi','func_itbi.php?pesquisa_chave='+document.form1.it08_guia.value+'&funcao_js=parent.js_mostraitbi','Pesquisa',false);
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('top.corpo','db_iframe_itbiconstr','func_itbiconstr.php?funcao_js=parent.js_preenchepesquisa|it08_codigo','Pesquisa',true);
}
