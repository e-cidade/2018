...
<form name="form2" method="post" action="">
                  ...
                  for ($iCont = 0; $iCont < $oDaoTurmaSerieRegimeMat->numrows; $iCont++) {
                    ...
                    if ($oDaoAlunoPossib->numrows > 0) {
                      ...
                      if($oDaoSerieEquiv->numrows>0){
                        ...
                        for($w=0;$w<$oDaoSerieEquiv->numrows;$w++){

                          $oDadosEquiv = db_utils::fieldsmemory($rsEquiv, $w);
                          if($oDadosEquiv->ed234_i_serieequiv==$oDadosEtapa->ed223_i_serie || $iSeriePossib==$oDadosEtapa->ed223_i_serie){
 ...
 ?>
      <tr>
         ...
         <center>
         <input name="incluirmatricula" type="submit" value="Incluir" disabled
...
function js_pesquisaed60_i_turma() {
  ...
  js_OpenJanelaIframe('', 'db_iframe_turma', 'func_alunocursoturma.php?aluno='+document.form2.ed56_i_aluno.value+
                      ...
                      'ed31_i_codigo|ed15_i_codigo|ed57_i_nummatr|ed57_i_numvagas|ed11_i_sequencia|ed52_i_ano|'+
...
function js_mostraturma1(chave1,chave2,chave3,chave4,chave5,chave6,chave7,chave8,chave9,chave10,
                         chave11,chave12,chave13,chave14,chave15,chave16,chave17,chave18) {
  ...
  if (parseInt(chave13) >= parseInt(chave14)) {
    ...
    document.getElementById("codetapaturma").style.visibility = "hidden";
    alert(_M('educacao.escola.db_frmalunocursomatr.turma_sem_vagas1'));
...
function js_mostraturma2(chave1,chave2,chave3,chave4,chave5,chave6,chave7,chave8,chave9,chave10,
  ...
  if (parseInt(chave13) >= parseInt(chave14)) {
    ...
    document.getElementById("codetapaturma").style.visibility = "hidden";
    alert(_M('educacao.escola.db_frmalunocursomatr.turma_sem_vagas2'));

  } else {
  <? if (!isset($ed60_i_turma) && !isset($opcao)) { ?>
    document.form2.submit();
  <? } ?>
    document.form2.incluirmatricula.disabled = false;
  }
...
$("ed57_i_numvagas").addClassName("field-size1");
$("ed57_i_nummatr").addClassName("field-size1");
$("restantes").addClassName("field-size1");
