...
if($db_opcao == 1){
  if($tipo == "z01_numcgm"){
    ...
    $dados = "<a onClick=\"js_abre('prot3_conscgm002.php?fechar=func_nome&numcgm=$valor');return false\" href=''>CGM: ".$valor."</a>";
...
?>
    ...
    <tr>
	 ...
	 <?
       db_ancora("<b>Processo:</b>","js_pesquisay60_proces(true);",$db_opcao);
       //db_ancora(@$Ly60_proces,"js_pesquisay60_proces(true);",$db_opcao);
       ?>
      </td>
      <td> 
  <?
