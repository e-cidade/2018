...
$clrotulo->label('db89_sequencial');
...
function js_verifica(){
  ...
  if(document.form1.db89_sequencial.value==""){
    alert("Digite o código da Agência!");
	document.form1.db89_sequencial.focus();
	return false;
  }
...
function js_banco(mostra) {
	...
	var iCodigoBanco = $('k15_codbco').value;
...
function js_mostrabanco1( chave, erro ) {
  ...
  if ( erro == true ) { 
    document.form1.k15_codbco.focus(); 
    document.form1.k15_codbco.value = ''; 
  }
}
