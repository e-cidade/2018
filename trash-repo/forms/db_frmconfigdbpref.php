  ...
  <tr>
    ...
    <td> 
		<?
		  ...
		  db_select('w13_liberapedsenha',$x,true,$db_opcao,"");
		?>
    </td>
  </tr>
  <tr>
    ...
    <td> 
		<?
		  ...
		  db_select('w13_permfornsemlog',$x,true,$db_opcao,"");
		?>
    </td>
  </tr>
  <tr>
    ...
    <td> 
		<?
		  ...
		  db_select('w13_permvarsemlog',$x,true,$db_opcao,"");
		?>
    </td>
  </tr>
  <tr>
    ...
    <?
      ...
      db_select('w13_permconsservdemit',$x,true,$db_opcao,"");
    ?>
    </td>
  </tr>  
  <tr>
    ...
    <td> 
		<?
		  ...
		  db_select('w13_liberaescritorios',$x,true,$db_opcao,"");
		?>
    </td>
  </tr>
  <tr>
    ...
    <td> 
		<?
		  ...
		  db_select('w13_liberaimobiliaria',$x,true,$db_opcao,"");
		?>
     </td>
    </tr>
    <tr>
    ...
    <td> 
		<?
		  ...
		  db_select('w13_permconscgm',$x,true,$db_opcao,"");
		?>
    </td>
  </tr>
  <tr>
    ...
    <td> 
		<?
		  ...
		  db_select('w13_aliqissretido',$x,true,$db_opcao,"");
		?>
    </td>
  </tr>
  <tr>
    ...
    <td> 
		<?
		  ...
		  db_select('w13_liberaissretido',$x,true,$db_opcao,"");
		?>
    </td>
  </tr>
  <tr>
    ...
    <td> 
		<?
		  ...
		  db_select('w13_utilizafolha',$x,true,$db_opcao,"");
		?>
    </td>
  </tr>
  <tr>
    ...
    <td> 
		<?
		  ...
		  db_select('w13_libcertpos',$x,true,$db_opcao,"");
		?>
    </td>
  </tr>
  <tr>
    ...
    <td> 
		<?
			...
			db_select('w13_regracnd',$aRegraCND,true,$db_opcao);
  	?>
    </td>
  </tr>
  <tr>
    ...
    <td> 
		<?
    	  ...
    	  db_select('w13_libcarnevariavel',$x,true,$db_opcao,"");
		?>
    </td>
  </tr>
  <tr>
    ...
    <td> 
		<?
		  ...
		  db_select('w13_libsociosdai',$x,true,$db_opcao,"");
		?>
    </td>
  </tr>
  <tr>
    ...
    <td> 
		<?
		  ...
		  db_select('w13_libissprestado',$x,true,$db_opcao,"");
		?>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td> 
		<?
		  ...
		  db_select('w13_liberalancisssemmov',$x,true,$db_opcao,"");
		?>
    </td>
  </tr>
      <tr>
    <td nowrap title="<?=@$Tw13_exigecpfcnpj?>">
       <?=@$Lw13_exigecpfcnpj?>
    </td>
    <td> 
		<?
		  $x = getValoresPadroesCampo("w13_exigecpfcnpj");
		  db_select('w13_exigecpfcnpj',$x,true,$db_opcao,"");
		?>
    </td>
  </tr>
  <tr>
    ...
    <td> 
		<?
		  ...
		  db_select('w13_tipocertidao',$x,true,$db_opcao,"");
		?>
    </td>
  </tr>
  <tr>
    ...
    <td> 
		<?
		  ...
		  db_select('w13_agrupadebrecibos',$x,true,$db_opcao,"");
		?>
    </td>
  </tr>
   <tr>
  ...
  <tr>
    ...
    <td> 
		<?
		  ...
		  db_select("w13_msgaviso",$x,true,$db_opcao,"");
		?>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td> 
		<?
		  ...
		  db_select("w13_tipocodigocertidao",$x,true,$db_opcao,"");
		?>
    </td>
  </tr>
