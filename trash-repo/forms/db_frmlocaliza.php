...
//MODULO: juridico
$cllocaliza->rotulo->label();
?>
<form class="container" name="form1" method="post" action="">
  <fieldset>
    <legend>Cadastros - Localização</legend>
...
function js_pesquisa(){
  db_iframe.jan.location.href = 'func_localiza.php?funcao_js=parent.js_preenchepesquisa|0';
  db_iframe.mostraMsg();
  db_iframe.show();
  db_iframe.focus();
}
...
$("v54_descr").addClassName("field-size9");
