...
<table border="0" align="left" width="100%">
 <tr>
  ...
  <td valign="top" width="220">
   <fieldset style="width:90%"><legend><b>Aproveitamento desta avaliação</b></legend>
    <table width="100%">
     <?
     ...
     <tr>
      <td>
       Alunos que não obtiveram o aproveitamento mínimo para:
      </td>
     </tr>
     <tr>
      <td nowrap>
...
function js_pesquisaed41_i_periodoavaliacao(mostra){
 if(mostra==true){
  js_OpenJanelaIframe('parent','db_iframe_periodoavaliacao','func_periodoavaliacao.php?periodos=<?=@$per_cad?>&funcao_js=parent.iframe_avaliacoes.js_mostraperiodoavaliacao1|ed09_i_codigo|ed09_c_descr','Pesquisa de Períodos de Avaliação',true,0,0);
 }else{
...
function js_pesquisaed41_i_formaavaliacao(mostra){
 if(mostra==true){
  js_OpenJanelaIframe('parent','db_iframe_formaavaliacao','func_formaavaliacao.php?forma=<?=@$formaaval?>&funcao_js=parent.iframe_avaliacoes.js_mostraformaavaliacao1|ed37_i_codigo|ed37_c_descr','Pesquisa de Formas de Avaliação',true,0,0);
 }else{
