	...
	<tr>
		<td>
			...
			<table border="0" width="97%">
			  ...
			  <tr>
			    <td width="19%" align="right" nowrap title="<?=@$Tsd24_i_codigo?>">
			       <?=@$Lsd24_i_codigo?>
			    </td>
			    <td>
			     <?
			    ...
			    <td align="right" width="19%" nowrap title="<?=@$Tsd23_i_codigo?>">
			       <?
			...
			//     $descrdepto=db_getsession("DB_nomedepto");
			  ...
			  <tr>
			    ...
			    <td colspan="3">
			     <?
			     db_input('z01_v_ender',73,$Iz01_v_ender,true,'text',(!isset($z01_c_municipio)||$z01_c_municipio=='S'?3:$db_opcao),"")
			     ?>
			    </td>
			  </tr>
			  ...
			  <tr>
			    ...
			    <td colspan="4">
			     ...
			     db_input('z01_v_bairro',73,$Iz01_v_bairro,true,'text',(!isset($z01_c_municipio)||$z01_c_municipio=='S'?3:$db_opcao),"")
			     ?>
			    </td>
			  </tr>
	...
	<tr>
        ...
        <fieldset><legend><b>Profissional de Atendimento</b></legend>
         <table border="0" width="97%">
								<!-- PROFISSIONAL -->
								<tr>
									<td align="right" width="19%" nowrap title="<?=@$Tsd03_i_codigo?>" >
										<? db_ancora(@$Lsd03_i_codigo,"js_pesquisasd03_i_codigo(true,1);",$db_opcaoprof); ?>
									</td>
									<td valing="top" align="top">
										<? 
											db_input('sd03_i_codigo',10,$Isd03_i_codigo,true,'text',$db_opcaoprof," onchange='js_pesquisasd03_i_codigo(false,1);' onFocus=\"nextfield='rh70_estrutural'\""); 
										?>
									</td>
									<td colspan="2">
								...
								<tr>
									...
									<td>
										<?
											...
											db_input('rh70_estrutural',10,$Irh70_estrutural,true,'text',$db_opcaoprof," onchange='js_pesquisasd04_i_cbo(false,1);' onFocus=\"nextfield='sd23_d_consulta'\"");
										?>
									</td>
									<td colspan="2">
...
<!-- anular incluído com menu no procedimentos
<input name="anular" type="button" id="anular" value="<?=($clprontanulado->numrows > 0)?"Cancelar Anulação":"Anular FAA"?>" onclick="js_anular()" <?=(!isset($sd24_i_codigo)||(@$sd24_c_digitada == "S")  ?"disabled":"")?> >
-->
</form>
<script>
