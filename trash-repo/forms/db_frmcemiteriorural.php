...
?>
  ...
  <tr>
    <td nowrap title="<?=@$Tcm16_c_endereco?>">
       <?=@$Lcm16_c_endereco?>
    </td>
    <td> 
<?
...
?>
  ...
  <tr>
    <td nowrap title="<?=@$Tcm16_c_cidade?>">
       <?=@$Lcm16_c_cidade?>
    </td>
    <td> 
<?
...
?>
  ...
  <tr>
    <td nowrap title="<?=@$Tcm16_c_bairro?>">
       <?=@$Lcm16_c_bairro?>
    </td>
    <td> 
<?
...
?>
  ...
  <tr>
    <td nowrap title="<?=@$Tcm16_c_telefone?>">
       <?=@$Lcm16_c_telefone?>
    </td>
    <td> 
<?
