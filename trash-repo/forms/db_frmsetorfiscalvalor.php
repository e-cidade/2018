...
function js_pesquisaj82_setorfiscal(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('top.corpo.iframe_setorfiscalvalor','db_iframe_setorfiscal','func_setorfiscal.php?funcao_js=parent.js_mostrasetorfiscal1|j90_codigo|j90_descr','Pesquisa',true,'0','1','775','390');
  }else{
     if(document.form1.j82_setorfiscal.value != ''){ 
        js_OpenJanelaIframe('top.corpo.iframe_setorfiscalvalor','db_iframe_setorfiscal','func_setorfiscal.php?pesquisa_chave='+document.form1.j82_setorfiscal.value+'&funcao_js=parent.js_mostrasetorfiscal','Pesquisa',false);
     }else{
