...
function js_pesquisao58_codele(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('top.corpo.iframe_orcdotacao','db_iframe_orcelemento','func_orcelemento.php?funcao_js=parent.js_mostraorcelemento1|o56_elemento|o56_descr','Pesquisa',true);
  }else{
    js_OpenJanelaIframe('top.corpo.iframe_orcdotacao','db_iframe_orcelemento','func_orcelemento.php?pesquisa_chave='+document.form1.o56_elemento.value+'&funcao_js=parent.js_mostraorcelemento','Pesquisa',false);
  }
}
