...
function js_pesquisa(){
 js_OpenJanelaIframe('top.corpo','db_iframe_progavalpedag','func_progavalpedag.php?funcao_js=parent.js_preenchepesquisa|ed117_i_codigo','Pesquisa de Avaliação Pedagógica',true);
}
