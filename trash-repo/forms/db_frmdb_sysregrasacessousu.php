...
function js_pesquisa(){
  js_OpenJanelaIframe('top.corpo','db_iframe_db_sysregrasacessousu','func_db_sysregrasacessousu.php?funcao_js=parent.js_preenchepesquisa|db47_idacesso','Pesquisa',true);
}
