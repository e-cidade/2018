...
<form class="container" name="form1" method="post" action="">
  <fieldset>
    <legend>Cadastros - Cadastro de Cartório</legend>
  ...
  if(mostra==true){
    js_OpenJanelaIframe('top.corpo','db_iframe_cgm','func_cgm.php?funcao_js=parent.js_mostracgm1|z01_numcgm|z01_nome','Pesquisa',true);
     ...
     if(document.form1.v82_numcgm.value != ''){ 
        js_OpenJanelaIframe('top.corpo','db_iframe_cgm','func_cgm.php?pesquisa_chave='+document.form1.v82_numcgm.value+'&funcao_js=parent.js_mostracgm','Pesquisa',false);
     }else{
...
function js_mostracgm1(chave1,chave2){
  ...
  document.form1.v82_descricao.value = chave2;
  db_iframe_cgm.hide();
}
function js_pesquisa(){
  js_OpenJanelaIframe('top.corpo','db_iframe_cartorio','func_cartorio.php?funcao_js=parent.js_preenchepesquisa|v82_sequencial','Pesquisa',true);
}
