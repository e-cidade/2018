...
<table border="0">
  ...
  <tr>
    ...
    <td> 
      ...
      <?=@$Le54_numerl?>
      <?
        db_input('e54_numerl',8,$Ie54_numerl,true,'text',isset($emprocesso)&&$emprocesso==true?"1":$dop);
      ?>
    </td>
  </tr>  
  <tr>
  ...
  <tr>
    ...
    <td> 
      <?
            ...
            */
      db_input('e54_destin',57,$Ie54_destin,true,'text',isset($emprocesso)&&$emprocesso==true?"1":$db_opcao,"")
      ?>
    </td>
  </tr>
  ...
  <tr title="Número do processo administrativo (PA). Máximo 15 caractéres.">
    ...
    <td colspan="3">
    <?php 
      db_input('e150_numeroprocesso', 57, $Ie150_numeroprocesso, true, 'text', $db_opcao);
    ?>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td nowrap="nowrap">
      <?
        ...
        db_input("c58_descr",43,0,true,"text",3);
      ?>
    </td>
  </tr>
<?
  ...
  <tr>
    <td nowrap title="<?=@$Te54_resumo?>" colspan="2">
      <fieldset>
       ...
       <? db_textarea('e54_resumo',3,78,$Ie54_resumo,true,'text',$db_opcao,"") ?>
      </fieldset>
    </td>
  </tr>
</table>
