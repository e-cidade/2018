...
function js_pesquisaj77_codproc(mostra){
  ...
  if(mostra==true){
    js_OpenJanelaIframe('','db_iframe_cgm','func_protprocesso_protocolo.php?funcao_js=parent.js_mostraprotprocesso1|dl_código_processo|p58_numero|dl_nome_ou_razão_social','Pesquisa',true);
  }else{
