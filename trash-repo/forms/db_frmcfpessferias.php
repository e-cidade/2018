...
<table border="0">
  ...
  ?>
  <tr>
    <td align="right" title="<?=@$Tr11_recalc?>">
      <?
      db_ancora(@$Lr11_recalc,"",3);
      ?>
    </td>
    <td nowrap> 
      <?
      $arr_SorN = array("t"=>"Sim", "f"=>"Não");
      db_select('r11_recalc',$arr_SorN,true,$db_opcao,"");
      ?>
    </td>
  </tr>
  <tr>
    <td nowrap align="right" title="<?=@$Tr11_13ferias?>">
      <?=@$Lr11_13ferias?>
    </td>
    <td> 
      <?
      db_select('r11_13ferias',$arr_SorN,true,$db_opcao,"");
      ?>
    </td>
  </tr>
  <tr>
    <td align="right" title="<?=@$Tr11_fersal?>">
      <?
      db_ancora(@$Lr11_fersal,"",3);
      ?>
    </td>
    <td nowrap> 
      <?
      $arr_fersal = array("S"=>"Salário", "F"=>"Férias");
      db_select('r11_fersal',$arr_fersal,true,$db_opcao,"");
      ?>
    </td>
  </tr>
  <tr>
    <td align="right" title="<?=@$Tr11_pagarferias?>">
      <?
      db_ancora(@$Lr11_pagarferias,"",3);
      ?>
    </td>
    <td nowrap> 
      <?
      $arr_pagarferias = array(" "=>"Nenhum","S"=>"Salário","C"=>"Complementar");
      db_select('r11_pagarferias',$arr_pagarferias,true,$db_opcao,"");
      ?>
    </td>
  </tr>
  <tr>
    <td align="right" title="<?=@$Tr11_pagaab?>">
      <?
      db_ancora(@$Lr11_pagaab,"",3);
      ?>
    </td>
    <td nowrap> 
      <?
      db_select('r11_pagaab',$arr_SorN,true,$db_opcao,"");
      ?>
    </td>
  </tr>
  <tr>
    <td colspan="2" align="center">
      <fieldset>
        <legend><strong>Proporcionalização em caso de faltas</strong></legend>
        <table>
          <tr>
            <td nowrap align="right" title="<?=@$Tr11_propae?>">
              <?
              db_ancora(@$Lr11_propae,"",3);
              ?>
            </td>
            <td nowrap> 
              <?
              db_select('r11_propae',$arr_SorN,true,$db_opcao,"");
              ?>
            </td>
          </tr>
          <tr>
            <td nowrap align="right" title="<?=@$Tr11_propac?>">
              <?
              db_ancora(@$Lr11_propac,"",3);
              ?>
            </td>
            <td nowrap> 
              <?
              db_select('r11_propac',$arr_SorN,true,$db_opcao,"");
              ?>
            </td>
          </tr>
        </table>
