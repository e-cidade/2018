...
<div style="color:red; padding-bottom:15px;">
  <b>Sem parametros para o Exercício de <?php echo $v19_anousu; ?>, favor incluir.</b>
</div>
<?php
  }
?>
...
<form class="container" name="form1" id="form_parametros" method="post" action="" onsubmit=" return js_validaDados();">
    <fieldset>
    <legend>Procedimentos - Manutenção de Parâmetros</legend>
    <table class="form-container">
      <tr>
        <td nowrap title="<?php echo @$Tv19_anousu?>">
      ...
      <tr>
        <td nowrap title="<?php echo @$Tv19_instit?>">
          <?php echo @$Lv19_instit?>
        </td>
        <td> 
          <?php
            db_input('v19_instit', 10, $Iv19_instit, true, 'text', 3, "");
    ...
    <fieldset>
      ...
      <table style="width: 100%;">
        <tr>
          <td style="width: 28.5%"><strong>Petição de Inicial Quitada:</strong></td>
          <td>
          <?php
        ...
        <tr id="documentoTipoInicialQuitada" style="display: none;">
          <td nowrap="nowrap" title="<?php echo @$Tp90_db_documentotemplate; ?>">
            <?php
              db_ancora("<B>Documento Template:</B>", "js_pesquisaDocumento($('v19_templateinicialquitada'), true);", $db_opcao);
            ?>
          </td>
          <td nowrap="nowrap"> 
            <?php
        ...
        <tr id="documentoTipoParcelamento" style="display: none;">
          <td nowrap="nowrap" title="<?php echo @$Tp90_db_documentotemplate; ?>">
            <?php
              db_ancora("<B>Documento Template:</B>", "js_pesquisaDocumento($('v19_templateparcelamento'), true);", $db_opcao);
            ?>
          </td>
          <td nowrap="nowrap"> 
            <?php
...
$("v19_instit").addClassName("field-size2");
$("nomeinst").addClassName("field-size7");
$("v19_vlrexecmin").addClassName("field-size2");
$("v19_urlwebservice").addClassName("field-size9");
$("v19_login").addClassName("field-size4");
$("v19_senha").addClassName("field-size4");
$("v19_codorgao").addClassName("field-size9");
