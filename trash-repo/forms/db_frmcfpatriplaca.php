...
function js_pesquisa(){
  js_OpenJanelaIframe('top.corpo','db_iframe_cfpatriplaca','func_cfpatriplaca.php?funcao_js=parent.js_preenchepesquisa|t07_instit','Pesquisa',true);
}
...
function js_pesquisat07_confplaca(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('top.corpo','db_iframe_bensconfplaca','func_bensconfplaca.php?funcao_js=parent.js_mostrabensconfplaca1|t40_codigo|t40_descr','Pesquisa',true);
  }else{
     if(document.form1.t07_confplaca.value != ''){ 
        js_OpenJanelaIframe('top.corpo','db_iframe_bensconfplaca','func_bensconfplaca.php?pesquisa_chave='+document.form1.t07_confplaca.value+'&funcao_js=parent.js_mostrabensconfplaca','Pesquisa',false);
     }else{
