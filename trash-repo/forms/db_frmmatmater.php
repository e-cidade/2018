...
function js_pesquisaGrupo(mostra) {
  ...
  if (mostra == true) {
    js_OpenJanelaIframe('','db_iframe_grupo','func_materialestoquegrupo.php?lGruposAtivos=true&iTipoConta=2&funcao_js=parent.js_mostraGrupo1|m65_sequencial|db121_descricao','Pesquisa',true);
  } else {
