...
function js_ver_templates(){
	js_OpenJanelaIframe('top.corpo','db_iframe_db_documentotemplatesver','con1_db_doctemplatepadraolistar.php','Pesquisa',true);
}

function js_pesquisadb82_templatetipo(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('top.corpo','db_iframe_db_documentotemplatetipo','func_db_documentotemplatetipo.php?funcao_js=parent.js_mostradb_documentotemplatetipo1|db80_sequencial|db80_descricao','Pesquisa',true);
  }else{
     if(document.form1.db82_templatetipo.value != ''){ 
        js_OpenJanelaIframe('top.corpo','db_iframe_db_documentotemplatetipo','func_db_documentotemplatetipo.php?pesquisa_chave='+document.form1.db82_templatetipo.value+'&funcao_js=parent.js_mostradb_documentotemplatetipo','Pesquisa',false);
     }else{
  ...
  if(mostra==true){
    js_OpenJanelaIframe('top.corpo','db_iframe_db_config','func_db_config.php?funcao_js=parent.js_mostradb_config1|codigo|nomeinst','Pesquisa',true);
     ...
     if(document.form1.db82_instit.value != ''){ 
        js_OpenJanelaIframe('top.corpo','db_iframe_db_config','func_db_config.php?pesquisa_chave='+document.form1.db82_instit.value+'&funcao_js=parent.js_mostradb_config','Pesquisa',false);
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('top.corpo','db_iframe_db_documentotemplate','func_db_documentotemplate.php?funcao_js=parent.js_preenchepesquisa|db82_sequencial','Pesquisa',true);
}

function js_pesquisatemplate(){
  js_OpenJanelaIframe('top.corpo','db_iframe_db_documentotemplatepadrao','func_db_documentotemplatepadrao.php?funcao_js=parent.js_preenche_template|db81_templatetipo|db81_nomearquivo','Pesquisa',true);
}
