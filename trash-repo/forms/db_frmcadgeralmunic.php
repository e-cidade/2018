...
//$clcgm->rotulo->label('z03_tipoempresa');
...
<table>
  <tr>
    ...
    ?>
      ...
      <tr>
        <td colspan="4">
          <fieldset class="rfieldsetinterno"><legend> <b>Endereço Primário</b></legend>
            <div align="center">
              <?
      ...
      <tr>
        <td colspan="4">
        <fieldset class="fieldsetinterno"><legend> <b>Dados do Emprego:</b></legend></fieldset>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        <td colspan="4">
          <fieldset class="rfieldsetinterno">
            <legend><b>Endereço Secundário</b></legend>
            <div align="center">
              <?
    ...
    ?>
      ...
      <tr>
        <td nowrap title="<?=@$Tz01_cgc?>"><b>CNPJ:</b></td>
        <td>
          <?
      ...
      <tr>
        <td colspan="4">
        <fieldset><legend> <b>Endereço Primário</b> </legend>
          <div align="center">
            <?
              db_input ( 'idEnderPrimario', 10, '', true, 'hidden', $db_opcao );
              db_input ( 'endPrimario', 52, '', true, 'text', 3 );
      ...
      <tr>
        <td colspan="4">
          <fieldset><legend> <b>Endereço Secundário</b> </legend>
            <div align="center">
              <?
                db_input ( 'idEnderSecundario', 10, '', true, 'hidden', $db_opcao );
                db_input ( 'endSecundario', 52, '', true, 'text', 3 );
  ...
  <tr align="center">
    <td>
      <input name="btnSubmit" type="button" id="btnSubmit"
             ...
             <?=($db_botao == false ? "disabled" : "")?> onclick="js_sendForm(this.value)"> 
...
function js_abreEnderPrimario() {
  ...
  //oEnderPrimario.getNomeMunicipio();
...
function js_abreEnderSecundario() {
  ...
  //oEnderSecundario.setEnderecoMunicipio(true);
  ...
  /*
  if (lEnderMunic) {
    oEnderSecundario.buscaEndereco();
  }
  */
...
function js_validaIncluir() {
  ...
  if (lPessoaFisica == true) {
    ...
    if ( $F('z01_dtfalecimento') != '' && $F('z01_nasc') != '' ) {
      ...
      var iDataFalecimento = $F('z01_dtfalecimento').replace(/\//g, ''); 
      var iDataNascimento  = $F('z01_nasc').replace(/\//g, ''); 

      if ( iDataNascimento > iDataFalecimento ) {
