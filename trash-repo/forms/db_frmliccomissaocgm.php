...
function js_pesquisal31_liccomissao(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('top.corpo.iframe_liccomissaocgm','db_iframe_liccomissao','func_liccomissao.php?funcao_js=parent.js_mostraliccomissao1|l30_codigo|l30_codigo','Pesquisa',true,'0','1','775','390');
  }else{
     if(document.form1.l31_liccomissao.value != ''){ 
        js_OpenJanelaIframe('top.corpo.iframe_liccomissaocgm','db_iframe_liccomissao','func_liccomissao.php?pesquisa_chave='+document.form1.l31_liccomissao.value+'&funcao_js=parent.js_mostraliccomissao','Pesquisa',false);
     }else{
...
function js_pesquisal31_numcgm(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('top.corpo.iframe_liccomissaocgm','db_iframe_cgm','func_nome.php?funcao_js=parent.js_mostracgm1|z01_numcgm|z01_nome','Pesquisa',true,'0','1','775','390');
  }else{
     if(document.form1.l31_numcgm.value != ''){ 
        js_OpenJanelaIframe('top.corpo.iframe_liccomissaocgm','db_iframe_cgm','func_nome.php?pesquisa_chave='+document.form1.l31_numcgm.value+'&funcao_js=parent.js_mostracgm','Pesquisa',false);
     }else{
