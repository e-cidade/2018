...
<form name="form1" method="post" action="">
  ...
  <center>
    <input name="geradisbanco" type="submit" id="geradisbanco" value="Processar Arquivo"> &nbsp;&nbsp; <input name="Cancela" type="button"
      onclick="location.href='cai4_baixabanco.php'" id="Cancela" value="Cancelar">
  </center>
</form>