...
function js_submit() {
 if (document.form1.ed101_d_data.value=="") {
  alert("Informe a Data do avanço para prosseguir!");
  ...
  if (document.form1.ed52_d_inicio.value!="") {
   ...
   if (check==false) {
    ...
    alert("Data do avanço fora do periodo do calendario ( "+data_ini+" a "+data_fim+" ).");
    document.form1.ed101_d_data.focus();
    document.form1.ed101_d_data.style.backgroundColor='#99A9AE';
    return false;
   }
  ...
  if (datamat!="") {
   ...
   if (parseInt(datamat)>parseInt(dataav)) {
    alert("Data do avanço menor que a data da matrícula do aluno!");
    document.form1.ed101_d_data.focus();
    document.form1.ed101_d_data.style.backgroundColor='#99A9AE';
    return false;
   }
...
function js_pesquisaed101_i_aluno(mostra) {
  ...
  if (mostra == true) {
    ...
    js_OpenJanelaIframe('top.corpo', 'db_iframe_aluno', 'func_alunoavancoav.php?'+
    ...
    if (document.form1.ed101_i_aluno.value != '') {
      ...
      js_OpenJanelaIframe('top.corpo', 'db_iframe_aluno', 'func_alunoavancoav.php?pesquisa_chave='+
