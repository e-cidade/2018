  ...
  if(mostra==true){
    ...
    js_OpenJanelaIframe('','db_iframe_cemiterio','func_cemiterio.php?funcao_js=parent.js_mostracemiterio1|cm14_i_codigo|z01_nome','Pesquisa',true);
     ...
     if(document.form1.cm22_i_cemiterio.value != ''){ 
        //js_OpenJanelaIframe('top.corpo','db_iframe_cemiterio','func_cemiterio.php?pesquisa_chave='+document.form1.cm22_i_cemiterio.value+'&funcao_js=parent.js_mostracemiterio','Pesquisa',false);
...
function js_pesquisa(){
  //js_OpenJanelaIframe('top.corpo','db_iframe_quadracemit','func_quadracemit.php?funcao_js=parent.js_preenchepesquisa|cm22_i_codigo','Pesquisa',true);
