  ...
  <fieldset style="width:570px;margin:10px auto;">
    ...
    <table border="0">
      ...
      <tr>
        ...
        <td colspan="3"> 
          <?php
            db_input('h16_regist',6,$Ih16_regist,true,'text',$db_opcao," onchange='js_pesquisah16_regist(false);'");
      ...
      <tr>
        ...
        <td nowrap title="Somar dias">
          <b>Quantidade:</b>
        </td>
        <td> 
          <?php db_input('h16_quant',6,$Ih16_quant,true,'text',$opcao_dtterm,"onchange='js_somar_dias(this.value, 1);'","quantidade") ?>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td> 
          <?php db_input('h16_quant',6,$Ih16_quant,true,'text',($opcao_dtterm == 3 ? 3 : $opcao_quant),"") ?>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td> 
          <?php db_input('h16_nrport',6,$Ih16_nrport,true,'text',$db_opcao,"") ?>
        </td>
      ...
      <tr>
        ...
        <td colspan='3'> 
          <?php db_input('h16_anoato',6,$Ih16_anoato,true,'text',$db_opcao,"") ?>
        </td>
      </tr>  
...
<script>
  ...
  function js_pesquisah16_assent(lMostra){
    ...
    if (lMostra == true) {
      ...
      if (document.form1.h12_codigo.value != '') { 
         js_OpenJanelaIframe( 'top.corpo',
                              'db_iframe_tipoasse',
                              'func_tipoasse.php?chave_assent=' + document.form1.h12_codigo.value 
  ...
  function js_pesquisa(){
    <?if($meiodia == true){?>
    js_OpenJanelaIframe('top.corpo','db_iframe_assmeio','func_assmeio.php?funcao_js=parent.js_preenchepesquisa|h22_codigo<?=$db_opcao == 33 || $db_opcao == 3? "" : "&bloqueia_assenta=true"?>','Pesquisa',true);
    <?}else{?>
    js_OpenJanelaIframe('top.corpo','db_iframe_assenta','func_assenta.php?funcao_js=parent.js_preenchepesquisa|h16_codigo','Pesquisa',true);
    <?}?>
  }
