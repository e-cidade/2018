      ...
      <fieldset>
        ...
        <table>
          ...
          <tr>
            ...
            <td nowrap>
              <?
              db_input('rh01_anoche',4,$Irh01_anoche,true,'text',$db_opcao,"")
              ?>
            </td>
          </tr>
      ...
      <fieldset>
        ...
        <table border="0">
          <tr>
            ...
            <td colspan="2" nowrap>
              <?
              db_inputdata('rh01_admiss',@$rh01_admiss_dia,@$rh01_admiss_mes,@$rh01_admiss_ano,true,'text',$db_opcao,"")
              ?>
            </td>
...
function js_verificacampos(){
  ...
  ?>
    ...
    if(document.form1.rh01_anoche.value == "" && document.form1.rh01_nacion.value != 10){
