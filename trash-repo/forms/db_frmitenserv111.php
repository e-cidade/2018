...
<script>
 function js_di(){
  if(document.form1.cm10_i_parcelas.value <= 1){
    document.form1.cm10_d_provenc_dia.disabled = true;
    document.form1.cm10_d_provenc_dia.value = "";
    document.form1.cm10_d_provenc_dia.style.backgroundColor = "#DEB887";
    
    document.form1.cm10_d_provenc_mes.disabled = true;
    document.form1.cm10_d_provenc_mes.value = "";
    document.form1.cm10_d_provenc_mes.style.backgroundColor = "#DEB887";
    
    document.form1.cm10_d_provenc_ano.disabled = true;
    document.form1.cm10_d_provenc_ano.style.backgroundColor = "#DEB887";
    document.form1.cm10_d_provenc_ano.value = "";
    
    document.form1.cm10_i_diavenc.disabled = true;
    document.form1.cm10_i_diavenc.style.backgroundColor = "#DEB887";
    document.form1.cm10_i_diavenc.value = "";
  }else{
    document.form1.cm10_d_provenc_dia.disabled = false;
    document.form1.cm10_d_provenc_dia.style.backgroundColor = "#FFFFFF";
    document.form1.cm10_d_provenc_mes.disabled = false;
    document.form1.cm10_d_provenc_mes.style.backgroundColor = "#FFFFFF";
    document.form1.cm10_d_provenc_ano.disabled = false;
    document.form1.cm10_d_provenc_ano.style.backgroundColor = "#FFFFFF";
    document.form1.cm10_i_diavenc.disabled = false;
    document.form1.cm10_i_diavenc.style.backgroundColor = "#FFFFFF";
  }
 }
</script>
