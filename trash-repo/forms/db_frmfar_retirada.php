...
$sSql                      = $oDaofar_tiporeceitapadrao->sql_query(null,
                                                                   'fa42_i_tiporeceita',
                                                                   null,
                                                                   'fa42_i_departamento = '.db_getsession('DB_coddepto')
                                                                  );
...
<form name="form1" method="post" action="">
  ...
  <table border="0">
    <tr>
      ...
      <fieldset style="width:97%"><legend><b>Dados da Retirada</b></legend>
      <table  border="0"  name="tabela1" width='100%' id="tabela1">
        <tr style="display:none">
          <td nowrap title="<?=@$Tfa04_i_unidade?>">
            <?
        ...
        <tr>
          ...
          <td colspan="3" nowrap>
            <?db_input('fa04_i_cgsund', 10, @$Ifa04_i_cgsund, true, 'text', "",
                       " onchange='js_pesquisafa04_i_cgsund(false); js_init();'");
              db_input('z01_v_nome', 55, @$Iz01_v_nome, true, 'text', 1,
        ...
        <tr>
          ...
          <td nowrap title="<?=@$Tfa04_d_dtvalidade?>"  align="left" colspan="2">
            <? if (isset($chavepesquisaretirada)) {
                 ...
                 <select name="fa04_i_tiporeceita" id="fa04_i_tiporeceita" onchange="js_tpreceita();">
                   <option value=""></option>
            ...
            db_input('fa04_i_receita', 10, $Ifa04_i_receita, true, 'text', $db_opcao,
                     'onchange="js_pesquisareceita(false);"'
                    );
            ?>
            <b>Validade:</b>
            <? db_inputdata('fa04_d_dtvalidade',
            ...
            <b>Número de Notificação:</b>
            <?php
              db_input('fa04_numeronotificacao', 20, $Ifa04_numeronotificacao, true, 'text', $db_opcao);
            ?>
            </td>
          </tr>
          <tr style=" <?=($oConfigFarmacia->fa02_i_origemreceita == 1 ? "''" : 'display: none;')?>">
            <td nowrap title="<?=@$Tfa41_i_origemreceita?>">
            <?db_ancora($Lfa41_i_origemreceita, 'js_pesquisafa41_i_origemreceita(true)', '')?>
            </td>
            <td nowrap colspan="2">
              <?db_input('fa41_i_origemreceita',
                         10,
                ...
                db_input('fa40_c_descr', 55, $Ifa40_c_descr, true, 'text', $db_opcao); ?>
            </td>
          </tr>
          <tr>
            ...
            <td colspan="3">
              <? db_input('fa04_i_profissional',
                 ...
                 db_input('z01_nome', 55, @$z01_nome, true, 'text', 1);?>
          ...
          <tr <?=(!isset($ender))?"style=\"display:none\"":""?>  id="linha1">
            ...
            <td colspan="3">
              <?
                db_input('ender', 55, @$Iz01_v_ender, true, 'text', 1);
        ...
        <center>
        <fieldset style="width: 1100px;"><legend><b>Dados dos Medicamentos:</b></legend>
        <table border="0" id="tabela_medicamento" >
          <tr>
            <td nowrap width='20%' title="<?=@$Tfa06_i_matersaude?>" colspan="2">
              <? db_ancora(@$Lfa06_i_matersaude, "js_pesquisafa06_i_matersaude(true);",$db_opcao);
                 db_input('fa06_i_matersaude',
                          10,
                          @$Ifa06_i_matersaude,
                          true,
                          'text',
                          "",
                          " onchange='js_pesquisafa06_i_matersaude(false);'");
                 db_input('m60_descr', 64, @$Im60_descr, true, 'text',1,'onblur="js_material();" ');
               ?>
               <input name="checkContinuado"
                      type="checkbox"
                      id="checkContinuado"
                      onclick="js_ativaContinuado();"
               > <b>Continuado</b>
            </td>
          </tr>
          <tr id="linha_continuado" style="display: 'none';">
            <td>
              <fieldset style='width: 98%;'><legend><b>Continuados</b></legend>
                ...
                <tr>
                  <td nowrap colspan="3">
                    <?
                      ...
                      db_input('fa12_c_descricao', 40, @$fa12_c_descricao, true, 'text', 3);
                    ?>
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td>
              <b>Quantidade dipensada: </b>
              <?db_input('fa06_f_quant', 5, @$Ifa06_f_quant, true, 'text', "", "onchange='js_quantidade(this.value)'");?>
              <b><a name    ="lotes"
                    id      ="lotes"
                    href    =''
                    onclick ="js_mostraLotes('','fa06_f_quant'); return false;"
              ...
              <input name    = "incluir"
                     ...
                     id      = "incluir"
                     value   = "Incluir"
                     onclick = 'js_incluiremedio();'>
            </td>
          </tr>
          <tr>
            <td valign="top" colspan="3">
              <div id="gridRemedios"></div>
              <select name="DadosGridRemedios" id="DadosGridRemedios" style="display:none;">
            </td>
          </tr>
        </table>
        </fieldset>
...
function js_retornoAvisoRetirada(objAjax){
    ...
    var objRetorno = eval("("+objAjax.responseText+")");
      if (objRetorno.status == 1) {
            alert('Ultima Retirada \n Data:'+objRetorno.dData+
                  ' \n Departamento:'+objRetorno.sDepartamento+
                  ' \n Medicamento:'+objRetorno.sMedicamentos);
              }
...
function js_pesquisafa06_i_matersaude(mostra) {
  prescricao = '';
  if ($('fa04_i_tiporeceita').value != '') {
    ...
    if (vet[0] == "S") {
      ...
      if (document.form1.numero.value == "") {
        ...
        alert("Campo numero não informado.Cadastre-o no CGS");
        $('fa06_i_matersaude').value='';
        return false;
      ...
      if (str.length != 10) {
        ...
        alert("Campo identidade invalido(10 digitos)!");
        $('fa06_i_matersaude').value='';
        return false;
  ...
  if (mostra == true) {
    js_OpenJanelaIframe('',
                        ...
                        prescricao+'funcao_js=parent.js_mostramatersaude1|fa01_i_codigo|m60_descr',
                        'Pesquisa',
                        true,
                        3);
    } else {
      if (document.form1.fa06_i_matersaude.value != '') {
        js_OpenJanelaIframe('',
                            'db_iframe_far_matersaude',
                            'func_far_matersaude.php?'+
                            prescricao+'pesquisa_chave='+$F(fa06_i_matersaude)+'&funcao_js=parent.js_mostramatersaude',
                            'Pesquisa',
                            false);
     } else {
...
function js_mostramatersaude(chave,erro){
  ...
  if (erro == true) {
    ...
    document.form1.fa06_i_matersaude.focus();
...
function js_quantidade(valor) {
  ...
  if (valor != "") {
    ...
    if(valor > new Number(document.form1.quant_disp.value)){
      ...
      alert('Quantidade requisitada maior que a disponivel!');
      $('fa06_f_quant').value = '';
...
function js_confirma(lComprovante) {
  ...
  <?}?>
    ...
    if ($F('validadeContinuado') != 0) {
      ...
      alert("Existe medicamentos próximos da data de vencimento ou vencidos!");
      $('confirmar').disabled = false;
      return false;
    ...
    if (aMedicamentos.length > 0) {
      ...
      alert("Nenhum medicamanto para retirar!");
      $('confirmar').disabled = false;
      return false;
...
function js_ultimas() {
  ...
  left    = (screen.availWidth - 600) / 5;   
  remedio = $('fa06_i_matersaude').value;
  cgs     = $('fa04_i_cgsund').value;
  if (remedio != '') {
