...
//      document.form1.r30_per1i_dia.focus();
      ...
      alert("Informe a data de pagamento do período de gozo inicial.");
...
//      document.form1.r30_per2i_dia.focus();
      ...
      alert("Informe a data de pagamento do período de gozo final.");
...
function js_verificaaquiini(opcao){
  ...
  if(x.r30_perai_dia.value != "" && x.r30_perai_mes.value != "" && x.r30_perai_ano.value != ""){
    ...
    if(perat > diacf && verificamsg == true){
      ...
      if(opcao == 1 || (opcao == 2 && confirm("O período aquisitivo ainda não venceu.\n\nContinua geração das Férias?"))){
