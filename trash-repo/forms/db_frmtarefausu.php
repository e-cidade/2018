...
db_selectrecord('at42_usuario',($cldb_usuarios->sql_record($cldb_usuarios->sql_query(($db_opcao==2?null:@$at42_usuario),"id_usuario,nome","nome","usuarioativo = '1'"))),true,$db_opcao,"");
 ...
 <table>
  <tr>
    ...
    <?
	 ...
	 $cliframe_alterar_excluir->sql     = $cltarefausu->sql_query(null,"at42_sequencial,at42_tarefa,db_usuarios.nome as nome,at42_perc",null,"at42_tarefa=$at42_tarefa");
