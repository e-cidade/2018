    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave) ){
        ...
        if(isset($chave_q123_sequencial) && (trim($chave_q123_sequencial)!="") ){
	         ...
	         $sql = $clissalvara->sql_queryBaixa("",$campos,"","q99_depto = {$iDepart} and q123_inscr = $chave_q123_sequencial");
	         
        } else if (isset($chave_z01_nome) && (trim($chave_z01_nome)!="") ){
        	
	         $sql = $clissalvara->sql_queryBaixa("",$campos,"q123_sequencial,z01_nome","q99_depto = {$iDepart} and z01_nome ilike '$chave_z01_nome%' ");
	         
	         
        } else {
        	//echo "aqui";
           $sql = $clissalvara->sql_queryBaixa("",$campos,"q123_sequencial","q99_depto = {$iDepart} and q123_situacao = 1");
        }
        ...
        if($pesquisa_chave!=null && $pesquisa_chave!="" ){
          ...
          $result = $clissalvara->sql_record($clissalvara->sql_queryBaixa("",$campos, "", " q99_depto = {$iDepart} and q123_situacao = 1 and q123_inscr = $pesquisa_chave"));
