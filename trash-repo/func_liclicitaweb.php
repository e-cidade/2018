	     ...
	     <form name="form2" method="post" action="" >
          <tr> 
            ...
            <td width="96%" align="left" nowrap> 
              <?
		       db_input("l29_sequencial",10,$Il29_sequencial,true,"text",4,"","chave_l29_sequencial");
		       ?>
            </td>
          </tr>
<tr>
          ...
          <tr> 
            ...
            <td width="96%" align="left" nowrap> 
              <?
		       db_input("l29_datapublic",10,$Il29_datapublic,true,"text",4,"","chave_l29_datapublic");
		       ?>
            </td>
          </tr>
          <tr> 
            <td colspan="2" align="center"> 
              ...
              <input name="Fechar" type="button" id="fechar" value="Fechar" onClick="parent.db_iframe_liclicitaweb.hide();">
             </td>
          </tr>
        </form>
        </table>
    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        if(isset($campos)==false){
           if(file_exists("funcoes/db_func_liclicitaweb.php")==true){
             include("funcoes/db_func_liclicitaweb.php");
           }else{
           $campos = "liclicitaweb.*";
           }
        }
        ...
        }else if(isset($chave_l29_datapublic) && (trim($chave_l29_datapublic)!="") ){
	         $sql = $clliclicitaweb->sql_query("",$campos,"l29_datapublic"," l29_datapublic like '$chave_l29_datapublic%' ");
        }else if(isset($chave_l20_edital) && (trim($chave_l20_edital)!="")){
	         $sql = $clliclicitaweb->sql_query($chave_l29_sequencial,$campos,"l29_sequencial","l20_edital=$chave_l20_edital");
       } else{
           $sql = $clliclicitaweb->sql_query("",$campos,"l29_sequencial","");
        }
        $repassa = array();
        if(isset($chave_l29_datapublic)){
          $repassa = array("chave_l29_sequencial"=>$chave_l29_sequencial,"chave_l29_datapublic"=>$chave_l29_datapublic);
        }
