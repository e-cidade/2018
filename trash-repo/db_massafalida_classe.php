...
class cl_massafalida { 
   ...
   var $campos = "
                 j58_codigo = int4 = Código de lançamento 
                 j58_data = date =  
                 j58_numcgm = int4 = NUMCGM do responsável 
                 j58_obs = text = Observação da massa falida 
                 ";
   ...
   function incluir ($j58_codigo){ 
     ...
     if($this->j58_numcgm == null ){ 
       $this->erro_sql = " Campo NUMCGM do responsável nao Informado.";
     ...
     if($this->j58_obs == null ){ 
       $this->erro_sql = " Campo Observação da massa falida nao Informado.";
   ...
   function alterar ($j58_codigo=null) { 
     ...
     if($this->j58_codigo!="" || isset($GLOBALS["HTTP_POST_VARS"]["j58_codigo"])){ 
       ...
       if($this->j58_codigo == null ){ 
         $this->erro_sql = " Campo Código de lançamento nao Informado.";
