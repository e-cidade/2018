    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        if(isset($campos)==false){
           if(file_exists("funcoes/db_func_arretipo_nova.php")==true){
             include("funcoes/db_func_arretipo_nova.php");
           }else{
           $campos = "arretipo.*";
           }
        }
        if(isset($chave_k00_tipo) && (trim($chave_k00_tipo)!="") ){
           ...
           $sql = $clarretipo->sql_query("",$campos,"k00_tipo","arretipo.k00_tipo in (select arrecad.k00_tipo from arrecad where arrecad.k00_tipo = arretipo.k00_tipo limit 1)");
        }
	  ...
	  //echo $sql;
        ...
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $sql = $clarretipo->sql_query("","*",null,
                    " arretipo.k00_tipo in 
                    (select arrecad.k00_tipo from arrecad where arrecad.k00_tipo = arretipo.k00_tipo limit 1)
                    and arretipo.k00_tipo = ".$pesquisa_chave." ");
