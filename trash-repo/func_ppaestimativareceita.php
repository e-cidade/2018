    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_o06_sequencial) && (trim($chave_o06_sequencial)!="") ){
	         $sql = $clppaestimativareceita->sql_query_analitica(null,
	                                                             $campos,
	                                                             "o06_sequencial",
	                                                             "o06_sequencial={$chave_o06_sequencial} and $sWhere");
        }else if(isset($chave_o06_codrec) && (trim($chave_o06_codrec)!="") ){
	         $sql = $clppaestimativareceita->sql_query_analitica("",$campos,"o06_ppaestimativa",
        ...
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          ...
          echo $clppaestimativareceita->sql_query_analitica($pesquisa_chave);
          
          $result = $clppaestimativareceita->sql_record($clppaestimativareceita->sql_query_analitica($pesquisa_chave));
