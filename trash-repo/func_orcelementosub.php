	     ...
	     <form name="form2" method="post" action="" >
          <tr>
            ...
            <td width="96%" align="left" nowrap>
              <?
      	       db_input("o56_codele",6,$Io56_codele,true,"text",4,"onKeyPress=\"js_ValidaMaiusculo(this,'f',event);\"","chave_o56_codele");
      	      ?>
            </td>
          </tr>
          <tr>
  ...
  <tr>
    <td align="center" valign="top">
      <?php
        ...
        /**
         * BUsca os elementos da Excecao quando setado.
         */
        if( isset( $lBuscaElementoExcecao ) ){
          ...
          if(isset( $pesquisa_chave )){
            $sSqlExcecao .= "  and o56_codele         = $pesquisa_chave      ";  
          }
          
          if(isset($chave_o56_codele) && (trim($chave_o56_codele)!="") ){
            $sSqlExcecao .= " and o56_codele = $chave_o56_codele             ";
          }

          if(isset($chave_o56_elemento) && (trim($chave_o56_elemento)!="") ){
             $sSqlExcecao .= " and o56_elemento like '$chave_o56_elemento%'  ";
          }
          ...
          if( !empty( $o58_subfuncao ) ) {
            $sSqlExcecao .= "  and o58_funcao         = $o58_funcao          ";
          }
      ...
      if( !isset( $pesquisa_chave ) ) {
        ...
        if(isset($chave_o56_codele) && (trim($chave_o56_codele)!="") ){
	         $sql = $clorcelemento->sql_query(null,null,$campos,"o56_elemento"," o56_anousu = ".db_getsession("DB_anousu")." and o56_codele = $chave_o56_codele $dbwhere");
        }else if(isset($chave_o56_elemento) && (trim($chave_o56_elemento)!="") ){
	         $sql = $clorcelemento->sql_query("","",$campos,"o56_elemento"," o56_anousu = ".db_getsession("DB_anousu")." and  o56_elemento like '$chave_o56_elemento%' $dbwhere ");
        }else if(isset($chave_o56_descr) && (trim($chave_o56_descr)!="") ){
	         $sql = $clorcelemento->sql_query("","",$campos,"o56_elemento","  o56_anousu = ".db_getsession("DB_anousu")." and o56_descr like '$chave_o56_descr%' $dbwhere ");

        }else{
           $sql = $clorcelemento->sql_query("","",$campos,"o56_elemento"," o56_anousu = ".db_getsession("DB_anousu")."  $dbwhere");
        }
        ...
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          ...
          $sSql = $clorcelemento->sql_query(null,null,"*",''," o56_anousu = ".db_getsession("DB_anousu")." and o56_codele=$pesquisa_chave $dbwhere ");
