...
$sql1 = "SELECT round(sum(ed72_i_valornota)/count(ed72_i_valornota),$decimais) as medias,
         ...
         GROUP BY ed18_c_abrev,ed10_c_descr,ed18_i_codigo,ed11_c_descr
         ORDER BY ed18_c_abrev
        ";
...
if($linhas1==0){?>
 ...
 $titulo = "Gráfico de Comparação entre Escolas - Aproveitamento Geral da Etapa";
 ...
 echo "<form name='form1'>
       ...
       <script>
        function js_imprimir(){
         jan = window.open('edu2_gfcoescaprovseries003.php?ano=$ano&serie=$nomeserie&nome_arquivo=$nome_arquivo','','width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
         jan.moveTo(0,0);
         parent.location.href='edu2_gfcoescaprovseries001.php';
        }
       </script>
      ";
 ImageDestroy($imagem);
