                    ...
                    from undmedhorario
                     ...
                     left join ausencias on '$ano/$mes/$s' between ausencias.sd06_d_inicio and ausencias.sd06_d_fim
                           and ( ( (ausencias.sd06_i_especmed = especmedico.sd27_i_codigo) 
                            ...
                            and (ausencias.sd06_c_horainicio between undmedhorario.sd30_c_horaini and undmedhorario.sd30_c_horafim
                                 or ausencias.sd06_c_horafim between undmedhorario.sd30_c_horaini and undmedhorario.sd30_c_horafim
                                 or (ausencias.sd06_c_horainicio <= undmedhorario.sd30_c_horaini 
                                     and ausencias.sd06_c_horafim >= undmedhorario.sd30_c_horafim))
...
if( ( isset($sd27_i_rhcbo) && (int)@$sd27_i_rhcbo != 0 ) ||( isset($sd27_i_codigo) && (int)@$sd27_i_codigo != 0 ) ) {
  ...
  $result     = pg_query($str_query) or die("ERRO: nos horários do profissional.");
