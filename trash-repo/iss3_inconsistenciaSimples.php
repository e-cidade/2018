...
$head3  = "Arquivo Processamento do Simples";
...
foreach ($aInconsistencia as $oIndiceDados => $oValorDados) {
	...
	$pdf->cell(25 ,  $iAlturalinha, "{$oValorDados->sTipo}"           ,  "TBR",  0, "L", 0);
	$pdf->cell(50 ,  $iAlturalinha, urldecode($oValorDados->sCnpj), "LTBR", 0, "L", 0);
	$pdf->cell(115,  $iAlturalinha, urldecode($oValorDados->sDetalhe) ,  "TBL",  1, "L", 0);
