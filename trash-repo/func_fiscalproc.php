    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_y29_codtipo) && (trim($chave_y29_codtipo)!="") ){
	         $sql = $clfiscalproc->sql_query($chave_y29_codtipo,$campos,"y29_codtipo");
        }else if(isset($chave_y29_descr) && (trim($chave_y29_descr)!="") ){
	         $sql = $clfiscalproc->sql_query("",$campos,"y29_descr"," y29_descr like '$chave_y29_descr%' ");
        }else{
           $sql = $clfiscalproc->sql_query("",$campos,"y29_codtipo","");
        }

        db_lovrot($sql,15,"()","",$funcao_js);
      }else{
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $clfiscalproc->sql_record($clfiscalproc->sql_query($pesquisa_chave));
