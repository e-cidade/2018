    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        if (isset($chave_ve01_codigo) && (trim($chave_ve01_codigo)!="") ) {
	         $sql = $clveiculos->sql_query($chave_ve01_codigo,$campos,"ve01_codigo","ve01_codigo=$chave_ve01_codigo ");
        } else if( isset($chave_ve01_placa) && (trim($chave_ve01_placa)!="") ) {
           $sql = $clveiculos->sql_query("",$campos,"ve01_placa"," trim(ve01_placa) like '$chave_ve01_placa%' ");
        } else {
           $sql = $clveiculos->sql_query("",$campos,"ve01_codigo","$where");
        }
        ...
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          ...
          $result = $clveiculos->sql_record($clveiculos->sql_query($pesquisa_chave,"*",null,"ve01_codigo=$pesquisa_chave $where"));
