  ...
  <tr> 
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        $sWhere = "1 = 1";
        if (isset($tipo)) {
        	$sWhere = " k125_tipoabatimento = {$tipo} ";
        }
        
        if (isset($chave_k125_sequencial) && (trim($chave_k125_sequencial)!="") ) {
           $sql = $clabatimento->sql_query($chave_k125_sequencial,$campos,"k125_sequencial");
	         
        } else if(isset($chave_k125_sequencial) && (trim($chave_k125_sequencial)!="") ) {
           $sql = $clabatimento->sql_query("",$campos,"k125_sequencial"," k125_sequencial like '$chave_k125_sequencial%' and {$sWhere}");
	         
        } else {
           $sql = $clabatimento->sql_query("",$campos,"k125_sequencial"," $sWhere ");
        }
        ...
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $clabatimento->sql_record($clabatimento->sql_query($pesquisa_chave));
