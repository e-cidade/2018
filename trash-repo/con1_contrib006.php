...
db_fieldsmemory($result,0);
  ...
  if (pg_numrows($resi) > 0 ) {
    ...
    db_msgbox("Aviso: Não encontrada testada para o lote da matricula informada.\\nOperação não poderá ser concluída!");
...
function js_atualiza(){
   desconto= new Number(document.form1.desconto.value);
   total= new Number(document.form1.total.value);
 ...
 <form name="form1" method="post" action="" >
  <tr> 
    <td height="63" align="center" valign="top">
	  ...
	  <tr title="Desconto da contrinuição"> 
	    ...
	    ?>
          ...
          <tr title="Total do valor da contribuição"> 
            <td width="34%" align="left" nowrap >
              <b>Total R$:</b>
	    </td>
            <td width="66%" align="left" nowrap> 
