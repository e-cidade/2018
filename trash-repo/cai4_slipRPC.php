...
if ($oParam->exec == "isExtra") {
  ...
  if ($iNumRows == 0) {
    ...
    $oRetorno->itens  = db_utils::getColectionByRecord($rsSqlTabPlan,false,false,true);
  }
  ...
  if ($dtData != null) {
    ...
    if ($oDaoTabPlan->numrows > 0) {
      ...
      $oRetorno->itens = db_utils::getColectionByRecord($rsRegistos);
  ...
  if ($iNumRows == 0) {
  	...
  	$oRetorno->itens  = db_utils::getColectionByRecord($rsSqlSaldoConta,false,false,true);
  }
