...
/**
 *classe para controle de estoques de almxarifados
...
class Almoxarifado {
   ...
   *
   */
  function __construct($iAlmoxarifado) {

    $this->iAlmoxarifado = $iAlmoxarifado;
    $this->iDepartamento = db_getsession("DB_coddepto");
  }
  ...
  public function receberTransferencia($iTransferencia) {
    ...
    $oDaoMatestoqueIni->m80_coddepto = $this->iDepartamento;
    $oDaoMatestoqueIni->incluir(null);
    ...
    for ($i = 0; $i < $iItensTransferencia; $i ++) {
      ...
      $sSqlEstoque = $oDaoMatEstoque->sql_query_file(null, "m70_codigo,m70_quant,m70_valor",
                                                     ...
                                                     "m70_codmatmater={$oDadosItem->m60_codmater}
                                                      and m70_coddepto={$this->iDepartamento}"
                                                     );
      ...
      if ($oDaoMatEstoque->numrows > 0) {
        ...
        $oDaoMatEstoque->m70_coddepto    = $this->iDepartamento;
