...
class PontoComplementar extends Ponto {
  ...
  public static function getRubricasAutomaticas() {
    ...
    $sSql         = $oDaoRubricas->sql_query_file(null,null,'rh27_rubric','rh27_rubric','rh27_complementarautomatica is true');
    ...
    foreach ( db_utils::getColectionByRecord($rsRubricas) as $oDadosRubrica ) {
  ...
  public function adicionarRegistro( RegistroPonto $oRegistroPonto ) {
     ...
     */
    parent::adicionarRegistro($oRegistroPonto);
