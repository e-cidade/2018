...
/**
 * realizada o calculo da retencao de autonomos
 * @package empenho
 */
class calculoRetencaoInssAutonomos implements iCalculoRetencao {
  ...
  function calcularRetencao() {
    ...
    $this->getTabelaInss();
    $this->nValorAliquota = 11;
    if ($this->getAliquota() <= 0) {
      throw new Exception("Erro [1] - Aliquota com valor inválido!-".$this->getAliquota());
    }
    $nValorRetido = 0;
...
function getTabelaInss() {
    ...
    $sSqlTabelaINSS  = "select r33_anousu,r33_mesusu, r33_fim as teto";
    ...
    $sSqlTabelaINSS .= " order by 1 desc,                                     ";
    $sSqlTabelaINSS .= "          2 desc,                                     ";
    $sSqlTabelaINSS .= "          3 desc  limit 1                             ";
