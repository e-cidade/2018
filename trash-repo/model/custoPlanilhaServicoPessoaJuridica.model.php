...
final class custoPlanilhaServicoPessoaJuridica implements iCustoPlanilha {
  ...
  public function processarDados($iMesBase, $iAnoBase) {
    ...
    $sSqlCustos .= "   and o56_elemento like '3339039%' ";
  ...
  public function save($iPlanilha) {
    ...
    $sWhere         .= "and cc17_custoplanilhaorigem  = 6";      
    ...
    for ($iCusto = 0; $iCusto < $iNumRowsCustos; $iCusto++) {
      ...
      $oCustoRemover->setOrigem(6)->remover();
