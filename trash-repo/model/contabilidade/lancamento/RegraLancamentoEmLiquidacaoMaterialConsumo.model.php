...
/*
        if ($oRegraLancamento->getContaDebito() == $iContaContabilGrupoMaterial && !$oLancamentoAuxiliar->isSaida()) {
          $aRegrasEncontradas[] = $oRegraLancamento;
        }

        if ($oRegraLancamento->getContaCredito() == $iContaContabilGrupoMaterial && $oLancamentoAuxiliar->isSaida()) {
          $aRegrasEncontradas[] = $oRegraLancamento;
        }
*/        
