 ...
 */
  ...
  class EventoContabilRepository {
     ...
     */
    public static function getEventoContabilByCodigo($iCodigoDocumento = null, $iAno = null) {

      $sHash = "{$iCodigoDocumento}{$iAno}";
      if (!array_key_exists($sHash, EventoContabilRepository::getInstance()->aInstancia)) {
        EventoContabilRepository::getInstance()->aInstancia[$sHash] = new EventoContabil($iCodigoDocumento, $iAno);
      }
