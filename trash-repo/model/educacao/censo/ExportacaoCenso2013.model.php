...
/**
 * Classe para retorno dos dados de exportação do censo 2013
...
class ExportacaoCenso2013 {

  protected $iCodigoLayout = 199 ;
  ...
  */
  ...
  protected function getDadosCensoDocente() {
    ...
    $sWhereDocentes      = " ed18_i_codigo = {$this->iCodigoEscola} AND ed01_c_regencia = 'S' AND ( ed75_i_saidaescola is null OR ed75_i_saidaescola  >= '{$this->dtBaseCenso}') ";
