  ...
  public static function getAvaliacaoDependente(IElementoAvaliacao $oElementoAvaliacao) {
    ...
    switch (get_class($oElementoAvaliacao)) {
      ...
      case 'ResultadoAvaliacao':
        ...
        $sWhere = " ed41_i_procresultvinc = {$oElementoAvaliacao->getCodigo()} ";
        break;

      case 'AvaliacaoPeriodica':
        $sWhere = " ed41_i_procavalvinc = {$oElementoAvaliacao->getCodigo()} ";
        break;
    }
    ...
    if ($oDaoProcavaliacao->numrows > 0) {
      ...
      return AvaliacaoPeriodicaRepository::getAvaliacaoPeriodicaByCodigo($iCodigoProcavaliacao);
    }
    return null;
  }
}
