...
define("URL_MENSAGEM_ETAPAREPOSITORY", "educacao.escola.EtapaRepository.");
  ...
  class EtapaRepository {
     ...
     * @param integer $iCodigo Codigo do Etapa
     * @return Etapa
     */
     ...
     * @throws DBException
     * @return $aEtapasEnsino[] array com instancias das etapas do ensino
     */
     ...
     * @param  Etapa $oEtapa 
     * @return $aEtapasPosteriores[] array com as etapas posteriores
     */
     ...
     * @param  Etapa $oEtapa
     * @return $aEtapasAnteriores[] array com as etapas posteriores
     */
