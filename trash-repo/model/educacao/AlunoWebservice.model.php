...
class AlunoWebservice {
  ...
  public function getDados() {
    ...
    $oDadosAluno->municipio_residencia_aluno   = utf8_encode($this->oAluno->getMunicipioResidencia()->getNome());
    $oDadosAluno->uf_residencia_aluno          = utf8_encode($this->oAluno->getMunicipioResidencia()->getUF()->getUF());
