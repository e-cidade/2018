...
/**
 * Model para efetuar o tipo de cálculo mes e dia
 * @author  matheus.felini@dbseller.com.br
 * @package contrato
 * @version $Revision: 1.5 $
 */
class AcordoItemTipoCalculoMesDia implements IAcordoItemTipoCalculo {
  ...
  public function calcular($iAcordo, $oParametro = null) {
    ...
    if ($iDiaInicial > 1) {
      $iDiaMes = ($iDiaMes - $iDiaInicial)+1;
    } else if ($iMesInicial == $iMesFinal) {
      $iDiaMes = $iDiaFinal;
    }

    $oRetornoCalculo                = new stdClass();
    $oRetornoCalculo->quantidade    = $iDiaMes;
