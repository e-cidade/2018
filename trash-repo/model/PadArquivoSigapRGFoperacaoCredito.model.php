...
/**
 * Prove dados para a geração do arquivo dados da RGF operação de crédito no periodo
 * do municipio para o SIGAP
 * @package Pad
 * @author  Luiz Marcelo Schmitt
 * @version $Revision: 1.2 $
 */
final class PadArquivoSigapRGFoperacaoCredito extends PadArquivoSigap {
  ...
  public function getNomeElementos() {
    ...
    $aElementos = array(
                         ...
                         "opcMesAnoMovimento",
                         "opcSinal",
                         "opcSaldoExercicioAnterior",
                         "opcPrevistoQuadrimReferencia",
                         "opcPrevistoAteQuadrimReferencia",
                         "opcExecutadoAteQuadrimReferencia",
