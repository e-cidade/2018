  ...
  */
  ...
  public function salvar() {
    ...
    if (!empty($this->iCodigoBemDepreciacao)) {
      ...
      /**
       * Salvamos as informações da placa.
       */
    ...
    if ($oDaoBensDepreciacao->erro_status == 0) {
      ...
      /*$sMsg  = "Erro ao salvar as informações para cálculo de depreciação do bem.\n";
    ...
    if ($this->getTipoAquisicao() instanceof BemTipoAquisicao) {
       ...
       */
        ...
        $oLancamentoauxiliarBem->setObservacaoHistorico('Incorporação de bem.');
