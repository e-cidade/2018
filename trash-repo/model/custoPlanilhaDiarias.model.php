...
final class custoPlanilhaDiarias implements iCustoPlanilha {
  ...
  public function processarDados($iMesBase, $iAnoBase) {
    ...
    $sSqlCustos .= "   and o56_elemento like '3339014%' ";
  ...
  public function save($iPlanilha) {
    ...
    for ($iCusto = 0; $iCusto < $iNumRowsCustos; $iCusto++) {
      ...
      $oCustoRemover->setOrigem(4)->remover();
      unset($oCustoRemover);    
    }
