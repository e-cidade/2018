...
class logbaixaalvara {
  ...
  private function setObservacao($oIssBaseLog) {
    ...
    switch ($oIssBaseLog->iOpcao) {
      ...
      case 1:
        ...
        if (isset($oIssBaseLog->issbaselogtipo) && $oIssBaseLog->issbaselogtipo == 6) {
          $this->sObservacao = "Baixada atividade {$oIssBaseLog->atividade}";  
        } else if (isset($oIssBaseLog->issbaselogtipo) && $oIssBaseLog->issbaselogtipo == 7) {
          $this->sObservacao = "Baixada atividade {$oIssBaseLog->atividade}";
        }
        break;
    }
  ...
  public function identificaAlteracao($iInscricao = null, $iOpcao, $iLogTipo = null, $iAtividade = null) {
    ...
    if ($iAtividade == null) {
      throw  new Exception("Erro: Atividade nгo informada.");
    }
    ...
    $oTipoAlteracao->atividade      = $iAtividade;
