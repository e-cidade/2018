...
/**
 * Prove dados para a geração do arquivo dados da RGF retorno do limite despesa pessoal no periodo
 * do municipio para o SIGAP
 * @package Pad
 * @author  Luiz Marcelo Schmitt
 * @version $Revision: 1.2 $
 */
final class PadArquivoSigapRGFretornoLimiteDespesaPessoal extends PadArquivoSigap {
  ...
  public function getNomeElementos() {
    ...
    $aElementos = array(
                         ...
                         "ldp1oQuadExercicio",
                         "ldp1oQuadLimite",
                         "ldp1oQuadPorcentagemDTP",
                         "ldp1oQuadRedutor",
                         "ldp2oQuadExercicio",
                         "ldp2oQuadLimite",
                         "ldp2oQuadRedutor",
                         "ldp2oQuadPorcentagemDTP",
                         "ldpOcorrenciaExercicio",
                         "ldpOcorrenciaQuadLimite",
