...
/*
    if ($this->isEstorno()) {
      $sSqlDebitos .= "       inner join arrecad arrecant on arrecant.k00_numpre = cornump.k12_numpre  ";
      $sSqlDebitos .= "                                  and arrecant.k00_numpar = cornump.k12_numpar  ";
      $sSqlDebitos .= "                                  and arrecant.k00_receit = cornump.k12_receit  ";
      $sSqlDebitos .= "                                  and arrecant.k00_hist   <> 918                ";
    } else {
      $sSqlDebitos .= "       inner join arrecant on arrecant.k00_numpre = cornump.k12_numpre  ";
      $sSqlDebitos .= "                          and arrecant.k00_numpar = cornump.k12_numpar  ";
      $sSqlDebitos .= "                          and arrecant.k00_receit = cornump.k12_receit  ";
      $sSqlDebitos .= "                          and arrecant.k00_hist   <> 918                ";
    }
*/
    ...
    return db_utils::getColectionByRecord($rsDebitos);
  ...
  function getDadosDevedor() {
    ...
    $sSqlDebitos .= "      inner join cgm        on cgm.z01_numcgm        = origem.k00_numcgm  ";
