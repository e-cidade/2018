  ...
  <td align="center" valign="top">
   ...
   if(!isset($pesquisa_chave)){
    ...
    if(isset($chave_ed15_i_codigo) && (trim($chave_ed15_i_codigo)!="") ){
     $sql = $clturno->sql_query($chave_ed15_i_codigo,$campos,"ed15_i_sequencia");
    }else if(isset($chave_ed15_c_nome) && (trim($chave_ed15_c_nome)!="") ){
     $sql = $clturno->sql_query("",$campos,"ed15_i_sequencia"," ed15_c_nome like '$chave_ed15_c_nome%' ");
    }else{
     $sql = $clturno->sql_query("",$campos,"ed15_i_sequencia","");
    }
    db_lovrot($sql,15,"()","",$funcao_js);
   }else{
    if($pesquisa_chave!=null && $pesquisa_chave!=""){
     $result = $clturno->sql_record($clturno->sql_query($pesquisa_chave));
