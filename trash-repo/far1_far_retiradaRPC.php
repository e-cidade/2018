...
require_once("classes/db_far_controle_classe.php");
require_once("classes/db_far_controlemed_classe.php");
require_once("classes/db_far_retiradaitens_classe.php");
require_once("classes/db_far_parametros_classe.php");
require_once("classes/db_far_retiradarequi_classe.php");
require_once("classes/db_far_retiradarequisitante_classe.php");
require_once("classes/db_far_requisitantecgs_classe.php");
require_once("classes/db_far_requisitanteoutro_classe.php");
require_once("classes/db_far_retiradaitemlote_classe.php");
...
if ($objParam->exec == 'getAvisoRetirada') {
  ...
  if ($clfar_retirada->numrows > 0) {
    ...
    $objRetorno->sMedicamentos  = $sMedicamentos;
...
//    die($sSubmovimentacao);
  ...
  if ($clfar_controlemed->numrows > 0) {
    ...
    $objRetorno->itens  = db_utils::getColectionByRecord($res_controlemed, true, false, true);
    ...
    $objRetorno->message = "Não ha remedios continuados para esse CGS, $strSQL ";
  }
}
...
if ($objParam->exec == 'Confirma_Remedio') {
  ...
  if ($sqlerro == "N") {
    ...
    $clfar_retirada->fa04_i_receita         = $objParam->numero_receita;
