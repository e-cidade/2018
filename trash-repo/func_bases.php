...
$clbases->rotulo->label("r08_anousu");
    ...
    <td height="63" align="center" valign="top">
        <table width="35%" border="0" align="center" cellspacing="0">
	     <form name="form2" method="post" action="" >       
          <tr> 
            <td width="4%" align="right" nowrap title="<?=$Tr08_codigo?>">
              <?=$Lr08_codigo?>
            </td>
            <td width="96%" align="left" nowrap> 
              <?
		       db_input("r08_codigo",4,$Ir08_codigo,true,"text",4,"","chave_r08_codigo");
		       ?>
            </td>
          </tr>
          <tr> 
            <td width="4%" align="right" nowrap title="<?=$Tr08_descr?>">
              <?=$Lr08_descr?>
            </td>
            <td width="96%" align="left" nowrap> 
              <?
		       db_input("r08_descr",30,$Ir08_descr,true,"text",4,"","chave_r08_descr");
		       ?>
            </td>
          </tr>
          <tr> 
