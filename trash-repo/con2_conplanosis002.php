...
$head3 = "RELATÓRIO DE SISTEMA DE CONTAS";
$head5 = "ORDEM $desc_ordem";

$result = $conplano->sql_record($conplano->sql_query("",db_getsession("DB_anousu"),"*","$order_by"));
//db_criatabela($result);exit;

if ($conplano->numrows == 0){
...
for($x = 0; $x < $conplano->numrows;$x++){
   ...
   if ($pdf->gety() > $pdf->h - 30 || $troca != 0 ){
      ...
      $pdf->cell(100,$alt,$RLc60_descr,1,1,"C",1);
      $troca = 0;
   }
   $pdf->setfont('arial','',7);
   $pdf->cell(15,$alt,$c60_codcon,0,0,"C",0);
   $pdf->cell(30,$alt,$c60_estrut,0,0,"C",0);
   $pdf->cell(100,$alt,$c60_descr,0,1,"L",0);
   $total++;
}

$pdf->setfont('arial','b',8);
$pdf->cell(145,$alt,'TOTAL DE REGISTROS  :  '.$total,"T",0,"L",0);
