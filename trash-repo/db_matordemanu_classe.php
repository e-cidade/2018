...
class cl_matordemanu { 
   ...
   function incluir ($m53_codordem){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,6224,'$this->m53_codordem','I')");
       $resac = pg_query("insert into db_acount values($acount,1009,6224,'','".AddSlashes(pg_result($resaco,0,'m53_codordem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1009,6225,'','".AddSlashes(pg_result($resaco,0,'m53_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1009,6226,'','".AddSlashes(pg_result($resaco,0,'m53_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($m53_codordem=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,6224,'$this->m53_codordem','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["m53_codordem"]))
           $resac = pg_query("insert into db_acount values($acount,1009,6224,'".AddSlashes(pg_result($resaco,$conresaco,'m53_codordem'))."','$this->m53_codordem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["m53_data"]))
           $resac = pg_query("insert into db_acount values($acount,1009,6225,'".AddSlashes(pg_result($resaco,$conresaco,'m53_data'))."','$this->m53_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["m53_obs"]))
           $resac = pg_query("insert into db_acount values($acount,1009,6226,'".AddSlashes(pg_result($resaco,$conresaco,'m53_obs'))."','$this->m53_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($m53_codordem=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,6224,'$this->m53_codordem','E')");
         $resac = pg_query("insert into db_acount values($acount,1009,6224,'','".AddSlashes(pg_result($resaco,$iresaco,'m53_codordem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1009,6225,'','".AddSlashes(pg_result($resaco,$iresaco,'m53_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1009,6226,'','".AddSlashes(pg_result($resaco,$iresaco,'m53_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
