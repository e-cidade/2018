...
$result = $cllab_requiitem->sql_record($cllab_requiitem->sql_query_nova("","la22_i_cgs,la22_i_codigo,la08_i_codigo,la08_c_descr,z01_v_nome,la23_c_descr,la32_d_data,la32_c_hora",""," la21_i_codigo in ($lista)" ));
...
$cody = 10;
$pacx = 13;//nome do paciente
$pacy = 28;
$exax = 13;//nome do exame
$exay = 32;
$setorx = 15;//nome do setor
$setory = 8;
$datax = 30;//data e hora
$datay = 8;
...
for ($i=0;$i<$linhas;$i++) {
 ...
 if ($colunas==4) {
  ...
  $pacy += $altura_ret+1;
  $pacx -=($largura_ret+1)*4;
  $exay += $altura_ret+1;
  $exax -=($largura_ret+1)*4;
  $setory += $altura_ret+1;
  $setorx -=($largura_ret+1)*4;
  $datay += $altura_ret+1;
  $datax -=($largura_ret+1)*4;
  $numy += $altura_ret+1;
