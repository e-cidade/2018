...
include("classes/db_cartorio_classe.php");
    ...
    <td height="63" align="center" valign="top">
        <table width="35%" border="0" align="center" cellspacing="0">
	     <form name="form2" method="post" action="" >
          <tr> 
            <td width="4%" align="right" nowrap title="<?=$Tv82_sequencial?>">
              <?=$Lv82_sequencial?>
            </td>
            <td width="96%" align="left" nowrap> 
              <?
		       db_input("v82_sequencial",10,$Iv82_sequencial,true,"text",4,"","chave_v82_sequencial");
		       ?>
            </td>
          </tr>
          <tr> 
    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_v82_sequencial) && (trim($chave_v82_sequencial)!="") ){
	         $sql = $clcartorio->sql_query($chave_v82_sequencial,$campos,"v82_sequencial");
        }else if(isset($chave_v82_sequencial) && (trim($chave_v82_sequencial)!="") ){
	         $sql = $clcartorio->sql_query("",$campos,"v82_sequencial"," v82_sequencial like '$chave_v82_sequencial%' ");
        }else{
           $sql = $clcartorio->sql_query("",$campos,"v82_sequencial","");
        }
        $repassa = array();
        ...
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $clcartorio->sql_record($clcartorio->sql_query($pesquisa_chave));
