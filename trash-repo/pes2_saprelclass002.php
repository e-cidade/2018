...
$head3 = "RELATÓRIO DE FUNCIONÁRIOS POR CLASSIFICAÇÃO";
...
for($x = 0; $x < pg_numrows($result);$x++){
   ...
   if ($pdf->gety() > $pdf->h - 30 || $troca != 0 ){
      ...
      $pdf->cell(15,$alt,'PADRÃO',1,0,"C",1);
      $pdf->cell(60,$alt,'LOTAÇÃO',1,1,"C",1);
      $troca = 0;
      $pre = 1;
   }
   ...
   if($clas != $r01_clas1){
     ...
     $pdf->cell(0,$alt,'CLASSIFICAÇÃO : '.$r01_clas1,0,1,"L",0);
//     $pdf->ln(3);
   }	   
   ...
   $pdf->setfont('arial','B',8);
   $pdf->cell(170,$alt,'TOTAL :  '.$tot_func.'   FUNCIONÁRIOS',"T",1,"L",0);
