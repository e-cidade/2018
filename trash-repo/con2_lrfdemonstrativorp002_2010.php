...
$pdf->cell(20,$alt,db_formatar(abs($nTotNintraInscricaoAnterior),'f'),"LR",0,"R",0);
$pdf->cell(20,$alt,db_formatar(abs($nTotNintraInscricaoAnteriorProcessado),'f'),"LR",0,"R",0);
$pdf->cell(20,$alt,db_formatar(abs($nTotNintraPago),'f'),"LR",0,"R",0);
$pdf->cell(20,$alt,db_formatar(abs($nTotNintraCancelado),'f'),"LR",0,"R",0);
$pdf->cell(20,$alt,db_formatar(abs($nTotNintraApagar),'f'),"LR",0,"R",0);
// no processados
$pdf->cell(20,$alt,db_formatar(abs($nTotNintraNPanterior),'f'),"LR",0,"R",0);
$pdf->cell(20,$alt,db_formatar(abs($nTotNintraNPDez),'f'),"LR",0,"R",0);
$pdf->cell(20,$alt,db_formatar(abs($nTotalLiquidadoNaoProcessado),'f'),"LR",0,"R",0);
$pdf->cell(20,$alt,db_formatar(abs($nTotNintraNPPagos),'f'),"LR",0,"R",0);
$pdf->cell(20,$alt,db_formatar(abs($nTotNintraNPCancelados),'f'),"LR",0,"R",0);
...
for ($x=0;$x<pg_numrows($result);$x++){
  ...
  if ($instit != $e60_instit) {
    ...
    if (!isset($arqinclude)){ // se este arquivo no esta incluido por outro
      ...
      $pdf->cell(60,$alt,$sPoder, "0", 0, "L", 0);
      $pdf->cell(20,$alt,db_formatar(abs($aTotInstit[$instit][0]),'f'),"LR",0,"R",0);
      $pdf->cell(20,$alt,db_formatar(abs($aTotInstit[$instit][1]),'f'),"LR",0,"R",0);
      $pdf->cell(20,$alt,db_formatar(abs($aTotInstit[$instit][3]),'f'),"LR",0,"R",0);
      $pdf->cell(20,$alt,db_formatar(abs($aTotInstit[$instit][2]),'f'),"LR",0,"R",0);
      $pdf->cell(20,$alt,db_formatar(abs($aTotInstit[$instit][4]),'f'),"LR",0,"R",0);
      // no processados
      $pdf->cell(20,$alt,db_formatar(abs($aTotInstit[$instit][5]),'f'),"LR",0,"R",0);
      $pdf->cell(20,$alt,db_formatar(abs($aTotInstit[$instit][6]),'f'),"LR",0,"R",0);
      $pdf->cell(20,$alt,db_formatar(abs($aTotInstit[$instit][10]), 'f'),"LR",0,"R",0);
      $pdf->cell(20,$alt,db_formatar(abs($aTotInstit[$instit][8]),'f'),"LR",0,"R",0);
      $pdf->cell(20,$alt,db_formatar(abs($aTotInstit[$instit][7]),'f'),"LR",0,"R",0);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////  
  ...
  if (!isset($arqinclude)){ // se este arquivo no esta incluido por outro
    ...
    $pdf->cell(60,$alt,'     '.$o58_orgao .'-'.substr($o40_descr,0,40), "R", 0, "L", 0);
  ...
  if (!isset($arqinclude)){ // se este arquivo no esta incluido por outro
    ...
    $pdf->cell(20,$alt,db_formatar(abs($vlrliq),'f'),"LR",0,"R",0);
...
$pdf->cell(60,$alt,'RESTOS A PAGAR (INTRA-ORÇAMENTÁRIOS)(II)', "0", 0, "L", 0);
$pdf->cell(20,$alt,db_formatar(abs($nTotintraInscricaoAnterior),'f'),"LR",0,"R",0);
$pdf->cell(20,$alt,db_formatar(abs($nTotintraInscricaoAnteriorProcessado),'f'),"LR",0,"R",0);
$pdf->cell(20,$alt,db_formatar(abs($nTotintraPago),'f'),"LR",0,"R",0);
$pdf->cell(20,$alt,db_formatar(abs($nTotintraCancelado),'f'),"LR",0,"R",0);
$pdf->cell(20,$alt,db_formatar(abs($nTotintraApagar),'f'),"LR",0,"R",0);
// no processados
$pdf->cell(20,$alt,db_formatar(abs($nTotintraNPanterior),'f'),"LR",0,"R",0);
$pdf->cell(20,$alt,db_formatar(abs($nTotintraNPDez),'f'),"LR",0,"R",0);
$pdf->cell(20,$alt,db_formatar(abs($nTotalIntraValorLiquidado),'f'),"LR",0,"R",0);
$pdf->cell(20,$alt,db_formatar(abs($nTotintraNPPagos),'f'),"LR",0,"R",0);
$pdf->cell(20,$alt,db_formatar(abs($nTotintraNPCancelados),'f'),"LR",0,"R",0);
...
for ($x=0;$x<pg_numrows($result_intra);$x++) {
  ...
  if ($instit != $e60_instit){
    ...
    if (!isset($arqinclude)){ // se este arquivo no esta incluido por outro
      ...
      $pdf->setfont('arial','b',6);
      $pdf->cell(60,$alt,$sPoder, "0", 0, "L", 0);
      $pdf->cell(20,$alt,db_formatar(abs($aTotInstitIntra[$instit][0]),'f'),"LR",0,"R",0);
      $pdf->cell(20,$alt,db_formatar(abs($aTotInstitIntra[$instit][1]),'f'),"LR",0,"R",0);
      $pdf->cell(20,$alt,db_formatar(abs($aTotInstitIntra[$instit][3]),'f'),"LR",0,"R",0);
      $pdf->cell(20,$alt,db_formatar(abs($aTotInstitIntra[$instit][2]),'f'),"LR",0,"R",0);
      $pdf->cell(20,$alt,db_formatar(abs($aTotInstitIntra[$instit][4]),'f'),"LR",0,"R",0);
      // no processados
      $pdf->cell(20,$alt,db_formatar(abs($aTotInstitIntra[$instit][5]),'f'),"LR",0,"R",0);
      $pdf->cell(20,$alt,db_formatar(abs($aTotInstitIntra[$instit][6]),'f'),"LR",0,"R",0);
      $pdf->cell(20,$alt,db_formatar(abs($aTotInstitIntra[$instit][10]),'f'),"LR",0,"R",0);
      $pdf->cell(20,$alt,db_formatar(abs($aTotInstitIntra[$instit][8]),'f'),"LR",0,"R",0);
      $pdf->cell(20,$alt,db_formatar(abs($aTotInstitIntra[$instit][7]),'f'),"LR",0,"R",0);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////  
  ...
  if (!isset($arqinclude)) { // se este arquivo no esta incluido por outro
    $pdf->cell(20,$alt,db_formatar(abs($vlrpag),'f'),"R",0,"R",0);
    $pdf->cell(20,$alt,db_formatar(abs($canc_proc),'f'),"R",0,"R",0);
    $pdf->cell(20,$alt,db_formatar(abs($a_pagar_processado),'f'),"R",0,"R",0);     
    // no processados
    $pdf->cell(20,$alt,db_formatar(abs($valor_nao_processado_ant),'f'),"R",0,"R",0);
    $pdf->cell(20,$alt,db_formatar(abs($valor_nao_processado),'f'),"R",0,"R",0);
    $pdf->cell(20,$alt,db_formatar(abs($vlrliq),'f'),"LR",0,"R",0);
 ...
 */
$tot_09 = $nTotintraNPAPAgar + $nTotNintraNPAPAgar;

if (!isset($arqinclude)) { // se este arquivo no esta incluido por outro
  
  $pdf->cell(60,$alt,'TOTAL (III) = (I + II)', "RTB", 0, "L", 0);
  $pdf->cell(20,$alt,db_formatar(abs($tot_01),'f'),"LRBT",0,"R",0);
  $pdf->cell(20,$alt,db_formatar(abs($tot_02),'f'),"LRTB",0,"R",0);
  $pdf->cell(20,$alt,db_formatar(abs($tot_04),'f'),"LRTB",0,"R",0);
  $pdf->cell(20,$alt,db_formatar(abs($tot_03),'f'),"LTRB",0,"R",0);
  $pdf->cell(20,$alt,db_formatar(abs($tot_05),'f'),"LTRB",0,"R",0);
  // nao processados
  $pdf->cell(20,$alt,db_formatar(abs($tot_10),'f'),"TLRB",0,"R",0);
  $pdf->cell(20,$alt,db_formatar(abs($tot_06),'f'),"TLRB",0,"R",0);
  $pdf->cell(20,$alt,db_formatar(abs($tot_11),'f'),"LTB",0,"R",0);
  $pdf->cell(20,$alt,db_formatar(abs($tot_08),'f'),"LRTB",0,"R",0);
  $pdf->cell(20,$alt,db_formatar(abs($tot_07),'f'),"LRTB",0,"R",0);
  $pdf->cell(20,$alt,db_formatar(abs($tot_09),'f'),"LTB",1,"R",0);
  if ($pdf->pageNo() > 1){
...
function writeHeader($pdf, $alt){
  ...
  $pdf->cell(100,$alt,"RESTOS A PAGAR PROCESSADOS E NÃO PROCESSADOS LIQUIDADOS","LRTB",0,"C",0);
  $pdf->cell(100,$alt,"RESTOS A PAGAR NÃO PROCESSADOS","TB",1,"C",0);
  
  $pdf->cell(60,$alt,"",0,0,"C",0);
  $pdf->cell(40,$alt,"Inscritos","TBLR",0,"C",0);
  ...
  $pdf->cell(20,$alt,"","LR",0,"C",0);
  $pdf->cell(20,$alt,"","LR",0,"C",0);
  $pdf->cell(20,$alt,"","TL",1,"C",0);
  
  $pdf->cell(60,$alt,"PODER/ORGÂO",0,0,"C",0);
  $pdf->cell(20,$alt,"Em","LR",0,"C",0);
  $pdf->cell(20,$alt,"Em 31 de","LR",0,"C",0);
  $pdf->cell(20,$alt,"","LR",0,"C",0);
  $pdf->cell(20,$alt,"","LR",0,"C",0);
  $pdf->cell(20,$alt,"","LR",0,"C",0);
  $pdf->cell(20,$alt,"Em","LR",0,"C",0);
  ...
  $pdf->cell(60,$alt,"",0,0,"C",0);
  $pdf->cell(20,$alt,"Exercícios","LR",0,"C",0);
  $pdf->cell(20,$alt,"dezembro de","LR",0,"C",0);
  $pdf->cell(20,$alt,"Pagos","LR",0,"C",0);
  $pdf->cell(20,$alt,"Cancelados","LR",0,"C",0);
  $pdf->cell(20,$alt,"Saldo","LR",0,"C",0);
  $pdf->cell(20,$alt,"Exercícios","LR",0,"C",0);
  $pdf->cell(20,$alt,"dezembro de","LR",0,"C",0);
  $pdf->cell(20,$alt,"Liquidado","LR",0,"C",0);
  $pdf->cell(20,$alt,"Pagos","LR",0,"C",0);
  $pdf->cell(20,$alt,"Cancelados","LR",0,"C",0);
  $pdf->cell(20,$alt,"Saldo","L",1,"C",0);
  
  $pdf->cell(60,$alt,"","B",0,"C",0);
  $pdf->cell(20,$alt,"Anteriores","LRB",0,"C",0);
  $pdf->cell(20,$alt,db_getsession("DB_anousu") - 1,"LRB",0,"C",0);
  $pdf->cell(20,$alt,"","LRB",0,"C",0);
  $pdf->cell(20,$alt,"","LRB",0,"C",0);
  $pdf->cell(20,$alt,"","LRB",0,"C",0);
  $pdf->cell(20,$alt,"Anteriores","LRB",0,"C",0);
  $pdf->cell(20,$alt,db_getsession("DB_anousu") - 1,"LRB",0,"C",0);
