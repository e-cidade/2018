...
if($ordem == 'a'){
  $xordem = " h02_descr, c.z01_nome ";
}else{
  $xordem = "  h02_descr, h01_descr, c.z01_nome ";
}
...
$sql = $clcurric->sql_query(null,
                            ' h03_seq, c.z01_numcgm, c.z01_nome, substr(h01_descr,1,65) as h01_descr, h03_data,h02_codigo, h02_descr, e.z01_nome as h01_cgmentid ', 
                            $xordem , 
                            $where);
// echo $sql ; exit;
