...
$clcgmcorreto->rotulo->label("z01_numcgm");
    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $clcgmcorreto->sql_record($clcgmcorreto->sql_query($pesquisa_chave,"*",null," z10_numcgm = $pesquisa_chave and z10_instit = ".db_getsession('DB_instit')." {$sWhere} "));
