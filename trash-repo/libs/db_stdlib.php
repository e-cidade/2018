  ...
  if (isset ($_POST["pri".$NomeForm])) {
    ...
    $query = str_replace("\\", "", $_POST["filtroquery"]);
          ...
          Retornado")."</form>
              ...
              <input name='recomecar' type='button' value='Recomeçar' onclick=\"js_troca_ordem('navega_lov".$NomeForm."','recomecar','0');\">
...
function db_menu($usuario, $modulo, $anousu, $instit) {
  ...
  if ($NumMenu != 0) {
    ...
    echo "<a class=\"menuButton\" id=\"menuModulosTela\" href=\"\" onclick=\"return buttonClick(event,'IListaAreas');return false\">Módulos</a>\n";
    echo "<a class=\"menuButton\" id=\"menuMostraHelp\" href=\"\" onclick=\"return buttonClick(event,'IMostraHelpMenu');return false\">Help</a>\n";
    //echo "&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a class=\"menuItem\" onMouseover=\"js_cria_objeto_div('mensagem_menu','Mensagem')\" onMouseout=\"js_remove_objeto_div('mensagem_menu')\" id=\"menuhelp\" href=\"\" onclick=\"buttonMensagemMenu();return false\">**** Você recebeu Mensagens ****</a>\n";
    

    $oPreferencias = unserialize(base64_decode(db_getsession('DB_preferencias_usuario')));
    if ($oPreferencias->getExibeBusca() == '1') {
      echo "<div style=\"margin-right:20px; float:right;\" id=\"autoComplete\">";
      echo "<label>Busca rápida de menus: </label>";
