...
$pdf->Open();
$pdf->AliasNbPages();
$head1 = "Quadro de Especificações por Evasão / Cancelamento";
...
$linhas1= pg_num_rows($result1);
  ...
  $pdf->cell(130,6,"Quadro de Especificações por Evasão / Cancelamento",1,1,"C",$cor);
	...
	for($c1=0;$c1<$linhas1;$c1++){
		...
		$sql2 = "Select
         ...
         where  ed47_v_sexo='M'
           ...
           and (ed60_c_situacao = 'CANCELADO'
           or ed60_c_situacao = 'EVADIDO')) as masculino,
        ...
        where  ed47_v_sexo='F'
          ...
          and ed57_i_serie = ed11_i_codigo
          and (ed60_c_situacao = 'CANCELADO'
          or ed60_c_situacao = 'EVADIDO')) as feminino
        from serie
