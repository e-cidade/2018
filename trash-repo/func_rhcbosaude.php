    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_rh70_sequencial) && (trim($chave_rh70_sequencial)!="") ){
                 $sql = $clrhcbo->sql_query($chave_rh70_sequencial,$campos,"rh70_sequencial", " rhcbo.rh70_sequencial =  $chave_rh70_sequencial and rh70_tipo = 4 $sRhcbo ");
        }else if(isset($chave_rh70_descr) && (trim($chave_rh70_descr)!="") ){
                 $sql = $clrhcbo->sql_query("",$campos,"rh70_sequencial"," upper(rh70_descr) like '".strtoupper($chave_rh70_descr)."%' and rh70_tipo = 4 $sRhcbo ");
        }else{
        ...
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          ...
          $result = $clrhcbo->sql_record($clrhcbo->sql_query(null,"rh70_estrutural,rh70_descr,rh70_sequencial",null,"rh70_estrutural = '".$pesquisa_chave."' and rh70_tipo = 4 $sRhcbo "));
