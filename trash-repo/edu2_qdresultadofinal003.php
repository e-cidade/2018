 ...
 for ($z = 0; $z < $clmatricula->numrows; $z++) {
   ...
   if ($linhas5 > 0) {
     ...
     for ($v = 0; $v < $linhas5; $v++) {
       ...
       $frequencia = (($itotalaulasdadas - $itotalfaltas) * 100) / $itotalaulasdadas;
   ...
   if (trim($ed60_c_situacao) != "MATRICULADO" || $linhas5 == 0) {
     ...
     $aDadosTermoAprovado  = DBEducacaoTermo::getTermoEncerramento($ed11_i_ensino, 'A');
     $aDadosTermoReprovado = DBEducacaoTermo::getTermoEncerramento($ed11_i_ensino, 'R');
