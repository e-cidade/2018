...
if(isset($opcao) && $opcao == "alterar"){
  echo "<script>location.href='pro1_andpadrao002.php?chavepesquisa=$p53_codigo&chavepesquisa1=$p53_ordem'</script>";}
if(isset($opcao) && $opcao == "excluir"){
  echo "<script>location.href='pro1_andpadrao003.php?chavepesquisa=$p53_codigo&chavepesquisa1=$p53_ordem'</script>";
}
?>
...
db_input('p53_codigo',3,$Ip53_codigo,true,'hidden',$db_opcao,"",'p53_codigo_old');
?>
       <?
...
db_input('p53_coddepto',5,$Ip53_coddepto,true,'hidden',$db_opcao,"",'p53_coddepto_old');
if($db_opcao == 2){
  echo "
        <script>
...
function js_pesquisap53_codigo(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('top.corpo','db_iframe_pctipoproc','func_tipoproc.php?funcao_js=parent.js_mostratipoproc1|0|1','Pesquisa',true);
...
//    db_iframe.jan.location.href = 'func_tipoproc.php?pesquisa_chave='+document.form1.p53_codigo.value+'&funcao_js=parent.js_mostratipoproc';
    js_OpenJanelaIframe('top.corpo','db_iframe_pctipoproc','func_tipoproc.php?pesquisa_chave='+document.form1.p53_codigo.value+'&funcao_js=parent.js_mostratipoproc','Pesquisa',false);
  }
}
...
function js_pesquisap53_coddepto(mostra){
  if(mostra==true){
      js_OpenJanelaIframe('top.corpo','db_iframe_db_depart','func_db_depart_transferencias.php?todasinstit=1&funcao_js=parent.js_mostradb_depart1|0|1','Pesquisa',true);
...
if(@$p53_codigo == ""){
  ?>
  <script>
  onLoad=js_pesquisap53_codigo(true);
  </script>
  <?
}
