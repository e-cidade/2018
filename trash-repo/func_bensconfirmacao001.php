    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)) {
        ...
        if (isset($chave_t52_bem) && (trim($chave_t52_bem)!="") ) {
	         $sql = $clbens->sql_query_benstransf("",$campos,"t52_bem","t52_bem=$chave_t52_bem $where2_instit $where_baixado","tudo");
        	...
        	$sql = $clbens->sql_query_benstransf("",$campos,"t52_descr","t52_descr like '$chave_t52_descr%' $where2_instit $where_baixado","tudo");
        	
        } else if(isset($where) && (trim($where)!="") ) {
        	
	        if($where == 'NDA'){
	          $sql = $clbens->sql_query_benstransf("",$campos,""," t52_depart = -1 $where2_instit $where_baixado","","tudo");
          } else {
        ...
        if ($pesquisa_chave!=null && $pesquisa_chave!="") {
          ...
          if (isset($chave_id_usuario) && (trim($chave_id_usuario)!="") ) {
            $sql = $clbens->sql_query_benstransf("",$campos,"","t52_bem=$pesquisa_chave $where2_instit $where_baixado","tudo");
	          $result = $clbens->sql_record($sql);
	          
          } else if(isset($chave_coddepto) && (trim($chave_descrdepto)!="")) {
            $sql = $clbens->sql_query_benstransf("",$campos,"","t52_depart = $pesquisa_chave $where2_instit $where_baixado","tudo");
	          $result = $clbens->sql_record($sql);
	          
	        } else {
            $result = $clbens->sql_record($clbens->sql_query(null,"*",null,"t52_bem = $pesquisa_chave $where2_instit $where_baixado","tudo"));
	        }
