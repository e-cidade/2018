...
<script>
   function js_confirma_dados(){
       ...
       if (confirm("Confirma exclusao dos lotes "+lista_itens+" ?") == true){
...
if ($numrows == 0&&trim(@$excluir)==""){
      $erro_msg = "Nenhum lote cadastrado ou foram excluidos desta licitacao.";
      echo "<script>
...
if ($numrows == 0&&trim(@$excluir)!=""){
      $erro_msg = "Todos os lotes desta licitacao foram excluidos.";
      echo "<script>
               document.form2.excluir.disabled = true;
            </script>";          
}
