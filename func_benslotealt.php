    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_t43_codlote) && (trim($chave_t43_codlote)!="") ){
	         $sql = $clbenslote->sql_query(null,$campos,"t42_codigo","t43_codlote=$chave_t43_codlote");
        }else if(isset($chave_t42_descr) && (trim($chave_t42_descr)!="") ){
	         $sql = $clbenslote->sql_query("",$campos,"t42_codigo"," t42_descr like '%$chave_t42_descr%' ");
        }else{
           $sql = $clbenslote->sql_query("",$campos,"t42_codigo","");
        }
        $repassa = array();
