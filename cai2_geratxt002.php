...
$dbwhere  = " and e80_instit = " .db_getsession("DB_instit") . " and e97_codforma = 3";
$dbwhere .= " and e90_codmov is null  ";
...
$sql    = $clempagemov->sql_query_txt(null,"distinct pc63_conta,
                                                     ...
                                                     1 as tipo",""," e90_codmov is null $dbwhere and $sWhereOrdem");
...
$sqlSlips  = $clempageslip->sql_query_txtbanco(null,"
                                                    ...
                                                    (case when z01_nome is  not null then z01_nome
                                                     ...
                                                     e81_valor ,
                                                     0 as vlrretencao,
                                                     2 as tipo",""," e90_codmov is null $dbwhere");
$sql .=  " union ".$sqlSlips;
