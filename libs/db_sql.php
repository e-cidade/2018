...
if($justific==true){
  $sql .=" datajust, ";
       ...
       from ( select distinct *,
		...
		inner join arreinstit on arreinstit.k00_numpre = i.k00_numpre 
		                     and arreinstit.k00_instit = $instit 
		inner	join issplan on q20_numpre = a.k00_numpre and q20_situacao <> 5
...
class cl_gera_sql_folha {
  ...
  function gerador_sql($sigla,$ano=null,$mes=null,$regist=null,$rubric=null,$campos=" * ",$order="",$where="",$instit=null){
    if($sigla == 'r14'){
      $arquivo = ' gerfsal';
    }elseif($sigla == 'r20'){
      $arquivo = ' gerfres';
