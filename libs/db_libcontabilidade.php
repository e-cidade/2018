...
class cl_translan extends cl_contranslan {
  ...
  function db_trans_empenho($codcom = null, $anousu, $iCodigoDocumento = '') {
    ...
    $this->sql = $this->sql_query_lr(null, "c46_seqtranslan,c47_seqtranslr,c46_codhist,c47_credito,c47_debito,c47_ref", 'c46_ordem',
  ...
  function db_trans_estorna_empenho($codcom = null, $anousu, $iCodigoDocumento = null) {
  ...
  function db_trans_liquida($codcom, $codele, $anousu, $iCodigoDocumento = null) {
    ...
    $this->sql = $this->sql_query_lr(null,"c47_compara,c47_seqtranslr,c47_ref,c46_seqtranslan,
                                           c46_codhist,c47_credito,c47_debito, c46_ordem", 'c46_ordem',
                                          "c45_coddoc = {$this->coddoc} and c45_anousu=" . db_getsession("DB_anousu") . " and c47_anousu={$anousu}");
    $this->result = $this->sql_record($this->sql);
  ...
  function db_trans_liquida_capital($codcom, $codele, $anousu) {
    ...
    $this->sql = $this
        ->sql_query_lr(null,
            "c47_compara,c47_seqtranslr,c47_ref,c46_seqtranslan,c46_codhist,c47_credito,
                                      c47_debito", 'c46_ordem',
            "    c45_coddoc = {$this->coddoc}
  ...
  function db_trans_estorna_liquida($codcom, $codele, $anousu, $iCodigoDocumento = null) {
    ...
    $this->sql = $this->sql_query_lr(null,"c47_compara,c47_seqtranslr,c47_ref,c46_seqtranslan,c46_codhist,
                                           c47_credito,c47_debito", 'c46_ordem',
                                          " c45_coddoc    = {$this->coddoc} and c45_anousu={$iAnoSessao}
                                           and c47_anousu = {$anousu}");
  ...
  function db_trans_pagamento($codele, $reduzido, $anousu, $iNumEmp = null, $iCodigoDocumento = null) {
    ...
    if (USE_PCASP) {
      ...
      if ($oGrupoOrcamento) {
        ...
        if ($oGrupoOrcamento->getCodigo() == 8) {
          ...
          $iTotalContas = count($aContasMaterial);
          if ($iTotalContas <> 1) {

            $sMensagem  = "Existe inconsistência na configuração dos grupo de materiais dos itens do empenho.\n";
            $sMensagem .= "Foram encontrados {$iTotalContas} grupos com as contas do grupo do material.";
            $sMensagem .= "Possiveis itens com problema:\n";
            foreach ($aItens as $oItem) {
              $sMensagem .= "{$oItem->m60_codmater} - {$oItem->m60_descr}\n";
            }
    ...
    $aDocumentosConferencia = array(204, 208, 209, 210, 211);
    if ( USE_PCASP && (in_array($coddoc_liq, $aDocumentosConferencia) || in_array($coddoc_liq_capital, $aDocumentosConferencia))) {

      $sSqlContaCreditoLiquidacao  = " select conlancamval.c69_credito as c47_credito";
      $sSqlContaCreditoLiquidacao .= "        , 0 as c47_seqtranslr";
      $sSqlContaCreditoLiquidacao .= "        , contranslan.c46_codhist";
      ...
      $sSqlContaCreditoLiquidacao .= "        inner join contrans     on (contrans.c45_coddoc = {$coddoc_liq_capital} ";
      $sSqlContaCreditoLiquidacao .= "                                or contrans.c45_coddoc  = {$coddoc_liq})";
      $sSqlContaCreditoLiquidacao .= "        inner join contranslan on contranslan.c46_seqtrans = contrans.c45_seqtrans";
      $sSqlContaCreditoLiquidacao .= "  where conlancamemp.c75_numemp  = {$iNumEmp}";
      $sSqlContaCreditoLiquidacao .= "    and (conlancamdoc.c71_coddoc = {$coddoc_liq_capital}";
      $sSqlContaCreditoLiquidacao .= "     or conlancamdoc.c71_coddoc  = {$coddoc_liq})";
      $sSqlContaCreditoLiquidacao .= "    and contrans.c45_anousu      = {$iAnoSessao}";
      $sSqlContaCreditoLiquidacao .= "    and contrans.c45_instit      = {$iInstituicaoSessao}";
      $sSqlContaCreditoLiquidacao .= "  order by conlancamval.c69_sequen asc ";
    ...
    $this->sql = $this->sql_query_lr(null,
    		                             " c47_seqtranslr,c47_credito,c47_debito",
    		                             " c46_ordem",
                                     " c45_coddoc = ".$this->coddoc.
    		                             " and c45_anousu=".db_getsession("DB_anousu").
                                     " and c47_anousu=$anousu");
  ...
  function db_trans_estorna_pagamento($codele, $reduzido, $anousu, $iNumEmp, $iCodigoDocumento = null) {
    ...
    $sSqlContaCreditoLiquidacao .= "       inner join contranslr on c47_seqtranslan = c46_seqtranslan ";
    $sSqlContaCreditoLiquidacao .= " where (c45_coddoc = $coddoc_liq_capital or c45_coddoc = $coddoc_liq) ";
    $sSqlContaCreditoLiquidacao .= "   and c45_anousu  = " . db_getsession("DB_anousu");
    $sSqlContaCreditoLiquidacao .= "   and c47_instit  = " . db_getsession("DB_instit");
    $sSqlContaCreditoLiquidacao .= "  {$sWhereConta}";

    $aDocumentosConferencia = array(208, 209, 210, 211);
    if ( USE_PCASP && (in_array($coddoc_liq, $aDocumentosConferencia) || in_array($coddoc_liq_capital, $aDocumentosConferencia))) {
    ...
    $this->sql = $this
        ->sql_query_lr(null, "c47_seqtranslr,c47_credito,c47_debito", 'c46_ordem',
   ...
   * @todo refatorar
   */
  public function db_trans_liquida_resto($codcom, $codele, $anousu, $numemp) {
    ...
    $sCamposRegraLancamento  = "c47_tiporesto, c47_seqtranslr, c47_ref, c46_seqtranslan, c47_compara,";
    $sCamposRegraLancamento .= "c46_codhist,c47_credito,c47_debito,c47_instit, c46_ordem";
    $sWhereRegraLancamento   = "     c45_coddoc = {$this->coddoc}";
    $sWhereRegraLancamento  .= " and c45_anousu = {$iAnoSessao}";
    $sWhereRegraLancamento  .= " and c47_anousu = {$anousu}";
    $this->sql    = $this->sql_query_lr(null, $sCamposRegraLancamento, 'c46_ordem',$sWhereRegraLancamento);
    $this->result = $this->sql_record($this->sql);
    $cont = 0;
    $arr_lans = array();
    /**
    ...
    for ($i = 0; $i < $this->numrows; $i++) {
      ...
      if ($c47_debito != $codele && USE_PCASP && $c46_ordem == 1) {
        continue;
      }
  ...
  public function db_trans_estorna_liquida_resto($codcom, $codele, $anousu, $numemp) {
    ...
    $sCamposRegraLancamento  = "c47_tiporesto, c47_seqtranslr, c47_ref, c46_seqtranslan, ";
    $sCamposRegraLancamento .= "c46_codhist,c47_credito,c47_debito, c46_ordem";
    $sWhereRegraLancamento   = "     c45_coddoc = {$this->coddoc}";
    $sWhereRegraLancamento  .= " and c45_anousu = {$iAnoSessao}";
    $sWhereRegraLancamento  .= " and c47_anousu = {$anousu}";
    $this->sql    = $this->sql_query_lr(null, $sCamposRegraLancamento, 'c46_ordem', $sWhereRegraLancamento);
    ...
    for ($i = 0; $i < $this->numrows; $i++) {
      ...
      if ($c47_credito != $codele && USE_PCASP && $c46_ordem == 1) {
        continue;
      }
  ...
  function db_trans_estorna_pagamento_resto($codele, $reduz, $anousu, $numemp, $iCodDoc = 36) {
    ...
    $this->sql = $this->sql_query_lr(null, "c47_tiporesto,
    		                                    c47_seqtranslr,
    		                                    c47_ref,
    		                                    c46_seqtranslan,
    		                                    c46_codhist,
  ...
  function db_trans_estorna_empenho_resto($codcom = null, $anousu, $numemp) {
    ...
    $this->coddoc = 32;
    $this->sql = $this
        ->sql_query_lr(null, "c47_tiporesto,c47_seqtranslr,c47_ref,c46_seqtranslan,c46_codhist,c47_credito,c47_debito",
            'c46_ordem',
            "c45_coddoc = " . $this->coddoc . " and c45_anousu=" . db_getsession("DB_anousu")
                . " and c47_anousu=$anousu");
    $this->result = $this->sql_record($this->sql);
  ...
  function db_trans_arrecada_receita($conta, $codcon, $anousu, $iCodigoDocumento = null, $iCodigoReceitaOrcamentaria = null) {
    ...
    $sCampos      = "c47_seqtranslr, c47_ref, c46_seqtranslan, c46_ordem, c46_codhist, c47_credito, c47_debito, c47_compara";
    $sWhere       = " c45_coddoc = {$this->coddoc} and c45_anousu=" . db_getsession("DB_anousu") . " and c47_anousu=" . db_getsession("DB_anousu");
    $sOrder       = 'c46_ordem';
    $this->sql    = $this->sql_query_receita(null, $sCampos, $sOrder, $sWhere);
    $this->result = $this->sql_record($this->sql);
  ...
  function db_trans_estorno_receita($conta, $codcon, $anousu, $iCodigoDocumento = null, $iCodigoReceitaOrcamentaria = null) {
    ...
    $this->sql = $this->sql_query_lr(null, "c46_ordem, c47_seqtranslr,c47_ref,c46_seqtranslan,c46_codhist,c47_credito,c47_debito,c47_compara",
                                           'c46_ordem',
                                           "    c45_coddoc = {$this->coddoc}
                                                                     and c45_anousu=" . db_getsession("DB_anousu")
                                               . "
  ...
  function db_trans_controle_despesa_liquidacao($iCodigoDocumento) {
    ...
    $this->sql = $this->sql_query_lr(null, "c47_seqtranslr,c47_ref,c46_seqtranslan,c46_codhist,c47_credito,c47_debito,c47_compara,c46_ordem",
                                     'c46_ordem',
                                     "    c45_coddoc = {$this->coddoc}
                                       and c45_anousu=" . db_getsession("DB_anousu") . "
                                       and c47_anousu=" . db_getsession("DB_anousu") . "
  ...
  public static function getVinculoPcasp($iCodigoConta) {
    ...
    if (USE_PCASP) {
      ...
      if ($oDaoConplanoConplanoOrcamento->numrows == 0) {
        $sMsgErro = "Conta {$iCodigoConta} não possui vínculo com o PCASP.\n ";
      ...
      for ($i = 0; $i < pg_numrows($result); $i++) {
        ...
        for ($ii = 1; $ii < 10; $ii++) {
          ...
          // busca no banco e inclui
            $res = db_query(
                "select c60_descr,c60_finali,c60_codcon
            from conplano
            where c60_anousu=" . $anousu . " and c60_estrut = '$estrutural'");
            if ($res == false || pg_numrows($res) == 0) {
              db_redireciona(
                  "db_erros.php?fechar=true&db_erro=Está faltando cadastrar esse estrutural na contabilidade. Nível : $nivel  Estrutural : $estrutural - ano: $anousu");
              exit;
            }
            db_fieldsmemory($res, 0);
