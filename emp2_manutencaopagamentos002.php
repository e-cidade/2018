...
$sCampos  = ",k13_conta,k13_descr, e96_descr,pc63_banco, pc63_agencia,pc63_agencia_dig,pc63_conta,pc63_conta_dig";
...
foreach ($aOrdensAgenda as $oMovimento) {
 ...
 if ($oPdf->Gety() > $oPdf->h - 25 || $lEscreverHeader) {
  ...
  if ($oPdf->Gety() > $oPdf->h - 25) {
   ...
   $oPdf->cell(35,5,"Conta",1,0,"C",1);
   $oPdf->cell(18,5,"Forma PGTO",1,0,"C",1);
   $oPdf->cell(20,5,"Dt Aut",1,0,"C",1);
  ...
  $oPdf->cell(35,5, $sContaBanco,"TBR",0,"L");
  $oPdf->cell(18,5,$oMovimento->e96_descr, "TBR", 0, "L");
  $oPdf->cell(20,5, $oMovimento->e42_sequencial." (".db_formatar($oMovimento->e42_dtpagamento,"d").")", "TBR", 0, "C");
