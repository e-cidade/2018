...
if (!isset($arqinclude)){
  ...
  $oLinha               = new stdClass();
  $oLinha->o69_labelrel = "PASSIVOS CONTIGENTES";
  $oLinha->total1       = "";
  $oLinha->total2       = "";
  $oLinha->total3       = "";
  $oLinha->total4       = "";
  ...
  $oLinha               = new stdClass();
  $oLinha->o69_labelrel = "ATIVOS CONTIGENTES";
  $oLinha->total1       = "";
  $oLinha->total2       = "";
  $oLinha->total3       = "";
  $oLinha->total4       = "";
  ...
  $oLinha               = new stdClass();
  $oLinha->o69_labelrel = "TOTAL DAS DESPESAS / RCL(%)";
  $aLinhasRelatorio[]   = $oLinha;
...
if (!isset($arqinclude)) {
	...
	$resultinst = pg_exec("select munic from db_config where codigo in ({$instit}) ");
	$descr_inst = '';
...
//$vdt_fin = split("-", $dt_fin);
  ...
  $head2 = "MUNICÍPIO DE " . strtoupper($descr_inst);
  ...
  $pdf->setfont('arial','',6);
  $pdf->cell(90,$alt,"RREO - ANEXO XVII (Lei n".chr(176)." 11.079, de 30.12.2004, arts, 22, 25 e 28)",0,0,"L",0);
...
// Cabecalho de receitas
  ...
  $pdf->Ln();
  $pdf->setfont('arial','',6); 
  $pdf->cell(36,$alt,"TOTAL DAS DESPESAS / RCL(%)" ,'TB',0,"L",1);
  $pdf->setfont('arial','',5);
