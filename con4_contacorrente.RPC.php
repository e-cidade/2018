  ...
  switch ($oParam->exec) {
       ...
       */
  		...
  		if ($oValoresConplanoExe->c62_vlrcre > 0 && $oValoresConplanoExe->c62_vlrdeb > 0) {
  			...
  			$sErroMessage = "ERRO [ 1 ] - Conta com valores a débito e a crédito.\n A conta deve ser corrigida a débito ou a crédito";
  			throw new BusinessException($sErroMessage);
  		}
  		if ($oValoresConplanoExe->c62_vlrcre <= 0 && $oValoresConplanoExe->c62_vlrdeb <= 0) {

  			$sErroMessage = "ERRO [ 2 ] - Conta com valores a débito e a crédito zerado.\n A conta deve ser corrigida a débito ou a crédito";
  			throw new BusinessException($sErroMessage);
  		}
  		/*
