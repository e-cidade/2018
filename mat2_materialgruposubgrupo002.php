...
$sSqlMovimentacao .= "                       inner join db_depart on m70_coddepto = coddepto ";
...
$sSqlMovimentacao .= "                 where {$sWhere} and instit = " . db_getsession("DB_instit") . " and b.m60_codmater = matmater.m60_codmater {$WhereAlmoxarifados} ";
...
$sSqlValorFinanceiro .= "                       inner join db_depart on m70_coddepto = coddepto ";
...
$sSqlValorFinanceiro .= "                 where {$sWhere} and instit = " . db_getsession("DB_instit") . " and b.m60_codmater = matmater.m60_codmater {$WhereAlmoxarifados} ";
...
for ($i = 0; $i < $iNumRowsItens; $i++) {
  ...
  $oItem->valor = ($oItem->quantidade * $oItem->valorfinanceiro);
