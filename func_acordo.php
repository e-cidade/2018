      ...
      if (!isset($pesquisa_chave)) {
        ...
        if (isset($campos) == false) {
          ...
          if (file_exists("funcoes/db_func_acordo.php") == true) {
            ...
            $campos  = "distinct acordo.ac16_sequencial, acordo.ac16_acordosituacao, acordo.ac16_coddepto";
        ...
        if (isset($chave_ac16_sequencial) && (trim($chave_ac16_sequencial)!="")) {
           ...
           $sql = $clacordo->sql_query_acordoitemexecutado("",$campos,"ac16_sequencial", $sWhere);
        }
