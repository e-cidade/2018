...
include_once("classes/db_orcreserva_classe.php"); // classe da reserva
...
//$pdf->cell( 30,$alt,$o58_elemento,1,0,"L",0);
...
if(isset($reservado) && ($reservado >0)){
  ...
  $res=$clorcreserva->sql_record($clorcreserva->sql_query_reservas(null,"o80_codres,o83_autori,o80_dtini,o80_dtfim,o80_valor,o80_descr","o80_codres",
                      "o80_coddot= $coddot
		       and o80_anousu=$anousu
		       and ('$fim' >= o80_dtfim  and o80_dtfim >='$ini')
                       and '$ini'>= o80_dtini and o83_codres is not null "));
  ...
  $res=$clorcreserva->sql_record($clorcreserva->sql_query_reservas(null,"*","o80_codres",
                      "o80_coddot= $coddot
                       and o80_anousu=$anousu
                       and ('$fim' >= o80_dtfim  and o80_dtfim >='$ini')
                       and '$ini'>= o80_dtini  
