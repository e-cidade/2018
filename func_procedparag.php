    ...
    <td height="63" align="center" valign="top">
        <table width="35%" border="0" align="center" cellspacing="0">
	     <form name="form2" method="post" action="" >
          <tr> 
            <td width="4%" align="right" nowrap title="<?=$Tv80_proced?>">
              <?=$Lv80_proced?>
            </td>
          ...
          <tr> 
            <td width="4%" align="right" nowrap title="<?=$Tv80_docum?>">
              <?=$Lv80_docum?>
            </td>
            <td width="96%" align="left" nowrap> 
              <?
          ...
          <tr> 
            <td colspan="2" align="center"> 
              ...
              <input name="Fechar" type="button" id="fechar" value="Fechar" onClick="parent.db_iframe_procedparag.hide();">
             </td>
          </tr>
        </form>
        </table>
    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $clprocedparag->sql_record($clprocedparag->sql_query($pesquisa_chave));
          if($clprocedparag->numrows!=0){
            db_fieldsmemory($result,0);
            echo "<script>".$funcao_js."('$v80_docum',false);</script>";
          }else{
