...
$result=$clpagordem->sql_record($clpagordem->sql_query_pagordemele(null,"e50_codord,e50_numemp,e60_numcgm,e50_obs,e50_data,z01_nome,sum(e53_valor-e53_vlranu) as e53_valor ","$ordem","  $where $where1 $where2 group by e50_codord,e50_numemp,e60_numcgm,e50_obs,e50_data,z01_nome"));
...
$pdf->cell(080,$alt,db_formatar($totalvalor,'f'),"T",0,"L",0);
