 ...
 <tr>
  ...
  if(!isset($pesquisa_chave)){
   if (isset($chave_ed47_i_codigo) && (trim($chave_ed47_i_codigo) != "")) {
    ...
    $sWhere .= "                  AND tur.ed57_i_turno = {$iTurno}";
    $sWhere .= "                  AND cal.ed52_i_ano   = calendario.ed52_i_ano";
    $sWhere .= "                  AND mat.ed60_c_ativa = 'S')";
    $sql = $oDaoAluno->sql_query_aluno_curso("", $sCampos, "ed47_v_nome, ed47_i_codigo", $sWhere);
    ...
    db_lovrot($sql,15,"()","", $funcao_js,"","NoMe",$repassa);
     ...
     if ($pesquisa_chave!=null && $pesquisa_chave!="") {
      ...
      $result  = $oDaoAluno->sql_record($oDaoAluno->sql_query_file("","*","",$sWhere));
