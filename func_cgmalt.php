...
<table height="100%" border="0"  align="center" cellspacing="0" bgcolor="#CCCCCC">
  <tr> 
		<td height="63" align="center" valign="top">
          ...
          <tr> 
            <td width="4%" align="right" nowrap title="<?=$Tz05_sequencia?>">
              <?=$Lz05_sequencia?>
            </td>
            <td width="96%" align="left" nowrap> 
              <?
								db_input("z05_sequencia",10,$Iz05_sequencia,true,"text",4,"","chave_z05_sequencia");
							?>
            </td>
          </tr>
          <tr> 
            <td colspan="2" align="center"> 
              ...
              <input name="Fechar"		type="button" id="fechar"			value="Fechar" onClick="parent.db_iframe_cgmalt.hide();">
            </td>
          </tr>
        </form>
      </table>
    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
				...
				if(isset($campos)==false){
					 	$campos = "z05_numcgm, z05_nome,trim(z05_cgccpf) as z05_cgccpf, case when length(trim(z05_cgccpf)) = 14 then 'JURIDICA' else 'FÍSICA' end as tipo, trim(z05_ender) as z05_ender, z05_munic, z05_uf, z05_cep, z05_email,z05_data_alt, z05_hora_alt, z05_login_alt";
        }
				...
				if(isset($chave_z05_sequencia) && (trim($chave_z05_sequencia)!="") ){
					 ...
					 $sql = $clcgmalt->sql_query("",$campos,"z05_sequencia","z05_nome like '%{$pesquisa_nomealt}%' and z05_tipo_alt = 'A'");
				}else{
