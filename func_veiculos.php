    ...
    <td align="center" valign="top"> 
      ...
      //$dbwhere = " (ve36_coddepto = ".db_getsession("DB_coddepto")." or  ve37_coddepto = ".db_getsession("DB_coddepto").") ";
        ...
        if(isset($chave_ve01_codigo) && trim($chave_ve01_codigo)!=""){
	         $sql = $clveiculos->sql_query(null,$campos,"ve01_codigo","ve01_codigo = $chave_ve01_codigo ");
         
        }else if (isset($chave_ve01_placa) && trim($chave_ve01_placa)!=""){
           $sql = $clveiculos->sql_query("",$campos,"ve01_placa","ve01_placa = '$chave_ve01_placa' ");
        }else if (isset($chave_ve01_veiccadmodelo)  && trim($chave_ve01_veiccadmodelo)!="" && $chave_ve01_veiccadmodelo > 0){ 
           $sql = $clveiculos->sql_query("",$campos,"veiccadmodelo.ve22_descr","ve01_veiccadmodelo = $chave_ve01_veiccadmodelo ");
        }else if (isset($chave_ve01_veiccadmarca) && trim($chave_ve01_veiccadmarca)!=""  && $chave_ve01_veiccadmarca > 0){
           $sql = $clveiculos->sql_query("",$campos,"veiccadmarca.ve21_descr","ve01_veiccadmarca = $chave_ve01_veiccadmarca ");
        }else if (isset($chave_ve01_veiccadtipo) && trim($chave_ve01_veiccadtipo)!="" && $chave_ve01_veiccadtipo > 0){
           $sql = $clveiculos->sql_query("",$campos,"veiccadtipo.ve20_descr","ve01_veiccadtipo = $chave_ve01_veiccadtipo ");
        }else { 
           
           $sql = $clveiculos->sql_query("",$campos,"ve01_codigo","");
        }
        $repassa = array();
